---
name: orm-remote
description: ORM client for the remote API — provides typed CRUD operations for 3 tables and 1 custom operations
---
...
ORM client for the remote API — provides typed CRUD operations for 3 tables and 1 custom operations
