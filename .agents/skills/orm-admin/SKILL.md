---
name: orm-admin
description: ORM client for the admin API — provides typed CRUD operations for 33 tables and 16 custom operations
---
...
ORM client for the admin API — provides typed CRUD operations for 33 tables and 16 custom operations
