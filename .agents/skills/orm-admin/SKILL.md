---
name: orm-admin
description: ORM client for the admin API — provides typed CRUD operations for 26 tables and 9 custom operations
---
...
ORM client for the admin API — provides typed CRUD operations for 26 tables and 9 custom operations
