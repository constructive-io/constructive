---
name: orm-admin
description: ORM client for the admin API — provides typed CRUD operations for 28 tables and 11 custom operations
---
...
ORM client for the admin API — provides typed CRUD operations for 28 tables and 11 custom operations
