---
name: orm-admin
description: ORM client for the admin API — provides typed CRUD operations for 44 tables and 12 custom operations
---
...
ORM client for the admin API — provides typed CRUD operations for 44 tables and 12 custom operations
