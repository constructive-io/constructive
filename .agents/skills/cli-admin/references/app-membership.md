...
csdk app-membership create --actorId <UUID> [--createdBy <UUID>] [--granted <BitString>] [--isActive <Boolean>] [--isAdmin <Boolean>] [--isApproved <Boolean>] [--isBanned <Boolean>] [--isDisabled <Boolean>] [--isOwner <Boolean>] [--isVerified <Boolean>] [--permissions <BitString>] [--profileId <UUID>] [--updatedBy <UUID>]
csdk app-membership update --id <UUID> [--actorId <UUID>] [--createdBy <UUID>] [--granted <BitString>] [--isActive <Boolean>] [--isAdmin <Boolean>] [--isApproved <Boolean>] [--isBanned <Boolean>] [--isDisabled <Boolean>] [--isOwner <Boolean>] [--isVerified <Boolean>] [--permissions <BitString>] [--profileId <UUID>] [--updatedBy <UUID>]
