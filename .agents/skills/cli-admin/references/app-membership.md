...
csdk app-membership create --actorId <UUID> [--capabilities <BitString>] [--createdBy <UUID>] [--granted <BitString>] [--isActive <Boolean>] [--isAdmin <Boolean>] [--isApproved <Boolean>] [--isBanned <Boolean>] [--isDisabled <Boolean>] [--isOwner <Boolean>] [--isVerified <Boolean>] [--profileId <UUID>] [--updatedBy <UUID>]
csdk app-membership update --id <UUID> [--actorId <UUID>] [--capabilities <BitString>] [--createdBy <UUID>] [--granted <BitString>] [--isActive <Boolean>] [--isAdmin <Boolean>] [--isApproved <Boolean>] [--isBanned <Boolean>] [--isDisabled <Boolean>] [--isOwner <Boolean>] [--isVerified <Boolean>] [--profileId <UUID>] [--updatedBy <UUID>]
