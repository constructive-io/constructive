...
csdk app-owner-grant create [--actorId <UUID>] [--grantorId <UUID>] [--isGrant <Boolean>]
csdk app-owner-grant update --id <UUID> [--actorId <UUID>] [--grantorId <UUID>] [--isGrant <Boolean>]
