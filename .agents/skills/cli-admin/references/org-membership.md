...
csdk org-membership create --actorId <UUID> --entityId <UUID> [--capabilities <BitString>] [--createdBy <UUID>] [--granted <BitString>] [--isActive <Boolean>] [--isAdmin <Boolean>] [--isApproved <Boolean>] [--isBanned <Boolean>] [--isDisabled <Boolean>] [--isExternal <Boolean>] [--isOwner <Boolean>] [--isReadOnly <Boolean>] [--profileId <UUID>] [--updatedBy <UUID>]
csdk org-membership update --id <UUID> [--actorId <UUID>] [--capabilities <BitString>] [--createdBy <UUID>] [--entityId <UUID>] [--granted <BitString>] [--isActive <Boolean>] [--isAdmin <Boolean>] [--isApproved <Boolean>] [--isBanned <Boolean>] [--isDisabled <Boolean>] [--isExternal <Boolean>] [--isOwner <Boolean>] [--isReadOnly <Boolean>] [--profileId <UUID>] [--updatedBy <UUID>]
