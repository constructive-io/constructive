...
csdk app-grant create [--actorId <UUID>] [--capabilities <BitString>] [--grantorId <UUID>] [--isGrant <Boolean>]
csdk app-grant update --id <UUID> [--actorId <UUID>] [--capabilities <BitString>] [--grantorId <UUID>] [--isGrant <Boolean>]
