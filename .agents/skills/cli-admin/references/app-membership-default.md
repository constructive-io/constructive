...
csdk app-membership-default create [--createdBy <UUID>] [--createdByPrincipal <UUID>] [--isApproved <Boolean>] [--isVerified <Boolean>] [--updatedBy <UUID>] [--updatedByPrincipal <UUID>]
csdk app-membership-default update --id <UUID> [--createdBy <UUID>] [--createdByPrincipal <UUID>] [--isApproved <Boolean>] [--isVerified <Boolean>] [--updatedBy <UUID>] [--updatedByPrincipal <UUID>]
