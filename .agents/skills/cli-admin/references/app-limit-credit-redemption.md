...
csdk app-limit-credit-redemption create --creditCodeId <UUID> --entityId <UUID>
csdk app-limit-credit-redemption update --id <UUID> [--creditCodeId <UUID>] [--entityId <UUID>]
