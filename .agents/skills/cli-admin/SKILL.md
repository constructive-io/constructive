---
name: cli-admin
description: CLI tool (csdk) for the admin API — provides CRUD commands for 28 tables and 11 custom operations
---
...
CLI tool (csdk) for the admin API — provides CRUD commands for 28 tables and 11 custom operations
