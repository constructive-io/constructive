---
name: cli-admin
description: CLI tool (csdk) for the admin API — provides CRUD commands for 34 tables and 15 custom operations
---
...
CLI tool (csdk) for the admin API — provides CRUD commands for 34 tables and 15 custom operations
