---
name: cli-admin
description: CLI tool (csdk) for the admin API — provides CRUD commands for 26 tables and 4 custom operations
---
...
CLI tool (csdk) for the admin API — provides CRUD commands for 26 tables and 4 custom operations
