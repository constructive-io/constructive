---
name: cli-admin
description: CLI tool (csdk) for the admin API — provides CRUD commands for 46 tables and 16 custom operations
---
...
CLI tool (csdk) for the admin API — provides CRUD commands for 46 tables and 16 custom operations
