...
csdk rate-limit-meters-module create --databaseId <UUID> [--schemaId <UUID>] [--privateSchemaId <UUID>] [--rateLimitStateTableId <UUID>] [--rateLimitStateTableName <String>] [--rateLimitOverridesTableId <UUID>] [--rateLimitOverridesTableName <String>] [--rateWindowLimitsTableId <UUID>] [--rateWindowLimitsTableName <String>] [--checkRateLimitFunction <String>] [--prefix <String>]
