...
csdk compute-log-module create --databaseId <UUID> [--schemaId <UUID>] [--privateSchemaId <UUID>] [--computeLogTableId <UUID>] [--computeLogTableName <String>] [--usageDailyTableId <UUID>] [--usageDailyTableName <String>] [--interval <String>] [--retention <String>] [--premake <Int>] [--scope <String>] [--actorFkTableId <UUID>] [--entityFkTableId <UUID>] [--prefix <String>]
