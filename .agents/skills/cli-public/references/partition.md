...
csdk partition create --databaseId <UUID> --tableId <UUID> --strategy <String> --partitionKeyId <UUID> [--interval <String>] [--retention <String>] [--lookahead <Int>] [--namingPattern <String>]
csdk partition update --id <UUID> [--databaseId <UUID>] [--tableId <UUID>] [--strategy <String>] [--partitionKeyId <UUID>] [--interval <String>] [--retention <String>] [--lookahead <Int>] [--namingPattern <String>]
