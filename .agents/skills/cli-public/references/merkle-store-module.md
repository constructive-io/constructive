...
csdk merkle-store-module create --databaseId <UUID> [--schemaId <UUID>] [--publicSchemaName <String>] [--objectTableId <UUID>] [--storeTableId <UUID>] [--commitTableId <UUID>] [--refTableId <UUID>] [--prefix <String>] [--apiName <String>] [--scopeField <String>]
csdk merkle-store-module update --id <UUID> [--databaseId <UUID>] [--schemaId <UUID>] [--publicSchemaName <String>] [--objectTableId <UUID>] [--storeTableId <UUID>] [--commitTableId <UUID>] [--refTableId <UUID>] [--prefix <String>] [--apiName <String>] [--scopeField <String>]
