---
name: cli-public
description: CLI tool (csdk) for the public API — provides CRUD commands for 153 tables and 69 custom operations
---
...
CLI tool (csdk) for the public API — provides CRUD commands for 153 tables and 69 custom operations
