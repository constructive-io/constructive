---
name: cli-public
description: CLI tool (csdk) for the public API — provides CRUD commands for 150 tables and 69 custom operations
---
...
CLI tool (csdk) for the public API — provides CRUD commands for 150 tables and 69 custom operations
