---
name: cli-public
description: CLI tool (csdk) for the public API — provides CRUD commands for 124 tables and 71 custom operations
---
...
CLI tool (csdk) for the public API — provides CRUD commands for 124 tables and 71 custom operations
