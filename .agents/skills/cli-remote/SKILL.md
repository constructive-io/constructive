---
name: cli-remote
description: CLI tool (csdk) for the remote API — provides CRUD commands for 3 tables and 2 custom operations
---
...
CLI tool (csdk) for the remote API — provides CRUD commands for 3 tables and 2 custom operations
