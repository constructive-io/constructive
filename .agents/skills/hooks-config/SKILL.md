---
name: hooks-config
description: React Query hooks for the config API — provides typed query and mutation hooks for 8 tables and 17 custom operations
---
...
React Query hooks for the config API — provides typed query and mutation hooks for 8 tables and 17 custom operations
