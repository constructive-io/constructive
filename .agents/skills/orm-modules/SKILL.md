---
name: orm-modules
description: ORM client for the modules API — provides typed CRUD operations for 74 tables and 12 custom operations
---
...
ORM client for the modules API — provides typed CRUD operations for 74 tables and 12 custom operations
