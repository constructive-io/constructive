---
name: orm-modules
description: ORM client for the modules API — provides typed CRUD operations for 87 tables and 3 custom operations
---
...
ORM client for the modules API — provides typed CRUD operations for 87 tables and 3 custom operations
