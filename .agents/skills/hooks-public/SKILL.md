---
name: hooks-public
description: React Query hooks for the public API — provides typed query and mutation hooks for 124 tables and 71 custom operations
---
...
React Query hooks for the public API — provides typed query and mutation hooks for 124 tables and 71 custom operations
