---
name: hooks-compute
description: React Query hooks for the compute API — provides typed query and mutation hooks for 119 tables and 58 custom operations
---
...
React Query hooks for the compute API — provides typed query and mutation hooks for 119 tables and 58 custom operations
