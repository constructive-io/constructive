---
name: hooks-compute
description: React Query hooks for the compute API — provides typed query and mutation hooks for 113 tables and 56 custom operations
---
...
React Query hooks for the compute API — provides typed query and mutation hooks for 113 tables and 56 custom operations
