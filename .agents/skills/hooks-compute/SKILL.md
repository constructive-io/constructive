---
name: hooks-compute
description: React Query hooks for the compute API — provides typed query and mutation hooks for 69 tables and 38 custom operations
---
...
React Query hooks for the compute API — provides typed query and mutation hooks for 69 tables and 38 custom operations
