---
name: hooks-auth
description: React Query hooks for the auth API — provides typed query and mutation hooks for 15 tables and 55 custom operations
---
...
React Query hooks for the auth API — provides typed query and mutation hooks for 15 tables and 55 custom operations
