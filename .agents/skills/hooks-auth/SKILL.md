---
name: hooks-auth
description: React Query hooks for the auth API — provides typed query and mutation hooks for 15 tables and 57 custom operations
---
...
React Query hooks for the auth API — provides typed query and mutation hooks for 15 tables and 57 custom operations
...
- [send-phone-verification-code](references/send-phone-verification-code.md)
...
- [verify-phone](references/verify-phone.md)
