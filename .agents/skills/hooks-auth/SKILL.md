---
name: hooks-auth
description: React Query hooks for the auth API — provides typed query and mutation hooks for 7 tables and 28 custom operations
---
...
React Query hooks for the auth API — provides typed query and mutation hooks for 7 tables and 28 custom operations
