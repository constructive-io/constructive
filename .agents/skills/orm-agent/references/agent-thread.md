...
db.agentThread.create({ data: { ownerId: '<UUID>', status: '<String>', title: '<String>', mode: '<String>', model: '<String>', systemPrompt: '<String>', promptTemplateId: '<UUID>' }, select: { id: true } }).execute()
...
const item = await db.agentThread.create({
  data: { ownerId: '<UUID>', status: '<String>', title: '<String>', mode: '<String>', model: '<String>', systemPrompt: '<String>', promptTemplateId: '<UUID>' },
  select: { id: true }
}).execute();
```
