---
name: orm-objects
description: ORM client for the objects API — provides typed CRUD operations for 5 tables and 12 custom operations
---
...
ORM client for the objects API — provides typed CRUD operations for 5 tables and 12 custom operations
