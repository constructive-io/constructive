---
name: orm-public
description: ORM client for the public API — provides typed CRUD operations for 150 tables and 58 custom operations
---
...
ORM client for the public API — provides typed CRUD operations for 150 tables and 58 custom operations
...
// Available models: orgGetManagersRecord, orgGetSubordinatesRecord, appPermission, orgPermission, database, schema, table, checkConstraint, ...
