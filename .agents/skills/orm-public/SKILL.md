---
name: orm-public
description: ORM client for the public API — provides typed CRUD operations for 148 tables and 69 custom operations
---
...
ORM client for the public API — provides typed CRUD operations for 148 tables and 69 custom operations
...
// Available models: orgGetManagersRecord, orgGetSubordinatesRecord, getAllRecord, appPermission, orgPermission, object, database, schema, ...
