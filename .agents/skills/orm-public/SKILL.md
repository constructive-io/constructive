---
name: orm-public
description: ORM client for the public API — provides typed CRUD operations for 153 tables and 69 custom operations
---
...
ORM client for the public API — provides typed CRUD operations for 153 tables and 69 custom operations
...
// Available models: orgGetManagersRecord, orgGetSubordinatesRecord, getAllRecord, object, appPermission, orgPermission, database, schema, ...
