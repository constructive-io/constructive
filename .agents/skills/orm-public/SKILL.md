---
name: orm-public
description: ORM client for the public API — provides typed CRUD operations for 150 tables and 69 custom operations
---
...
ORM client for the public API — provides typed CRUD operations for 150 tables and 69 custom operations
