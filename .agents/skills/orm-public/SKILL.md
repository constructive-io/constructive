---
name: orm-public
description: ORM client for the public API — provides typed CRUD operations for 124 tables and 71 custom operations
---
...
ORM client for the public API — provides typed CRUD operations for 124 tables and 71 custom operations
