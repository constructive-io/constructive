...
csdk crypto-address create --address <String> [--isPrimary <Boolean>] [--isVerified <Boolean>] [--name <String>] [--ownerId <UUID>]
csdk crypto-address update --id <UUID> [--address <String>] [--isPrimary <Boolean>] [--isVerified <Boolean>] [--name <String>] [--ownerId <UUID>]
