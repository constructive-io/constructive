...
csdk audit-log-auth create --event <String> --success <Boolean> [--actorId <UUID>] [--details <JSON>] [--ipAddress <InternetAddress>] [--origin <Origin>] [--userAgent <String>]
csdk audit-log-auth update --id <UUID> [--actorId <UUID>] [--details <JSON>] [--event <String>] [--ipAddress <InternetAddress>] [--origin <Origin>] [--success <Boolean>] [--userAgent <String>]
