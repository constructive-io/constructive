...
csdk email create --email <Email> [--isPrimary <Boolean>] [--isVerified <Boolean>] [--name <String>] [--ownerId <UUID>]
csdk email update --id <UUID> [--email <Email>] [--isPrimary <Boolean>] [--isVerified <Boolean>] [--name <String>] [--ownerId <UUID>]
