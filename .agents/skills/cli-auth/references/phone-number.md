...
csdk phone-number create --cc <String> --number <String> [--isPrimary <Boolean>] [--isVerified <Boolean>] [--name <String>] [--ownerId <UUID>]
csdk phone-number update --id <UUID> [--cc <String>] [--isPrimary <Boolean>] [--isVerified <Boolean>] [--name <String>] [--number <String>] [--ownerId <UUID>]
