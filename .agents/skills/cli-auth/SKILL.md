---
name: cli-auth
description: CLI tool (csdk) for the auth API — provides CRUD commands for 9 tables and 27 custom operations
---
...
CLI tool (csdk) for the auth API — provides CRUD commands for 9 tables and 27 custom operations
