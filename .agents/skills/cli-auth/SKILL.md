---
name: cli-auth
description: CLI tool (csdk) for the auth API — provides CRUD commands for 15 tables and 57 custom operations
---
...
CLI tool (csdk) for the auth API — provides CRUD commands for 15 tables and 57 custom operations
