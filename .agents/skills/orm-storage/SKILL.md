---
name: orm-storage
description: ORM client for the storage API — provides typed CRUD operations for 4 tables and 7 custom operations
---
...
ORM client for the storage API — provides typed CRUD operations for 4 tables and 7 custom operations
