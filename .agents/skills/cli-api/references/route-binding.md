...
csdk route-binding create --domainId <UUID> --path <String> [--isActive <Boolean>] [--method <String>] [--priority <Int>] [--targetApiId <UUID>] [--targetFunctionId <UUID>] [--targetSiteId <UUID>]
csdk route-binding update --id <UUID> [--domainId <UUID>] [--isActive <Boolean>] [--method <String>] [--path <String>] [--priority <Int>] [--targetApiId <UUID>] [--targetFunctionId <UUID>] [--targetSiteId <UUID>]
