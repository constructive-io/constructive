...
csdk route-binding create --domainId <UUID> --path <String> [--isActive <Boolean>] [--method <String>] [--priority <Int>] [--servingSiteId <UUID>] [--targetApiId <UUID>] [--targetBucketId <UUID>] [--targetFunctionId <UUID>] [--targetRedirectId <UUID>] [--targetServiceId <UUID>] [--targetSiteId <UUID>]
csdk route-binding update --id <UUID> [--domainId <UUID>] [--isActive <Boolean>] [--method <String>] [--path <String>] [--priority <Int>] [--servingSiteId <UUID>] [--targetApiId <UUID>] [--targetBucketId <UUID>] [--targetFunctionId <UUID>] [--targetRedirectId <UUID>] [--targetServiceId <UUID>] [--targetSiteId <UUID>]
