...
csdk route create --databaseId <UUID> --domainId <UUID> [--config <JSON>] [--isActive <Boolean>] [--method <String>] [--path <String>] [--priority <Int>] [--targetApiId <UUID>] [--targetFunctionId <UUID>] [--targetSiteId <UUID>]
csdk route update --id <UUID> [--config <JSON>] [--databaseId <UUID>] [--domainId <UUID>] [--isActive <Boolean>] [--method <String>] [--path <String>] [--priority <Int>] [--targetApiId <UUID>] [--targetFunctionId <UUID>] [--targetSiteId <UUID>]
