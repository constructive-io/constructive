...
csdk foreign-key-constraint create --tableId <UUID> --fieldIds <UUID> --refTableId <UUID> --refFieldIds <UUID> [--databaseId <UUID>] [--name <String>] [--description <String>] [--smartTags <JSON>] [--type <String>] [--deleteAction <String>] [--updateAction <String>] [--category <ObjectCategory>] [--scope <Int>] [--tags <String>]
csdk foreign-key-constraint update --id <UUID> [--databaseId <UUID>] [--tableId <UUID>] [--name <String>] [--description <String>] [--smartTags <JSON>] [--type <String>] [--fieldIds <UUID>] [--refTableId <UUID>] [--refFieldIds <UUID>] [--deleteAction <String>] [--updateAction <String>] [--category <ObjectCategory>] [--scope <Int>] [--tags <String>]
