...
csdk index create --databaseId <UUID> --tableId <UUID> [--accessMethod <String>] [--category <ObjectCategory>] [--fieldIds <UUID>] [--includeFieldIds <UUID>] [--indexParams <JSON>] [--isUnique <Boolean>] [--name <String>] [--nullsNotDistinct <Boolean>] [--opClasses <String>] [--options <JSON>] [--smartTags <JSON>] [--tags <String>] [--whereClause <JSON>]
csdk index update --id <UUID> [--accessMethod <String>] [--category <ObjectCategory>] [--databaseId <UUID>] [--fieldIds <UUID>] [--includeFieldIds <UUID>] [--indexParams <JSON>] [--isUnique <Boolean>] [--name <String>] [--nullsNotDistinct <Boolean>] [--opClasses <String>] [--options <JSON>] [--smartTags <JSON>] [--tableId <UUID>] [--tags <String>] [--whereClause <JSON>]
