...
csdk check-constraint create --fieldIds <UUID> --tableId <UUID> [--category <ObjectCategory>] [--databaseId <UUID>] [--expr <JSON>] [--initiallyDeferred <Boolean>] [--isDeferrable <Boolean>] [--name <String>] [--smartTags <JSON>] [--tags <String>] [--type <String>]
csdk check-constraint update --id <UUID> [--category <ObjectCategory>] [--databaseId <UUID>] [--expr <JSON>] [--fieldIds <UUID>] [--initiallyDeferred <Boolean>] [--isDeferrable <Boolean>] [--name <String>] [--smartTags <JSON>] [--tableId <UUID>] [--tags <String>] [--type <String>]
