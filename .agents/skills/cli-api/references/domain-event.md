...
csdk domain-event create --databaseId <UUID> --eventType <String> [--actorId <UUID>] [--domainId <UUID>] [--domainVerificationId <UUID>] [--managedDomainId <UUID>] [--message <String>] [--metadata <JSON>]
csdk domain-event update --id <UUID> [--actorId <UUID>] [--databaseId <UUID>] [--domainId <UUID>] [--domainVerificationId <UUID>] [--eventType <String>] [--managedDomainId <UUID>] [--message <String>] [--metadata <JSON>]
