...
csdk domain-verification create --databaseId <UUID> --method <String> [--attempts <Int>] [--domainId <UUID>] [--error <String>] [--expiresAt <Datetime>] [--lastCheckedAt <Datetime>] [--managedDomainId <UUID>] [--recordName <String>] [--recordType <String>] [--recordValue <String>] [--status <String>] [--verifiedAt <Datetime>]
csdk domain-verification update --id <UUID> [--attempts <Int>] [--databaseId <UUID>] [--domainId <UUID>] [--error <String>] [--expiresAt <Datetime>] [--lastCheckedAt <Datetime>] [--managedDomainId <UUID>] [--method <String>] [--recordName <String>] [--recordType <String>] [--recordValue <String>] [--status <String>] [--verifiedAt <Datetime>]
