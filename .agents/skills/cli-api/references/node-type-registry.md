...
csdk node-type-registry create --category <String> --slug <String> [--description <String>] [--displayName <String>] [--parameterSchema <JSON>] [--tags <String>]
csdk node-type-registry update --name <String> [--category <String>] [--description <String>] [--displayName <String>] [--parameterSchema <JSON>] [--slug <String>] [--tags <String>]
