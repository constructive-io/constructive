...
csdk trigger create --tableId <UUID> --name <String> [--databaseId <UUID>] [--event <String>] [--functionName <String>] [--smartTags <JSON>] [--category <ObjectCategory>] [--tags <String>]
csdk trigger update --id <UUID> [--databaseId <UUID>] [--tableId <UUID>] [--name <String>] [--event <String>] [--functionName <String>] [--smartTags <JSON>] [--category <ObjectCategory>] [--tags <String>]
