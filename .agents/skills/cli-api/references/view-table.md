...
csdk view-table create --tableId <UUID> --viewId <UUID> [--databaseId <UUID>] [--joinOrder <Int>]
csdk view-table update --id <UUID> [--databaseId <UUID>] [--joinOrder <Int>] [--tableId <UUID>] [--viewId <UUID>]
