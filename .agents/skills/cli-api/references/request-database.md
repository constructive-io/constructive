...
```bash
csdk request-database --input.clientMutationId <String> --input.databaseName <String> --input.domain <String> --input.modules <JSON> --input.options <JSON> --input.organizationId <UUID> --input.presetSlug <String> --input.subdomain <String>
```
