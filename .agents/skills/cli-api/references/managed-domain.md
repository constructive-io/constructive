...
csdk managed-domain create --databaseId <UUID> --domain <String> [--allowPublicUsage <Boolean>] [--annotations <JSON>] [--certStatus <String>] [--isWildcard <Boolean>] [--tlsReadyAt <Datetime>] [--tlsStatus <String>] [--verificationStatus <String>] [--verifiedAt <Datetime>]
csdk managed-domain update --id <UUID> [--allowPublicUsage <Boolean>] [--annotations <JSON>] [--certStatus <String>] [--databaseId <UUID>] [--domain <String>] [--isWildcard <Boolean>] [--tlsReadyAt <Datetime>] [--tlsStatus <String>] [--verificationStatus <String>] [--verifiedAt <Datetime>]
