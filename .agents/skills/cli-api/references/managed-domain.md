...
csdk managed-domain create --databaseId <UUID> --domain <String> [--allowPublicUsage <Boolean>] [--annotations <JSON>] [--certStatus <String>] [--createdByPrincipal <UUID>] [--isWildcard <Boolean>] [--tlsReadyAt <Datetime>] [--tlsStatus <String>] [--updatedByPrincipal <UUID>] [--verificationStatus <String>] [--verifiedAt <Datetime>]
csdk managed-domain update --id <UUID> [--allowPublicUsage <Boolean>] [--annotations <JSON>] [--certStatus <String>] [--createdByPrincipal <UUID>] [--databaseId <UUID>] [--domain <String>] [--isWildcard <Boolean>] [--tlsReadyAt <Datetime>] [--tlsStatus <String>] [--updatedByPrincipal <UUID>] [--verificationStatus <String>] [--verifiedAt <Datetime>]
