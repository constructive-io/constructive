...
csdk database create [--hash <UUID>] [--label <String>] [--name <String>] [--ownerId <UUID>] [--platform <Boolean>]
csdk database update --id <UUID> [--hash <UUID>] [--label <String>] [--name <String>] [--ownerId <UUID>] [--platform <Boolean>]
