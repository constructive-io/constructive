...
csdk derive create --kind <String> --sourceTableId <UUID> --tableId <UUID> [--databaseId <UUID>] [--includeGrants <Boolean>] [--includeMutations <Boolean>] [--policyPrefix <String>]
csdk derive update --id <UUID> [--databaseId <UUID>] [--includeGrants <Boolean>] [--includeMutations <Boolean>] [--kind <String>] [--policyPrefix <String>] [--sourceTableId <UUID>] [--tableId <UUID>]
