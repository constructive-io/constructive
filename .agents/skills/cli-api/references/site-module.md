...
csdk site-module create --data <JSON> --databaseId <UUID> --name <String> --siteId <UUID> [--isEnabled <Boolean>] [--position <Int>]
csdk site-module update --id <UUID> [--data <JSON>] [--databaseId <UUID>] [--isEnabled <Boolean>] [--name <String>] [--position <Int>] [--siteId <UUID>]
