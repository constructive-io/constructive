...
csdk api create --databaseId <UUID> --name <String> [--annotations <JSON>] [--anonRole <String>] [--dbname <String>] [--isPublic <Boolean>] [--labels <JSON>] [--roleName <String>]
csdk api update --id <UUID> [--annotations <JSON>] [--anonRole <String>] [--databaseId <UUID>] [--dbname <String>] [--isPublic <Boolean>] [--labels <JSON>] [--name <String>] [--roleName <String>]
