---
name: cli-api
description: CLI tool (csdk) for the api API — provides CRUD commands for 65 tables and 10 custom operations
---
...
CLI tool (csdk) for the api API — provides CRUD commands for 65 tables and 10 custom operations
