---
name: cli-api
description: CLI tool (csdk) for the api API — provides CRUD commands for 63 tables and 11 custom operations
---
...
CLI tool (csdk) for the api API — provides CRUD commands for 63 tables and 11 custom operations
