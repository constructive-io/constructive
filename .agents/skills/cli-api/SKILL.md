---
name: cli-api
description: CLI tool (csdk) for the api API — provides CRUD commands for 91 tables and 46 custom operations
---
...
CLI tool (csdk) for the api API — provides CRUD commands for 91 tables and 46 custom operations
