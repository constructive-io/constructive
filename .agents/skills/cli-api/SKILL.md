---
name: cli-api
description: CLI tool (csdk) for the api API — provides CRUD commands for 50 tables and 9 custom operations
---
...
CLI tool (csdk) for the api API — provides CRUD commands for 50 tables and 9 custom operations
