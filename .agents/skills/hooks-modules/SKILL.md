---
name: hooks-modules
description: React Query hooks for the modules API — provides typed query and mutation hooks for 83 tables and 3 custom operations
---
...
React Query hooks for the modules API — provides typed query and mutation hooks for 83 tables and 3 custom operations
