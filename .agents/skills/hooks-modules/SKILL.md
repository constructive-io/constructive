---
name: hooks-modules
description: React Query hooks for the modules API — provides typed query and mutation hooks for 57 tables and 12 custom operations
---
...
React Query hooks for the modules API — provides typed query and mutation hooks for 57 tables and 12 custom operations
