---
name: cli-agent
description: CLI tool (csdk) for the agent API — provides CRUD commands for 21 tables and 1 custom operations
---
...
CLI tool (csdk) for the agent API — provides CRUD commands for 21 tables and 1 custom operations
