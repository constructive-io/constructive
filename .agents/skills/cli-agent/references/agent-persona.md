...
csdk agent-persona create --databaseId <UUID> --name <String> --slug <String> [--config <JSON>] [--createdBy <UUID>] [--createdByPrincipal <UUID>] [--description <String>] [--isActive <Boolean>] [--resources <String>] [--systemPrompt <String>] [--updatedBy <UUID>] [--updatedByPrincipal <UUID>]
csdk agent-persona update --id <UUID> [--config <JSON>] [--createdBy <UUID>] [--createdByPrincipal <UUID>] [--databaseId <UUID>] [--description <String>] [--isActive <Boolean>] [--name <String>] [--resources <String>] [--slug <String>] [--systemPrompt <String>] [--updatedBy <UUID>] [--updatedByPrincipal <UUID>]
