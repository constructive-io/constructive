...
csdk agent-message create --threadId <UUID> --databaseId <UUID> --authorRole <String> [--actorId <UUID>] [--parts <JSON>] [--model <String>] [--agentId <UUID>]
csdk agent-message update --id <UUID> [--actorId <UUID>] [--parts <JSON>] [--threadId <UUID>] [--databaseId <UUID>] [--authorRole <String>] [--model <String>] [--agentId <UUID>]
