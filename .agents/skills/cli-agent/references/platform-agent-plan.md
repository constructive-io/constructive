...
csdk platform-agent-plan create --threadId <UUID> --title <String> [--description <String>] [--ownerId <UUID>] [--status <String>]
csdk platform-agent-plan update --id <UUID> [--description <String>] [--ownerId <UUID>] [--status <String>] [--threadId <UUID>] [--title <String>]
