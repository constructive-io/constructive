...
csdk platform-agent-run-workspace create --baseBranch <String> --branch <String> --provider <String> --repo <String> --runId <UUID> [--artifacts <JSON>] [--baseCommit <String>] [--clonedAt <Datetime>] [--headCommit <String>] [--lastUsedAt <Datetime>] [--ordinal <Int>] [--publication <String>] [--repositoryId <UUID>] [--state <String>]
csdk platform-agent-run-workspace update --id <UUID> [--artifacts <JSON>] [--baseBranch <String>] [--baseCommit <String>] [--branch <String>] [--clonedAt <Datetime>] [--headCommit <String>] [--lastUsedAt <Datetime>] [--ordinal <Int>] [--provider <String>] [--publication <String>] [--repo <String>] [--repositoryId <UUID>] [--runId <UUID>] [--state <String>]
