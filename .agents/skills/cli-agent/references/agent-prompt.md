...
csdk agent-prompt create --content <String> --databaseId <UUID> --name <String> [--createdBy <UUID>] [--createdByPrincipal <UUID>] [--description <String>] [--isDefault <Boolean>] [--metadata <JSON>] [--updatedBy <UUID>] [--updatedByPrincipal <UUID>]
csdk agent-prompt update --id <UUID> [--content <String>] [--createdBy <UUID>] [--createdByPrincipal <UUID>] [--databaseId <UUID>] [--description <String>] [--isDefault <Boolean>] [--metadata <JSON>] [--name <String>] [--updatedBy <UUID>] [--updatedByPrincipal <UUID>]
