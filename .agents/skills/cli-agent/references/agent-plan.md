...
csdk agent-plan create --databaseId <UUID> --threadId <UUID> --title <String> [--description <String>] [--ownerId <UUID>] [--status <String>]
csdk agent-plan update --id <UUID> [--databaseId <UUID>] [--description <String>] [--ownerId <UUID>] [--status <String>] [--threadId <UUID>] [--title <String>]
