---
name: hooks-agent
description: React Query hooks for the agent API — provides typed query and mutation hooks for 24 tables and 1 custom operations
---
...
React Query hooks for the agent API — provides typed query and mutation hooks for 24 tables and 1 custom operations
