...
csdk platform-internal-secret create --annotations <JSON> --description <String> --labels <JSON> --name <String> --realm <String> --retiredAt <Datetime> --rotatedAt <Datetime>
csdk platform-internal-secret update --id <UUID> [--annotations <JSON>] [--description <String>] [--labels <JSON>] [--name <String>] [--realm <String>] [--retiredAt <Datetime>] [--rotatedAt <Datetime>]
