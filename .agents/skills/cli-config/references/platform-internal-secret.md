...
csdk platform-internal-secret create [--name <String>] [--namespaceId <UUID>] [--description <String>] [--labels <JSON>] [--annotations <JSON>] [--rotatedAt <Datetime>] [--retiredAt <Datetime>]
csdk platform-internal-secret update --id <UUID> [--name <String>] [--namespaceId <UUID>] [--description <String>] [--labels <JSON>] [--annotations <JSON>] [--rotatedAt <Datetime>] [--retiredAt <Datetime>]
