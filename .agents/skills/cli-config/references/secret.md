...
csdk secret create --annotations <JSON> --databaseId <UUID> --description <String> --labels <JSON> --name <String> --namespaceId <UUID> --provider <String> --realm <String> --retiredAt <Datetime> --rotatedAt <Datetime>
csdk secret update --id <UUID> [--annotations <JSON>] [--databaseId <UUID>] [--description <String>] [--labels <JSON>] [--name <String>] [--namespaceId <UUID>] [--provider <String>] [--realm <String>] [--retiredAt <Datetime>] [--rotatedAt <Datetime>]
