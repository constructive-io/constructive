...
csdk platform-secret create --annotations <JSON> --description <String> --labels <JSON> --name <String> --namespaceId <UUID> --provider <String> --realm <String> --retiredAt <Datetime> --rotatedAt <Datetime>
csdk platform-secret update --id <UUID> [--annotations <JSON>] [--description <String>] [--labels <JSON>] [--name <String>] [--namespaceId <UUID>] [--provider <String>] [--realm <String>] [--retiredAt <Datetime>] [--rotatedAt <Datetime>]
