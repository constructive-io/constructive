...
csdk config create --databaseId <UUID> --name <String> --namespaceId <UUID> [--annotations <JSON>] [--description <String>] [--expiresAt <Datetime>] [--labels <JSON>] [--provider <String>] [--realm <String>] [--value <String>]
csdk config update --id <UUID> [--annotations <JSON>] [--databaseId <UUID>] [--description <String>] [--expiresAt <Datetime>] [--labels <JSON>] [--name <String>] [--namespaceId <UUID>] [--provider <String>] [--realm <String>] [--value <String>]
