---
name: hooks-admin
description: React Query hooks for the admin API — provides typed query and mutation hooks for 28 tables and 11 custom operations
---
...
React Query hooks for the admin API — provides typed query and mutation hooks for 28 tables and 11 custom operations
...
- [my-pending-app-invites-record](references/my-pending-app-invites-record.md)
- [my-pending-org-invites-record](references/my-pending-org-invites-record.md)
...
- [accept-app-invite](references/accept-app-invite.md)
- [accept-org-invite](references/accept-org-invite.md)
- [provision-app-user](references/provision-app-user.md)
- [provision-app-users-bulk](references/provision-app-users-bulk.md)
- [provision-bucket](references/provision-bucket.md)
- [provision-org-user](references/provision-org-user.md)
- [provision-org-users-bulk](references/provision-org-users-bulk.md)
