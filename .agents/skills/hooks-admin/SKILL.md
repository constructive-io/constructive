---
name: hooks-admin
description: React Query hooks for the admin API — provides typed query and mutation hooks for 26 tables and 4 custom operations
---
...
React Query hooks for the admin API — provides typed query and mutation hooks for 26 tables and 4 custom operations
