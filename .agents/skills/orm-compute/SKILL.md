---
name: orm-compute
description: ORM client for the compute API — provides typed CRUD operations for 69 tables and 38 custom operations
---
...
ORM client for the compute API — provides typed CRUD operations for 69 tables and 38 custom operations
