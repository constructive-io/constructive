---
name: orm-compute
description: ORM client for the compute API — provides typed CRUD operations for 18 tables and 15 custom operations
---
...
ORM client for the compute API — provides typed CRUD operations for 18 tables and 15 custom operations
...
// Available models: getAllRecord, functionApiBinding, functionDeployment, functionGraphRef, functionGraphStore, functionGraphObject, functionDeploymentEvent, orgFunctionExecutionLog, ...
