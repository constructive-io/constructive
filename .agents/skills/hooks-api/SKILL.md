---
name: hooks-api
description: React Query hooks for the api API — provides typed query and mutation hooks for 91 tables and 46 custom operations
---
...
React Query hooks for the api API — provides typed query and mutation hooks for 91 tables and 46 custom operations
...
- [suspend-database](references/suspend-database.md)
- [unsuspend-database](references/unsuspend-database.md)
