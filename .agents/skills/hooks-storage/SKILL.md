---
name: hooks-storage
description: React Query hooks for the storage API — provides typed query and mutation hooks for 4 tables and 5 custom operations
---
...
React Query hooks for the storage API — provides typed query and mutation hooks for 4 tables and 5 custom operations
