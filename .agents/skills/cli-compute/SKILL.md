---
name: cli-compute
description: CLI tool (csdk) for the compute API — provides CRUD commands for 69 tables and 38 custom operations
---
...
CLI tool (csdk) for the compute API — provides CRUD commands for 69 tables and 38 custom operations
