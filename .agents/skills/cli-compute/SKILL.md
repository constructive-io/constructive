---
name: cli-compute
description: CLI tool (csdk) for the compute API — provides CRUD commands for 119 tables and 58 custom operations
---
...
CLI tool (csdk) for the compute API — provides CRUD commands for 119 tables and 58 custom operations
