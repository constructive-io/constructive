...
csdk function-definition create --category <String> --databaseId <UUID> --name <String> [--accessChannels <String>] [--catalogImageId <UUID>] [--concurrency <Int>] [--createdByPrincipal <UUID>] [--description <String>] [--fnCategory <String>] [--functionColumns <JSON>] [--graphId <UUID>] [--icon <String>] [--image <String>] [--inputs <JSON>] [--integrations <String>] [--isPublished <Boolean>] [--maxAttempts <Int>] [--moduleTable <String>] [--outputs <JSON>] [--payloadArgs <JSON>] [--priority <Int>] [--props <JSON>] [--protected <Boolean>] [--publishedAt <Datetime>] [--queueName <String>] [--requiredBuckets <String>] [--requiredConfigs <ResourceRequirement>] [--requiredModels <String>] [--requiredModules <String>] [--requiredSecrets <ResourceRequirement>] [--resources <JSON>] [--runtime <String>] [--scaleMax <Int>] [--scaleMin <Int>] [--targetFunction <String>] [--targetSchema <String>] [--timeoutSeconds <Int>] [--updatedByPrincipal <UUID>] [--volatile <Boolean>]
csdk function-definition update --id <UUID> [--accessChannels <String>] [--catalogImageId <UUID>] [--category <String>] [--concurrency <Int>] [--createdByPrincipal <UUID>] [--databaseId <UUID>] [--description <String>] [--fnCategory <String>] [--functionColumns <JSON>] [--graphId <UUID>] [--icon <String>] [--image <String>] [--inputs <JSON>] [--integrations <String>] [--isPublished <Boolean>] [--maxAttempts <Int>] [--moduleTable <String>] [--name <String>] [--outputs <JSON>] [--payloadArgs <JSON>] [--priority <Int>] [--props <JSON>] [--protected <Boolean>] [--publishedAt <Datetime>] [--queueName <String>] [--requiredBuckets <String>] [--requiredConfigs <ResourceRequirement>] [--requiredModels <String>] [--requiredModules <String>] [--requiredSecrets <ResourceRequirement>] [--resources <JSON>] [--runtime <String>] [--scaleMax <Int>] [--scaleMin <Int>] [--targetFunction <String>] [--targetSchema <String>] [--timeoutSeconds <Int>] [--updatedByPrincipal <UUID>] [--volatile <Boolean>]
