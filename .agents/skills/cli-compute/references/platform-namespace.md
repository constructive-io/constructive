...
csdk platform-namespace create --name <String> --namespaceName <String> [--annotations <JSON>] [--clusterId <UUID>] [--description <String>] [--isActive <Boolean>] [--isManaged <Boolean>] [--labels <JSON>] [--lastError <String>] [--status <String>]
csdk platform-namespace update --id <UUID> [--annotations <JSON>] [--clusterId <UUID>] [--description <String>] [--isActive <Boolean>] [--isManaged <Boolean>] [--labels <JSON>] [--lastError <String>] [--name <String>] [--namespaceName <String>] [--status <String>]
