...
csdk platform-namespace create --name <String> --namespaceName <String> --databaseId <UUID> [--description <String>] [--isActive <Boolean>] [--labels <JSON>] [--annotations <JSON>] [--sourceDatabaseId <UUID>] [--sourceScope <String>] [--isManaged <Boolean>]
csdk platform-namespace update --id <UUID> [--name <String>] [--namespaceName <String>] [--description <String>] [--isActive <Boolean>] [--labels <JSON>] [--annotations <JSON>] [--databaseId <UUID>] [--sourceDatabaseId <UUID>] [--sourceScope <String>] [--isManaged <Boolean>]
