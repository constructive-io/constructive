...
csdk build create --repositoryId <UUID> [--actorId <UUID>] [--attempt <Int>] [--commitSha <String>] [--conclusion <String>] [--createdByPrincipal <UUID>] [--eventId <UUID>] [--finishedAt <Datetime>] [--imageRef <String>] [--jobId <BigInt>] [--logs <Upload>] [--matrixKey <String>] [--metadata <JSON>] [--proposalId <UUID>] [--ref <String>] [--startedAt <Datetime>] [--status <String>] [--updatedByPrincipal <UUID>] [--workflowId <UUID>]
csdk build update --id <UUID> [--actorId <UUID>] [--attempt <Int>] [--commitSha <String>] [--conclusion <String>] [--createdByPrincipal <UUID>] [--eventId <UUID>] [--finishedAt <Datetime>] [--imageRef <String>] [--jobId <BigInt>] [--logs <Upload>] [--matrixKey <String>] [--metadata <JSON>] [--proposalId <UUID>] [--ref <String>] [--repositoryId <UUID>] [--startedAt <Datetime>] [--status <String>] [--updatedByPrincipal <UUID>] [--workflowId <UUID>]
