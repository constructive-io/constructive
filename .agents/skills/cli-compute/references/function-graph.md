...
csdk function-graph create --databaseId <UUID> --storeId <UUID> --entityId <UUID> --context <String> --name <String> --description <String> --definitionsCommitId <UUID> --isValid <Boolean> --validationErrors <JSON> --createdBy <UUID>
csdk function-graph update --id <UUID> [--databaseId <UUID>] [--storeId <UUID>] [--entityId <UUID>] [--context <String>] [--name <String>] [--description <String>] [--definitionsCommitId <UUID>] [--isValid <Boolean>] [--validationErrors <JSON>] [--createdBy <UUID>]
