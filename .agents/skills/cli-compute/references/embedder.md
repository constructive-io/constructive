...
csdk build search "my query" --auto-embed
```
...
EMBEDDER_PROVIDER=openai EMBEDDER_MODEL=text-embedding-3-small EMBEDDER_API_KEY=sk-proj-...your-api-key csdk build search "my query" --auto-embed
```
