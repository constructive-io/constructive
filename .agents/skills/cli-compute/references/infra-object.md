...
csdk infra-object create --databaseId <UUID> [--data <JSON>] [--kids <UUID>] [--ktree <String>]
csdk infra-object update --id <UUID> [--data <JSON>] [--databaseId <UUID>] [--kids <UUID>] [--ktree <String>]
