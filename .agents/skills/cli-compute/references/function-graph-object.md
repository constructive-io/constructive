...
csdk function-graph-object create --scopeId <UUID> [--data <JSON>] [--kids <UUID>] [--ktree <String>]
csdk function-graph-object update --id <UUID> [--data <JSON>] [--kids <UUID>] [--ktree <String>] [--scopeId <UUID>]
