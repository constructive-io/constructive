...
csdk function-graph-object create --scopeId <UUID> [--kids <UUID>] [--ktree <String>] [--data <JSON>]
csdk function-graph-object update --id <UUID> [--scopeId <UUID>] [--kids <UUID>] [--ktree <String>] [--data <JSON>]
