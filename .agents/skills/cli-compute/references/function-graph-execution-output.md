...
csdk function-graph-execution-output create --databaseId <UUID> --hash <Base64EncodedBinary> --data <JSON>
csdk function-graph-execution-output update --id <UUID> [--databaseId <UUID>] [--hash <Base64EncodedBinary>] [--data <JSON>]
