...
csdk platform-resource-definition create --kind <String> --name <String> --namespaceId <UUID> --slug <String> [--annotations <JSON>] [--createdBy <UUID>] [--createdByPrincipal <UUID>] [--defaultSpec <JSON>] [--description <String>] [--integrations <String>] [--labels <JSON>] [--paramsSchema <JSON>] [--requiredConfigs <ResourceRequirement>] [--requiredSecrets <ResourceRequirement>] [--stepUpMinAge <Interval>] [--updatedBy <UUID>] [--updatedByPrincipal <UUID>]
