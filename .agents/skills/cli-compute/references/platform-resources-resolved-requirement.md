...
csdk platform-resources-resolved-requirement create --atomId <UUID> --configObjectName <String> --name <String> --namespaceId <UUID> --present <Boolean> --realm <String> --required <Boolean> --requirementKind <String> --resourceId <UUID> --secretsObjectName <String> --slug <String>
csdk platform-resources-resolved-requirement update --id <UUID> [--atomId <UUID>] [--configObjectName <String>] [--name <String>] [--namespaceId <UUID>] [--present <Boolean>] [--realm <String>] [--required <Boolean>] [--requirementKind <String>] [--resourceId <UUID>] [--secretsObjectName <String>] [--slug <String>]
