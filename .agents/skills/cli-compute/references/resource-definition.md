...
csdk resource-definition create --databaseId <UUID> --kind <String> --name <String> --namespaceId <UUID> --slug <String> [--annotations <JSON>] [--catalogImageId <UUID>] [--createdBy <UUID>] [--createdByPrincipal <UUID>] [--defaultSpec <JSON>] [--description <String>] [--integrations <String>] [--labels <JSON>] [--paramsSchema <JSON>] [--requiredConfigs <ResourceRequirement>] [--requiredSecrets <ResourceRequirement>] [--stepUpMinAge <Interval>] [--updatedBy <UUID>] [--updatedByPrincipal <UUID>]
csdk resource-definition update --id <UUID> [--annotations <JSON>] [--catalogImageId <UUID>] [--createdBy <UUID>] [--createdByPrincipal <UUID>] [--databaseId <UUID>] [--defaultSpec <JSON>] [--description <String>] [--integrations <String>] [--kind <String>] [--labels <JSON>] [--name <String>] [--namespaceId <UUID>] [--paramsSchema <JSON>] [--requiredConfigs <ResourceRequirement>] [--requiredSecrets <ResourceRequirement>] [--slug <String>] [--stepUpMinAge <Interval>] [--updatedBy <UUID>] [--updatedByPrincipal <UUID>]
