---
name: orm-api
description: ORM client for the api API — provides typed CRUD operations for 91 tables and 46 custom operations
---
...
ORM client for the api API — provides typed CRUD operations for 91 tables and 46 custom operations
