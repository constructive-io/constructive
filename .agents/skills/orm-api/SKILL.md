---
name: orm-api
description: ORM client for the api API — provides typed CRUD operations for 65 tables and 10 custom operations
---
...
ORM client for the api API — provides typed CRUD operations for 65 tables and 10 custom operations
