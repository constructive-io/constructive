...
db.database.create({ data: { hash: '<UUID>', label: '<String>', name: '<String>', ownerId: '<UUID>', platform: '<Boolean>', suspendedAt: '<Datetime>', suspendedReason: '<String>' }, select: { id: true } }).execute()
...
const item = await db.database.create({
  data: { hash: '<UUID>', label: '<String>', name: '<String>', ownerId: '<UUID>', platform: '<Boolean>', suspendedAt: '<Datetime>', suspendedReason: '<String>' },
  select: { id: true }
}).execute();
```
