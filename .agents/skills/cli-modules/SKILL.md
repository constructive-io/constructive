---
name: cli-modules
description: CLI tool (csdk) for the modules API — provides CRUD commands for 74 tables and 12 custom operations
---
...
CLI tool (csdk) for the modules API — provides CRUD commands for 74 tables and 12 custom operations
...
# CRUD for any table (e.g. agent-module)
csdk agent-module list
csdk agent-module get --id <value>
csdk agent-module create --<field> <value>

# Non-interactive mode (skip all prompts, use flags only)
csdk --no-tty agent-module list
```
...
```bash
csdk --no-tty agent-module create --<field> <value>
```
