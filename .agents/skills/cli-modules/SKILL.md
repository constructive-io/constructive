---
name: cli-modules
description: CLI tool (csdk) for the modules API — provides CRUD commands for 78 tables and 3 custom operations
---
...
CLI tool (csdk) for the modules API — provides CRUD commands for 78 tables and 3 custom operations
