---
name: cli-modules
description: CLI tool (csdk) for the modules API — provides CRUD commands for 61 tables and 12 custom operations
---
...
CLI tool (csdk) for the modules API — provides CRUD commands for 61 tables and 12 custom operations
