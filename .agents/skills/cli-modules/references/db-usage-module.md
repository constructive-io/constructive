...
csdk db-usage-module create --databaseId <UUID> [--schemaId <UUID>] [--privateSchemaId <UUID>] [--publicSchemaName <String>] [--privateSchemaName <String>] [--tableStatsLogTableId <UUID>] [--tableStatsLogTableName <String>] [--tableStatsDailyTableId <UUID>] [--tableStatsDailyTableName <String>] [--queryStatsLogTableId <UUID>] [--queryStatsLogTableName <String>] [--queryStatsDailyTableId <UUID>] [--queryStatsDailyTableName <String>] [--interval <String>] [--retention <String>] [--premake <Int>] [--scope <String>] [--prefix <String>] [--defaultPermissions <String>] [--apiName <String>] [--privateApiName <String>]
csdk db-usage-module update --id <UUID> [--databaseId <UUID>] [--schemaId <UUID>] [--privateSchemaId <UUID>] [--publicSchemaName <String>] [--privateSchemaName <String>] [--tableStatsLogTableId <UUID>] [--tableStatsLogTableName <String>] [--tableStatsDailyTableId <UUID>] [--tableStatsDailyTableName <String>] [--queryStatsLogTableId <UUID>] [--queryStatsLogTableName <String>] [--queryStatsDailyTableId <UUID>] [--queryStatsDailyTableName <String>] [--interval <String>] [--retention <String>] [--premake <Int>] [--scope <String>] [--prefix <String>] [--defaultPermissions <String>] [--apiName <String>] [--privateApiName <String>]
