...
csdk rate-limit-meters-module create --databaseId <UUID> [--schemaId <UUID>] [--privateSchemaId <UUID>] [--publicSchemaName <String>] [--privateSchemaName <String>] [--rateLimitStateTableId <UUID>] [--rateLimitStateTableName <String>] [--rateLimitOverridesTableId <UUID>] [--rateLimitOverridesTableName <String>] [--rateWindowLimitsTableId <UUID>] [--rateWindowLimitsTableName <String>] [--checkRateLimitFunction <String>] [--prefix <String>] [--defaultPermissions <String>] [--apiName <String>] [--privateApiName <String>]
csdk rate-limit-meters-module update --id <UUID> [--databaseId <UUID>] [--schemaId <UUID>] [--privateSchemaId <UUID>] [--publicSchemaName <String>] [--privateSchemaName <String>] [--rateLimitStateTableId <UUID>] [--rateLimitStateTableName <String>] [--rateLimitOverridesTableId <UUID>] [--rateLimitOverridesTableName <String>] [--rateWindowLimitsTableId <UUID>] [--rateWindowLimitsTableName <String>] [--checkRateLimitFunction <String>] [--prefix <String>] [--defaultPermissions <String>] [--apiName <String>] [--privateApiName <String>]
