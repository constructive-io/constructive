...
csdk function-invocation-module create --databaseId <UUID> --scope <String> [--apiName <String>] [--attemptsTableId <UUID>] [--attemptsTableName <String>] [--defaultCapabilities <String>] [--entityField <String>] [--entityTableId <UUID>] [--executionLogsTableId <UUID>] [--executionLogsTableName <String>] [--invocationsTableId <UUID>] [--invocationsTableName <String>] [--policies <JSON>] [--prefix <String>] [--privateApiName <String>] [--privateSchemaId <UUID>] [--privateSchemaName <String>] [--provisions <JSON>] [--publicSchemaName <String>] [--schemaId <UUID>]
csdk function-invocation-module update --id <UUID> [--apiName <String>] [--attemptsTableId <UUID>] [--attemptsTableName <String>] [--databaseId <UUID>] [--defaultCapabilities <String>] [--entityField <String>] [--entityTableId <UUID>] [--executionLogsTableId <UUID>] [--executionLogsTableName <String>] [--invocationsTableId <UUID>] [--invocationsTableName <String>] [--policies <JSON>] [--prefix <String>] [--privateApiName <String>] [--privateSchemaId <UUID>] [--privateSchemaName <String>] [--provisions <JSON>] [--publicSchemaName <String>] [--schemaId <UUID>] [--scope <String>]
