...
csdk config-secrets-user-module create --databaseId <UUID> [--schemaId <UUID>] [--tableId <UUID>] [--tableName <String>] [--configDefinitionsTableId <UUID>] [--apiName <String>] [--privateApiName <String>]
csdk config-secrets-user-module update --id <UUID> [--databaseId <UUID>] [--schemaId <UUID>] [--tableId <UUID>] [--tableName <String>] [--configDefinitionsTableId <UUID>] [--apiName <String>] [--privateApiName <String>]
