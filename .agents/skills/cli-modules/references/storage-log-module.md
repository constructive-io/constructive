...
csdk storage-log-module create --databaseId <UUID> --scope <String> [--actorFkTableId <UUID>] [--apiName <String>] [--entityField <String>] [--entityFkTableId <UUID>] [--interval <String>] [--prefix <String>] [--premake <Int>] [--privateApiName <String>] [--privateSchemaId <UUID>] [--privateSchemaName <String>] [--publicSchemaName <String>] [--retention <String>] [--schemaId <UUID>] [--storageLogTableId <UUID>] [--storageLogTableName <String>] [--usageSummaryTableId <UUID>] [--usageSummaryTableName <String>]
