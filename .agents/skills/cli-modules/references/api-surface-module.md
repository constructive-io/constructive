...
csdk api-surface-module create --databaseId <UUID> --scope <String> [--apiModulesTableId <UUID>] [--apiModulesTableName <String>] [--apiName <String>] [--apiSchemasTableId <UUID>] [--apiSchemasTableName <String>] [--apiSettingsTableId <UUID>] [--apiSettingsTableName <String>] [--apisTableId <UUID>] [--apisTableName <String>] [--catalogModuleId <UUID>] [--corsSettingsTableId <UUID>] [--corsSettingsTableName <String>] [--defaultPermissions <String>] [--entityField <String>] [--entityTableId <UUID>] [--policies <JSON>] [--prefix <String>] [--privateApiName <String>] [--provisions <JSON>] [--publicSchemaName <String>] [--schemaId <UUID>]
