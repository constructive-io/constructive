...
csdk config-secrets-org-module create --databaseId <UUID> [--schemaId <UUID>] [--tableId <UUID>] [--tableName <String>] [--apiName <String>] [--privateApiName <String>]
csdk config-secrets-org-module update --id <UUID> [--databaseId <UUID>] [--schemaId <UUID>] [--tableId <UUID>] [--tableName <String>] [--apiName <String>] [--privateApiName <String>]
