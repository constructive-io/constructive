...
csdk site-surface-module create --databaseId <UUID> --scope <String> [--apiName <String>] [--catalogModuleId <UUID>] [--defaultPermissions <String>] [--entityField <String>] [--entityTableId <UUID>] [--policies <JSON>] [--prefix <String>] [--privateApiName <String>] [--provisions <JSON>] [--publicSchemaName <String>] [--schemaId <UUID>] [--siteMetadataTableId <UUID>] [--siteMetadataTableName <String>] [--siteModulesTableId <UUID>] [--siteModulesTableName <String>] [--siteThemesTableId <UUID>] [--siteThemesTableName <String>] [--sitesTableId <UUID>] [--sitesTableName <String>]
