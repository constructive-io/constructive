...
csdk identity-providers-module create --databaseId <UUID> [--schemaId <UUID>] [--privateSchemaId <UUID>] [--tableId <UUID>] [--tableName <String>] [--apiName <String>] [--privateApiName <String>]
csdk identity-providers-module update --id <UUID> [--databaseId <UUID>] [--schemaId <UUID>] [--privateSchemaId <UUID>] [--tableId <UUID>] [--tableName <String>] [--apiName <String>] [--privateApiName <String>]
