...
csdk identity-providers-module create --databaseId <UUID> --scope <String> [--apiName <String>] [--entityField <String>] [--entityTableId <UUID>] [--prefix <String>] [--privateApiName <String>] [--privateSchemaId <UUID>] [--privateSchemaName <String>] [--publicSchemaName <String>] [--schemaId <UUID>] [--tableId <UUID>] [--tableName <String>]
