---
name: cli-storage
description: CLI tool (csdk) for the storage API — provides CRUD commands for 4 tables and 7 custom operations
---
...
CLI tool (csdk) for the storage API — provides CRUD commands for 4 tables and 7 custom operations
