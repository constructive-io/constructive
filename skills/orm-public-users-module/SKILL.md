---
name: orm-public-users-module
description: ORM operations for UsersModule records
---

# orm-public-users-module
...
const item = await db.usersModule.create({
  data: { databaseId: 'value', schemaId: 'value', tableId: 'value', tableName: 'value', typeTableId: 'value', typeTableName: 'value' },
  select: { id: true }
}).execute();
```
