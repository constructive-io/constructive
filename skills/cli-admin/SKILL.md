---
name: cli-admin
description: CLI tool (app) for the admin API — provides CRUD commands for 32 tables and 13 custom operations
---
...
CLI tool (app) for the admin API — provides CRUD commands for 32 tables and 13 custom operations
