---
name: hooks-public-site-metadatum
description: SEO and social sharing metadata for a site: page title, description, and Open Graph image
---

# hooks-public-site-metadatum
