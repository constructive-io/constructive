---
name: hooks-public-api-module
description: Server-side module configuration for an API endpoint; stores module name and JSON settings used by the application server
---

# hooks-public-api-module
