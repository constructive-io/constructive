---
name: hooks-public
description: React Query hooks for the public API — provides typed query and mutation hooks for 104 tables and 50 custom operations
---
...
React Query hooks for the public API — provides typed query and mutation hooks for 104 tables and 50 custom operations
