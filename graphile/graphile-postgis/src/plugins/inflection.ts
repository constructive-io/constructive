...
export const PostgisInflectionPlugin: GraphileConfig.Plugin = {
  ...
  inflection: {
    add: {
      ...
      gisInterfaceName(_options, typeName: string) {
      ...
      gisXFieldName(_options, typeName: string) {
        return typeName === 'geography' ? 'longitude' : 'x';
      },

      gisYFieldName(_options, typeName: string) {
        return typeName === 'geography' ? 'latitude' : 'y';
      },

      gisZFieldName(_options, typeName: string) {
