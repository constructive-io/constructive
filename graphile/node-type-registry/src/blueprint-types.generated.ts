...
export interface DataJobTriggerParams {
  ...
  payload_custom?: Record<string, unknown>;
...
export interface TableUserProfilesParams {
}
...
export interface AuthzAllowAllParams {
}

/** Denies all access. Generates FALSE expression. */
export interface AuthzDenyAllParams {
}
...
export interface ViewCompositeParams {
  ...
  query_ast: Record<string, unknown>;
}
...
export type BlueprintNodeObject =
  | { $type: 'AuthzDirectOwner'; data: AuthzDirectOwnerParams }
  | { $type: 'AuthzDirectOwnerAny'; data: AuthzDirectOwnerAnyParams }
  | { $type: 'AuthzMembership'; data: AuthzMembershipParams }
  | { $type: 'AuthzEntityMembership'; data: AuthzEntityMembershipParams }
  | { $type: 'AuthzRelatedEntityMembership'; data: AuthzRelatedEntityMembershipParams }
  | { $type: 'AuthzOrgHierarchy'; data: AuthzOrgHierarchyParams }
  | { $type: 'AuthzTemporal'; data: AuthzTemporalParams }
  | { $type: 'AuthzPublishable'; data: AuthzPublishableParams }
  | { $type: 'AuthzMemberList'; data: AuthzMemberListParams }
  | { $type: 'AuthzRelatedMemberList'; data: AuthzRelatedMemberListParams }
  | { $type: 'AuthzAllowAll'; data?: Record<string, never> }
  | { $type: 'AuthzDenyAll'; data?: Record<string, never> }
  | { $type: 'AuthzComposite'; data: AuthzCompositeParams }
  | { $type: 'AuthzPeerOwnership'; data: AuthzPeerOwnershipParams }
  | { $type: 'AuthzRelatedPeerOwnership'; data: AuthzRelatedPeerOwnershipParams }
  | { $type: 'DataId'; data: DataIdParams }
  | { $type: 'DataDirectOwner'; data: DataDirectOwnerParams }
  | { $type: 'DataEntityMembership'; data: DataEntityMembershipParams }
  | { $type: 'DataOwnershipInEntity'; data: DataOwnershipInEntityParams }
  | { $type: 'DataTimestamps'; data: DataTimestampsParams }
  | { $type: 'DataPeoplestamps'; data: DataPeoplestampsParams }
  | { $type: 'DataPublishable'; data: DataPublishableParams }
  | { $type: 'DataSoftDelete'; data: DataSoftDeleteParams }
  | { $type: 'DataEmbedding'; data: DataEmbeddingParams }
  | { $type: 'DataFullTextSearch'; data: DataFullTextSearchParams }
  | { $type: 'DataBm25'; data: DataBm25Params }
  | { $type: 'DataSearch'; data: DataSearchParams }
  | { $type: 'DataPostGIS'; data: DataPostGISParams }
  | { $type: 'DataPostGISAggregate'; data: DataPostGISAggregateParams }
  | { $type: 'DataJobTrigger'; data: DataJobTriggerParams }
  | { $type: 'DataTags'; data: DataTagsParams }
  | { $type: 'DataStatusField'; data: DataStatusFieldParams }
  | { $type: 'DataJsonb'; data: DataJsonbParams }
  | { $type: 'DataTrgm'; data: DataTrgmParams }
  | { $type: 'DataSlug'; data: DataSlugParams }
  | { $type: 'DataInflection'; data: DataInflectionParams }
  | { $type: 'DataOwnedFields'; data: DataOwnedFieldsParams }
  | { $type: 'DataInheritFromParent'; data: DataInheritFromParentParams }
  | { $type: 'DataForceCurrentUser'; data: DataForceCurrentUserParams }
  | { $type: 'DataImmutableFields'; data: DataImmutableFieldsParams }
  | { $type: 'TableUserProfiles'; data?: Record<string, never> }
  | { $type: 'TableOrganizationSettings'; data?: Record<string, never> }
  | { $type: 'TableUserSettings'; data?: Record<string, never> };
