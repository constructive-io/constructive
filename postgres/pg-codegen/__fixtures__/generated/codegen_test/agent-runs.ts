 ...
 */
/* eslint-disable */
import { asArrayOf, asInteger, asIsoString, asJson, asNumeric, asString, requireArrayOf, requireBigIntString, requireJson, requireRecord, requireUuid } from '@constructive-io/coerce';
...
export const agentRunsFields = {
  ...
  /** `last_event_seq` (int8) */lastEventSeq: (value: unknown, label = 'agent_runs.last_event_seq'): string => requireBigIntString(value, label),
...
export const decodeAgentRuns = (value: unknown, label = 'codegen_test.agent_runs'): AgentRuns => {
  ...
  return {
    ...
    lastEventSeq: requireBigIntString(record.lastEventSeq, `${label}.lastEventSeq`),
...
export const decodeAgentRunsRow = (value: unknown, label = 'codegen_test.agent_runs'): AgentRunsRow => {
  ...
  return {
    ...
    metadata: requireJson(record.metadata, `${label}.metadata`),
    settings: asJson(record.settings),
    last_event_seq: requireBigIntString(record.last_event_seq, `${label}.last_event_seq`),
    score: asNumeric(record.score),
