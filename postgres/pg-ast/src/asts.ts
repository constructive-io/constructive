...
export default {
  ...
  var(_p?: Var): Var {
    ...
    _o.set(_j, "varreturningtype", _p?.varreturningtype);
    _o.set(_j, "location", _p?.location);
    return _j;
  },
  ...
  arrayExpr(_p?: ArrayExpr): ArrayExpr {
    ...
    _o.set(_j, "list_start", _p?.list_start);
    _o.set(_j, "list_end", _p?.list_end);
    _o.set(_j, "location", _p?.location);
    return _j;
  },
  ...
  returningExpr(_p?: ReturningExpr): ReturningExpr {
    const _j = {} as ReturningExpr;
    _o.set(_j, "xpr", _p?.xpr);
    _o.set(_j, "retlevelsup", _p?.retlevelsup);
    _o.set(_j, "retold", _p?.retold);
    _o.set(_j, "retexpr", _p?.retexpr);
    return _j;
  },
  ...
  query(_p?: Query): Query {
    ...
    _o.set(_j, "hasGroupRTE", _p?.hasGroupRTE);
    ...
    _o.set(_j, "returningOldAlias", _p?.returningOldAlias);
    _o.set(_j, "returningNewAlias", _p?.returningNewAlias);
  ...
  aExpr(_p?: A_Expr): A_Expr {
    ...
    _o.set(_j, "rexpr_list_start", _p?.rexpr_list_start);
    _o.set(_j, "rexpr_list_end", _p?.rexpr_list_end);
    _o.set(_j, "location", _p?.location);
    return _j;
  },
  ...
  rangeTblEntry(_p?: RangeTblEntry): RangeTblEntry {
    ...
    _o.set(_j, "groupexprs", _p?.groupexprs);
    _o.set(_j, "lateral", _p?.lateral);
  ...
  sortGroupClause(_p?: SortGroupClause): SortGroupClause {
    ...
    _o.set(_j, "reverse_sort", _p?.reverse_sort);
  ...
  returningOption(_p?: ReturningOption): ReturningOption {
    const _j = {} as ReturningOption;
    _o.set(_j, "option", _p?.option);
    _o.set(_j, "value", _p?.value);
    _o.set(_j, "location", _p?.location);
    return _j;
  },
  returningClause(_p?: ReturningClause): ReturningClause {
    const _j = {} as ReturningClause;
    _o.set(_j, "options", _p?.options);
  ...
  insertStmt(_p?: InsertStmt): InsertStmt {
    ...
    _o.set(_j, "returningClause", _p?.returningClause);
  ...
  atAlterConstraint(_p?: ATAlterConstraint): ATAlterConstraint {
    const _j = {} as ATAlterConstraint;
    _o.set(_j, "conname", _p?.conname);
    _o.set(_j, "alterEnforceability", _p?.alterEnforceability);
    _o.set(_j, "is_enforced", _p?.is_enforced);
    _o.set(_j, "alterDeferrability", _p?.alterDeferrability);
    _o.set(_j, "deferrable", _p?.deferrable);
    _o.set(_j, "initdeferred", _p?.initdeferred);
    _o.set(_j, "alterInheritability", _p?.alterInheritability);
    _o.set(_j, "noinherit", _p?.noinherit);
    return _j;
  },
  ...
  variableSetStmt(_p?: VariableSetStmt): VariableSetStmt {
    ...
    _o.set(_j, "name", _p?.name);
    _o.set(_j, "args", _p?.args);
    _o.set(_j, "jumble_args", _p?.jumble_args);
    _o.set(_j, "is_local", _p?.is_local);
    _o.set(_j, "location", _p?.location);
    return _j;
  },
  ...
  createStmt(_p?: CreateStmt): CreateStmt {
    ...
    _o.set(_j, "constraints", _p?.constraints);
    _o.set(_j, "nnconstraints", _p?.nnconstraints);
    _o.set(_j, "options", _p?.options);
    _o.set(_j, "oncommit", _p?.oncommit);
    _o.set(_j, "tablespacename", _p?.tablespacename);
    _o.set(_j, "accessMethod", _p?.accessMethod);
  ...
  constraint(_p?: Constraint): Constraint {
    ...
    _o.set(_j, "generated_kind", _p?.generated_kind);
    _o.set(_j, "nulls_not_distinct", _p?.nulls_not_distinct);
    _o.set(_j, "keys", _p?.keys);
    _o.set(_j, "without_overlaps", _p?.without_overlaps);
    ...
    _o.set(_j, "fk_with_period", _p?.fk_with_period);
    _o.set(_j, "pk_with_period", _p?.pk_with_period);
  ...
  indexStmt(_p?: IndexStmt): IndexStmt {
    ...
    _o.set(_j, "isconstraint", _p?.isconstraint);
    _o.set(_j, "iswithoutoverlaps", _p?.iswithoutoverlaps);
    _o.set(_j, "deferrable", _p?.deferrable);
    _o.set(_j, "initdeferred", _p?.initdeferred);
  ...
  summaryResult(_p?: SummaryResult): SummaryResult {
    const _j = {} as SummaryResult;
    _o.set(_j, "tables", _p?.tables);
    _o.set(_j, "aliases", _p?.aliases);
    _o.set(_j, "cteNames", _p?.cteNames);
    _o.set(_j, "functions", _p?.functions);
    _o.set(_j, "filterColumns", _p?.filterColumns);
    _o.set(_j, "statementTypes", _p?.statementTypes);
    _o.set(_j, "truncatedQuery", _p?.truncatedQuery);
    return _j;
  },
  table(_p?: Table): Table {
    const _j = {} as Table;
    _o.set(_j, "name", _p?.name);
    _o.set(_j, "schemaName", _p?.schemaName);
    _o.set(_j, "tableName", _p?.tableName);
    _o.set(_j, "context", _p?.context);
    return _j;
  },
  function(_p?: Function): Function {
    const _j = {} as Function;
    _o.set(_j, "name", _p?.name);
    _o.set(_j, "functionName", _p?.functionName);
    _o.set(_j, "schemaName", _p?.schemaName);
    _o.set(_j, "context", _p?.context);
    return _j;
  },
  filterColumn(_p?: FilterColumn): FilterColumn {
    const _j = {} as FilterColumn;
    _o.set(_j, "schemaName", _p?.schemaName);
    _o.set(_j, "tableName", _p?.tableName);
    _o.set(_j, "column", _p?.column);
    return _j;
  }
};