...
export default {
  ...
  returningExpr(_p?: ReturningExpr): {
  ...
  returningOption(_p?: ReturningOption): {
  ...
  returningClause(_p?: ReturningClause): {
  ...
  atAlterConstraint(_p?: ATAlterConstraint): {
  ...
  summaryResult(_p?: SummaryResult): {
