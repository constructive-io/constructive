# Diff — `M` `jobs/knative-job-example/CHANGELOG.md`
...
- Numstat: `+2/-2`
- Reproduce: `git diff main...HEAD -- jobs/knative-job-example/CHANGELOG.md`
...
```text
## [0.2.3](https://github.com/constructive-io/jobs/compare/@launchql/knative-job-example@0.2.2...@launchql/knative-jo |	## [0.2.3](https://github.com/constructive-io/jobs/compare/@constructive-io/knative-job-example@0.2.2...@constructive
