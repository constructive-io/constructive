...
import agentEventCmd from './commands/agent-event';
...
import agentRunCmd from './commands/agent-run';
import agentRunWorkspaceCmd from './commands/agent-run-workspace';
...
> = () => ({
  ...
  'agent-run': agentRunCmd,
  'agent-run-workspace': agentRunWorkspaceCmd,
