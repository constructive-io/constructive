...
import type { PrincipalScopeOverride, PrincipalScopeOverrideWithRelations, PrincipalScopeOverrideSelect, PrincipalScopeOverrideFilter, PrincipalScopeOverrideOrderBy, CreatePrincipalScopeOverrideInput, UpdatePrincipalScopeOverrideInput, PrincipalScopeOverridePatch } from "../input-types";
...
export class PrincipalScopeOverrideModel {
  ...
  findMany<S extends PrincipalScopeOverrideSelect>(args: FindManyArgs<S, PrincipalScopeOverrideFilter, PrincipalScopeOverrideOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("PrincipalScopeOverride", "principalScopeOverrides", args.select, {
      where: args?.where,
  ...
  findFirst<S extends PrincipalScopeOverrideSelect>(args: FindFirstArgs<S, PrincipalScopeOverrideFilter, PrincipalScopeOverrideOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("PrincipalScopeOverride", "principalScopeOverrides", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "PrincipalScopeOverrideFilter", "PrincipalScopeOverrideOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends PrincipalScopeOverrideSelect>(args: CreateArgs<S, CreatePrincipalScopeOverrideInput["principalScopeOverride"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("PrincipalScopeOverride", "createPrincipalScopeOverride", "principalScopeOverride", args.select, args.data, "CreatePrincipalScopeOverrideInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "PrincipalScopeOverride",
