...
import createChildPrincipalCmd from './commands/create-child-principal';
...
import createPrincipalFromPresetCmd from './commands/create-principal-from-preset';
...
import mintAccessTokenCmd from './commands/mint-access-token';
import provisionBucketCmd from './commands/provision-bucket';
import provisionNewUserCmd from './commands/provision-new-user';
import refreshAccessTokenCmd from './commands/refresh-access-token';
...
import sendPhoneVerificationCodeCmd from './commands/send-phone-verification-code';
import sendVerificationEmailCmd from './commands/send-verification-email';
import setPasswordCmd from './commands/set-password';
import setPrincipalEntitiesCmd from './commands/set-principal-entities';
import setPrincipalScopeCmd from './commands/set-principal-scope';
...
import updatePrincipalCmd from './commands/update-principal';
import verifyEmailCmd from './commands/verify-email';
import verifyPasswordCmd from './commands/verify-password';
import verifyPhoneCmd from './commands/verify-phone';
...
> = () => ({
  ...
  'create-child-principal': createChildPrincipalCmd,
  'create-org-api-key': createOrgApiKeyCmd,
  'create-org-principal': createOrgPrincipalCmd,
  'create-principal-from-preset': createPrincipalFromPresetCmd,
  ...
  'mint-access-token': mintAccessTokenCmd,
  'provision-bucket': provisionBucketCmd,
  'provision-new-user': provisionNewUserCmd,
  'refresh-access-token': refreshAccessTokenCmd,
  ...
  'send-phone-verification-code': sendPhoneVerificationCodeCmd,
  'send-verification-email': sendVerificationEmailCmd,
  'set-password': setPasswordCmd,
  'set-principal-entities': setPrincipalEntitiesCmd,
  'set-principal-scope': setPrincipalScopeCmd,
  'sign-in': signInCmd,
  ...
  'update-principal': updatePrincipalCmd,
  'verify-email': verifyEmailCmd,
  'verify-password': verifyPasswordCmd,
  'verify-phone': verifyPhoneCmd,
