...
import type { CreateUserInput, UserPatch, UserSelect, UserFilter, UserOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<UserSelect, UserFilter, UserOrderBy> & {
      select: UserSelect;
    }>(argv, defaultSelect);
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<UserSelect, UserFilter, UserOrderBy> & {
      select: UserSelect;
    }>(argv, defaultSelect);
    const client = getClient();
