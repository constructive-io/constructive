...
import type { CreateIdentityProviderInput, IdentityProviderPatch, IdentityProviderSelect, IdentityProviderFilter, IdentityProviderOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<IdentityProviderSelect, IdentityProviderFilter, IdentityProviderOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<IdentityProviderSelect, IdentityProviderFilter, IdentityProviderOrderBy> & {
      select: IdentityProviderSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateIdentityProviderInput["identityProvider"];
    const client = getClient();
    const result = await client.identityProvider.create({
      data: {
