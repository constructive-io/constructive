...
import type { CreatePrincipalInput, PrincipalPatch, PrincipalSelect, PrincipalFilter, PrincipalOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PrincipalSelect, PrincipalFilter, PrincipalOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PrincipalSelect, PrincipalFilter, PrincipalOrderBy> & {
      select: PrincipalSelect;
    }>(argv, defaultSelect);
    const client = getClient();
