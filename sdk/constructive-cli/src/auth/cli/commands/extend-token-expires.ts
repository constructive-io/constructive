/**
 * CLI command for mutation extendTokenExpires
...
import type { ExtendTokenExpiresPayloadSelect } from "../../orm/input-types";
export default async (argv: Partial<Record<string, unknown>>, prompter: Inquirerer, _options: CLIOptions) => {
  try {
    ...
    const result = await client.mutation.extendTokenExpires(parsedAnswers as unknown as ExtendTokenExpiresVariables, {
      select: selectFields
    } as unknown as {
      select: ExtendTokenExpiresPayloadSelect;
    }).execute();
