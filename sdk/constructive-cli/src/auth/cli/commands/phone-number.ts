...
import type { CreatePhoneNumberInput, PhoneNumberPatch, PhoneNumberSelect, PhoneNumberFilter, PhoneNumberOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PhoneNumberSelect, PhoneNumberFilter, PhoneNumberOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PhoneNumberSelect, PhoneNumberFilter, PhoneNumberOrderBy> & {
      select: PhoneNumberSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.phoneNumber.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePhoneNumberInput["phoneNumber"];
    const client = getClient();
