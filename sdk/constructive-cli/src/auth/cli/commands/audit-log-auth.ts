...
import type { CreateAuditLogAuthInput, AuditLogAuthPatch, AuditLogAuthSelect, AuditLogAuthFilter, AuditLogAuthOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<AuditLogAuthSelect, AuditLogAuthFilter, AuditLogAuthOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<AuditLogAuthSelect, AuditLogAuthFilter, AuditLogAuthOrderBy> & {
      select: AuditLogAuthSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.auditLogAuth.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateAuditLogAuthInput["auditLogAuth"];
    const client = getClient();
    const result = await client.auditLogAuth.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.auditLogAuth.update({
      where: {
        id: answers.id as string,
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.auditLogAuth.delete({
      where: {
        id: answers.id as string,
        createdAt: answers.createdAt as string
      },
