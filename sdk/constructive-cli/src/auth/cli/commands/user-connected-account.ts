...
import type { CreateUserConnectedAccountInput, UserConnectedAccountPatch, UserConnectedAccountSelect, UserConnectedAccountFilter, UserConnectedAccountOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<UserConnectedAccountSelect, UserConnectedAccountFilter, UserConnectedAccountOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<UserConnectedAccountSelect, UserConnectedAccountFilter, UserConnectedAccountOrderBy> & {
      select: UserConnectedAccountSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateUserConnectedAccountInput["userConnectedAccount"];
    const client = getClient();
    const result = await client.userConnectedAccount.create({
      data: {
