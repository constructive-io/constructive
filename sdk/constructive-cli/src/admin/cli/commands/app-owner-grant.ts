...
import type { CreateAppOwnerGrantInput, AppOwnerGrantPatch, AppOwnerGrantSelect, AppOwnerGrantFilter, AppOwnerGrantOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<AppOwnerGrantSelect, AppOwnerGrantFilter, AppOwnerGrantOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<AppOwnerGrantSelect, AppOwnerGrantFilter, AppOwnerGrantOrderBy> & {
      select: AppOwnerGrantSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.appOwnerGrant.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateAppOwnerGrantInput["appOwnerGrant"];
    const client = getClient();
    const result = await client.appOwnerGrant.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.appOwnerGrant.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.appOwnerGrant.delete({
      where: {
        id: answers.id as string
      },
      select: {
