...
import type { CreateOrgClaimedInviteInput, OrgClaimedInvitePatch, OrgClaimedInviteSelect, OrgClaimedInviteFilter, OrgClaimedInviteOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<OrgClaimedInviteSelect, OrgClaimedInviteFilter, OrgClaimedInviteOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<OrgClaimedInviteSelect, OrgClaimedInviteFilter, OrgClaimedInviteOrderBy> & {
      select: OrgClaimedInviteSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.orgClaimedInvite.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateOrgClaimedInviteInput["orgClaimedInvite"];
    const client = getClient();
    const result = await client.orgClaimedInvite.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.orgClaimedInvite.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.orgClaimedInvite.delete({
      where: {
        id: answers.id as string
      },
      select: {
