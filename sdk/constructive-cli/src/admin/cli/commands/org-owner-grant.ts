...
import type { CreateOrgOwnerGrantInput, OrgOwnerGrantPatch, OrgOwnerGrantSelect, OrgOwnerGrantFilter, OrgOwnerGrantOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<OrgOwnerGrantSelect, OrgOwnerGrantFilter, OrgOwnerGrantOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<OrgOwnerGrantSelect, OrgOwnerGrantFilter, OrgOwnerGrantOrderBy> & {
      select: OrgOwnerGrantSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.orgOwnerGrant.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateOrgOwnerGrantInput["orgOwnerGrant"];
    const client = getClient();
    const result = await client.orgOwnerGrant.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.orgOwnerGrant.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.orgOwnerGrant.delete({
      where: {
        id: answers.id as string
      },
      select: {
