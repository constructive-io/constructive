...
import type { CreateOrgMembershipDefaultInput, OrgMembershipDefaultPatch, OrgMembershipDefaultSelect, OrgMembershipDefaultFilter, OrgMembershipDefaultOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<OrgMembershipDefaultSelect, OrgMembershipDefaultFilter, OrgMembershipDefaultOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<OrgMembershipDefaultSelect, OrgMembershipDefaultFilter, OrgMembershipDefaultOrderBy> & {
      select: OrgMembershipDefaultSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.orgMembershipDefault.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateOrgMembershipDefaultInput["orgMembershipDefault"];
    const client = getClient();
    const result = await client.orgMembershipDefault.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.orgMembershipDefault.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.orgMembershipDefault.delete({
      where: {
        id: answers.id as string
      },
      select: {
