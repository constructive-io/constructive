...
import type { CreateOrgMemberProfileInput, OrgMemberProfilePatch, OrgMemberProfileSelect, OrgMemberProfileFilter, OrgMemberProfileOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<OrgMemberProfileSelect, OrgMemberProfileFilter, OrgMemberProfileOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<OrgMemberProfileSelect, OrgMemberProfileFilter, OrgMemberProfileOrderBy> & {
      select: OrgMemberProfileSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.orgMemberProfile.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.orgMemberProfile.delete({
      where: {
        id: answers.id as string
      },
      select: {
