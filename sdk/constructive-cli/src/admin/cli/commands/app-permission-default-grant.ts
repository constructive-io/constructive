...
import type { CreateAppPermissionDefaultGrantInput, AppPermissionDefaultGrantPatch, AppPermissionDefaultGrantSelect, AppPermissionDefaultGrantFilter, AppPermissionDefaultGrantOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<AppPermissionDefaultGrantSelect, AppPermissionDefaultGrantFilter, AppPermissionDefaultGrantOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<AppPermissionDefaultGrantSelect, AppPermissionDefaultGrantFilter, AppPermissionDefaultGrantOrderBy> & {
      select: AppPermissionDefaultGrantSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.appPermissionDefaultGrant.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateAppPermissionDefaultGrantInput["appPermissionDefaultGrant"];
    const client = getClient();
    const result = await client.appPermissionDefaultGrant.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as AppPermissionDefaultGrantPatch;
    const client = getClient();
    const result = await client.appPermissionDefaultGrant.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.appPermissionDefaultGrant.delete({
      where: {
        id: answers.id as string
      },
      select: {
