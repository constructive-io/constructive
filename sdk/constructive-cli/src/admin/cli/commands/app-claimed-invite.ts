...
import type { CreateAppClaimedInviteInput, AppClaimedInvitePatch, AppClaimedInviteSelect, AppClaimedInviteFilter, AppClaimedInviteOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<AppClaimedInviteSelect, AppClaimedInviteFilter, AppClaimedInviteOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<AppClaimedInviteSelect, AppClaimedInviteFilter, AppClaimedInviteOrderBy> & {
      select: AppClaimedInviteSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.appClaimedInvite.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateAppClaimedInviteInput["appClaimedInvite"];
    const client = getClient();
    const result = await client.appClaimedInvite.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as AppClaimedInvitePatch;
    const client = getClient();
    const result = await client.appClaimedInvite.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.appClaimedInvite.delete({
      where: {
        id: answers.id as string
      },
      select: {
