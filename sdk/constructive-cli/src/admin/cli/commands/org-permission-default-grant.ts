...
import type { CreateOrgPermissionDefaultGrantInput, OrgPermissionDefaultGrantPatch, OrgPermissionDefaultGrantSelect, OrgPermissionDefaultGrantFilter, OrgPermissionDefaultGrantOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<OrgPermissionDefaultGrantSelect, OrgPermissionDefaultGrantFilter, OrgPermissionDefaultGrantOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<OrgPermissionDefaultGrantSelect, OrgPermissionDefaultGrantFilter, OrgPermissionDefaultGrantOrderBy> & {
      select: OrgPermissionDefaultGrantSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.orgPermissionDefaultGrant.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateOrgPermissionDefaultGrantInput["orgPermissionDefaultGrant"];
    const client = getClient();
    const result = await client.orgPermissionDefaultGrant.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as OrgPermissionDefaultGrantPatch;
    const client = getClient();
    const result = await client.orgPermissionDefaultGrant.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.orgPermissionDefaultGrant.delete({
      where: {
        id: answers.id as string
      },
      select: {
