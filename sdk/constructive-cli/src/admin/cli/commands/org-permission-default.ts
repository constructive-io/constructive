...
import type { CreateOrgPermissionDefaultInput, OrgPermissionDefaultPatch, OrgPermissionDefaultSelect, OrgPermissionDefaultFilter, OrgPermissionDefaultOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<OrgPermissionDefaultSelect, OrgPermissionDefaultFilter, OrgPermissionDefaultOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<OrgPermissionDefaultSelect, OrgPermissionDefaultFilter, OrgPermissionDefaultOrderBy> & {
      select: OrgPermissionDefaultSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.orgPermissionDefault.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateOrgPermissionDefaultInput["orgPermissionDefault"];
    const client = getClient();
    const result = await client.orgPermissionDefault.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.orgPermissionDefault.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.orgPermissionDefault.delete({
      where: {
        id: answers.id as string
      },
      select: {
