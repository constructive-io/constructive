...
import type { CreateOrgPermissionDefaultPermissionInput, OrgPermissionDefaultPermissionPatch, OrgPermissionDefaultPermissionSelect, OrgPermissionDefaultPermissionFilter, OrgPermissionDefaultPermissionOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<OrgPermissionDefaultPermissionSelect, OrgPermissionDefaultPermissionFilter, OrgPermissionDefaultPermissionOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<OrgPermissionDefaultPermissionSelect, OrgPermissionDefaultPermissionFilter, OrgPermissionDefaultPermissionOrderBy> & {
      select: OrgPermissionDefaultPermissionSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.orgPermissionDefaultPermission.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateOrgPermissionDefaultPermissionInput["orgPermissionDefaultPermission"];
    const client = getClient();
    const result = await client.orgPermissionDefaultPermission.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as OrgPermissionDefaultPermissionPatch;
    const client = getClient();
    const result = await client.orgPermissionDefaultPermission.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.orgPermissionDefaultPermission.delete({
      where: {
        id: answers.id as string
      },
      select: {
