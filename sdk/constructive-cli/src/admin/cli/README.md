...
**Required create fields:** `entityId`
**Optional create fields (backend defaults):** `allowExternalMembers`, `allowPrincipalOwnedApiKeys`, `createChildCascadeAdmins`, `createChildCascadeMembers`, `createChildCascadeOwners`, `createdBy`, `createdByPrincipal`, `deleteMemberCascadeChildren`, `inviteProfileAssignmentMode`, `limitAllocationMode`, `populateMemberEmail`, `updatedBy`, `updatedByPrincipal`
