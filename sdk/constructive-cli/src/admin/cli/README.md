...
**Optional create fields (backend defaults):** `capabilities`, `createdBy`, `granted`, `isActive`, `isAdmin`, `isApproved`, `isBanned`, `isDisabled`, `isOwner`, `isVerified`, `profileId`, `updatedBy`
...
**Required create fields:** `actorId`, `entityId`
**Optional create fields (backend defaults):** `capabilities`, `createdBy`, `granted`, `isActive`, `isAdmin`, `isApproved`, `isBanned`, `isDisabled`, `isExternal`, `isOwner`, `isReadOnly`, `profileId`, `updatedBy`
