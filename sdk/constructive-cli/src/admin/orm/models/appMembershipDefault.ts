...
import type { AppMembershipDefault, AppMembershipDefaultWithRelations, AppMembershipDefaultSelect, AppMembershipDefaultFilter, AppMembershipDefaultOrderBy, CreateAppMembershipDefaultInput, UpdateAppMembershipDefaultInput, AppMembershipDefaultPatch } from "../input-types";
...
export class AppMembershipDefaultModel {
  ...
  findFirst<S extends AppMembershipDefaultSelect>(args: FindFirstArgs<S, AppMembershipDefaultFilter, AppMembershipDefaultOrderBy> & {
    select: S;
  } & StrictSelect<S, AppMembershipDefaultSelect>): QueryBuilder<{
  ...
  create<S extends AppMembershipDefaultSelect>(args: CreateArgs<S, CreateAppMembershipDefaultInput["appMembershipDefault"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AppMembershipDefault", "createAppMembershipDefault", "appMembershipDefault", args.select, args.data, "CreateAppMembershipDefaultInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppMembershipDefault",
  ...
  update<S extends AppMembershipDefaultSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AppMembershipDefault", "updateAppMembershipDefault", "appMembershipDefault", args.select, args.where.id, args.data, "UpdateAppMembershipDefaultInput", "id", "appMembershipDefaultPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppMembershipDefault",
  ...
  delete<S extends AppMembershipDefaultSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AppMembershipDefault", "deleteAppMembershipDefault", "appMembershipDefault", {
      id: args.where.id
