...
export class AppPermissionDefaultPermissionModel {
  ...
  findMany<S extends AppPermissionDefaultPermissionSelect>(args: FindManyArgs<S, AppPermissionDefaultPermissionFilter, AppPermissionDefaultPermissionOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("AppPermissionDefaultPermission", "appPermissionDefaultPermissions", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "AppPermissionDefaultPermissionFilter", "AppPermissionDefaultPermissionOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends AppPermissionDefaultPermissionSelect>(args: FindFirstArgs<S, AppPermissionDefaultPermissionFilter, AppPermissionDefaultPermissionOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("AppPermissionDefaultPermission", "appPermissionDefaultPermissions", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "AppPermissionDefaultPermissionFilter", "AppPermissionDefaultPermissionOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends AppPermissionDefaultPermissionSelect>(args: CreateArgs<S, CreateAppPermissionDefaultPermissionInput["appPermissionDefaultPermission"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AppPermissionDefaultPermission", "createAppPermissionDefaultPermission", "appPermissionDefaultPermission", args.select, args.data, "CreateAppPermissionDefaultPermissionInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppPermissionDefaultPermission",
  ...
  update<S extends AppPermissionDefaultPermissionSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AppPermissionDefaultPermission", "updateAppPermissionDefaultPermission", "appPermissionDefaultPermission", args.select, args.where.id, args.data, "UpdateAppPermissionDefaultPermissionInput", "id", "appPermissionDefaultPermissionPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppPermissionDefaultPermission",
  ...
  delete<S extends AppPermissionDefaultPermissionSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AppPermissionDefaultPermission", "deleteAppPermissionDefaultPermission", "appPermissionDefaultPermission", {
      id: args.where.id
    }, "DeleteAppPermissionDefaultPermissionInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppPermissionDefaultPermission",
