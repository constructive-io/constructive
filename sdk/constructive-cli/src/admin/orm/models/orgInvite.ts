...
import type { OrgInvite, OrgInviteWithRelations, OrgInviteSelect, OrgInviteFilter, OrgInviteOrderBy, CreateOrgInviteInput, UpdateOrgInviteInput, OrgInvitePatch } from "../input-types";
...
export class OrgInviteModel {
  ...
  create<S extends OrgInviteSelect>(args: CreateArgs<S, CreateOrgInviteInput["orgInvite"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("OrgInvite", "createOrgInvite", "orgInvite", args.select, args.data, "CreateOrgInviteInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgInvite",
  ...
  update<S extends OrgInviteSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("OrgInvite", "updateOrgInvite", "orgInvite", args.select, args.where.id, args.data, "UpdateOrgInviteInput", "id", "orgInvitePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgInvite",
  ...
  delete<S extends OrgInviteSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("OrgInvite", "deleteOrgInvite", "orgInvite", {
      id: args.where.id
