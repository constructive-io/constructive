...
import type { AppGrant, AppGrantWithRelations, AppGrantSelect, AppGrantFilter, AppGrantOrderBy, CreateAppGrantInput, UpdateAppGrantInput, AppGrantPatch } from "../input-types";
...
export class AppGrantModel {
  ...
  findFirst<S extends AppGrantSelect>(args: FindFirstArgs<S, AppGrantFilter, AppGrantOrderBy> & {
    select: S;
  } & StrictSelect<S, AppGrantSelect>): QueryBuilder<{
  ...
  create<S extends AppGrantSelect>(args: CreateArgs<S, CreateAppGrantInput["appGrant"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AppGrant", "createAppGrant", "appGrant", args.select, args.data, "CreateAppGrantInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppGrant",
  ...
  update<S extends AppGrantSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AppGrant", "updateAppGrant", "appGrant", args.select, args.where.id, args.data, "UpdateAppGrantInput", "id", "appGrantPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppGrant",
  ...
  delete<S extends AppGrantSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AppGrant", "deleteAppGrant", "appGrant", {
      id: args.where.id
