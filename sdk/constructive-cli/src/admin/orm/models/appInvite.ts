...
import type { AppInvite, AppInviteWithRelations, AppInviteSelect, AppInviteFilter, AppInviteOrderBy, CreateAppInviteInput, UpdateAppInviteInput, AppInvitePatch } from "../input-types";
...
export class AppInviteModel {
  ...
  findMany<S extends AppInviteSelect>(args: FindManyArgs<S, AppInviteFilter, AppInviteOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("AppInvite", "appInvites", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "AppInviteFilter", "AppInviteOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends AppInviteSelect>(args: FindFirstArgs<S, AppInviteFilter, AppInviteOrderBy> & {
    select: S;
  } & StrictSelect<S, AppInviteSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("AppInvite", "appInvites", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "AppInviteFilter", "AppInviteOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends AppInviteSelect>(args: CreateArgs<S, CreateAppInviteInput["appInvite"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AppInvite", "createAppInvite", "appInvite", args.select, args.data, "CreateAppInviteInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppInvite",
  ...
  update<S extends AppInviteSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AppInvite", "updateAppInvite", "appInvite", args.select, args.where.id, args.data, "UpdateAppInviteInput", "id", "appInvitePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppInvite",
  ...
  delete<S extends AppInviteSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AppInvite", "deleteAppInvite", "appInvite", {
      id: args.where.id
    }, "DeleteAppInviteInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppInvite",
