...
import type { PrincipalAuthModule, PrincipalAuthModuleWithRelations, PrincipalAuthModuleSelect, PrincipalAuthModuleFilter, PrincipalAuthModuleOrderBy, CreatePrincipalAuthModuleInput, UpdatePrincipalAuthModuleInput, PrincipalAuthModulePatch } from "../input-types";
...
export class PrincipalAuthModuleModel {
  ...
  findMany<S extends PrincipalAuthModuleSelect>(args: FindManyArgs<S, PrincipalAuthModuleFilter, PrincipalAuthModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("PrincipalAuthModule", "principalAuthModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends PrincipalAuthModuleSelect>(args: FindFirstArgs<S, PrincipalAuthModuleFilter, PrincipalAuthModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("PrincipalAuthModule", "principalAuthModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "PrincipalAuthModuleFilter", "PrincipalAuthModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends PrincipalAuthModuleSelect>(args: CreateArgs<S, CreatePrincipalAuthModuleInput["principalAuthModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("PrincipalAuthModule", "createPrincipalAuthModule", "principalAuthModule", args.select, args.data, "CreatePrincipalAuthModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "PrincipalAuthModule",
  ...
  update<S extends PrincipalAuthModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("PrincipalAuthModule", "updatePrincipalAuthModule", "principalAuthModule", args.select, args.where.id, args.data, "UpdatePrincipalAuthModuleInput", "id", "principalAuthModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "PrincipalAuthModule",
  ...
  delete<S extends PrincipalAuthModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("PrincipalAuthModule", "deletePrincipalAuthModule", "principalAuthModule", {
      id: args.where.id
