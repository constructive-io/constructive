...
import type { InferenceLogModule, InferenceLogModuleWithRelations, InferenceLogModuleSelect, InferenceLogModuleFilter, InferenceLogModuleOrderBy, CreateInferenceLogModuleInput, UpdateInferenceLogModuleInput, InferenceLogModulePatch } from "../input-types";
...
export class InferenceLogModuleModel {
  ...
  findMany<S extends InferenceLogModuleSelect>(args: FindManyArgs<S, InferenceLogModuleFilter, InferenceLogModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("InferenceLogModule", "inferenceLogModules", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "InferenceLogModuleFilter", "InferenceLogModuleOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends InferenceLogModuleSelect>(args: FindFirstArgs<S, InferenceLogModuleFilter, InferenceLogModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("InferenceLogModule", "inferenceLogModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "InferenceLogModuleFilter", "InferenceLogModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends InferenceLogModuleSelect>(args: CreateArgs<S, CreateInferenceLogModuleInput["inferenceLogModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("InferenceLogModule", "createInferenceLogModule", "inferenceLogModule", args.select, args.data, "CreateInferenceLogModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "InferenceLogModule",
  ...
  update<S extends InferenceLogModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("InferenceLogModule", "updateInferenceLogModule", "inferenceLogModule", args.select, args.where.id, args.data, "UpdateInferenceLogModuleInput", "id", "inferenceLogModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "InferenceLogModule",
  ...
  delete<S extends InferenceLogModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("InferenceLogModule", "deleteInferenceLogModule", "inferenceLogModule", {
      id: args.where.id
    }, "DeleteInferenceLogModuleInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "InferenceLogModule",
