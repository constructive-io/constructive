...
import type { InternalSecretsModule, InternalSecretsModuleWithRelations, InternalSecretsModuleSelect, InternalSecretsModuleFilter, InternalSecretsModuleOrderBy, CreateInternalSecretsModuleInput, UpdateInternalSecretsModuleInput, InternalSecretsModulePatch } from "../input-types";
...
export class InternalSecretsModuleModel {
  ...
  findMany<S extends InternalSecretsModuleSelect>(args: FindManyArgs<S, InternalSecretsModuleFilter, InternalSecretsModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("InternalSecretsModule", "internalSecretsModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends InternalSecretsModuleSelect>(args: FindFirstArgs<S, InternalSecretsModuleFilter, InternalSecretsModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("InternalSecretsModule", "internalSecretsModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "InternalSecretsModuleFilter", "InternalSecretsModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends InternalSecretsModuleSelect>(args: CreateArgs<S, CreateInternalSecretsModuleInput["internalSecretsModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("InternalSecretsModule", "createInternalSecretsModule", "internalSecretsModule", args.select, args.data, "CreateInternalSecretsModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "InternalSecretsModule",
  ...
  update<S extends InternalSecretsModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("InternalSecretsModule", "updateInternalSecretsModule", "internalSecretsModule", args.select, args.where.id, args.data, "UpdateInternalSecretsModuleInput", "id", "internalSecretsModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "InternalSecretsModule",
  ...
  delete<S extends InternalSecretsModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("InternalSecretsModule", "deleteInternalSecretsModule", "internalSecretsModule", {
      id: args.where.id
