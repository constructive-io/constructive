...
import type { EntityTypeProvision, EntityTypeProvisionWithRelations, EntityTypeProvisionSelect, EntityTypeProvisionFilter, EntityTypeProvisionOrderBy, CreateEntityTypeProvisionInput, UpdateEntityTypeProvisionInput, EntityTypeProvisionPatch } from "../input-types";
...
export class EntityTypeProvisionModel {
  ...
  findMany<S extends EntityTypeProvisionSelect>(args: FindManyArgs<S, EntityTypeProvisionFilter, EntityTypeProvisionOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("EntityTypeProvision", "entityTypeProvisions", args.select, {
      where: args?.where,
  ...
  findFirst<S extends EntityTypeProvisionSelect>(args: FindFirstArgs<S, EntityTypeProvisionFilter, EntityTypeProvisionOrderBy> & {
    select: S;
  } & StrictSelect<S, EntityTypeProvisionSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("EntityTypeProvision", "entityTypeProvisions", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "EntityTypeProvisionFilter", "EntityTypeProvisionOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends EntityTypeProvisionSelect>(args: CreateArgs<S, CreateEntityTypeProvisionInput["entityTypeProvision"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("EntityTypeProvision", "createEntityTypeProvision", "entityTypeProvision", args.select, args.data, "CreateEntityTypeProvisionInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "EntityTypeProvision",
  ...
  update<S extends EntityTypeProvisionSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("EntityTypeProvision", "updateEntityTypeProvision", "entityTypeProvision", args.select, args.where.id, args.data, "UpdateEntityTypeProvisionInput", "id", "entityTypeProvisionPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "EntityTypeProvision",
  ...
  delete<S extends EntityTypeProvisionSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("EntityTypeProvision", "deleteEntityTypeProvision", "entityTypeProvision", {
      id: args.where.id
