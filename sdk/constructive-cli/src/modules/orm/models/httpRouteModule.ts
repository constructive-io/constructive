...
import type { HttpRouteModule, HttpRouteModuleWithRelations, HttpRouteModuleSelect, HttpRouteModuleFilter, HttpRouteModuleOrderBy, CreateHttpRouteModuleInput, UpdateHttpRouteModuleInput, HttpRouteModulePatch } from "../input-types";
...
export class HttpRouteModuleModel {
  ...
  findMany<S extends HttpRouteModuleSelect>(args: FindManyArgs<S, HttpRouteModuleFilter, HttpRouteModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("HttpRouteModule", "httpRouteModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends HttpRouteModuleSelect>(args: FindFirstArgs<S, HttpRouteModuleFilter, HttpRouteModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("HttpRouteModule", "httpRouteModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "HttpRouteModuleFilter", "HttpRouteModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends HttpRouteModuleSelect>(args: CreateArgs<S, CreateHttpRouteModuleInput["httpRouteModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("HttpRouteModule", "createHttpRouteModule", "httpRouteModule", args.select, args.data, "CreateHttpRouteModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "HttpRouteModule",
  ...
  update<S extends HttpRouteModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("HttpRouteModule", "updateHttpRouteModule", "httpRouteModule", args.select, args.where.id, args.data, "UpdateHttpRouteModuleInput", "id", "httpRouteModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "HttpRouteModule",
  ...
  delete<S extends HttpRouteModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("HttpRouteModule", "deleteHttpRouteModule", "httpRouteModule", {
      id: args.where.id
