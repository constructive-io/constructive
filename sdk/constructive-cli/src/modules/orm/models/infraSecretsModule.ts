...
import type { InfraSecretsModule, InfraSecretsModuleWithRelations, InfraSecretsModuleSelect, InfraSecretsModuleFilter, InfraSecretsModuleOrderBy, CreateInfraSecretsModuleInput, UpdateInfraSecretsModuleInput, InfraSecretsModulePatch } from "../input-types";
...
export class InfraSecretsModuleModel {
  ...
  findMany<S extends InfraSecretsModuleSelect>(args: FindManyArgs<S, InfraSecretsModuleFilter, InfraSecretsModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("InfraSecretsModule", "infraSecretsModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends InfraSecretsModuleSelect>(args: FindFirstArgs<S, InfraSecretsModuleFilter, InfraSecretsModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("InfraSecretsModule", "infraSecretsModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "InfraSecretsModuleFilter", "InfraSecretsModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends InfraSecretsModuleSelect>(args: CreateArgs<S, CreateInfraSecretsModuleInput["infraSecretsModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("InfraSecretsModule", "createInfraSecretsModule", "infraSecretsModule", args.select, args.data, "CreateInfraSecretsModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "InfraSecretsModule",
  ...
  update<S extends InfraSecretsModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("InfraSecretsModule", "updateInfraSecretsModule", "infraSecretsModule", args.select, args.where.id, args.data, "UpdateInfraSecretsModuleInput", "id", "infraSecretsModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "InfraSecretsModule",
  ...
  delete<S extends InfraSecretsModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("InfraSecretsModule", "deleteInfraSecretsModule", "infraSecretsModule", {
      id: args.where.id
