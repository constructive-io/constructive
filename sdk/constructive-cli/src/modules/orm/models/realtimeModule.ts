...
import type { RealtimeModule, RealtimeModuleWithRelations, RealtimeModuleSelect, RealtimeModuleFilter, RealtimeModuleOrderBy, CreateRealtimeModuleInput, UpdateRealtimeModuleInput, RealtimeModulePatch } from "../input-types";
...
export class RealtimeModuleModel {
  ...
  findMany<S extends RealtimeModuleSelect>(args: FindManyArgs<S, RealtimeModuleFilter, RealtimeModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("RealtimeModule", "realtimeModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends RealtimeModuleSelect>(args: FindFirstArgs<S, RealtimeModuleFilter, RealtimeModuleOrderBy> & {
    select: S;
  } & StrictSelect<S, RealtimeModuleSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("RealtimeModule", "realtimeModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "RealtimeModuleFilter", "RealtimeModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends RealtimeModuleSelect>(args: CreateArgs<S, CreateRealtimeModuleInput["realtimeModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("RealtimeModule", "createRealtimeModule", "realtimeModule", args.select, args.data, "CreateRealtimeModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "RealtimeModule",
  ...
  update<S extends RealtimeModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("RealtimeModule", "updateRealtimeModule", "realtimeModule", args.select, args.where.id, args.data, "UpdateRealtimeModuleInput", "id", "realtimeModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "RealtimeModule",
  ...
  delete<S extends RealtimeModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("RealtimeModule", "deleteRealtimeModule", "realtimeModule", {
      id: args.where.id
