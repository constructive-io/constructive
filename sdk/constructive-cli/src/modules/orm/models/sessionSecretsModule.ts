...
import type { SessionSecretsModule, SessionSecretsModuleWithRelations, SessionSecretsModuleSelect, SessionSecretsModuleFilter, SessionSecretsModuleOrderBy, CreateSessionSecretsModuleInput, UpdateSessionSecretsModuleInput, SessionSecretsModulePatch } from "../input-types";
...
export class SessionSecretsModuleModel {
  ...
  findMany<S extends SessionSecretsModuleSelect>(args: FindManyArgs<S, SessionSecretsModuleFilter, SessionSecretsModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("SessionSecretsModule", "sessionSecretsModules", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "SessionSecretsModuleFilter", "SessionSecretsModuleOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends SessionSecretsModuleSelect>(args: FindFirstArgs<S, SessionSecretsModuleFilter, SessionSecretsModuleOrderBy> & {
    select: S;
  } & StrictSelect<S, SessionSecretsModuleSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("SessionSecretsModule", "sessionSecretsModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "SessionSecretsModuleFilter", "SessionSecretsModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends SessionSecretsModuleSelect>(args: CreateArgs<S, CreateSessionSecretsModuleInput["sessionSecretsModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("SessionSecretsModule", "createSessionSecretsModule", "sessionSecretsModule", args.select, args.data, "CreateSessionSecretsModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "SessionSecretsModule",
  ...
  update<S extends SessionSecretsModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("SessionSecretsModule", "updateSessionSecretsModule", "sessionSecretsModule", args.select, args.where.id, args.data, "UpdateSessionSecretsModuleInput", "id", "sessionSecretsModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "SessionSecretsModule",
  ...
  delete<S extends SessionSecretsModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("SessionSecretsModule", "deleteSessionSecretsModule", "sessionSecretsModule", {
      id: args.where.id
    }, "DeleteSessionSecretsModuleInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "SessionSecretsModule",
