...
import type { BillingModule, BillingModuleWithRelations, BillingModuleSelect, BillingModuleFilter, BillingModuleOrderBy, CreateBillingModuleInput, UpdateBillingModuleInput, BillingModulePatch } from "../input-types";
...
export class BillingModuleModel {
  ...
  findMany<S extends BillingModuleSelect>(args: FindManyArgs<S, BillingModuleFilter, BillingModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("BillingModule", "billingModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends BillingModuleSelect>(args: FindFirstArgs<S, BillingModuleFilter, BillingModuleOrderBy> & {
    select: S;
  } & StrictSelect<S, BillingModuleSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("BillingModule", "billingModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "BillingModuleFilter", "BillingModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends BillingModuleSelect>(args: CreateArgs<S, CreateBillingModuleInput["billingModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("BillingModule", "createBillingModule", "billingModule", args.select, args.data, "CreateBillingModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "BillingModule",
  ...
  update<S extends BillingModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("BillingModule", "updateBillingModule", "billingModule", args.select, args.where.id, args.data, "UpdateBillingModuleInput", "id", "billingModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "BillingModule",
  ...
  delete<S extends BillingModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("BillingModule", "deleteBillingModule", "billingModule", {
      id: args.where.id
