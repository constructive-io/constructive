...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      ...
      creditPacksTableId: true,
      creditPacksTableName: true,
      databaseId: true,
      defaultCapabilities: true,
      defaultMeterCatalog: true,
      grantMeterCreditsFunction: true,
      id: true,
      ledgerTableId: true,
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [
      ...
      {
        type: 'text',
        name: 'creditPacksTableId',
        message: 'creditPacksTableId',
        required: false,
        skipPrompt: true,
      },
      {
        type: 'text',
        name: 'creditPacksTableName',
        message: 'creditPacksTableName',
        required: false,
        skipPrompt: true,
      },
      {
      ...
      {
        type: 'json',
        name: 'defaultMeterCatalog',
        message: 'defaultMeterCatalog',
        required: false,
        skipPrompt: true,
      },
      {
        type: 'text',
        name: 'grantMeterCreditsFunction',
        message: 'grantMeterCreditsFunction',
        required: false,
        skipPrompt: true,
      },
      {
    ...
    const result = await client.billingModule
      .create({
        data: {
          ...
          creditPacksTableId: cleanedData.creditPacksTableId,
          creditPacksTableName: cleanedData.creditPacksTableName,
          databaseId: cleanedData.databaseId,
          defaultCapabilities: cleanedData.defaultCapabilities,
          defaultMeterCatalog: cleanedData.defaultMeterCatalog,
          grantMeterCreditsFunction: cleanedData.grantMeterCreditsFunction,
