...
import type { CreateConfigSecretsUserModuleInput, ConfigSecretsUserModulePatch, ConfigSecretsUserModuleSelect, ConfigSecretsUserModuleFilter, ConfigSecretsUserModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<ConfigSecretsUserModuleSelect, ConfigSecretsUserModuleFilter, ConfigSecretsUserModuleOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<ConfigSecretsUserModuleSelect, ConfigSecretsUserModuleFilter, ConfigSecretsUserModuleOrderBy> & {
      select: ConfigSecretsUserModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.configSecretsUserModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateConfigSecretsUserModuleInput["configSecretsUserModule"];
    const client = getClient();
    const result = await client.configSecretsUserModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as ConfigSecretsUserModulePatch;
    const client = getClient();
    const result = await client.configSecretsUserModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.configSecretsUserModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
