/**
 * CLI commands for ScopeTypesModule
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      ...
      schemaId: true,
      scopeTypesTableId: true,
    };
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<ScopeTypesModuleSelect, ScopeTypesModuleFilter, ScopeTypesModuleOrderBy> & {
        select: ScopeTypesModuleSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.scopeTypesModule.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<ScopeTypesModuleSelect, ScopeTypesModuleFilter, ScopeTypesModuleOrderBy> & {
        select: ScopeTypesModuleSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.scopeTypesModule
      .findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [
      ...
      {
        type: 'text',
        name: 'scopeTypesTableId',
        message: 'scopeTypesTableId',
        required: false,
        skipPrompt: true,
      },
    ]);
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreateScopeTypesModuleInput['scopeTypesModule'];
    const client = getClient();
    const result = await client.scopeTypesModule
      .create({
        data: {
          ...
          scopeTypesTableId: cleanedData.scopeTypesTableId,
        },
        select: {
          databaseId: true,
          id: true,
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as ScopeTypesModulePatch;
    const client = getClient();
    const result = await client.scopeTypesModule
      .update({
        where: {
