/**
 * CLI commands for UserSettingsModule
...
import type { CreateUserSettingsModuleInput, UserSettingsModulePatch, UserSettingsModuleSelect, UserSettingsModuleFilter, UserSettingsModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<UserSettingsModuleSelect, UserSettingsModuleFilter, UserSettingsModuleOrderBy> & {
      select: UserSettingsModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.userSettingsModule.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<UserSettingsModuleSelect, UserSettingsModuleFilter, UserSettingsModuleOrderBy> & {
      select: UserSettingsModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.userSettingsModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateUserSettingsModuleInput["userSettingsModule"];
    const client = getClient();
    const result = await client.userSettingsModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as UserSettingsModulePatch;
    const client = getClient();
    const result = await client.userSettingsModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.userSettingsModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
