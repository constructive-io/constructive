...
import type { CreateBillingProviderModuleInput, BillingProviderModulePatch, BillingProviderModuleSelect, BillingProviderModuleFilter, BillingProviderModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<BillingProviderModuleSelect, BillingProviderModuleFilter, BillingProviderModuleOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<BillingProviderModuleSelect, BillingProviderModuleFilter, BillingProviderModuleOrderBy> & {
      select: BillingProviderModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.billingProviderModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateBillingProviderModuleInput["billingProviderModule"];
    const client = getClient();
    const result = await client.billingProviderModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.billingProviderModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.billingProviderModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
