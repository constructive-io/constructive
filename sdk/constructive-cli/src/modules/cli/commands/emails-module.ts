...
import type { CreateEmailsModuleInput, EmailsModulePatch, EmailsModuleSelect, EmailsModuleFilter, EmailsModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<EmailsModuleSelect, EmailsModuleFilter, EmailsModuleOrderBy> & {
      select: EmailsModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.emailsModule.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<EmailsModuleSelect, EmailsModuleFilter, EmailsModuleOrderBy> & {
      select: EmailsModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.emailsModule.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.emailsModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateEmailsModuleInput["emailsModule"];
    const client = getClient();
    const result = await client.emailsModule.create({
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.emailsModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
