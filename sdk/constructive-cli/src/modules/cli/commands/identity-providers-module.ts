...
import type { CreateIdentityProvidersModuleInput, IdentityProvidersModulePatch, IdentityProvidersModuleSelect, IdentityProvidersModuleFilter, IdentityProvidersModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<IdentityProvidersModuleSelect, IdentityProvidersModuleFilter, IdentityProvidersModuleOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<IdentityProvidersModuleSelect, IdentityProvidersModuleFilter, IdentityProvidersModuleOrderBy> & {
      select: IdentityProvidersModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.identityProvidersModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateIdentityProvidersModuleInput["identityProvidersModule"];
    const client = getClient();
    const result = await client.identityProvidersModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.identityProvidersModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.identityProvidersModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
