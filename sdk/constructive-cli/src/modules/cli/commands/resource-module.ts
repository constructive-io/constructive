...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      apiName: true,
      builderBindingsTableId: true,
      builderBindingsTableName: true,
      databaseId: true,
      ...
      registryBindingsTableId: true,
      registryBindingsTableName: true,
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [
      ...
      {
        type: 'text',
        name: 'builderBindingsTableId',
        message: 'builderBindingsTableId',
        required: false,
        skipPrompt: true,
      },
      {
        type: 'text',
        name: 'builderBindingsTableName',
        message: 'builderBindingsTableName',
        required: false,
        skipPrompt: true,
      },
      {
      ...
      {
        type: 'text',
        name: 'registryBindingsTableId',
        message: 'registryBindingsTableId',
        required: false,
        skipPrompt: true,
      },
      {
        type: 'text',
        name: 'registryBindingsTableName',
        message: 'registryBindingsTableName',
        required: false,
        skipPrompt: true,
      },
      {
    ...
    const result = await client.resourceModule
      .create({
        data: {
          ...
          builderBindingsTableId: cleanedData.builderBindingsTableId,
          builderBindingsTableName: cleanedData.builderBindingsTableName,
          ...
          registryBindingsTableId: cleanedData.registryBindingsTableId,
          registryBindingsTableName: cleanedData.registryBindingsTableName,
