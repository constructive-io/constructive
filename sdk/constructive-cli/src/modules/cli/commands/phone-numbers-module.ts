...
import type { CreatePhoneNumbersModuleInput, PhoneNumbersModulePatch, PhoneNumbersModuleSelect, PhoneNumbersModuleFilter, PhoneNumbersModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PhoneNumbersModuleSelect, PhoneNumbersModuleFilter, PhoneNumbersModuleOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PhoneNumbersModuleSelect, PhoneNumbersModuleFilter, PhoneNumbersModuleOrderBy> & {
      select: PhoneNumbersModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.phoneNumbersModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePhoneNumbersModuleInput["phoneNumbersModule"];
    const client = getClient();
    const result = await client.phoneNumbersModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.phoneNumbersModule.update({
      where: {
        id: answers.id as string
      },
      data: {
