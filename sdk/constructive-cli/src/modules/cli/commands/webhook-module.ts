/**
 * CLI commands for WebhookModule
...
import type { CreateWebhookModuleInput, WebhookModulePatch, WebhookModuleSelect, WebhookModuleFilter, WebhookModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      ...
      entityField: true,
      entityTableId: true,
      functionInvocationModuleId: true,
      functionModuleId: true,
      id: true,
      infraSecretsModuleId: true,
      ...
      schemaId: true,
      scope: true,
      webhookEndpointsTableId: true,
      webhookEndpointsTableName: true,
      webhookEventsTableId: true,
      webhookEventsTableName: true
    };
    const findManyArgs = parseFindManyArgs<FindManyArgs<WebhookModuleSelect, WebhookModuleFilter, WebhookModuleOrderBy> & {
      select: WebhookModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.webhookModule.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<WebhookModuleSelect, WebhookModuleFilter, WebhookModuleOrderBy> & {
      select: WebhookModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.webhookModule.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.webhookModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [{
      ...
      type: "text",
      name: "functionInvocationModuleId",
      message: "functionInvocationModuleId",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
      ...
      type: "text",
      name: "infraSecretsModuleId",
      message: "infraSecretsModuleId",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
      ...
      type: "text",
      name: "webhookEndpointsTableId",
      message: "webhookEndpointsTableId",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
      name: "webhookEndpointsTableName",
      message: "webhookEndpointsTableName",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
      name: "webhookEventsTableId",
      message: "webhookEventsTableId",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
      name: "webhookEventsTableName",
      message: "webhookEventsTableName",
      required: false,
      skipPrompt: true
    }]);
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateWebhookModuleInput["webhookModule"];
    const client = getClient();
    const result = await client.webhookModule.create({
      data: {
        ...
        functionInvocationModuleId: cleanedData.functionInvocationModuleId,
        functionModuleId: cleanedData.functionModuleId,
        infraSecretsModuleId: cleanedData.infraSecretsModuleId,
        ...
        webhookEndpointsTableId: cleanedData.webhookEndpointsTableId,
        webhookEndpointsTableName: cleanedData.webhookEndpointsTableName,
        webhookEventsTableId: cleanedData.webhookEventsTableId,
        webhookEventsTableName: cleanedData.webhookEventsTableName
      },
      select: {
        apiName: true,
        databaseId: true,
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as WebhookModulePatch;
    const client = getClient();
    const result = await client.webhookModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.webhookModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
