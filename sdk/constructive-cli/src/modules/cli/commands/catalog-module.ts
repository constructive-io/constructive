...
import type { CreateCatalogModuleInput, CatalogModulePatch, CatalogModuleSelect, CatalogModuleFilter, CatalogModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<CatalogModuleSelect, CatalogModuleFilter, CatalogModuleOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<CatalogModuleSelect, CatalogModuleFilter, CatalogModuleOrderBy> & {
      select: CatalogModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.catalogModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateCatalogModuleInput["catalogModule"];
    const client = getClient();
    const result = await client.catalogModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.catalogModule.update({
      where: {
        id: answers.id as string
      },
      data: {
