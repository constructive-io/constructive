/**
 * CLI commands for InfraSecretsModule
...
import type { CreateInfraSecretsModuleInput, InfraSecretsModulePatch, InfraSecretsModuleSelect, InfraSecretsModuleFilter, InfraSecretsModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      ...
      scope: true,
      secretsTableId: true,
      secretsTableName: true
    };
    const findManyArgs = parseFindManyArgs<FindManyArgs<InfraSecretsModuleSelect, InfraSecretsModuleFilter, InfraSecretsModuleOrderBy> & {
      select: InfraSecretsModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.infraSecretsModule.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<InfraSecretsModuleSelect, InfraSecretsModuleFilter, InfraSecretsModuleOrderBy> & {
      select: InfraSecretsModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.infraSecretsModule.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.infraSecretsModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [{
      ...
      message: "secretsTableName",
      required: false,
      skipPrompt: true
    }]);
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateInfraSecretsModuleInput["infraSecretsModule"];
    const client = getClient();
    const result = await client.infraSecretsModule.create({
      data: {
        ...
        secretsTableName: cleanedData.secretsTableName
      },
      select: {
        apiName: true,
        databaseId: true,
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as InfraSecretsModulePatch;
    const client = getClient();
    const result = await client.infraSecretsModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.infraSecretsModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
