...
import type { CreateCryptoAddressesModuleInput, CryptoAddressesModulePatch, CryptoAddressesModuleSelect, CryptoAddressesModuleFilter, CryptoAddressesModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<CryptoAddressesModuleSelect, CryptoAddressesModuleFilter, CryptoAddressesModuleOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<CryptoAddressesModuleSelect, CryptoAddressesModuleFilter, CryptoAddressesModuleOrderBy> & {
      select: CryptoAddressesModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.cryptoAddressesModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateCryptoAddressesModuleInput["cryptoAddressesModule"];
    const client = getClient();
    const result = await client.cryptoAddressesModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.cryptoAddressesModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.cryptoAddressesModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
