...
import type { CreateInferenceLogModuleInput, InferenceLogModulePatch, InferenceLogModuleSelect, InferenceLogModuleFilter, InferenceLogModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<InferenceLogModuleSelect, InferenceLogModuleFilter, InferenceLogModuleOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<InferenceLogModuleSelect, InferenceLogModuleFilter, InferenceLogModuleOrderBy> & {
      select: InferenceLogModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.inferenceLogModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateInferenceLogModuleInput["inferenceLogModule"];
    const client = getClient();
    const result = await client.inferenceLogModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.inferenceLogModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.inferenceLogModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
