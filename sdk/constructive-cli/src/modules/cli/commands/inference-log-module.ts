...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      ...
      inferencePriceTableId: true,
      inferencePriceTableName: true,
      interval: true,
      prefix: true,
      premake: true,
      privateApiName: true,
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [
      ...
      {
        type: 'text',
        name: 'inferencePriceTableId',
        message: 'inferencePriceTableId',
        required: false,
        skipPrompt: true,
      },
      {
        type: 'text',
        name: 'inferencePriceTableName',
        message: 'inferencePriceTableName',
        required: false,
        skipPrompt: true,
      },
      {
    ...
    const result = await client.inferenceLogModule
      .create({
        data: {
          ...
          inferencePriceTableId: cleanedData.inferencePriceTableId,
          inferencePriceTableName: cleanedData.inferencePriceTableName,
