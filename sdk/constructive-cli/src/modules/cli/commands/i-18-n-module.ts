...
import type { CreateI18NModuleInput, I18NModulePatch, I18NModuleSelect, I18NModuleFilter, I18NModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<I18NModuleSelect, I18NModuleFilter, I18NModuleOrderBy> & {
      select: I18NModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.i18NModule.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<I18NModuleSelect, I18NModuleFilter, I18NModuleOrderBy> & {
      select: I18NModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.i18NModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateI18NModuleInput["i18NModule"];
    const client = getClient();
    const result = await client.i18NModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as I18NModulePatch;
    const client = getClient();
    const result = await client.i18NModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.i18NModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
