...
import type { CreateDomainModuleInput, DomainModulePatch, DomainModuleSelect, DomainModuleFilter, DomainModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      ...
      domainEventsTableId: true,
      domainEventsTableName: true,
      domainVerificationsTableId: true,
      domainVerificationsTableName: true,
      domainsTableId: true,
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<DomainModuleSelect, DomainModuleFilter, DomainModuleOrderBy> & {
      select: DomainModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.domainModule.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<DomainModuleSelect, DomainModuleFilter, DomainModuleOrderBy> & {
      select: DomainModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.domainModule.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.domainModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [{
      ...
      type: "text",
      name: "domainEventsTableId",
      message: "domainEventsTableId",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
      name: "domainEventsTableName",
      message: "domainEventsTableName",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
      name: "domainVerificationsTableId",
      message: "domainVerificationsTableId",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
      name: "domainVerificationsTableName",
      message: "domainVerificationsTableName",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
    ...
    const client = getClient();
    const result = await client.domainModule.create({
      data: {
        ...
        domainEventsTableId: cleanedData.domainEventsTableId,
        domainEventsTableName: cleanedData.domainEventsTableName,
        domainVerificationsTableId: cleanedData.domainVerificationsTableId,
        domainVerificationsTableName: cleanedData.domainVerificationsTableName,
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as DomainModulePatch;
    const client = getClient();
    const result = await client.domainModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.domainModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
