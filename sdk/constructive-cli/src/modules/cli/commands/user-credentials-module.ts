/**
 * CLI commands for UserCredentialsModule
...
import type { CreateUserCredentialsModuleInput, UserCredentialsModulePatch, UserCredentialsModuleSelect, UserCredentialsModuleFilter, UserCredentialsModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<UserCredentialsModuleSelect, UserCredentialsModuleFilter, UserCredentialsModuleOrderBy> & {
      select: UserCredentialsModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.userCredentialsModule.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<UserCredentialsModuleSelect, UserCredentialsModuleFilter, UserCredentialsModuleOrderBy> & {
      select: UserCredentialsModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.userCredentialsModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateUserCredentialsModuleInput["userCredentialsModule"];
    const client = getClient();
    const result = await client.userCredentialsModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.userCredentialsModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.userCredentialsModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
