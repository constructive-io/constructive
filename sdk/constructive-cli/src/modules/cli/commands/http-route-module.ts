/**
 * CLI commands for HttpRouteModule
...
import type { CreateHttpRouteModuleInput, HttpRouteModulePatch, HttpRouteModuleSelect, HttpRouteModuleFilter, HttpRouteModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      ...
      httpRoutesTableId: true,
      httpRoutesTableName: true,
      id: true,
      policies: true,
      prefix: true,
      privateApiName: true,
      ...
      resourceModuleId: true,
      schemaId: true,
      scope: true,
      storageModuleId: true
    };
    const findManyArgs = parseFindManyArgs<FindManyArgs<HttpRouteModuleSelect, HttpRouteModuleFilter, HttpRouteModuleOrderBy> & {
      select: HttpRouteModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.httpRouteModule.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<HttpRouteModuleSelect, HttpRouteModuleFilter, HttpRouteModuleOrderBy> & {
      select: HttpRouteModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.httpRouteModule.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [{
      ...
      type: "text",
      name: "httpRoutesTableId",
      message: "httpRoutesTableId",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
      name: "httpRoutesTableName",
      message: "httpRoutesTableName",
      required: false,
      skipPrompt: true
    }, {
      type: "json",
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateHttpRouteModuleInput["httpRouteModule"];
    const client = getClient();
    const result = await client.httpRouteModule.create({
      data: {
        ...
        httpRoutesTableId: cleanedData.httpRoutesTableId,
        httpRoutesTableName: cleanedData.httpRoutesTableName,
        ...
        resourceModuleId: cleanedData.resourceModuleId,
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as HttpRouteModulePatch;
    const client = getClient();
    const result = await client.httpRouteModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.httpRouteModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
