...
import type { CreateRouteModuleInput, RouteModulePatch, RouteModuleSelect, RouteModuleFilter, RouteModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      ...
      entityField: true,
      entityTableId: true,
      hostnameBindingsTableId: true,
      hostnameBindingsTableName: true,
      id: true,
      policies: true,
      prefix: true,
      privateApiName: true,
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<RouteModuleSelect, RouteModuleFilter, RouteModuleOrderBy> & {
      select: RouteModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.routeModule.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<RouteModuleSelect, RouteModuleFilter, RouteModuleOrderBy> & {
      select: RouteModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.routeModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [{
      ...
      type: "text",
      name: "hostnameBindingsTableId",
      message: "hostnameBindingsTableId",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
      name: "hostnameBindingsTableName",
      message: "hostnameBindingsTableName",
      required: false,
      skipPrompt: true
    }, {
      type: "json",
      ...
      type: "text",
      name: "routeBindingsTableId",
      message: "routeBindingsTableId",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
      name: "routeBindingsTableName",
      message: "routeBindingsTableName",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
      name: "routesTableId",
      message: "routesTableId",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
      name: "routesTableName",
      message: "routesTableName",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateRouteModuleInput["routeModule"];
    const client = getClient();
    const result = await client.routeModule.create({
      data: {
        ...
        hostnameBindingsTableId: cleanedData.hostnameBindingsTableId,
        hostnameBindingsTableName: cleanedData.hostnameBindingsTableName,
        ...
        routesTableId: cleanedData.routesTableId,
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.routeModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.routeModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
