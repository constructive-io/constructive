...
import type { CreateBlueprintConstructionInput, BlueprintConstructionPatch, BlueprintConstructionSelect, BlueprintConstructionFilter, BlueprintConstructionOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<BlueprintConstructionSelect, BlueprintConstructionFilter, BlueprintConstructionOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<BlueprintConstructionSelect, BlueprintConstructionFilter, BlueprintConstructionOrderBy> & {
      select: BlueprintConstructionSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.blueprintConstruction.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateBlueprintConstructionInput["blueprintConstruction"];
    const client = getClient();
    const result = await client.blueprintConstruction.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.blueprintConstruction.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.blueprintConstruction.delete({
      where: {
        id: answers.id as string
      },
      select: {
