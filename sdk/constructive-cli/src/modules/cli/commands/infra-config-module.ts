...
import type { CreateInfraConfigModuleInput, InfraConfigModulePatch, InfraConfigModuleSelect, InfraConfigModuleFilter, InfraConfigModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<InfraConfigModuleSelect, InfraConfigModuleFilter, InfraConfigModuleOrderBy> & {
      select: InfraConfigModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.infraConfigModule.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<InfraConfigModuleSelect, InfraConfigModuleFilter, InfraConfigModuleOrderBy> & {
      select: InfraConfigModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.infraConfigModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [{
      ...
      type: "text",
      name: "configTableId",
      message: "configTableId",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
      name: "configTableName",
      message: "configTableName",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateInfraConfigModuleInput["infraConfigModule"];
    const client = getClient();
    const result = await client.infraConfigModule.create({
      data: {
        apiName: cleanedData.apiName,
        configTableId: cleanedData.configTableId,
        configTableName: cleanedData.configTableName,
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as InfraConfigModulePatch;
    const client = getClient();
    const result = await client.infraConfigModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.infraConfigModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
