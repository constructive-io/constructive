...
import type { CreateEntityTypeProvisionInput, EntityTypeProvisionPatch, EntityTypeProvisionSelect, EntityTypeProvisionFilter, EntityTypeProvisionOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<EntityTypeProvisionSelect, EntityTypeProvisionFilter, EntityTypeProvisionOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<EntityTypeProvisionSelect, EntityTypeProvisionFilter, EntityTypeProvisionOrderBy> & {
      select: EntityTypeProvisionSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateEntityTypeProvisionInput["entityTypeProvision"];
    const client = getClient();
    const result = await client.entityTypeProvision.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.entityTypeProvision.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.entityTypeProvision.delete({
      where: {
        id: answers.id as string
      },
      select: {
