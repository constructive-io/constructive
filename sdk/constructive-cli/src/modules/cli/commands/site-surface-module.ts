...
import type { CreateSiteSurfaceModuleInput, SiteSurfaceModulePatch, SiteSurfaceModuleSelect, SiteSurfaceModuleFilter, SiteSurfaceModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<SiteSurfaceModuleSelect, SiteSurfaceModuleFilter, SiteSurfaceModuleOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<SiteSurfaceModuleSelect, SiteSurfaceModuleFilter, SiteSurfaceModuleOrderBy> & {
      select: SiteSurfaceModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.siteSurfaceModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateSiteSurfaceModuleInput["siteSurfaceModule"];
    const client = getClient();
    const result = await client.siteSurfaceModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.siteSurfaceModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.siteSurfaceModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
