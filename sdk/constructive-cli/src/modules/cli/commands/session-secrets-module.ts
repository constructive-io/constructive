...
import type { CreateSessionSecretsModuleInput, SessionSecretsModulePatch, SessionSecretsModuleSelect, SessionSecretsModuleFilter, SessionSecretsModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<SessionSecretsModuleSelect, SessionSecretsModuleFilter, SessionSecretsModuleOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<SessionSecretsModuleSelect, SessionSecretsModuleFilter, SessionSecretsModuleOrderBy> & {
      select: SessionSecretsModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.sessionSecretsModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateSessionSecretsModuleInput["sessionSecretsModule"];
    const client = getClient();
    const result = await client.sessionSecretsModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.sessionSecretsModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.sessionSecretsModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
