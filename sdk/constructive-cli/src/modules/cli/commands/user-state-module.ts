...
import type { CreateUserStateModuleInput, UserStateModulePatch, UserStateModuleSelect, UserStateModuleFilter, UserStateModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<UserStateModuleSelect, UserStateModuleFilter, UserStateModuleOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<UserStateModuleSelect, UserStateModuleFilter, UserStateModuleOrderBy> & {
      select: UserStateModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.userStateModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateUserStateModuleInput["userStateModule"];
    const client = getClient();
    const result = await client.userStateModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as UserStateModulePatch;
    const client = getClient();
    const result = await client.userStateModule.update({
      where: {
        id: answers.id as string
      },
      data: {
