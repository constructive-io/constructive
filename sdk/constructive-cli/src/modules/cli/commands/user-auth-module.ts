...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      ...
      revokeSessionTreeFunction: true,
      schemaId: true,
      secretsTableId: true,
      ...
      signUpFunction: true,
      sweepExpiredSessionsFunction: true,
      sweepUnverifiedIdentifiersFunction: true,
      usersTableId: true,
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [
      ...
      {
        type: 'text',
        name: 'revokeSessionTreeFunction',
        message: 'revokeSessionTreeFunction',
        required: false,
        skipPrompt: true,
      },
      {
      ...
      {
        type: 'text',
        name: 'sweepExpiredSessionsFunction',
        message: 'sweepExpiredSessionsFunction',
        required: false,
        skipPrompt: true,
      },
      {
        type: 'text',
        name: 'sweepUnverifiedIdentifiersFunction',
        message: 'sweepUnverifiedIdentifiersFunction',
        required: false,
        skipPrompt: true,
      },
      {
    ...
    const result = await client.userAuthModule
      .create({
        data: {
          ...
          revokeSessionTreeFunction: cleanedData.revokeSessionTreeFunction,
          ...
          sweepExpiredSessionsFunction: cleanedData.sweepExpiredSessionsFunction,
          sweepUnverifiedIdentifiersFunction: cleanedData.sweepUnverifiedIdentifiersFunction,
