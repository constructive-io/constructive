/**
 * CLI commands for IntegrationProvidersModule
...
import type { CreateIntegrationProvidersModuleInput, IntegrationProvidersModulePatch, IntegrationProvidersModuleSelect, IntegrationProvidersModuleFilter, IntegrationProvidersModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<IntegrationProvidersModuleSelect, IntegrationProvidersModuleFilter, IntegrationProvidersModuleOrderBy> & {
      select: IntegrationProvidersModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.integrationProvidersModule.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<IntegrationProvidersModuleSelect, IntegrationProvidersModuleFilter, IntegrationProvidersModuleOrderBy> & {
      select: IntegrationProvidersModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.integrationProvidersModule.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.integrationProvidersModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateIntegrationProvidersModuleInput["integrationProvidersModule"];
    const client = getClient();
    const result = await client.integrationProvidersModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as IntegrationProvidersModulePatch;
    const client = getClient();
    const result = await client.integrationProvidersModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.integrationProvidersModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
