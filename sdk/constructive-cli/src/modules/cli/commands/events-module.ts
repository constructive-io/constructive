...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      ...
      recomputeCapabilities: true,
      recordError: true,
      recordEvent: true,
      removeEvent: true,
      retention: true,
      revokeAchievement: true,
      schemaId: true,
      scope: true,
      stepsRequired: true,
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [
      ...
      {
        type: 'text',
        name: 'recomputeCapabilities',
        message: 'recomputeCapabilities',
        required: false,
        skipPrompt: true,
      },
      {
      ...
      {
        type: 'text',
        name: 'tgLevelGrantSync',
        message: 'tgLevelGrantSync',
        required: false,
        skipPrompt: true,
      },
      {
    ...
    const result = await client.eventsModule
      .create({
        data: {
          ...
          expireGrants: cleanedData.expireGrants,
          ...
          recomputeCapabilities: cleanedData.recomputeCapabilities,
          recordError: cleanedData.recordError,
          recordEvent: cleanedData.recordEvent,
          removeEvent: cleanedData.removeEvent,
          retention: cleanedData.retention,
          revokeAchievement: cleanedData.revokeAchievement,
          ...
          tgLevelGrantSync: cleanedData.tgLevelGrantSync,
          tgUpdateAggregates: cleanedData.tgUpdateAggregates,
          trustLadder: cleanedData.trustLadder,
