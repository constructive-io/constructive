...
import type { CreateFunctionDeploymentModuleInput, FunctionDeploymentModulePatch, FunctionDeploymentModuleSelect, FunctionDeploymentModuleFilter, FunctionDeploymentModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<FunctionDeploymentModuleSelect, FunctionDeploymentModuleFilter, FunctionDeploymentModuleOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<FunctionDeploymentModuleSelect, FunctionDeploymentModuleFilter, FunctionDeploymentModuleOrderBy> & {
      select: FunctionDeploymentModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.functionDeploymentModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateFunctionDeploymentModuleInput["functionDeploymentModule"];
    const client = getClient();
    const result = await client.functionDeploymentModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.functionDeploymentModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.functionDeploymentModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
