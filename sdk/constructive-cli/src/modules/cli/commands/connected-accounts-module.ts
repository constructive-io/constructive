/**
 * CLI commands for ConnectedAccountsModule
...
import type { CreateConnectedAccountsModuleInput, ConnectedAccountsModulePatch, ConnectedAccountsModuleSelect, ConnectedAccountsModuleFilter, ConnectedAccountsModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<ConnectedAccountsModuleSelect, ConnectedAccountsModuleFilter, ConnectedAccountsModuleOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<ConnectedAccountsModuleSelect, ConnectedAccountsModuleFilter, ConnectedAccountsModuleOrderBy> & {
      select: ConnectedAccountsModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.connectedAccountsModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateConnectedAccountsModuleInput["connectedAccountsModule"];
    const client = getClient();
    const result = await client.connectedAccountsModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as ConnectedAccountsModulePatch;
    const client = getClient();
    const result = await client.connectedAccountsModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.connectedAccountsModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
