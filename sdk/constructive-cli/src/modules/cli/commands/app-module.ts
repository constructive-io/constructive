...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      apiName: true,
      appMembersTableId: true,
      appMembersTableName: true,
      appsTableId: true,
      appsTableName: true,
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [
      ...
      {
        type: 'text',
        name: 'appMembersTableId',
        message: 'appMembersTableId',
        required: false,
        skipPrompt: true,
      },
      {
        type: 'text',
        name: 'appMembersTableName',
        message: 'appMembersTableName',
        required: false,
        skipPrompt: true,
      },
      {
    ...
    const result = await client.appModule
      .create({
        data: {
          ...
          appMembersTableId: cleanedData.appMembersTableId,
          appMembersTableName: cleanedData.appMembersTableName,
