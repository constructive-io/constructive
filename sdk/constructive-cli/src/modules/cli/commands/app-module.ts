...
import type { CreateAppModuleInput, AppModulePatch, AppModuleSelect, AppModuleFilter, AppModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      apiName: true,
      appComponentsTableId: true,
      appComponentsTableName: true,
      appsTableId: true,
      appsTableName: true,
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<AppModuleSelect, AppModuleFilter, AppModuleOrderBy> & {
      select: AppModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.appModule.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<AppModuleSelect, AppModuleFilter, AppModuleOrderBy> & {
      select: AppModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.appModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [{
      ...
      type: "text",
      name: "appComponentsTableId",
      message: "appComponentsTableId",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
      name: "appComponentsTableName",
      message: "appComponentsTableName",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateAppModuleInput["appModule"];
    const client = getClient();
    const result = await client.appModule.create({
      data: {
        apiName: cleanedData.apiName,
        appComponentsTableId: cleanedData.appComponentsTableId,
        appComponentsTableName: cleanedData.appComponentsTableName,
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as AppModulePatch;
    const client = getClient();
    const result = await client.appModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.appModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
