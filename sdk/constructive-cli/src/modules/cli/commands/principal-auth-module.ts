...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      ...
      sweepExpiredPrincipalsFunction: true,
      usersTableId: true,
    };
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [
      ...
      {
        type: 'text',
        name: 'sweepExpiredPrincipalsFunction',
        message: 'sweepExpiredPrincipalsFunction',
        required: false,
        skipPrompt: true,
      },
      {
    ...
    const result = await client.principalAuthModule
      .create({
        data: {
          ...
          sweepExpiredPrincipalsFunction: cleanedData.sweepExpiredPrincipalsFunction,
