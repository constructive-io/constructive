...
import type { CreateProfilesModuleInput, ProfilesModulePatch, ProfilesModuleSelect, ProfilesModuleFilter, ProfilesModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<ProfilesModuleSelect, ProfilesModuleFilter, ProfilesModuleOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<ProfilesModuleSelect, ProfilesModuleFilter, ProfilesModuleOrderBy> & {
      select: ProfilesModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.profilesModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateProfilesModuleInput["profilesModule"];
    const client = getClient();
    const result = await client.profilesModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.profilesModule.update({
      where: {
        id: answers.id as string
      },
      data: {
