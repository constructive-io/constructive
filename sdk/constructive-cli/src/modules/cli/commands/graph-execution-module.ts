...
import type { CreateGraphExecutionModuleInput, GraphExecutionModulePatch, GraphExecutionModuleSelect, GraphExecutionModuleFilter, GraphExecutionModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<GraphExecutionModuleSelect, GraphExecutionModuleFilter, GraphExecutionModuleOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<GraphExecutionModuleSelect, GraphExecutionModuleFilter, GraphExecutionModuleOrderBy> & {
      select: GraphExecutionModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.graphExecutionModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateGraphExecutionModuleInput["graphExecutionModule"];
    const client = getClient();
    const result = await client.graphExecutionModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.graphExecutionModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.graphExecutionModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
