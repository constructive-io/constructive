/**
 * CLI commands for MembershipTypesModule
...
import type { CreateMembershipTypesModuleInput, MembershipTypesModulePatch, MembershipTypesModuleSelect, MembershipTypesModuleFilter, MembershipTypesModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<MembershipTypesModuleSelect, MembershipTypesModuleFilter, MembershipTypesModuleOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<MembershipTypesModuleSelect, MembershipTypesModuleFilter, MembershipTypesModuleOrderBy> & {
      select: MembershipTypesModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.membershipTypesModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateMembershipTypesModuleInput["membershipTypesModule"];
    const client = getClient();
    const result = await client.membershipTypesModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as MembershipTypesModulePatch;
    const client = getClient();
    const result = await client.membershipTypesModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.membershipTypesModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
