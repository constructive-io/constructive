...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      ...
      capabilityDefaultCapabilitiesTableId: true,
      capabilityDefaultGrantsTableId: true,
      databaseId: true,
      defaultCapabilitiesTableId: true,
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [
      ...
      {
        type: 'text',
        name: 'capabilityDefaultCapabilitiesTableId',
        message: 'capabilityDefaultCapabilitiesTableId',
        required: false,
        skipPrompt: true,
      },
      {
        type: 'text',
        name: 'capabilityDefaultGrantsTableId',
        message: 'capabilityDefaultGrantsTableId',
        required: false,
        skipPrompt: true,
      },
      {
      ...
      {
        type: 'text',
        name: 'defaultCapabilitiesTableId',
        message: 'defaultCapabilitiesTableId',
        required: false,
        skipPrompt: true,
      },
      {
    ...
    const result = await client.membershipsModule
      .create({
        data: {
          ...
          capabilityDefaultCapabilitiesTableId: cleanedData.capabilityDefaultCapabilitiesTableId,
          capabilityDefaultGrantsTableId: cleanedData.capabilityDefaultGrantsTableId,
          databaseId: cleanedData.databaseId,
          defaultCapabilitiesTableId: cleanedData.defaultCapabilitiesTableId,
