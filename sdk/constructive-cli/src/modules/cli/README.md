...
**Required create fields:** `databaseId`
**Optional create fields (backend defaults):** `schemaId`, `privateSchemaId`, `publicSchemaName`, `privateSchemaName`, `definitionsTableId`, `invocationsTableId`, `executionLogsTableId`, `secretDefinitionsTableId`, `definitionsTableName`, `invocationsTableName`, `executionLogsTableName`, `secretDefinitionsTableName`, `apiName`, `privateApiName`, `scope`, `prefix`, `entityTableId`, `policies`, `provisions`, `defaultPermissions`
