...
export function createMutationOperations(client: OrmClient) {
  return {
    acceptDatabaseTransfer: <S extends AcceptDatabaseTransferPayloadSelect,>(args: AcceptDatabaseTransferVariables, options: {
      select: S;
    } & StrictSelect<S, AcceptDatabaseTransferPayloadSelect>) => new QueryBuilder<{
    ...
    applyRls: <S extends ApplyRlsPayloadSelect,>(args: ApplyRlsVariables, options: {
      select: S;
    } & StrictSelect<S, ApplyRlsPayloadSelect>) => new QueryBuilder<{
    ...
    cancelDatabaseTransfer: <S extends CancelDatabaseTransferPayloadSelect,>(args: CancelDatabaseTransferVariables, options: {
      select: S;
    } & StrictSelect<S, CancelDatabaseTransferPayloadSelect>) => new QueryBuilder<{
    ...
    rejectDatabaseTransfer: <S extends RejectDatabaseTransferPayloadSelect,>(args: RejectDatabaseTransferVariables, options: {
      select: S;
    } & StrictSelect<S, RejectDatabaseTransferPayloadSelect>) => new QueryBuilder<{
    ...
    requestDatabase: <S extends RequestDatabasePayloadSelect,>(args: RequestDatabaseVariables, options: {
      select: S;
    } & StrictSelect<S, RequestDatabasePayloadSelect>) => new QueryBuilder<{
    ...
    setFieldOrder: <S extends SetFieldOrderPayloadSelect,>(args: SetFieldOrderVariables, options: {
      select: S;
    } & StrictSelect<S, SetFieldOrderPayloadSelect>) => new QueryBuilder<{
