...
import type { EmbeddingChunk, EmbeddingChunkWithRelations, EmbeddingChunkSelect, EmbeddingChunkFilter, EmbeddingChunkOrderBy, CreateEmbeddingChunkInput, UpdateEmbeddingChunkInput, EmbeddingChunkPatch } from "../input-types";
...
export class EmbeddingChunkModel {
  ...
  findMany<S extends EmbeddingChunkSelect>(args: FindManyArgs<S, EmbeddingChunkFilter, EmbeddingChunkOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("EmbeddingChunk", "embeddingChunks", args.select, {
      where: args?.where,
  ...
  findFirst<S extends EmbeddingChunkSelect>(args: FindFirstArgs<S, EmbeddingChunkFilter, EmbeddingChunkOrderBy> & {
    select: S;
  } & StrictSelect<S, EmbeddingChunkSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("EmbeddingChunk", "embeddingChunks", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "EmbeddingChunkFilter", "EmbeddingChunkOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends EmbeddingChunkSelect>(args: CreateArgs<S, CreateEmbeddingChunkInput["embeddingChunk"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("EmbeddingChunk", "createEmbeddingChunk", "embeddingChunk", args.select, args.data, "CreateEmbeddingChunkInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "EmbeddingChunk",
  ...
  update<S extends EmbeddingChunkSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("EmbeddingChunk", "updateEmbeddingChunk", "embeddingChunk", args.select, args.where.id, args.data, "UpdateEmbeddingChunkInput", "id", "embeddingChunkPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "EmbeddingChunk",
  ...
  delete<S extends EmbeddingChunkSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("EmbeddingChunk", "deleteEmbeddingChunk", "embeddingChunk", {
      id: args.where.id
