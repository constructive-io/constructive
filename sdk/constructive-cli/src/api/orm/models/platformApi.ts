...
import type {
  ...
  UpdatePlatformApiInput,
  PlatformApiPatch,
} from '../input-types';
import { connectionFieldsMap } from '../input-types';
export class PlatformApiModel {
  constructor(private client: OrmClient) {}
  findMany<S extends PlatformApiSelect>(
    args: FindManyArgs<S, PlatformApiFilter, PlatformApiOrderBy> & {
      select: S;
    } & StrictSelect<S, PlatformApiSelect>
  ): QueryBuilder<{
  ...
  findFirst<S extends PlatformApiSelect>(
    args: FindFirstArgs<S, PlatformApiFilter, PlatformApiOrderBy> & {
      select: S;
    } & StrictSelect<S, PlatformApiSelect>
  ): QueryBuilder<{
  ...
  findOne<S extends PlatformApiSelect>(
    args: {
      id: string;
      select: S;
    } & StrictSelect<S, PlatformApiSelect>
  ...
  create<S extends PlatformApiSelect>(
    args: CreateArgs<S, CreatePlatformApiInput['platformApi']> & {
      select: S;
    } & StrictSelect<S, PlatformApiSelect>
  ): QueryBuilder<{
    createPlatformApi: {
  ...
  update<S extends PlatformApiSelect>(
    args: UpdateArgs<
      S,
      {
        id: string;
  ...
  delete<S extends PlatformApiSelect>(
    args: DeleteArgs<
      {
        id: string;
      },
