...
import type { DatabaseSetting, DatabaseSettingWithRelations, DatabaseSettingSelect, DatabaseSettingFilter, DatabaseSettingOrderBy, CreateDatabaseSettingInput, UpdateDatabaseSettingInput, DatabaseSettingPatch } from "../input-types";
...
export class DatabaseSettingModel {
  ...
  findMany<S extends DatabaseSettingSelect>(args: FindManyArgs<S, DatabaseSettingFilter, DatabaseSettingOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("DatabaseSetting", "databaseSettings", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "DatabaseSettingFilter", "DatabaseSettingOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends DatabaseSettingSelect>(args: FindFirstArgs<S, DatabaseSettingFilter, DatabaseSettingOrderBy> & {
    select: S;
  } & StrictSelect<S, DatabaseSettingSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("DatabaseSetting", "databaseSettings", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "DatabaseSettingFilter", "DatabaseSettingOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends DatabaseSettingSelect>(args: CreateArgs<S, CreateDatabaseSettingInput["databaseSetting"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("DatabaseSetting", "createDatabaseSetting", "databaseSetting", args.select, args.data, "CreateDatabaseSettingInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "DatabaseSetting",
  ...
  update<S extends DatabaseSettingSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("DatabaseSetting", "updateDatabaseSetting", "databaseSetting", args.select, args.where.id, args.data, "UpdateDatabaseSettingInput", "id", "databaseSettingPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "DatabaseSetting",
  ...
  delete<S extends DatabaseSettingSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("DatabaseSetting", "deleteDatabaseSetting", "databaseSetting", {
      id: args.where.id
    }, "DeleteDatabaseSettingInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "DatabaseSetting",
