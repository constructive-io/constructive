...
import suspendDatabaseCmd from './commands/suspend-database';
import unsuspendDatabaseCmd from './commands/unsuspend-database';
...
> = () => ({
  ...
  'suspend-database': suspendDatabaseCmd,
  'unsuspend-database': unsuspendDatabaseCmd,
});
const usage =
