...
import type { CreateSiteModuleInput, SiteModulePatch, SiteModuleSelect, SiteModuleFilter, SiteModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<SiteModuleSelect, SiteModuleFilter, SiteModuleOrderBy> & {
      select: SiteModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.siteModule.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<SiteModuleSelect, SiteModuleFilter, SiteModuleOrderBy> & {
      select: SiteModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.siteModule.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.siteModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateSiteModuleInput["siteModule"];
    const client = getClient();
    const result = await client.siteModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as SiteModulePatch;
    const client = getClient();
    const result = await client.siteModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.siteModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
