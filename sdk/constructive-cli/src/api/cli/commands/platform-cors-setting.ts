/**
 * CLI commands for PlatformCorsSetting
...
import type { CreatePlatformCorsSettingInput, PlatformCorsSettingPatch, PlatformCorsSettingSelect, PlatformCorsSettingFilter, PlatformCorsSettingOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformCorsSettingSelect, PlatformCorsSettingFilter, PlatformCorsSettingOrderBy> & {
      select: PlatformCorsSettingSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformCorsSetting.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformCorsSettingSelect, PlatformCorsSettingFilter, PlatformCorsSettingOrderBy> & {
      select: PlatformCorsSettingSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformCorsSettingInput["platformCorsSetting"];
    const client = getClient();
    const result = await client.platformCorsSetting.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as PlatformCorsSettingPatch;
    const client = getClient();
    const result = await client.platformCorsSetting.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformCorsSetting.delete({
      where: {
        id: answers.id as string
      },
      select: {
