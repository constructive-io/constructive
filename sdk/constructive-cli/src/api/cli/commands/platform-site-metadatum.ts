...
import type { CreatePlatformSiteMetadatumInput, PlatformSiteMetadatumPatch, PlatformSiteMetadatumSelect, PlatformSiteMetadatumFilter, PlatformSiteMetadatumOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformSiteMetadatumSelect, PlatformSiteMetadatumFilter, PlatformSiteMetadatumOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformSiteMetadatumSelect, PlatformSiteMetadatumFilter, PlatformSiteMetadatumOrderBy> & {
      select: PlatformSiteMetadatumSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformSiteMetadatum.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformSiteMetadatumInput["platformSiteMetadatum"];
    const client = getClient();
    const result = await client.platformSiteMetadatum.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformSiteMetadatum.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformSiteMetadatum.delete({
      where: {
        id: answers.id as string
      },
      select: {
