...
import type { CreateDatabaseInput, DatabasePatch, DatabaseSelect, DatabaseFilter, DatabaseOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<DatabaseSelect, DatabaseFilter, DatabaseOrderBy> & {
      select: DatabaseSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.database.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<DatabaseSelect, DatabaseFilter, DatabaseOrderBy> & {
      select: DatabaseSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.database.findOne({
