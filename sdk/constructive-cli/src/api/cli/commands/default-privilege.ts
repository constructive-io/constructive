...
import type { CreateDefaultPrivilegeInput, DefaultPrivilegePatch, DefaultPrivilegeSelect, DefaultPrivilegeFilter, DefaultPrivilegeOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<DefaultPrivilegeSelect, DefaultPrivilegeFilter, DefaultPrivilegeOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<DefaultPrivilegeSelect, DefaultPrivilegeFilter, DefaultPrivilegeOrderBy> & {
      select: DefaultPrivilegeSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.defaultPrivilege.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateDefaultPrivilegeInput["defaultPrivilege"];
    const client = getClient();
    const result = await client.defaultPrivilege.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.defaultPrivilege.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.defaultPrivilege.delete({
      where: {
        id: answers.id as string
      },
      select: {
