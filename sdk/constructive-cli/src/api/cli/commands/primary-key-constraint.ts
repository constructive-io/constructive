...
import type { CreatePrimaryKeyConstraintInput, PrimaryKeyConstraintPatch, PrimaryKeyConstraintSelect, PrimaryKeyConstraintFilter, PrimaryKeyConstraintOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PrimaryKeyConstraintSelect, PrimaryKeyConstraintFilter, PrimaryKeyConstraintOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PrimaryKeyConstraintSelect, PrimaryKeyConstraintFilter, PrimaryKeyConstraintOrderBy> & {
      select: PrimaryKeyConstraintSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.primaryKeyConstraint.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePrimaryKeyConstraintInput["primaryKeyConstraint"];
    const client = getClient();
    const result = await client.primaryKeyConstraint.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.primaryKeyConstraint.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.primaryKeyConstraint.delete({
      where: {
        id: answers.id as string
      },
      select: {
