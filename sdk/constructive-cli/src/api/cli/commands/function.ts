...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const result = await client.function
      .create({
        data: {
          apiExposed: cleanedData.apiExposed,
          arguments: cleanedData.arguments,
          bodyAst: cleanedData.bodyAst,
          category: cleanedData.category,
          data: cleanedData.data,
          databaseId: cleanedData.databaseId,
          functionType: cleanedData.functionType,
          isStrict: cleanedData.isStrict,
          kind: cleanedData.kind,
          name: cleanedData.name,
          returns: cleanedData.returns,
          schemaId: cleanedData.schemaId,
          securityInvoker: cleanedData.securityInvoker,
          smartTags: cleanedData.smartTags,
          tags: cleanedData.tags,
          volatility: cleanedData.volatility,
        },
        select: {
          apiExposed: true,
          arguments: true,
