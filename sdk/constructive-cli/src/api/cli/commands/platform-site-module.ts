/**
 * CLI commands for PlatformSiteModule
...
import type { CreatePlatformSiteModuleInput, PlatformSiteModulePatch, PlatformSiteModuleSelect, PlatformSiteModuleFilter, PlatformSiteModuleOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformSiteModuleSelect, PlatformSiteModuleFilter, PlatformSiteModuleOrderBy> & {
      select: PlatformSiteModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformSiteModule.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformSiteModuleSelect, PlatformSiteModuleFilter, PlatformSiteModuleOrderBy> & {
      select: PlatformSiteModuleSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformSiteModule.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformSiteModuleInput["platformSiteModule"];
    const client = getClient();
    const result = await client.platformSiteModule.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as PlatformSiteModulePatch;
    const client = getClient();
    const result = await client.platformSiteModule.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformSiteModule.delete({
      where: {
        id: answers.id as string
      },
      select: {
