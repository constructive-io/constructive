/**
 * CLI commands for PlatformApiSchema
...
import type { CreatePlatformApiSchemaInput, PlatformApiSchemaPatch, PlatformApiSchemaSelect, PlatformApiSchemaFilter, PlatformApiSchemaOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformApiSchemaSelect, PlatformApiSchemaFilter, PlatformApiSchemaOrderBy> & {
      select: PlatformApiSchemaSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformApiSchema.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformApiSchemaSelect, PlatformApiSchemaFilter, PlatformApiSchemaOrderBy> & {
      select: PlatformApiSchemaSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformApiSchema.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformApiSchemaInput["platformApiSchema"];
    const client = getClient();
    const result = await client.platformApiSchema.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as PlatformApiSchemaPatch;
    const client = getClient();
    const result = await client.platformApiSchema.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformApiSchema.delete({
      where: {
        id: answers.id as string
      },
      select: {
