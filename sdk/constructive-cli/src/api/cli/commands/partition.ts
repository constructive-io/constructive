...
import type { CreatePartitionInput, PartitionPatch, PartitionSelect, PartitionFilter, PartitionOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PartitionSelect, PartitionFilter, PartitionOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PartitionSelect, PartitionFilter, PartitionOrderBy> & {
      select: PartitionSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.partition.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [{
      ...
      type: "boolean",
      name: "retentionKeepTable",
      message: "retentionKeepTable",
      required: false,
      skipPrompt: true
    }, {
      type: "text",
    ...
    const client = getClient();
    const result = await client.partition.create({
      data: {
        databaseId: cleanedData.databaseId,
        interval: cleanedData.interval,
        isParented: cleanedData.isParented,
        ...
        retentionKeepTable: cleanedData.retentionKeepTable,
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.partition.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.partition.delete({
      where: {
        id: answers.id as string
      },
      select: {
