/**
 * CLI commands for PlatformSiteTheme
...
import type { CreatePlatformSiteThemeInput, PlatformSiteThemePatch, PlatformSiteThemeSelect, PlatformSiteThemeFilter, PlatformSiteThemeOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformSiteThemeSelect, PlatformSiteThemeFilter, PlatformSiteThemeOrderBy> & {
      select: PlatformSiteThemeSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformSiteTheme.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformSiteThemeSelect, PlatformSiteThemeFilter, PlatformSiteThemeOrderBy> & {
      select: PlatformSiteThemeSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformSiteTheme.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformSiteThemeInput["platformSiteTheme"];
    const client = getClient();
    const result = await client.platformSiteTheme.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as PlatformSiteThemePatch;
    const client = getClient();
    const result = await client.platformSiteTheme.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformSiteTheme.delete({
      where: {
        id: answers.id as string
      },
      select: {
