...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    const defaultSelect = {
      ...
      data: true,
      databaseId: true,
      derivedFromPolicyId: true,
      derivedFromTableId: true,
      disabled: true,
      granteeName: true,
      id: true,
      name: true,
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    const rawAnswers = await prompter.prompt(argv, [
      ...
      {
        type: 'text',
        name: 'derivedFromPolicyId',
        message: 'derivedFromPolicyId',
        required: false,
        skipPrompt: true,
      },
      {
        type: 'text',
        name: 'derivedFromTableId',
        message: 'derivedFromTableId',
        required: false,
        skipPrompt: true,
      },
      {
    ...
    const result = await client.policy
      .create({
        data: {
          ...
          derivedFromTableId: cleanedData.derivedFromTableId,
