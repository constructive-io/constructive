...
import type { CreateDomainEventInput, DomainEventPatch, DomainEventSelect, DomainEventFilter, DomainEventOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<DomainEventSelect, DomainEventFilter, DomainEventOrderBy> & {
      select: DomainEventSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.domainEvent.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<DomainEventSelect, DomainEventFilter, DomainEventOrderBy> & {
      select: DomainEventSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.domainEvent.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateDomainEventInput["domainEvent"];
    const client = getClient();
    const result = await client.domainEvent.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as DomainEventPatch;
    const client = getClient();
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.domainEvent.delete({
      where: {
        id: answers.id as string
      },
      select: {
