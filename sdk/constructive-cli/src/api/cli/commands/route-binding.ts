...
import type { CreateRouteBindingInput, RouteBindingPatch, RouteBindingSelect, RouteBindingFilter, RouteBindingOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<RouteBindingSelect, RouteBindingFilter, RouteBindingOrderBy> & {
      select: RouteBindingSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.routeBinding.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<RouteBindingSelect, RouteBindingFilter, RouteBindingOrderBy> & {
      select: RouteBindingSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.routeBinding.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateRouteBindingInput["routeBinding"];
    const client = getClient();
    const result = await client.routeBinding.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as RouteBindingPatch;
    const client = getClient();
    const result = await client.routeBinding.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.routeBinding.delete({
      where: {
        id: answers.id as string
      },
      select: {
