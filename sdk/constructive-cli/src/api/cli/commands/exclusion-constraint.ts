...
import type { CreateExclusionConstraintInput, ExclusionConstraintPatch, ExclusionConstraintSelect, ExclusionConstraintFilter, ExclusionConstraintOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<ExclusionConstraintSelect, ExclusionConstraintFilter, ExclusionConstraintOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<ExclusionConstraintSelect, ExclusionConstraintFilter, ExclusionConstraintOrderBy> & {
      select: ExclusionConstraintSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.exclusionConstraint.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateExclusionConstraintInput["exclusionConstraint"];
    const client = getClient();
    const result = await client.exclusionConstraint.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.exclusionConstraint.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.exclusionConstraint.delete({
      where: {
        id: answers.id as string
      },
      select: {
