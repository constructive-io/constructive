...
import type { CreateSiteThemeInput, SiteThemePatch, SiteThemeSelect, SiteThemeFilter, SiteThemeOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<SiteThemeSelect, SiteThemeFilter, SiteThemeOrderBy> & {
      select: SiteThemeSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.siteTheme.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<SiteThemeSelect, SiteThemeFilter, SiteThemeOrderBy> & {
      select: SiteThemeSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.siteTheme.findOne({
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.siteTheme.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.siteTheme.delete({
      where: {
        id: answers.id as string
      },
      select: {
