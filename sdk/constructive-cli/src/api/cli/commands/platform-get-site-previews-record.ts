/**
 * CLI commands for PlatformGetSitePreviewsRecord
  ...
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<
        ...
        PlatformGetSitePreviewsRecordsOrderBy
      > & {
        select: PlatformGetSitePreviewsRecordSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformGetSitePreviewsRecord.findMany(findManyArgs).execute();
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreatePlatformGetSitePreviewsRecordInput['platformGetSitePreviewsRecord'];
    const client = getClient();
    const result = await client.platformGetSitePreviewsRecord
      .create({
        data: {
