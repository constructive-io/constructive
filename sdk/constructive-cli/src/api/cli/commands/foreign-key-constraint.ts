...
import type { CreateForeignKeyConstraintInput, ForeignKeyConstraintPatch, ForeignKeyConstraintSelect, ForeignKeyConstraintFilter, ForeignKeyConstraintOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<ForeignKeyConstraintSelect, ForeignKeyConstraintFilter, ForeignKeyConstraintOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<ForeignKeyConstraintSelect, ForeignKeyConstraintFilter, ForeignKeyConstraintOrderBy> & {
      select: ForeignKeyConstraintSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.foreignKeyConstraint.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateForeignKeyConstraintInput["foreignKeyConstraint"];
    const client = getClient();
    const result = await client.foreignKeyConstraint.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.foreignKeyConstraint.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.foreignKeyConstraint.delete({
      where: {
        id: answers.id as string
      },
      select: {
