 ...
 *
 * Provides helpers for CLI commands: type coercion (string CLI args to proper
 ...
 * ORM's expected structure for OBJECT sub-fields.
 *
 * @param paths - Comma-separated dot-notation field paths
