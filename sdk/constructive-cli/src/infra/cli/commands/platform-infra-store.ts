/**
 * CLI commands for PlatformInfraStore
...
import type { CreatePlatformInfraStoreInput, PlatformInfraStorePatch, PlatformInfraStoreSelect, PlatformInfraStoreFilter, PlatformInfraStoreOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformInfraStoreSelect, PlatformInfraStoreFilter, PlatformInfraStoreOrderBy> & {
      select: PlatformInfraStoreSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformInfraStore.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformInfraStoreSelect, PlatformInfraStoreFilter, PlatformInfraStoreOrderBy> & {
      select: PlatformInfraStoreSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformInfraStore.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformInfraStoreInput["platformInfraStore"];
    const client = getClient();
    const result = await client.platformInfraStore.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as PlatformInfraStorePatch;
    const client = getClient();
    const result = await client.platformInfraStore.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformInfraStore.delete({
      where: {
        id: answers.id as string
      },
      select: {
