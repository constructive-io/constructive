...
import type { CreatePlatformFunctionExecutionLogInput, PlatformFunctionExecutionLogPatch, PlatformFunctionExecutionLogSelect, PlatformFunctionExecutionLogFilter, PlatformFunctionExecutionLogOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformFunctionExecutionLogSelect, PlatformFunctionExecutionLogFilter, PlatformFunctionExecutionLogOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformFunctionExecutionLogSelect, PlatformFunctionExecutionLogFilter, PlatformFunctionExecutionLogOrderBy> & {
      select: PlatformFunctionExecutionLogSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformFunctionExecutionLog.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformFunctionExecutionLog.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformFunctionExecutionLog.update({
      where: {
        id: answers.id as string,
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformFunctionExecutionLog.delete({
      where: {
        id: answers.id as string,
        createdAt: answers.createdAt as string
      },
