/**
 * CLI commands for ResourceDeclaredCapacity
...
import type { CreateResourceDeclaredCapacityInput, ResourceDeclaredCapacityPatch, ResourceDeclaredCapacitySelect, ResourceDeclaredCapacityFilter, ResourceDeclaredCapacityOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<ResourceDeclaredCapacitySelect, ResourceDeclaredCapacityFilter, ResourceDeclaredCapacityOrderBy> & {
      select: ResourceDeclaredCapacitySelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.resourceDeclaredCapacity.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<ResourceDeclaredCapacitySelect, ResourceDeclaredCapacityFilter, ResourceDeclaredCapacityOrderBy> & {
      select: ResourceDeclaredCapacitySelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateResourceDeclaredCapacityInput["resourceDeclaredCapacity"];
    const client = getClient();
    const result = await client.resourceDeclaredCapacity.create({
      data: {
