/**
 * CLI commands for NamespaceEvent
...
import type { CreateNamespaceEventInput, NamespaceEventPatch, NamespaceEventSelect, NamespaceEventFilter, NamespaceEventOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<NamespaceEventSelect, NamespaceEventFilter, NamespaceEventOrderBy> & {
      select: NamespaceEventSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.namespaceEvent.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<NamespaceEventSelect, NamespaceEventFilter, NamespaceEventOrderBy> & {
      select: NamespaceEventSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.namespaceEvent.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateNamespaceEventInput["namespaceEvent"];
    const client = getClient();
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as NamespaceEventPatch;
    const client = getClient();
    const result = await client.namespaceEvent.update({
      where: {
        id: answers.id as string,
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.namespaceEvent.delete({
      where: {
        id: answers.id as string,
        createdAt: answers.createdAt as string
      },
