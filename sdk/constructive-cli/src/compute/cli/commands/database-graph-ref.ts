/**
 * CLI commands for DatabaseGraphRef
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<DatabaseGraphRefSelect, DatabaseGraphRefFilter, DatabaseGraphRefOrderBy> & {
        select: DatabaseGraphRefSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.databaseGraphRef.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<DatabaseGraphRefSelect, DatabaseGraphRefFilter, DatabaseGraphRefOrderBy> & {
        select: DatabaseGraphRefSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.databaseGraphRef.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreateDatabaseGraphRefInput['databaseGraphRef'];
    const client = getClient();
    const result = await client.databaseGraphRef
      .create({
        data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as DatabaseGraphRefPatch;
    const client = getClient();
    const result = await client.databaseGraphRef
      .update({
        where: {
