...
import type { CreateResourcesResolvedRequirementInput, ResourcesResolvedRequirementPatch, ResourcesResolvedRequirementSelect, ResourcesResolvedRequirementFilter, ResourcesResolvedRequirementOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<ResourcesResolvedRequirementSelect, ResourcesResolvedRequirementFilter, ResourcesResolvedRequirementOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<ResourcesResolvedRequirementSelect, ResourcesResolvedRequirementFilter, ResourcesResolvedRequirementOrderBy> & {
      select: ResourcesResolvedRequirementSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateResourcesResolvedRequirementInput["resourcesResolvedRequirement"];
    const client = getClient();
    const result = await client.resourcesResolvedRequirement.create({
      data: {
