...
import type { CreateInfraRefInput, InfraRefPatch, InfraRefSelect, InfraRefFilter, InfraRefOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<InfraRefSelect, InfraRefFilter, InfraRefOrderBy> & {
      select: InfraRefSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.infraRef.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<InfraRefSelect, InfraRefFilter, InfraRefOrderBy> & {
      select: InfraRefSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.infraRef.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateInfraRefInput["infraRef"];
    const client = getClient();
    const result = await client.infraRef.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as InfraRefPatch;
    const client = getClient();
    const result = await client.infraRef.update({
      where: {
        id: answers.id as string,
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.infraRef.delete({
      where: {
        id: answers.id as string,
        databaseId: answers.databaseId as string
      },
