...
import type { CreatePlatformFunctionInvocationInput, PlatformFunctionInvocationPatch, PlatformFunctionInvocationSelect, PlatformFunctionInvocationFilter, PlatformFunctionInvocationOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformFunctionInvocationSelect, PlatformFunctionInvocationFilter, PlatformFunctionInvocationOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformFunctionInvocationSelect, PlatformFunctionInvocationFilter, PlatformFunctionInvocationOrderBy> & {
      select: PlatformFunctionInvocationSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformFunctionInvocation.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformFunctionInvocationInput["platformFunctionInvocation"];
    const client = getClient();
    const result = await client.platformFunctionInvocation.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformFunctionInvocation.update({
      where: {
        id: answers.id as string,
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformFunctionInvocation.delete({
      where: {
        id: answers.id as string,
        createdAt: answers.createdAt as string
      },
