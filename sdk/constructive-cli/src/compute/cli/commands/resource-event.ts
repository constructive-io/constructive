...
import type { CreateResourceEventInput, ResourceEventPatch, ResourceEventSelect, ResourceEventFilter, ResourceEventOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<ResourceEventSelect, ResourceEventFilter, ResourceEventOrderBy> & {
      select: ResourceEventSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.resourceEvent.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<ResourceEventSelect, ResourceEventFilter, ResourceEventOrderBy> & {
      select: ResourceEventSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.resourceEvent.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateResourceEventInput["resourceEvent"];
    const client = getClient();
    const result = await client.resourceEvent.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as ResourceEventPatch;
    const client = getClient();
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.resourceEvent.delete({
      where: {
        id: answers.id as string,
        createdAt: answers.createdAt as string
      },
