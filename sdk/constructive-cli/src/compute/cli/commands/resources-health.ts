...
import type { CreateResourcesHealthInput, ResourcesHealthPatch, ResourcesHealthSelect, ResourcesHealthFilter, ResourcesHealthOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<ResourcesHealthSelect, ResourcesHealthFilter, ResourcesHealthOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<ResourcesHealthSelect, ResourcesHealthFilter, ResourcesHealthOrderBy> & {
      select: ResourcesHealthSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateResourcesHealthInput["resourcesHealth"];
    const client = getClient();
    const result = await client.resourcesHealth.create({
      data: {
