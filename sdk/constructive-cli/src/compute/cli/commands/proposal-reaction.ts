/**
 * CLI commands for ProposalReaction
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<ProposalReactionSelect, ProposalReactionFilter, ProposalReactionOrderBy> & {
        select: ProposalReactionSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.proposalReaction.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<ProposalReactionSelect, ProposalReactionFilter, ProposalReactionOrderBy> & {
        select: ProposalReactionSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.proposalReaction.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.proposalReaction
      .findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreateProposalReactionInput['proposalReaction'];
    const client = getClient();
    const result = await client.proposalReaction
      .create({
        data: {
          actorId: cleanedData.actorId,
          commentId: cleanedData.commentId,
          createdByPrincipal: cleanedData.createdByPrincipal,
          databaseId: cleanedData.databaseId,
          emoji: cleanedData.emoji,
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as ProposalReactionPatch;
    const client = getClient();
    const result = await client.proposalReaction
      .update({
        where: {
