...
import type { CreateFunctionGraphCommitInput, FunctionGraphCommitPatch, FunctionGraphCommitSelect, FunctionGraphCommitFilter, FunctionGraphCommitOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<FunctionGraphCommitSelect, FunctionGraphCommitFilter, FunctionGraphCommitOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<FunctionGraphCommitSelect, FunctionGraphCommitFilter, FunctionGraphCommitOrderBy> & {
      select: FunctionGraphCommitSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.functionGraphCommit.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateFunctionGraphCommitInput["functionGraphCommit"];
    const client = getClient();
    const result = await client.functionGraphCommit.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.functionGraphCommit.update({
      where: {
        id: answers.id as string,
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.functionGraphCommit.delete({
      where: {
        id: answers.id as string,
        scopeId: answers.scopeId as string
      },
