...
import type { CreatePlatformResourceDefinitionInput, PlatformResourceDefinitionPatch, PlatformResourceDefinitionSelect, PlatformResourceDefinitionFilter, PlatformResourceDefinitionOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformResourceDefinitionSelect, PlatformResourceDefinitionFilter, PlatformResourceDefinitionOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformResourceDefinitionSelect, PlatformResourceDefinitionFilter, PlatformResourceDefinitionOrderBy> & {
      select: PlatformResourceDefinitionSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformResourceDefinition.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformResourceDefinitionInput["platformResourceDefinition"];
    const client = getClient();
    const result = await client.platformResourceDefinition.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformResourceDefinition.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformResourceDefinition.delete({
      where: {
        id: answers.id as string
      },
      select: {
