...
import type { CreateFunctionExecutionLogInput, FunctionExecutionLogPatch, FunctionExecutionLogSelect, FunctionExecutionLogFilter, FunctionExecutionLogOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<FunctionExecutionLogSelect, FunctionExecutionLogFilter, FunctionExecutionLogOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<FunctionExecutionLogSelect, FunctionExecutionLogFilter, FunctionExecutionLogOrderBy> & {
      select: FunctionExecutionLogSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.functionExecutionLog.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateFunctionExecutionLogInput["functionExecutionLog"];
    const client = getClient();
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as FunctionExecutionLogPatch;
    const client = getClient();
    const result = await client.functionExecutionLog.update({
      where: {
        id: answers.id as string,
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.functionExecutionLog.delete({
      where: {
        id: answers.id as string,
        createdAt: answers.createdAt as string
      },
