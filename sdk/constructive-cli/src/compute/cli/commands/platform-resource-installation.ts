/**
 * CLI commands for PlatformResourceInstallation
...
import type { CreatePlatformResourceInstallationInput, PlatformResourceInstallationPatch, PlatformResourceInstallationSelect, PlatformResourceInstallationFilter, PlatformResourceInstallationOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformResourceInstallationSelect, PlatformResourceInstallationFilter, PlatformResourceInstallationOrderBy> & {
      select: PlatformResourceInstallationSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformResourceInstallation.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformResourceInstallationSelect, PlatformResourceInstallationFilter, PlatformResourceInstallationOrderBy> & {
      select: PlatformResourceInstallationSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformResourceInstallation.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformResourceInstallationInput["platformResourceInstallation"];
    const client = getClient();
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as PlatformResourceInstallationPatch;
    const client = getClient();
    const result = await client.platformResourceInstallation.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformResourceInstallation.delete({
      where: {
        id: answers.id as string
      },
      select: {
