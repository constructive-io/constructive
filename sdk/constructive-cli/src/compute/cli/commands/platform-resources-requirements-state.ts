/**
 * CLI commands for PlatformResourcesRequirementsState
...
import type { CreatePlatformResourcesRequirementsStateInput, PlatformResourcesRequirementsStatePatch, PlatformResourcesRequirementsStateSelect, PlatformResourcesRequirementsStateFilter, PlatformResourcesRequirementsStateOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformResourcesRequirementsStateSelect, PlatformResourcesRequirementsStateFilter, PlatformResourcesRequirementsStateOrderBy> & {
      select: PlatformResourcesRequirementsStateSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformResourcesRequirementsState.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformResourcesRequirementsStateSelect, PlatformResourcesRequirementsStateFilter, PlatformResourcesRequirementsStateOrderBy> & {
      select: PlatformResourcesRequirementsStateSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformResourcesRequirementsState.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformResourcesRequirementsState.create({
      data: {
