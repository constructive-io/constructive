/**
 * CLI commands for RepositoryRequiredCheck
  ...
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<
        ...
        RepositoryRequiredCheckOrderBy
      > & {
        select: RepositoryRequiredCheckSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.repositoryRequiredCheck.findMany(findManyArgs).execute();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.repositoryRequiredCheck
      .findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreateRepositoryRequiredCheckInput['repositoryRequiredCheck'];
    const client = getClient();
    const result = await client.repositoryRequiredCheck
      .create({
        data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as RepositoryRequiredCheckPatch;
    const client = getClient();
    const result = await client.repositoryRequiredCheck
      .update({
        where: {
