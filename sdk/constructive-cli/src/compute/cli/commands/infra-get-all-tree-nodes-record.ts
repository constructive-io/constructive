...
import type { CreateInfraGetAllTreeNodesRecordInput, InfraGetAllTreeNodesRecordPatch, InfraGetAllTreeNodesRecordSelect, InfraGetAllTreeNodesRecordFilter, InfraGetAllTreeNodesRecordsOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<InfraGetAllTreeNodesRecordSelect, InfraGetAllTreeNodesRecordFilter, InfraGetAllTreeNodesRecordsOrderBy> & {
      select: InfraGetAllTreeNodesRecordSelect;
    }>(argv, defaultSelect);
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<InfraGetAllTreeNodesRecordSelect, InfraGetAllTreeNodesRecordFilter, InfraGetAllTreeNodesRecordsOrderBy> & {
      select: InfraGetAllTreeNodesRecordSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateInfraGetAllTreeNodesRecordInput["infraGetAllTreeNodesRecord"];
    const client = getClient();
    const result = await client.infraGetAllTreeNodesRecord.create({
      data: {
