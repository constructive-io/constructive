/**
 * CLI commands for FunctionGraphObject
...
import type { CreateFunctionGraphObjectInput, FunctionGraphObjectPatch, FunctionGraphObjectSelect, FunctionGraphObjectFilter, FunctionGraphObjectOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<FunctionGraphObjectSelect, FunctionGraphObjectFilter, FunctionGraphObjectOrderBy> & {
      select: FunctionGraphObjectSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.functionGraphObject.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<FunctionGraphObjectSelect, FunctionGraphObjectFilter, FunctionGraphObjectOrderBy> & {
      select: FunctionGraphObjectSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.functionGraphObject.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.functionGraphObject.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.functionGraphObject.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.functionGraphObject.update({
      where: {
        id: answers.id as string,
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.functionGraphObject.delete({
      where: {
        id: answers.id as string,
        scopeId: answers.scopeId as string
      },
