/**
 * CLI commands for PlatformInfraRef
...
import type { CreatePlatformInfraRefInput, PlatformInfraRefPatch, PlatformInfraRefSelect, PlatformInfraRefFilter, PlatformInfraRefOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformInfraRefSelect, PlatformInfraRefFilter, PlatformInfraRefOrderBy> & {
      select: PlatformInfraRefSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformInfraRef.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformInfraRefSelect, PlatformInfraRefFilter, PlatformInfraRefOrderBy> & {
      select: PlatformInfraRefSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformInfraRef.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformInfraRefInput["platformInfraRef"];
    const client = getClient();
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as PlatformInfraRefPatch;
    const client = getClient();
    const result = await client.platformInfraRef.update({
      where: {
        id: answers.id as string,
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformInfraRef.delete({
      where: {
        id: answers.id as string,
        scopeId: answers.scopeId as string
      },
