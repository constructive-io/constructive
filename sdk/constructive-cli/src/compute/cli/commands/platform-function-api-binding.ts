/**
 * CLI commands for PlatformFunctionApiBinding
...
import type { CreatePlatformFunctionApiBindingInput, PlatformFunctionApiBindingPatch, PlatformFunctionApiBindingSelect, PlatformFunctionApiBindingFilter, PlatformFunctionApiBindingOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformFunctionApiBindingSelect, PlatformFunctionApiBindingFilter, PlatformFunctionApiBindingOrderBy> & {
      select: PlatformFunctionApiBindingSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformFunctionApiBinding.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformFunctionApiBindingSelect, PlatformFunctionApiBindingFilter, PlatformFunctionApiBindingOrderBy> & {
      select: PlatformFunctionApiBindingSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformFunctionApiBinding.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformFunctionApiBindingInput["platformFunctionApiBinding"];
    const client = getClient();
    const result = await client.platformFunctionApiBinding.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as PlatformFunctionApiBindingPatch;
    const client = getClient();
    const result = await client.platformFunctionApiBinding.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformFunctionApiBinding.delete({
      where: {
        id: answers.id as string
      },
      select: {
