/**
 * CLI commands for FunctionInvocationAttempt
...
import type { CreateFunctionInvocationAttemptInput, FunctionInvocationAttemptPatch, FunctionInvocationAttemptSelect, FunctionInvocationAttemptFilter, FunctionInvocationAttemptOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<FunctionInvocationAttemptSelect, FunctionInvocationAttemptFilter, FunctionInvocationAttemptOrderBy> & {
      select: FunctionInvocationAttemptSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.functionInvocationAttempt.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<FunctionInvocationAttemptSelect, FunctionInvocationAttemptFilter, FunctionInvocationAttemptOrderBy> & {
      select: FunctionInvocationAttemptSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.functionInvocationAttempt.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.functionInvocationAttempt.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.functionInvocationAttempt.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as FunctionInvocationAttemptPatch;
    const client = getClient();
    const result = await client.functionInvocationAttempt.update({
      where: {
        id: answers.id as string,
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.functionInvocationAttempt.delete({
      where: {
        id: answers.id as string,
        createdAt: answers.createdAt as string
      },
