/**
 * CLI commands for WebhookEndpoint
...
import type { CreateWebhookEndpointInput, WebhookEndpointPatch, WebhookEndpointSelect, WebhookEndpointFilter, WebhookEndpointOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<WebhookEndpointSelect, WebhookEndpointFilter, WebhookEndpointOrderBy> & {
      select: WebhookEndpointSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.webhookEndpoint.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<WebhookEndpointSelect, WebhookEndpointFilter, WebhookEndpointOrderBy> & {
      select: WebhookEndpointSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.webhookEndpoint.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateWebhookEndpointInput["webhookEndpoint"];
    const client = getClient();
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.webhookEndpoint.delete({
      where: {
        id: answers.id as string
      },
      select: {
