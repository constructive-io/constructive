/**
 * CLI commands for PlatformFunctionCapabilityBinding
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const result = await client.platformFunctionCapabilityBinding.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformFunctionCapabilityBinding
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreatePlatformFunctionCapabilityBindingInput['platformFunctionCapabilityBinding'];
    const client = getClient();
    const result = await client.platformFunctionCapabilityBinding
      .create({
        data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as PlatformFunctionCapabilityBindingPatch;
    const client = getClient();
    const result = await client.platformFunctionCapabilityBinding
      .update({
        where: {
