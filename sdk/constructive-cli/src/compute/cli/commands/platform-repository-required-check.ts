/**
 * CLI commands for PlatformRepositoryRequiredCheck
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const result = await client.platformRepositoryRequiredCheck.findMany(findManyArgs).execute();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformRepositoryRequiredCheck
      .findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreatePlatformRepositoryRequiredCheckInput['platformRepositoryRequiredCheck'];
    const client = getClient();
    const result = await client.platformRepositoryRequiredCheck
      .create({
        data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as PlatformRepositoryRequiredCheckPatch;
    const client = getClient();
    const result = await client.platformRepositoryRequiredCheck
      .update({
        where: {
