...
import type { CreateResourcesRequirementsStateInput, ResourcesRequirementsStatePatch, ResourcesRequirementsStateSelect, ResourcesRequirementsStateFilter, ResourcesRequirementsStateOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<ResourcesRequirementsStateSelect, ResourcesRequirementsStateFilter, ResourcesRequirementsStateOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<ResourcesRequirementsStateSelect, ResourcesRequirementsStateFilter, ResourcesRequirementsStateOrderBy> & {
      select: ResourcesRequirementsStateSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateResourcesRequirementsStateInput["resourcesRequirementsState"];
    const client = getClient();
    const result = await client.resourcesRequirementsState.create({
      data: {
