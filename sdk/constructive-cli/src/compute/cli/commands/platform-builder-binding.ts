/**
 * CLI commands for PlatformBuilderBinding
  ...
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<
        ...
        PlatformBuilderBindingOrderBy
      > & {
        select: PlatformBuilderBindingSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformBuilderBinding.findMany(findManyArgs).execute();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformBuilderBinding
      .findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreatePlatformBuilderBindingInput['platformBuilderBinding'];
    const client = getClient();
    const result = await client.platformBuilderBinding
      .create({
        data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as PlatformBuilderBindingPatch;
    const client = getClient();
    const result = await client.platformBuilderBinding
      .update({
        where: {
