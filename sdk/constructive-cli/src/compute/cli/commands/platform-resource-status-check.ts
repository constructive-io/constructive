...
import type { CreatePlatformResourceStatusCheckInput, PlatformResourceStatusCheckPatch, PlatformResourceStatusCheckSelect, PlatformResourceStatusCheckFilter, PlatformResourceStatusCheckOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformResourceStatusCheckSelect, PlatformResourceStatusCheckFilter, PlatformResourceStatusCheckOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformResourceStatusCheckSelect, PlatformResourceStatusCheckFilter, PlatformResourceStatusCheckOrderBy> & {
      select: PlatformResourceStatusCheckSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformResourceStatusCheck.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformResourceStatusCheckInput["platformResourceStatusCheck"];
    const client = getClient();
    const result = await client.platformResourceStatusCheck.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformResourceStatusCheck.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformResourceStatusCheck.delete({
      where: {
        id: answers.id as string
      },
      select: {
