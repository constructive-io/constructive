/**
 * CLI command for mutation addEdge
...
import type { AddEdgePayloadSelect } from "../../orm/input-types";
export default async (argv: Partial<Record<string, unknown>>, prompter: Inquirerer, _options: CLIOptions) => {
  try {
    ...
    const result = await client.mutation.addEdge(parsedAnswers as unknown as AddEdgeVariables, {
      select: selectFields
    } as unknown as {
      select: AddEdgePayloadSelect;
    }).execute();
