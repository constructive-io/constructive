/**
 * CLI commands for DatabaseGraphGetAllTreeNodesRecord
  ...
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<
        ...
        DatabaseGraphGetAllTreeNodesRecordsOrderBy
      > & {
        select: DatabaseGraphGetAllTreeNodesRecordSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.databaseGraphGetAllTreeNodesRecord.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.databaseGraphGetAllTreeNodesRecord
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreateDatabaseGraphGetAllTreeNodesRecordInput['databaseGraphGetAllTreeNodesRecord'];
    const client = getClient();
    const result = await client.databaseGraphGetAllTreeNodesRecord
      .create({
        data: {
