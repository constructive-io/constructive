    ...
    const result = await client.platformFunctionDefinition
      .create({
        data: {
          ...
          anonymousCallable: cleanedData.anonymousCallable,
          ...
          requiredCapabilities: cleanedData.requiredCapabilities,
          requiredConfigs: cleanedData.requiredConfigs,
          requiredModels: cleanedData.requiredModels,
          requiredModules: cleanedData.requiredModules,
