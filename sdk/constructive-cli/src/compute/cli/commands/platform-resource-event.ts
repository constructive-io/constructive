/**
 * CLI commands for PlatformResourceEvent
...
import type { CreatePlatformResourceEventInput, PlatformResourceEventPatch, PlatformResourceEventSelect, PlatformResourceEventFilter, PlatformResourceEventOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformResourceEventSelect, PlatformResourceEventFilter, PlatformResourceEventOrderBy> & {
      select: PlatformResourceEventSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformResourceEvent.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformResourceEventSelect, PlatformResourceEventFilter, PlatformResourceEventOrderBy> & {
      select: PlatformResourceEventSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformResourceEvent.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformResourceEventInput["platformResourceEvent"];
    const client = getClient();
    const result = await client.platformResourceEvent.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as PlatformResourceEventPatch;
    const client = getClient();
    const result = await client.platformResourceEvent.update({
      where: {
        id: answers.id as string,
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformResourceEvent.delete({
      where: {
        id: answers.id as string,
        createdAt: answers.createdAt as string
      },
