/**
 * CLI commands for PlatformInfraObject
...
import type { CreatePlatformInfraObjectInput, PlatformInfraObjectPatch, PlatformInfraObjectSelect, PlatformInfraObjectFilter, PlatformInfraObjectOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformInfraObjectSelect, PlatformInfraObjectFilter, PlatformInfraObjectOrderBy> & {
      select: PlatformInfraObjectSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformInfraObject.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformInfraObjectSelect, PlatformInfraObjectFilter, PlatformInfraObjectOrderBy> & {
      select: PlatformInfraObjectSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformInfraObject.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformInfraObjectInput["platformInfraObject"];
    const client = getClient();
    const result = await client.platformInfraObject.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as PlatformInfraObjectPatch;
    const client = getClient();
    const result = await client.platformInfraObject.update({
      where: {
        id: answers.id as string,
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformInfraObject.delete({
      where: {
        id: answers.id as string,
        scopeId: answers.scopeId as string
      },
