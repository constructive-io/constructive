/**
 * CLI commands for PlatformFunctionDeploymentEvent
...
import type { CreatePlatformFunctionDeploymentEventInput, PlatformFunctionDeploymentEventPatch, PlatformFunctionDeploymentEventSelect, PlatformFunctionDeploymentEventFilter, PlatformFunctionDeploymentEventOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformFunctionDeploymentEventSelect, PlatformFunctionDeploymentEventFilter, PlatformFunctionDeploymentEventOrderBy> & {
      select: PlatformFunctionDeploymentEventSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformFunctionDeploymentEvent.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformFunctionDeploymentEventSelect, PlatformFunctionDeploymentEventFilter, PlatformFunctionDeploymentEventOrderBy> & {
      select: PlatformFunctionDeploymentEventSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformFunctionDeploymentEvent.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformFunctionDeploymentEventInput["platformFunctionDeploymentEvent"];
    const client = getClient();
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as PlatformFunctionDeploymentEventPatch;
    const client = getClient();
    const result = await client.platformFunctionDeploymentEvent.update({
      where: {
        id: answers.id as string,
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformFunctionDeploymentEvent.delete({
      where: {
        id: answers.id as string,
        createdAt: answers.createdAt as string
      },
