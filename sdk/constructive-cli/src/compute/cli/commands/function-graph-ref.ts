/**
 * CLI commands for FunctionGraphRef
...
import type { CreateFunctionGraphRefInput, FunctionGraphRefPatch, FunctionGraphRefSelect, FunctionGraphRefFilter, FunctionGraphRefOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<FunctionGraphRefSelect, FunctionGraphRefFilter, FunctionGraphRefOrderBy> & {
      select: FunctionGraphRefSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.functionGraphRef.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<FunctionGraphRefSelect, FunctionGraphRefFilter, FunctionGraphRefOrderBy> & {
      select: FunctionGraphRefSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.functionGraphRef.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.functionGraphRef.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateFunctionGraphRefInput["functionGraphRef"];
    const client = getClient();
    const result = await client.functionGraphRef.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.functionGraphRef.update({
      where: {
        id: answers.id as string,
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.functionGraphRef.delete({
      where: {
        id: answers.id as string,
        scopeId: answers.scopeId as string
      },
