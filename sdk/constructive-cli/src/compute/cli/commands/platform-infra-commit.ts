/**
 * CLI commands for PlatformInfraCommit
...
import type { CreatePlatformInfraCommitInput, PlatformInfraCommitPatch, PlatformInfraCommitSelect, PlatformInfraCommitFilter, PlatformInfraCommitOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformInfraCommitSelect, PlatformInfraCommitFilter, PlatformInfraCommitOrderBy> & {
      select: PlatformInfraCommitSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.platformInfraCommit.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformInfraCommitSelect, PlatformInfraCommitFilter, PlatformInfraCommitOrderBy> & {
      select: PlatformInfraCommitSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformInfraCommit.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformInfraCommitInput["platformInfraCommit"];
    const client = getClient();
    const result = await client.platformInfraCommit.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as PlatformInfraCommitPatch;
    const client = getClient();
    const result = await client.platformInfraCommit.update({
      where: {
        id: answers.id as string,
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformInfraCommit.delete({
      where: {
        id: answers.id as string,
        scopeId: answers.scopeId as string
      },
