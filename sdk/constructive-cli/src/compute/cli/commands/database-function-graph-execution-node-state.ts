...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreateDatabaseFunctionGraphExecutionNodeStateInput['databaseFunctionGraphExecutionNodeState'];
    const client = getClient();
    const result = await client.databaseFunctionGraphExecutionNodeState
      .create({
        data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as DatabaseFunctionGraphExecutionNodeStatePatch;
    const client = getClient();
    const result = await client.databaseFunctionGraphExecutionNodeState
      .update({
        where: {
