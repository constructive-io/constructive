...
import type { CreatePlatformNamespaceInput, PlatformNamespacePatch, PlatformNamespaceSelect, PlatformNamespaceFilter, PlatformNamespaceOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformNamespaceSelect, PlatformNamespaceFilter, PlatformNamespaceOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformNamespaceSelect, PlatformNamespaceFilter, PlatformNamespaceOrderBy> & {
      select: PlatformNamespaceSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformNamespaceInput["platformNamespace"];
    const client = getClient();
    const result = await client.platformNamespace.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.platformNamespace.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.platformNamespace.delete({
      where: {
        id: answers.id as string
      },
      select: {
