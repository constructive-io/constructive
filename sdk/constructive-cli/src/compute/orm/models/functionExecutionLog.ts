...
import type { FunctionExecutionLog, FunctionExecutionLogWithRelations, FunctionExecutionLogSelect, FunctionExecutionLogFilter, FunctionExecutionLogOrderBy, CreateFunctionExecutionLogInput, UpdateFunctionExecutionLogInput, FunctionExecutionLogPatch } from "../input-types";
...
export class FunctionExecutionLogModel {
  ...
  findMany<S extends FunctionExecutionLogSelect>(args: FindManyArgs<S, FunctionExecutionLogFilter, FunctionExecutionLogOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("FunctionExecutionLog", "functionExecutionLogs", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "FunctionExecutionLogFilter", "FunctionExecutionLogOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends FunctionExecutionLogSelect>(args: FindFirstArgs<S, FunctionExecutionLogFilter, FunctionExecutionLogOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("FunctionExecutionLog", "functionExecutionLogs", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "FunctionExecutionLogFilter", "FunctionExecutionLogOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends FunctionExecutionLogSelect>(args: CreateArgs<S, CreateFunctionExecutionLogInput["functionExecutionLog"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("FunctionExecutionLog", "createFunctionExecutionLog", "functionExecutionLog", args.select, args.data, "CreateFunctionExecutionLogInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "FunctionExecutionLog",
  ...
  update<S extends FunctionExecutionLogSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("FunctionExecutionLog", "updateFunctionExecutionLog", "functionExecutionLog", args.select, args.where.id, args.data, "UpdateFunctionExecutionLogInput", "id", "functionExecutionLogPatch", connectionFieldsMap, {
  ...
  delete<S extends FunctionExecutionLogSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("FunctionExecutionLog", "deleteFunctionExecutionLog", "functionExecutionLog", {
      id: args.where.id,
      createdAt: args.where.createdAt
    }, "DeleteFunctionExecutionLogInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "FunctionExecutionLog",
