...
import type { ResourceStatusCheck, ResourceStatusCheckWithRelations, ResourceStatusCheckSelect, ResourceStatusCheckFilter, ResourceStatusCheckOrderBy, CreateResourceStatusCheckInput, UpdateResourceStatusCheckInput, ResourceStatusCheckPatch } from "../input-types";
...
export class ResourceStatusCheckModel {
  ...
  findMany<S extends ResourceStatusCheckSelect>(args: FindManyArgs<S, ResourceStatusCheckFilter, ResourceStatusCheckOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("ResourceStatusCheck", "resourceStatusChecks", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "ResourceStatusCheckFilter", "ResourceStatusCheckOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends ResourceStatusCheckSelect>(args: FindFirstArgs<S, ResourceStatusCheckFilter, ResourceStatusCheckOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("ResourceStatusCheck", "resourceStatusChecks", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "ResourceStatusCheckFilter", "ResourceStatusCheckOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends ResourceStatusCheckSelect>(args: CreateArgs<S, CreateResourceStatusCheckInput["resourceStatusCheck"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("ResourceStatusCheck", "createResourceStatusCheck", "resourceStatusCheck", args.select, args.data, "CreateResourceStatusCheckInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ResourceStatusCheck",
  ...
  update<S extends ResourceStatusCheckSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("ResourceStatusCheck", "updateResourceStatusCheck", "resourceStatusCheck", args.select, args.where.id, args.data, "UpdateResourceStatusCheckInput", "id", "resourceStatusCheckPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ResourceStatusCheck",
  ...
  delete<S extends ResourceStatusCheckSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("ResourceStatusCheck", "deleteResourceStatusCheck", "resourceStatusCheck", {
      id: args.where.id
    }, "DeleteResourceStatusCheckInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ResourceStatusCheck",
