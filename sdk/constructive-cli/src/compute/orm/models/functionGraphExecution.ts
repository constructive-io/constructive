...
import type { FunctionGraphExecution, FunctionGraphExecutionWithRelations, FunctionGraphExecutionSelect, FunctionGraphExecutionFilter, FunctionGraphExecutionOrderBy, CreateFunctionGraphExecutionInput, UpdateFunctionGraphExecutionInput, FunctionGraphExecutionPatch } from "../input-types";
...
export class FunctionGraphExecutionModel {
  ...
  findMany<S extends FunctionGraphExecutionSelect>(args: FindManyArgs<S, FunctionGraphExecutionFilter, FunctionGraphExecutionOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("FunctionGraphExecution", "functionGraphExecutions", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "FunctionGraphExecutionFilter", "FunctionGraphExecutionOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends FunctionGraphExecutionSelect>(args: FindFirstArgs<S, FunctionGraphExecutionFilter, FunctionGraphExecutionOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("FunctionGraphExecution", "functionGraphExecutions", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "FunctionGraphExecutionFilter", "FunctionGraphExecutionOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends FunctionGraphExecutionSelect>(args: CreateArgs<S, CreateFunctionGraphExecutionInput["functionGraphExecution"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("FunctionGraphExecution", "createFunctionGraphExecution", "functionGraphExecution", args.select, args.data, "CreateFunctionGraphExecutionInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "FunctionGraphExecution",
  ...
  update<S extends FunctionGraphExecutionSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("FunctionGraphExecution", "updateFunctionGraphExecution", "functionGraphExecution", args.select, args.where.id, args.data, "UpdateFunctionGraphExecutionInput", "id", "functionGraphExecutionPatch", connectionFieldsMap, {
  ...
  delete<S extends FunctionGraphExecutionSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("FunctionGraphExecution", "deleteFunctionGraphExecution", "functionGraphExecution", {
      id: args.where.id,
      startedAt: args.where.startedAt
    }, "DeleteFunctionGraphExecutionInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "FunctionGraphExecution",
