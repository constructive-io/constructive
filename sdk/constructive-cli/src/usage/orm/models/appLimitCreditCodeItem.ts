...
import type { AppLimitCreditCodeItem, AppLimitCreditCodeItemWithRelations, AppLimitCreditCodeItemSelect, AppLimitCreditCodeItemFilter, AppLimitCreditCodeItemOrderBy, CreateAppLimitCreditCodeItemInput, UpdateAppLimitCreditCodeItemInput, AppLimitCreditCodeItemPatch } from "../input-types";
...
export class AppLimitCreditCodeItemModel {
  ...
  findMany<S extends AppLimitCreditCodeItemSelect>(args: FindManyArgs<S, AppLimitCreditCodeItemFilter, AppLimitCreditCodeItemOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("AppLimitCreditCodeItem", "appLimitCreditCodeItems", args.select, {
      where: args?.where,
  ...
  findFirst<S extends AppLimitCreditCodeItemSelect>(args: FindFirstArgs<S, AppLimitCreditCodeItemFilter, AppLimitCreditCodeItemOrderBy> & {
    select: S;
  } & StrictSelect<S, AppLimitCreditCodeItemSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("AppLimitCreditCodeItem", "appLimitCreditCodeItems", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "AppLimitCreditCodeItemFilter", "AppLimitCreditCodeItemOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends AppLimitCreditCodeItemSelect>(args: CreateArgs<S, CreateAppLimitCreditCodeItemInput["appLimitCreditCodeItem"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AppLimitCreditCodeItem", "createAppLimitCreditCodeItem", "appLimitCreditCodeItem", args.select, args.data, "CreateAppLimitCreditCodeItemInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppLimitCreditCodeItem",
  ...
  update<S extends AppLimitCreditCodeItemSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AppLimitCreditCodeItem", "updateAppLimitCreditCodeItem", "appLimitCreditCodeItem", args.select, args.where.id, args.data, "UpdateAppLimitCreditCodeItemInput", "id", "appLimitCreditCodeItemPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppLimitCreditCodeItem",
  ...
  delete<S extends AppLimitCreditCodeItemSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AppLimitCreditCodeItem", "deleteAppLimitCreditCodeItem", "appLimitCreditCodeItem", {
      id: args.where.id
