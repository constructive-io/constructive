...
import type { OrgLimitAggregate, OrgLimitAggregateWithRelations, OrgLimitAggregateSelect, OrgLimitAggregateFilter, OrgLimitAggregateOrderBy, CreateOrgLimitAggregateInput, UpdateOrgLimitAggregateInput, OrgLimitAggregatePatch } from "../input-types";
...
export class OrgLimitAggregateModel {
  ...
  findMany<S extends OrgLimitAggregateSelect>(args: FindManyArgs<S, OrgLimitAggregateFilter, OrgLimitAggregateOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("OrgLimitAggregate", "orgLimitAggregates", args.select, {
      where: args?.where,
  ...
  findFirst<S extends OrgLimitAggregateSelect>(args: FindFirstArgs<S, OrgLimitAggregateFilter, OrgLimitAggregateOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("OrgLimitAggregate", "orgLimitAggregates", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "OrgLimitAggregateFilter", "OrgLimitAggregateOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends OrgLimitAggregateSelect>(args: CreateArgs<S, CreateOrgLimitAggregateInput["orgLimitAggregate"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("OrgLimitAggregate", "createOrgLimitAggregate", "orgLimitAggregate", args.select, args.data, "CreateOrgLimitAggregateInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgLimitAggregate",
  ...
  update<S extends OrgLimitAggregateSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("OrgLimitAggregate", "updateOrgLimitAggregate", "orgLimitAggregate", args.select, args.where.id, args.data, "UpdateOrgLimitAggregateInput", "id", "orgLimitAggregatePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgLimitAggregate",
  ...
  delete<S extends OrgLimitAggregateSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("OrgLimitAggregate", "deleteOrgLimitAggregate", "orgLimitAggregate", {
      id: args.where.id
