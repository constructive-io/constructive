...
import type { AppLimitWarning, AppLimitWarningWithRelations, AppLimitWarningSelect, AppLimitWarningFilter, AppLimitWarningOrderBy, CreateAppLimitWarningInput, UpdateAppLimitWarningInput, AppLimitWarningPatch } from "../input-types";
...
export class AppLimitWarningModel {
  ...
  findMany<S extends AppLimitWarningSelect>(args: FindManyArgs<S, AppLimitWarningFilter, AppLimitWarningOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("AppLimitWarning", "appLimitWarnings", args.select, {
      where: args?.where,
  ...
  findFirst<S extends AppLimitWarningSelect>(args: FindFirstArgs<S, AppLimitWarningFilter, AppLimitWarningOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("AppLimitWarning", "appLimitWarnings", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "AppLimitWarningFilter", "AppLimitWarningOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends AppLimitWarningSelect>(args: CreateArgs<S, CreateAppLimitWarningInput["appLimitWarning"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AppLimitWarning", "createAppLimitWarning", "appLimitWarning", args.select, args.data, "CreateAppLimitWarningInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppLimitWarning",
  ...
  update<S extends AppLimitWarningSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AppLimitWarning", "updateAppLimitWarning", "appLimitWarning", args.select, args.where.id, args.data, "UpdateAppLimitWarningInput", "id", "appLimitWarningPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppLimitWarning",
  ...
  delete<S extends AppLimitWarningSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AppLimitWarning", "deleteAppLimitWarning", "appLimitWarning", {
      id: args.where.id
