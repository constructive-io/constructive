...
import type { CreateOrgLimitWarningInput, OrgLimitWarningPatch, OrgLimitWarningSelect, OrgLimitWarningFilter, OrgLimitWarningOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<OrgLimitWarningSelect, OrgLimitWarningFilter, OrgLimitWarningOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<OrgLimitWarningSelect, OrgLimitWarningFilter, OrgLimitWarningOrderBy> & {
      select: OrgLimitWarningSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.orgLimitWarning.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateOrgLimitWarningInput["orgLimitWarning"];
    const client = getClient();
    const result = await client.orgLimitWarning.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as OrgLimitWarningPatch;
    const client = getClient();
    const result = await client.orgLimitWarning.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.orgLimitWarning.delete({
      where: {
        id: answers.id as string
      },
      select: {
