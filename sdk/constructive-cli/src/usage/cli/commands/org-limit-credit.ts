...
import type { CreateOrgLimitCreditInput, OrgLimitCreditPatch, OrgLimitCreditSelect, OrgLimitCreditFilter, OrgLimitCreditOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<OrgLimitCreditSelect, OrgLimitCreditFilter, OrgLimitCreditOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<OrgLimitCreditSelect, OrgLimitCreditFilter, OrgLimitCreditOrderBy> & {
      select: OrgLimitCreditSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.orgLimitCredit.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateOrgLimitCreditInput["orgLimitCredit"];
    const client = getClient();
    const result = await client.orgLimitCredit.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as OrgLimitCreditPatch;
    const client = getClient();
    const result = await client.orgLimitCredit.update({
      where: {
        id: answers.id as string
      },
      data: {
