...
import type { CreateOrgLimitDefaultInput, OrgLimitDefaultPatch, OrgLimitDefaultSelect, OrgLimitDefaultFilter, OrgLimitDefaultOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<OrgLimitDefaultSelect, OrgLimitDefaultFilter, OrgLimitDefaultOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<OrgLimitDefaultSelect, OrgLimitDefaultFilter, OrgLimitDefaultOrderBy> & {
      select: OrgLimitDefaultSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.orgLimitDefault.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateOrgLimitDefaultInput["orgLimitDefault"];
    const client = getClient();
    const result = await client.orgLimitDefault.create({
      data: {
        max: cleanedData.max,
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.orgLimitDefault.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.orgLimitDefault.delete({
      where: {
        id: answers.id as string
      },
      select: {
