/**
 * CLI commands for AppLimitCreditCode
...
import type { CreateAppLimitCreditCodeInput, AppLimitCreditCodePatch, AppLimitCreditCodeSelect, AppLimitCreditCodeFilter, AppLimitCreditCodeOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<AppLimitCreditCodeSelect, AppLimitCreditCodeFilter, AppLimitCreditCodeOrderBy> & {
      select: AppLimitCreditCodeSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.appLimitCreditCode.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<AppLimitCreditCodeSelect, AppLimitCreditCodeFilter, AppLimitCreditCodeOrderBy> & {
      select: AppLimitCreditCodeSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.appLimitCreditCode.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.appLimitCreditCode.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.appLimitCreditCode.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as AppLimitCreditCodePatch;
    const client = getClient();
    const result = await client.appLimitCreditCode.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.appLimitCreditCode.delete({
      where: {
        id: answers.id as string
      },
      select: {
