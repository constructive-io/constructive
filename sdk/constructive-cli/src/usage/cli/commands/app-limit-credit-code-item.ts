/**
 * CLI commands for AppLimitCreditCodeItem
...
import type { CreateAppLimitCreditCodeItemInput, AppLimitCreditCodeItemPatch, AppLimitCreditCodeItemSelect, AppLimitCreditCodeItemFilter, AppLimitCreditCodeItemOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<AppLimitCreditCodeItemSelect, AppLimitCreditCodeItemFilter, AppLimitCreditCodeItemOrderBy> & {
      select: AppLimitCreditCodeItemSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.appLimitCreditCodeItem.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<AppLimitCreditCodeItemSelect, AppLimitCreditCodeItemFilter, AppLimitCreditCodeItemOrderBy> & {
      select: AppLimitCreditCodeItemSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.appLimitCreditCodeItem.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.appLimitCreditCodeItem.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateAppLimitCreditCodeItemInput["appLimitCreditCodeItem"];
    const client = getClient();
    const result = await client.appLimitCreditCodeItem.create({
      data: {
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as AppLimitCreditCodeItemPatch;
    const client = getClient();
    const result = await client.appLimitCreditCodeItem.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.appLimitCreditCodeItem.delete({
      where: {
        id: answers.id as string
      },
      select: {
