/**
 * CLI commands for AppLimitCapsDefault
...
import type { CreateAppLimitCapsDefaultInput, AppLimitCapsDefaultPatch, AppLimitCapsDefaultSelect, AppLimitCapsDefaultFilter, AppLimitCapsDefaultOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<AppLimitCapsDefaultSelect, AppLimitCapsDefaultFilter, AppLimitCapsDefaultOrderBy> & {
      select: AppLimitCapsDefaultSelect;
    }>(argv, defaultSelect);
    const client = getClient();
    const result = await client.appLimitCapsDefault.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<AppLimitCapsDefaultSelect, AppLimitCapsDefaultFilter, AppLimitCapsDefaultOrderBy> & {
      select: AppLimitCapsDefaultSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.appLimitCapsDefault.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateAppLimitCapsDefaultInput["appLimitCapsDefault"];
    const client = getClient();
    const result = await client.appLimitCapsDefault.create({
      data: {
        max: cleanedData.max,
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as AppLimitCapsDefaultPatch;
    const client = getClient();
    const result = await client.appLimitCapsDefault.update({
      where: {
        id: answers.id as string
      },
      data: {
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.appLimitCapsDefault.delete({
      where: {
        id: answers.id as string
      },
      select: {
