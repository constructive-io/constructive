...
import type { CreateOrgLimitCapsDefaultInput, OrgLimitCapsDefaultPatch, OrgLimitCapsDefaultSelect, OrgLimitCapsDefaultFilter, OrgLimitCapsDefaultOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<OrgLimitCapsDefaultSelect, OrgLimitCapsDefaultFilter, OrgLimitCapsDefaultOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<OrgLimitCapsDefaultSelect, OrgLimitCapsDefaultFilter, OrgLimitCapsDefaultOrderBy> & {
      select: OrgLimitCapsDefaultSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.orgLimitCapsDefault.findOne({
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateOrgLimitCapsDefaultInput["orgLimitCapsDefault"];
    const client = getClient();
    const result = await client.orgLimitCapsDefault.create({
      data: {
        max: cleanedData.max,
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as OrgLimitCapsDefaultPatch;
    const client = getClient();
    const result = await client.orgLimitCapsDefault.update({
      where: {
        id: answers.id as string
      },
      data: {
