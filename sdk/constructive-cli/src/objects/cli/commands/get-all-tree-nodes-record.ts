...
import type { CreateGetAllTreeNodesRecordInput, GetAllTreeNodesRecordPatch, GetAllTreeNodesRecordSelect, GetAllTreeNodesRecordFilter, GetAllTreeNodesRecordsOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<GetAllTreeNodesRecordSelect, GetAllTreeNodesRecordFilter, GetAllTreeNodesRecordsOrderBy> & {
      select: GetAllTreeNodesRecordSelect;
    }>(argv, defaultSelect);
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<GetAllTreeNodesRecordSelect, GetAllTreeNodesRecordFilter, GetAllTreeNodesRecordsOrderBy> & {
      select: GetAllTreeNodesRecordSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateGetAllTreeNodesRecordInput["getAllTreeNodesRecord"];
    const client = getClient();
    const result = await client.getAllTreeNodesRecord.create({
      data: {
