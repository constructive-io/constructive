...
import type { CreateObjectInput, ObjectPatch, ObjectSelect, ObjectFilter, ObjectOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<ObjectSelect, ObjectFilter, ObjectOrderBy> & {
      select: ObjectSelect;
    }>(argv, defaultSelect);
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<ObjectSelect, ObjectFilter, ObjectOrderBy> & {
      select: ObjectSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleGet(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const client = getClient();
    const result = await client.object.findOne({
...
async function handleDelete(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const client = getClient();
    const result = await client.object.delete({
      where: {
        id: answers.id as string,
        databaseId: answers.databaseId as string
      },
