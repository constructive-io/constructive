...
import type { CreateSecretInput, SecretPatch, SecretSelect, SecretFilter, SecretOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<SecretSelect, SecretFilter, SecretOrderBy> & {
      select: SecretSelect;
    }>(argv, defaultSelect);
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<SecretSelect, SecretFilter, SecretOrderBy> & {
      select: SecretSelect;
    }>(argv, defaultSelect);
    const client = getClient();
