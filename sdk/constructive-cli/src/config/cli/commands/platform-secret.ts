...
import type { CreatePlatformSecretInput, PlatformSecretPatch, PlatformSecretSelect, PlatformSecretFilter, PlatformSecretOrderBy } from "../../orm/input-types";
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<FindManyArgs<PlatformSecretSelect, PlatformSecretFilter, PlatformSecretOrderBy> & {
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<FindFirstArgs<PlatformSecretSelect, PlatformSecretFilter, PlatformSecretOrderBy> & {
      select: PlatformSecretSelect;
    }>(argv, defaultSelect);
    const client = getClient();
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreatePlatformSecretInput["platformSecret"];
    const client = getClient();
    const result = await client.platformSecret.create({
      data: {
