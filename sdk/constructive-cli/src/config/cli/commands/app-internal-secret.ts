/**
 * CLI commands for AppInternalSecret
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<AppInternalSecretSelect, AppInternalSecretFilter, AppInternalSecretOrderBy> & {
        select: AppInternalSecretSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.appInternalSecret.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<AppInternalSecretSelect, AppInternalSecretFilter, AppInternalSecretOrderBy> & {
        select: AppInternalSecretSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreateAppInternalSecretInput['appInternalSecret'];
    const client = getClient();
    const result = await client.appInternalSecret
      .create({
        data: {
