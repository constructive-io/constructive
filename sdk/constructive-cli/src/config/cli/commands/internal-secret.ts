/**
 * CLI commands for InternalSecret
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<InternalSecretSelect, InternalSecretFilter, InternalSecretOrderBy> & {
        select: InternalSecretSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.internalSecret.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<InternalSecretSelect, InternalSecretFilter, InternalSecretOrderBy> & {
        select: InternalSecretSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreateInternalSecretInput['internalSecret'];
    const client = getClient();
    const result = await client.internalSecret
      .create({
        data: {
