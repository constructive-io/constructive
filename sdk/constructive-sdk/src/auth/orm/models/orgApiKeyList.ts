...
import type { OrgApiKeyList, OrgApiKeyListWithRelations, OrgApiKeyListSelect, OrgApiKeyListFilter, OrgApiKeyListOrderBy, CreateOrgApiKeyListInput, UpdateOrgApiKeyListInput, OrgApiKeyListPatch } from "../input-types";
...
export class OrgApiKeyListModel {
  ...
  findMany<S extends OrgApiKeyListSelect>(args: FindManyArgs<S, OrgApiKeyListFilter, OrgApiKeyListOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("OrgApiKeyList", "orgApiKeyLists", args.select, {
      where: args?.where,
  ...
  findFirst<S extends OrgApiKeyListSelect>(args: FindFirstArgs<S, OrgApiKeyListFilter, OrgApiKeyListOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("OrgApiKeyList", "orgApiKeyLists", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "OrgApiKeyListFilter", "OrgApiKeyListOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends OrgApiKeyListSelect>(args: CreateArgs<S, CreateOrgApiKeyListInput["orgApiKeyList"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("OrgApiKeyList", "createOrgApiKeyList", "orgApiKeyList", args.select, args.data, "CreateOrgApiKeyListInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgApiKeyList",
