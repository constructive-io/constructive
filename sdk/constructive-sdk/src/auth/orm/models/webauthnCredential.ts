...
import type { WebauthnCredential, WebauthnCredentialWithRelations, WebauthnCredentialSelect, WebauthnCredentialFilter, WebauthnCredentialOrderBy, CreateWebauthnCredentialInput, UpdateWebauthnCredentialInput, WebauthnCredentialPatch } from "../input-types";
...
export class WebauthnCredentialModel {
  ...
  findMany<S extends WebauthnCredentialSelect>(args: FindManyArgs<S, WebauthnCredentialFilter, WebauthnCredentialOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("WebauthnCredential", "webauthnCredentials", args.select, {
      where: args?.where,
  ...
  findFirst<S extends WebauthnCredentialSelect>(args: FindFirstArgs<S, WebauthnCredentialFilter, WebauthnCredentialOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("WebauthnCredential", "webauthnCredentials", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "WebauthnCredentialFilter", "WebauthnCredentialOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends WebauthnCredentialSelect>(args: CreateArgs<S, CreateWebauthnCredentialInput["webauthnCredential"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("WebauthnCredential", "createWebauthnCredential", "webauthnCredential", args.select, args.data, "CreateWebauthnCredentialInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "WebauthnCredential",
  ...
  update<S extends WebauthnCredentialSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("WebauthnCredential", "updateWebauthnCredential", "webauthnCredential", args.select, args.where.id, args.data, "UpdateWebauthnCredentialInput", "id", "webauthnCredentialPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "WebauthnCredential",
  ...
  delete<S extends WebauthnCredentialSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("WebauthnCredential", "deleteWebauthnCredential", "webauthnCredential", {
      id: args.where.id
