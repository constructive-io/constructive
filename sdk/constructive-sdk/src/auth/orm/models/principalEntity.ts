...
import type { PrincipalEntity, PrincipalEntityWithRelations, PrincipalEntitySelect, PrincipalEntityFilter, PrincipalEntityOrderBy, CreatePrincipalEntityInput, UpdatePrincipalEntityInput, PrincipalEntityPatch } from "../input-types";
...
export class PrincipalEntityModel {
  ...
  findMany<S extends PrincipalEntitySelect>(args: FindManyArgs<S, PrincipalEntityFilter, PrincipalEntityOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("PrincipalEntity", "principalEntities", args.select, {
      where: args?.where,
  ...
  findFirst<S extends PrincipalEntitySelect>(args: FindFirstArgs<S, PrincipalEntityFilter, PrincipalEntityOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("PrincipalEntity", "principalEntities", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "PrincipalEntityFilter", "PrincipalEntityOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends PrincipalEntitySelect>(args: CreateArgs<S, CreatePrincipalEntityInput["principalEntity"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("PrincipalEntity", "createPrincipalEntity", "principalEntity", args.select, args.data, "CreatePrincipalEntityInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "PrincipalEntity",
  ...
  update<S extends PrincipalEntitySelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("PrincipalEntity", "updatePrincipalEntity", "principalEntity", args.select, args.where.id, args.data, "UpdatePrincipalEntityInput", "id", "principalEntityPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "PrincipalEntity",
  ...
  delete<S extends PrincipalEntitySelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("PrincipalEntity", "deletePrincipalEntity", "principalEntity", {
      id: args.where.id
