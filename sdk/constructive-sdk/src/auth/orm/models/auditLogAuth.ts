...
import type { AuditLogAuth, AuditLogAuthWithRelations, AuditLogAuthSelect, AuditLogAuthFilter, AuditLogAuthOrderBy, CreateAuditLogAuthInput, UpdateAuditLogAuthInput, AuditLogAuthPatch } from "../input-types";
...
export class AuditLogAuthModel {
  ...
  findMany<S extends AuditLogAuthSelect>(args: FindManyArgs<S, AuditLogAuthFilter, AuditLogAuthOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("AuditLogAuth", "auditLogAuths", args.select, {
      where: args?.where,
  ...
  findFirst<S extends AuditLogAuthSelect>(args: FindFirstArgs<S, AuditLogAuthFilter, AuditLogAuthOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("AuditLogAuth", "auditLogAuths", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "AuditLogAuthFilter", "AuditLogAuthOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends AuditLogAuthSelect>(args: CreateArgs<S, CreateAuditLogAuthInput["auditLogAuth"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AuditLogAuth", "createAuditLogAuth", "auditLogAuth", args.select, args.data, "CreateAuditLogAuthInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AuditLogAuth",
  ...
  update<S extends AuditLogAuthSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AuditLogAuth", "updateAuditLogAuth", "auditLogAuth", args.select, args.where.id, args.data, "UpdateAuditLogAuthInput", "id", "auditLogAuthPatch", connectionFieldsMap, {
  ...
  delete<S extends AuditLogAuthSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AuditLogAuth", "deleteAuditLogAuth", "auditLogAuth", {
      id: args.where.id,
      createdAt: args.where.createdAt
