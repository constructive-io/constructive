...
import type { OrgLimitWarning, OrgLimitWarningWithRelations, OrgLimitWarningSelect, OrgLimitWarningFilter, OrgLimitWarningOrderBy, CreateOrgLimitWarningInput, UpdateOrgLimitWarningInput, OrgLimitWarningPatch } from "../input-types";
...
export class OrgLimitWarningModel {
  ...
  findMany<S extends OrgLimitWarningSelect>(args: FindManyArgs<S, OrgLimitWarningFilter, OrgLimitWarningOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("OrgLimitWarning", "orgLimitWarnings", args.select, {
      where: args?.where,
  ...
  findFirst<S extends OrgLimitWarningSelect>(args: FindFirstArgs<S, OrgLimitWarningFilter, OrgLimitWarningOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("OrgLimitWarning", "orgLimitWarnings", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "OrgLimitWarningFilter", "OrgLimitWarningOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends OrgLimitWarningSelect>(args: CreateArgs<S, CreateOrgLimitWarningInput["orgLimitWarning"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("OrgLimitWarning", "createOrgLimitWarning", "orgLimitWarning", args.select, args.data, "CreateOrgLimitWarningInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgLimitWarning",
  ...
  update<S extends OrgLimitWarningSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("OrgLimitWarning", "updateOrgLimitWarning", "orgLimitWarning", args.select, args.where.id, args.data, "UpdateOrgLimitWarningInput", "id", "orgLimitWarningPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgLimitWarning",
  ...
  delete<S extends OrgLimitWarningSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("OrgLimitWarning", "deleteOrgLimitWarning", "orgLimitWarning", {
      id: args.where.id
