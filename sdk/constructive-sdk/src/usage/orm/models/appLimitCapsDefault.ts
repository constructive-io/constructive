...
import type { AppLimitCapsDefault, AppLimitCapsDefaultWithRelations, AppLimitCapsDefaultSelect, AppLimitCapsDefaultFilter, AppLimitCapsDefaultOrderBy, CreateAppLimitCapsDefaultInput, UpdateAppLimitCapsDefaultInput, AppLimitCapsDefaultPatch } from "../input-types";
...
export class AppLimitCapsDefaultModel {
  ...
  findMany<S extends AppLimitCapsDefaultSelect>(args: FindManyArgs<S, AppLimitCapsDefaultFilter, AppLimitCapsDefaultOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("AppLimitCapsDefault", "appLimitCapsDefaults", args.select, {
      where: args?.where,
  ...
  findFirst<S extends AppLimitCapsDefaultSelect>(args: FindFirstArgs<S, AppLimitCapsDefaultFilter, AppLimitCapsDefaultOrderBy> & {
    select: S;
  } & StrictSelect<S, AppLimitCapsDefaultSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("AppLimitCapsDefault", "appLimitCapsDefaults", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "AppLimitCapsDefaultFilter", "AppLimitCapsDefaultOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends AppLimitCapsDefaultSelect>(args: CreateArgs<S, CreateAppLimitCapsDefaultInput["appLimitCapsDefault"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AppLimitCapsDefault", "createAppLimitCapsDefault", "appLimitCapsDefault", args.select, args.data, "CreateAppLimitCapsDefaultInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppLimitCapsDefault",
  ...
  update<S extends AppLimitCapsDefaultSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AppLimitCapsDefault", "updateAppLimitCapsDefault", "appLimitCapsDefault", args.select, args.where.id, args.data, "UpdateAppLimitCapsDefaultInput", "id", "appLimitCapsDefaultPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppLimitCapsDefault",
  ...
  delete<S extends AppLimitCapsDefaultSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AppLimitCapsDefault", "deleteAppLimitCapsDefault", "appLimitCapsDefault", {
      id: args.where.id
