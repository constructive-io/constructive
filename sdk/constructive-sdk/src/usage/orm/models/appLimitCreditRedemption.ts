...
import type { AppLimitCreditRedemption, AppLimitCreditRedemptionWithRelations, AppLimitCreditRedemptionSelect, AppLimitCreditRedemptionFilter, AppLimitCreditRedemptionOrderBy, CreateAppLimitCreditRedemptionInput, UpdateAppLimitCreditRedemptionInput, AppLimitCreditRedemptionPatch } from "../input-types";
...
export class AppLimitCreditRedemptionModel {
  ...
  findMany<S extends AppLimitCreditRedemptionSelect>(args: FindManyArgs<S, AppLimitCreditRedemptionFilter, AppLimitCreditRedemptionOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("AppLimitCreditRedemption", "appLimitCreditRedemptions", args.select, {
      where: args?.where,
  ...
  findFirst<S extends AppLimitCreditRedemptionSelect>(args: FindFirstArgs<S, AppLimitCreditRedemptionFilter, AppLimitCreditRedemptionOrderBy> & {
    select: S;
  } & StrictSelect<S, AppLimitCreditRedemptionSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("AppLimitCreditRedemption", "appLimitCreditRedemptions", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "AppLimitCreditRedemptionFilter", "AppLimitCreditRedemptionOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends AppLimitCreditRedemptionSelect>(args: CreateArgs<S, CreateAppLimitCreditRedemptionInput["appLimitCreditRedemption"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AppLimitCreditRedemption", "createAppLimitCreditRedemption", "appLimitCreditRedemption", args.select, args.data, "CreateAppLimitCreditRedemptionInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppLimitCreditRedemption",
  ...
  update<S extends AppLimitCreditRedemptionSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AppLimitCreditRedemption", "updateAppLimitCreditRedemption", "appLimitCreditRedemption", args.select, args.where.id, args.data, "UpdateAppLimitCreditRedemptionInput", "id", "appLimitCreditRedemptionPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppLimitCreditRedemption",
  ...
  delete<S extends AppLimitCreditRedemptionSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AppLimitCreditRedemption", "deleteAppLimitCreditRedemption", "appLimitCreditRedemption", {
      id: args.where.id
