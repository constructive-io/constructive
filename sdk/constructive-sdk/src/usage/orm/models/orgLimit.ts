...
import type { OrgLimit, OrgLimitWithRelations, OrgLimitSelect, OrgLimitFilter, OrgLimitOrderBy, CreateOrgLimitInput, UpdateOrgLimitInput, OrgLimitPatch } from "../input-types";
...
export class OrgLimitModel {
  ...
  create<S extends OrgLimitSelect>(args: CreateArgs<S, CreateOrgLimitInput["orgLimit"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("OrgLimit", "createOrgLimit", "orgLimit", args.select, args.data, "CreateOrgLimitInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgLimit",
  ...
  update<S extends OrgLimitSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("OrgLimit", "updateOrgLimit", "orgLimit", args.select, args.where.id, args.data, "UpdateOrgLimitInput", "id", "orgLimitPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgLimit",
  ...
  delete<S extends OrgLimitSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("OrgLimit", "deleteOrgLimit", "orgLimit", {
      id: args.where.id
