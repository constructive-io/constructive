...
import type { OrgLimitCapsDefault, OrgLimitCapsDefaultWithRelations, OrgLimitCapsDefaultSelect, OrgLimitCapsDefaultFilter, OrgLimitCapsDefaultOrderBy, CreateOrgLimitCapsDefaultInput, UpdateOrgLimitCapsDefaultInput, OrgLimitCapsDefaultPatch } from "../input-types";
...
export class OrgLimitCapsDefaultModel {
  ...
  findMany<S extends OrgLimitCapsDefaultSelect>(args: FindManyArgs<S, OrgLimitCapsDefaultFilter, OrgLimitCapsDefaultOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("OrgLimitCapsDefault", "orgLimitCapsDefaults", args.select, {
      where: args?.where,
  ...
  findFirst<S extends OrgLimitCapsDefaultSelect>(args: FindFirstArgs<S, OrgLimitCapsDefaultFilter, OrgLimitCapsDefaultOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("OrgLimitCapsDefault", "orgLimitCapsDefaults", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "OrgLimitCapsDefaultFilter", "OrgLimitCapsDefaultOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends OrgLimitCapsDefaultSelect>(args: CreateArgs<S, CreateOrgLimitCapsDefaultInput["orgLimitCapsDefault"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("OrgLimitCapsDefault", "createOrgLimitCapsDefault", "orgLimitCapsDefault", args.select, args.data, "CreateOrgLimitCapsDefaultInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgLimitCapsDefault",
  ...
  update<S extends OrgLimitCapsDefaultSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("OrgLimitCapsDefault", "updateOrgLimitCapsDefault", "orgLimitCapsDefault", args.select, args.where.id, args.data, "UpdateOrgLimitCapsDefaultInput", "id", "orgLimitCapsDefaultPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgLimitCapsDefault",
  ...
  delete<S extends OrgLimitCapsDefaultSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("OrgLimitCapsDefault", "deleteOrgLimitCapsDefault", "orgLimitCapsDefault", {
      id: args.where.id
