...
import type { AppPermission, AppPermissionWithRelations, AppPermissionSelect, AppPermissionFilter, AppPermissionOrderBy, CreateAppPermissionInput, UpdateAppPermissionInput, AppPermissionPatch } from "../input-types";
...
export class AppPermissionModel {
  ...
  create<S extends AppPermissionSelect>(args: CreateArgs<S, CreateAppPermissionInput["appPermission"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AppPermission", "createAppPermission", "appPermission", args.select, args.data, "CreateAppPermissionInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppPermission",
  ...
  update<S extends AppPermissionSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AppPermission", "updateAppPermission", "appPermission", args.select, args.where.id, args.data, "UpdateAppPermissionInput", "id", "appPermissionPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppPermission",
  ...
  delete<S extends AppPermissionSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AppPermission", "deleteAppPermission", "appPermission", {
      id: args.where.id
