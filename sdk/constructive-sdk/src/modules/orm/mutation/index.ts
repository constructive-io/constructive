...
import type { ConstructBlueprintInput, CopyTemplateToBlueprintInput, ProvisionBucketInput, ProvisionCheckConstraintInput, ProvisionFullTextSearchInput, ProvisionIndexInput, ProvisionRelationInput, ProvisionSpatialRelationInput, ProvisionTableInput, ProvisionUniqueConstraintInput, ConstructBlueprintPayload, CopyTemplateToBlueprintPayload, ProvisionBucketPayload, ProvisionCheckConstraintPayload, ProvisionFullTextSearchPayload, ProvisionIndexPayload, ProvisionRelationPayload, ProvisionSpatialRelationPayload, ProvisionTablePayload, ProvisionUniqueConstraintPayload, ConstructBlueprintPayloadSelect, CopyTemplateToBlueprintPayloadSelect, ProvisionBucketPayloadSelect, ProvisionCheckConstraintPayloadSelect, ProvisionFullTextSearchPayloadSelect, ProvisionIndexPayloadSelect, ProvisionRelationPayloadSelect, ProvisionSpatialRelationPayloadSelect, ProvisionTablePayloadSelect, ProvisionUniqueConstraintPayloadSelect } from "../input-types";
...
export function createMutationOperations(client: OrmClient) {
  return {
    constructBlueprint: <S extends ConstructBlueprintPayloadSelect,>(args: ConstructBlueprintVariables, options: {
      select: S;
    } & StrictSelect<S, ConstructBlueprintPayloadSelect>) => new QueryBuilder<{
    ...
    copyTemplateToBlueprint: <S extends CopyTemplateToBlueprintPayloadSelect,>(args: CopyTemplateToBlueprintVariables, options: {
      select: S;
    } & StrictSelect<S, CopyTemplateToBlueprintPayloadSelect>) => new QueryBuilder<{
    ...
    provisionCheckConstraint: <S extends ProvisionCheckConstraintPayloadSelect,>(args: ProvisionCheckConstraintVariables, options: {
      select: S;
    } & StrictSelect<S, ProvisionCheckConstraintPayloadSelect>) => new QueryBuilder<{
    ...
    provisionFullTextSearch: <S extends ProvisionFullTextSearchPayloadSelect,>(args: ProvisionFullTextSearchVariables, options: {
      select: S;
    } & StrictSelect<S, ProvisionFullTextSearchPayloadSelect>) => new QueryBuilder<{
    ...
    provisionIndex: <S extends ProvisionIndexPayloadSelect,>(args: ProvisionIndexVariables, options: {
      select: S;
    } & StrictSelect<S, ProvisionIndexPayloadSelect>) => new QueryBuilder<{
    ...
    provisionRelation: <S extends ProvisionRelationPayloadSelect,>(args: ProvisionRelationVariables, options: {
      select: S;
    } & StrictSelect<S, ProvisionRelationPayloadSelect>) => new QueryBuilder<{
    ...
    provisionSpatialRelation: <S extends ProvisionSpatialRelationPayloadSelect,>(args: ProvisionSpatialRelationVariables, options: {
      select: S;
    } & StrictSelect<S, ProvisionSpatialRelationPayloadSelect>) => new QueryBuilder<{
    ...
    provisionTable: <S extends ProvisionTablePayloadSelect,>(args: ProvisionTableVariables, options: {
      select: S;
    } & StrictSelect<S, ProvisionTablePayloadSelect>) => new QueryBuilder<{
    ...
    provisionUniqueConstraint: <S extends ProvisionUniqueConstraintPayloadSelect,>(args: ProvisionUniqueConstraintVariables, options: {
      select: S;
    } & StrictSelect<S, ProvisionUniqueConstraintPayloadSelect>) => new QueryBuilder<{
