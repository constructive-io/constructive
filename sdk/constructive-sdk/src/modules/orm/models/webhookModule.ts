...
import type { WebhookModule, WebhookModuleWithRelations, WebhookModuleSelect, WebhookModuleFilter, WebhookModuleOrderBy, CreateWebhookModuleInput, UpdateWebhookModuleInput, WebhookModulePatch } from "../input-types";
...
export class WebhookModuleModel {
  ...
  findMany<S extends WebhookModuleSelect>(args: FindManyArgs<S, WebhookModuleFilter, WebhookModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("WebhookModule", "webhookModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends WebhookModuleSelect>(args: FindFirstArgs<S, WebhookModuleFilter, WebhookModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("WebhookModule", "webhookModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "WebhookModuleFilter", "WebhookModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends WebhookModuleSelect>(args: CreateArgs<S, CreateWebhookModuleInput["webhookModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("WebhookModule", "createWebhookModule", "webhookModule", args.select, args.data, "CreateWebhookModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "WebhookModule",
  ...
  update<S extends WebhookModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("WebhookModule", "updateWebhookModule", "webhookModule", args.select, args.where.id, args.data, "UpdateWebhookModuleInput", "id", "webhookModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "WebhookModule",
  ...
  delete<S extends WebhookModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("WebhookModule", "deleteWebhookModule", "webhookModule", {
      id: args.where.id
