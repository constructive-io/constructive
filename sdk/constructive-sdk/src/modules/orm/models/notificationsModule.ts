...
import type { NotificationsModule, NotificationsModuleWithRelations, NotificationsModuleSelect, NotificationsModuleFilter, NotificationsModuleOrderBy, CreateNotificationsModuleInput, UpdateNotificationsModuleInput, NotificationsModulePatch } from "../input-types";
...
export class NotificationsModuleModel {
  ...
  findMany<S extends NotificationsModuleSelect>(args: FindManyArgs<S, NotificationsModuleFilter, NotificationsModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("NotificationsModule", "notificationsModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends NotificationsModuleSelect>(args: FindFirstArgs<S, NotificationsModuleFilter, NotificationsModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("NotificationsModule", "notificationsModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "NotificationsModuleFilter", "NotificationsModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends NotificationsModuleSelect>(args: CreateArgs<S, CreateNotificationsModuleInput["notificationsModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("NotificationsModule", "createNotificationsModule", "notificationsModule", args.select, args.data, "CreateNotificationsModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "NotificationsModule",
  ...
  update<S extends NotificationsModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("NotificationsModule", "updateNotificationsModule", "notificationsModule", args.select, args.where.id, args.data, "UpdateNotificationsModuleInput", "id", "notificationsModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "NotificationsModule",
  ...
  delete<S extends NotificationsModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("NotificationsModule", "deleteNotificationsModule", "notificationsModule", {
      id: args.where.id
