...
import type { InfraConfigModule, InfraConfigModuleWithRelations, InfraConfigModuleSelect, InfraConfigModuleFilter, InfraConfigModuleOrderBy, CreateInfraConfigModuleInput, UpdateInfraConfigModuleInput, InfraConfigModulePatch } from "../input-types";
...
export class InfraConfigModuleModel {
  ...
  findMany<S extends InfraConfigModuleSelect>(args: FindManyArgs<S, InfraConfigModuleFilter, InfraConfigModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("InfraConfigModule", "infraConfigModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends InfraConfigModuleSelect>(args: FindFirstArgs<S, InfraConfigModuleFilter, InfraConfigModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("InfraConfigModule", "infraConfigModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "InfraConfigModuleFilter", "InfraConfigModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends InfraConfigModuleSelect>(args: CreateArgs<S, CreateInfraConfigModuleInput["infraConfigModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("InfraConfigModule", "createInfraConfigModule", "infraConfigModule", args.select, args.data, "CreateInfraConfigModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "InfraConfigModule",
  ...
  update<S extends InfraConfigModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("InfraConfigModule", "updateInfraConfigModule", "infraConfigModule", args.select, args.where.id, args.data, "UpdateInfraConfigModuleInput", "id", "infraConfigModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "InfraConfigModule",
  ...
  delete<S extends InfraConfigModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("InfraConfigModule", "deleteInfraConfigModule", "infraConfigModule", {
      id: args.where.id
