...
import type { WebauthnAuthModule, WebauthnAuthModuleWithRelations, WebauthnAuthModuleSelect, WebauthnAuthModuleFilter, WebauthnAuthModuleOrderBy, CreateWebauthnAuthModuleInput, UpdateWebauthnAuthModuleInput, WebauthnAuthModulePatch } from "../input-types";
...
export class WebauthnAuthModuleModel {
  ...
  findMany<S extends WebauthnAuthModuleSelect>(args: FindManyArgs<S, WebauthnAuthModuleFilter, WebauthnAuthModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("WebauthnAuthModule", "webauthnAuthModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends WebauthnAuthModuleSelect>(args: FindFirstArgs<S, WebauthnAuthModuleFilter, WebauthnAuthModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("WebauthnAuthModule", "webauthnAuthModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "WebauthnAuthModuleFilter", "WebauthnAuthModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends WebauthnAuthModuleSelect>(args: CreateArgs<S, CreateWebauthnAuthModuleInput["webauthnAuthModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("WebauthnAuthModule", "createWebauthnAuthModule", "webauthnAuthModule", args.select, args.data, "CreateWebauthnAuthModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "WebauthnAuthModule",
  ...
  update<S extends WebauthnAuthModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("WebauthnAuthModule", "updateWebauthnAuthModule", "webauthnAuthModule", args.select, args.where.id, args.data, "UpdateWebauthnAuthModuleInput", "id", "webauthnAuthModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "WebauthnAuthModule",
  ...
  delete<S extends WebauthnAuthModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("WebauthnAuthModule", "deleteWebauthnAuthModule", "webauthnAuthModule", {
      id: args.where.id
