...
import type { EventsModule, EventsModuleWithRelations, EventsModuleSelect, EventsModuleFilter, EventsModuleOrderBy, CreateEventsModuleInput, UpdateEventsModuleInput, EventsModulePatch } from "../input-types";
...
export class EventsModuleModel {
  ...
  findMany<S extends EventsModuleSelect>(args: FindManyArgs<S, EventsModuleFilter, EventsModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("EventsModule", "eventsModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends EventsModuleSelect>(args: FindFirstArgs<S, EventsModuleFilter, EventsModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("EventsModule", "eventsModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "EventsModuleFilter", "EventsModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends EventsModuleSelect>(args: CreateArgs<S, CreateEventsModuleInput["eventsModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("EventsModule", "createEventsModule", "eventsModule", args.select, args.data, "CreateEventsModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "EventsModule",
  ...
  update<S extends EventsModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("EventsModule", "updateEventsModule", "eventsModule", args.select, args.where.id, args.data, "UpdateEventsModuleInput", "id", "eventsModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "EventsModule",
  ...
  delete<S extends EventsModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("EventsModule", "deleteEventsModule", "eventsModule", {
      id: args.where.id
