...
export class IntegrationProvidersModuleModel {
  ...
  findMany<S extends IntegrationProvidersModuleSelect>(args: FindManyArgs<S, IntegrationProvidersModuleFilter, IntegrationProvidersModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("IntegrationProvidersModule", "integrationProvidersModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends IntegrationProvidersModuleSelect>(args: FindFirstArgs<S, IntegrationProvidersModuleFilter, IntegrationProvidersModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("IntegrationProvidersModule", "integrationProvidersModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "IntegrationProvidersModuleFilter", "IntegrationProvidersModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends IntegrationProvidersModuleSelect>(args: CreateArgs<S, CreateIntegrationProvidersModuleInput["integrationProvidersModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("IntegrationProvidersModule", "createIntegrationProvidersModule", "integrationProvidersModule", args.select, args.data, "CreateIntegrationProvidersModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "IntegrationProvidersModule",
  ...
  update<S extends IntegrationProvidersModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("IntegrationProvidersModule", "updateIntegrationProvidersModule", "integrationProvidersModule", args.select, args.where.id, args.data, "UpdateIntegrationProvidersModuleInput", "id", "integrationProvidersModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "IntegrationProvidersModule",
  ...
  delete<S extends IntegrationProvidersModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("IntegrationProvidersModule", "deleteIntegrationProvidersModule", "integrationProvidersModule", {
      id: args.where.id
