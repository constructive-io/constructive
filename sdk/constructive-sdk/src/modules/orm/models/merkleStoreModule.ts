...
import type { MerkleStoreModule, MerkleStoreModuleWithRelations, MerkleStoreModuleSelect, MerkleStoreModuleFilter, MerkleStoreModuleOrderBy, CreateMerkleStoreModuleInput, UpdateMerkleStoreModuleInput, MerkleStoreModulePatch } from "../input-types";
...
export class MerkleStoreModuleModel {
  ...
  findMany<S extends MerkleStoreModuleSelect>(args: FindManyArgs<S, MerkleStoreModuleFilter, MerkleStoreModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("MerkleStoreModule", "merkleStoreModules", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "MerkleStoreModuleFilter", "MerkleStoreModuleOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends MerkleStoreModuleSelect>(args: FindFirstArgs<S, MerkleStoreModuleFilter, MerkleStoreModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("MerkleStoreModule", "merkleStoreModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "MerkleStoreModuleFilter", "MerkleStoreModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends MerkleStoreModuleSelect>(args: CreateArgs<S, CreateMerkleStoreModuleInput["merkleStoreModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("MerkleStoreModule", "createMerkleStoreModule", "merkleStoreModule", args.select, args.data, "CreateMerkleStoreModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "MerkleStoreModule",
  ...
  update<S extends MerkleStoreModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("MerkleStoreModule", "updateMerkleStoreModule", "merkleStoreModule", args.select, args.where.id, args.data, "UpdateMerkleStoreModuleInput", "id", "merkleStoreModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "MerkleStoreModule",
  ...
  delete<S extends MerkleStoreModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("MerkleStoreModule", "deleteMerkleStoreModule", "merkleStoreModule", {
      id: args.where.id
    }, "DeleteMerkleStoreModuleInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "MerkleStoreModule",
