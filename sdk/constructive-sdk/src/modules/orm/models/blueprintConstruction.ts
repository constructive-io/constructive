...
import type { BlueprintConstruction, BlueprintConstructionWithRelations, BlueprintConstructionSelect, BlueprintConstructionFilter, BlueprintConstructionOrderBy, CreateBlueprintConstructionInput, UpdateBlueprintConstructionInput, BlueprintConstructionPatch } from "../input-types";
...
export class BlueprintConstructionModel {
  ...
  findMany<S extends BlueprintConstructionSelect>(args: FindManyArgs<S, BlueprintConstructionFilter, BlueprintConstructionOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("BlueprintConstruction", "blueprintConstructions", args.select, {
      where: args?.where,
  ...
  findFirst<S extends BlueprintConstructionSelect>(args: FindFirstArgs<S, BlueprintConstructionFilter, BlueprintConstructionOrderBy> & {
    select: S;
  } & StrictSelect<S, BlueprintConstructionSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("BlueprintConstruction", "blueprintConstructions", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "BlueprintConstructionFilter", "BlueprintConstructionOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends BlueprintConstructionSelect>(args: CreateArgs<S, CreateBlueprintConstructionInput["blueprintConstruction"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("BlueprintConstruction", "createBlueprintConstruction", "blueprintConstruction", args.select, args.data, "CreateBlueprintConstructionInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "BlueprintConstruction",
  ...
  update<S extends BlueprintConstructionSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("BlueprintConstruction", "updateBlueprintConstruction", "blueprintConstruction", args.select, args.where.id, args.data, "UpdateBlueprintConstructionInput", "id", "blueprintConstructionPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "BlueprintConstruction",
  ...
  delete<S extends BlueprintConstructionSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("BlueprintConstruction", "deleteBlueprintConstruction", "blueprintConstruction", {
      id: args.where.id
