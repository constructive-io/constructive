...
import type { BlueprintTemplate, BlueprintTemplateWithRelations, BlueprintTemplateSelect, BlueprintTemplateFilter, BlueprintTemplateOrderBy, CreateBlueprintTemplateInput, UpdateBlueprintTemplateInput, BlueprintTemplatePatch } from "../input-types";
...
export class BlueprintTemplateModel {
  ...
  findMany<S extends BlueprintTemplateSelect>(args: FindManyArgs<S, BlueprintTemplateFilter, BlueprintTemplateOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("BlueprintTemplate", "blueprintTemplates", args.select, {
      where: args?.where,
  ...
  findFirst<S extends BlueprintTemplateSelect>(args: FindFirstArgs<S, BlueprintTemplateFilter, BlueprintTemplateOrderBy> & {
    select: S;
  } & StrictSelect<S, BlueprintTemplateSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("BlueprintTemplate", "blueprintTemplates", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "BlueprintTemplateFilter", "BlueprintTemplateOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends BlueprintTemplateSelect>(args: CreateArgs<S, CreateBlueprintTemplateInput["blueprintTemplate"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("BlueprintTemplate", "createBlueprintTemplate", "blueprintTemplate", args.select, args.data, "CreateBlueprintTemplateInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "BlueprintTemplate",
  ...
  update<S extends BlueprintTemplateSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("BlueprintTemplate", "updateBlueprintTemplate", "blueprintTemplate", args.select, args.where.id, args.data, "UpdateBlueprintTemplateInput", "id", "blueprintTemplatePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "BlueprintTemplate",
  ...
  delete<S extends BlueprintTemplateSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("BlueprintTemplate", "deleteBlueprintTemplate", "blueprintTemplate", {
      id: args.where.id
