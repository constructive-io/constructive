...
import type { FunctionGraphCommit, FunctionGraphCommitWithRelations, FunctionGraphCommitSelect, FunctionGraphCommitFilter, FunctionGraphCommitOrderBy, CreateFunctionGraphCommitInput, UpdateFunctionGraphCommitInput, FunctionGraphCommitPatch } from "../input-types";
...
export class FunctionGraphCommitModel {
  ...
  findMany<S extends FunctionGraphCommitSelect>(args: FindManyArgs<S, FunctionGraphCommitFilter, FunctionGraphCommitOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("FunctionGraphCommit", "functionGraphCommits", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "FunctionGraphCommitFilter", "FunctionGraphCommitOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends FunctionGraphCommitSelect>(args: FindFirstArgs<S, FunctionGraphCommitFilter, FunctionGraphCommitOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("FunctionGraphCommit", "functionGraphCommits", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "FunctionGraphCommitFilter", "FunctionGraphCommitOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends FunctionGraphCommitSelect>(args: CreateArgs<S, CreateFunctionGraphCommitInput["functionGraphCommit"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("FunctionGraphCommit", "createFunctionGraphCommit", "functionGraphCommit", args.select, args.data, "CreateFunctionGraphCommitInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "FunctionGraphCommit",
  ...
  update<S extends FunctionGraphCommitSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("FunctionGraphCommit", "updateFunctionGraphCommit", "functionGraphCommit", args.select, args.where.id, args.data, "UpdateFunctionGraphCommitInput", "id", "functionGraphCommitPatch", connectionFieldsMap, {
  ...
  delete<S extends FunctionGraphCommitSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("FunctionGraphCommit", "deleteFunctionGraphCommit", "functionGraphCommit", {
      id: args.where.id,
      scopeId: args.where.scopeId
    }, "DeleteFunctionGraphCommitInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "FunctionGraphCommit",
