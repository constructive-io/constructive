...
import type { FunctionGraph, FunctionGraphWithRelations, FunctionGraphSelect, FunctionGraphFilter, FunctionGraphOrderBy, CreateFunctionGraphInput, UpdateFunctionGraphInput, FunctionGraphPatch } from "../input-types";
...
export class FunctionGraphModel {
  ...
  findMany<S extends FunctionGraphSelect>(args: FindManyArgs<S, FunctionGraphFilter, FunctionGraphOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("FunctionGraph", "functionGraphs", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "FunctionGraphFilter", "FunctionGraphOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends FunctionGraphSelect>(args: FindFirstArgs<S, FunctionGraphFilter, FunctionGraphOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("FunctionGraph", "functionGraphs", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "FunctionGraphFilter", "FunctionGraphOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends FunctionGraphSelect>(args: CreateArgs<S, CreateFunctionGraphInput["functionGraph"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("FunctionGraph", "createFunctionGraph", "functionGraph", args.select, args.data, "CreateFunctionGraphInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "FunctionGraph",
  ...
  update<S extends FunctionGraphSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("FunctionGraph", "updateFunctionGraph", "functionGraph", args.select, args.where.id, args.data, "UpdateFunctionGraphInput", "id", "functionGraphPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "FunctionGraph",
  ...
  delete<S extends FunctionGraphSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("FunctionGraph", "deleteFunctionGraph", "functionGraph", {
      id: args.where.id
    }, "DeleteFunctionGraphInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "FunctionGraph",
