...
import type {
  ...
  SuspendDatabaseInput,
  UnsuspendDatabaseInput,
...
export interface SuspendDatabaseVariables {
  input: SuspendDatabaseInput;
}
export interface UnsuspendDatabaseVariables {
  input: UnsuspendDatabaseInput;
}
export function createMutationOperations(client: OrmClient) {
  return {
    ...
    suspendDatabase: <S extends SuspendDatabasePayloadSelect>(
      args: SuspendDatabaseVariables,
      options: {
        select: S;
      ...
      new QueryBuilder<{
        ...
        client,
        operation: 'mutation',
        operationName: 'SuspendDatabase',
        fieldName: 'suspendDatabase',
        ...buildCustomDocument(
          'mutation',
          'SuspendDatabase',
          'suspendDatabase',
    ...
    unsuspendDatabase: <S extends UnsuspendDatabasePayloadSelect>(
      args: UnsuspendDatabaseVariables,
      options: {
        select: S;
      ...
      new QueryBuilder<{
        ...
        client,
        operation: 'mutation',
        operationName: 'UnsuspendDatabase',
        fieldName: 'unsuspendDatabase',
        ...buildCustomDocument(
          'mutation',
          'UnsuspendDatabase',
          'unsuspendDatabase',
