...
export interface DatabaseSetting {
  ...
  createdAt?: string | null;
  /** How many universal credits one cent buys; 1 = credits are cents. Changing it re-prices credit packs, plan allowances and leaf credit_cost; the ledger stays denominated in credits. */
  ...
  enableI18N?: boolean | null;
  /** Enable GraphQL schema introspection queries in the GraphQL API. A tenant may only ever lower a bound, so the stored default is the permissive end: turning introspection off is the opt-in. */
  enableIntrospection?: boolean | null;
...
export interface Function {
  ...
  bodyAst?: Record<string, unknown> | null;
  category?: ObjectCategory | null;
...
export interface Trigger {
  ...
  timing?: string | null;
  updatedAt?: string | null;
  whenAst?: Record<string, unknown> | null;
}
...
export type ApiSettingSelect = {
  ...
  id?: boolean;
  idleInTransactionTimeoutMs?: boolean;
  lockTimeoutMs?: boolean;
  maxConcurrentRequests?: boolean;
  maxPageSize?: boolean;
  maxQueryCost?: boolean;
  maxQueryDepth?: boolean;
  maxQueueWaitMs?: boolean;
  maxRequestBytes?: boolean;
  options?: boolean;
  rateLimitBurst?: boolean;
...
export interface DatabaseSettingFilter {
  ...
  /** Filter by the object’s `createdAt` field. */
  createdAt?: DatetimeFilter;
  /** Filter by the object’s `creditsPerCent` field. */
  creditsPerCent?: IntFilter;
  /** Filter by the object’s `databaseId` field. */
  databaseId?: UUIDFilter;
  /** Filter by the object’s `enableAggregates` field. */
  enableAggregates?: BooleanFilter;
...
export interface EmbeddingChunkFilter {
  ...
  /** Filter by the object’s `sourceFields` field. */
  sourceFields?: JSONFilter;
  /** Filter by the object’s `table` relation. */
  table?: TableFilter;
  /** Filter by the object’s `tableId` field. */
  tableId?: UUIDFilter;
...
export interface IndexFilter {
  ...
  /** Negates the expression. */
  not?: IndexFilter;
  /** Filter by the object’s `nullsNotDistinct` field. */
  nullsNotDistinct?: BooleanFilter;
...
export type DatabaseSettingOrderBy =
  ...
  | 'CREATED_AT_ASC'
  | 'CREATED_AT_DESC'
  | 'CREDITS_PER_CENT_ASC'
  | 'CREDITS_PER_CENT_DESC'
  | 'DATABASE_ID_ASC'
  | 'DATABASE_ID_DESC'
  | 'ENABLE_AGGREGATES_ASC'
  | 'ENABLE_AGGREGATES_DESC'
...
export type IndexOrderBy =
  ...
  | 'NAME_DESC'
  | 'NATURAL'
  | 'NULLS_NOT_DISTINCT_ASC'
  | 'NULLS_NOT_DISTINCT_DESC'
  | 'OPTIONS_ASC'
  | 'OPTIONS_DESC'
  | 'OP_CLASSES_ASC'
  | 'OP_CLASSES_DESC'
...
export interface SuspendDatabaseInput {
  clientMutationId?: string;
  databaseId?: string;
  reason?: string;
}
export interface UnsuspendDatabaseInput {
  clientMutationId?: string;
  databaseId?: string;
  reason?: string;
}
...
export interface SuspendDatabasePayload {
  clientMutationId?: string | null;
  databaseEdge?: DatabaseEdge | null;
  result?: Database | null;
}
export type SuspendDatabasePayloadSelect = {
  clientMutationId?: boolean;
  databaseEdge?: {
...
export interface UnsuspendDatabasePayload {
  clientMutationId?: string | null;
  databaseEdge?: DatabaseEdge | null;
  result?: Database | null;
}
export type UnsuspendDatabasePayloadSelect = {
  clientMutationId?: boolean;
  databaseEdge?: {
    select: DatabaseEdgeSelect;
  };
