...
import type { ApiSchema, ApiSchemaWithRelations, ApiSchemaSelect, ApiSchemaFilter, ApiSchemaOrderBy, CreateApiSchemaInput, UpdateApiSchemaInput, ApiSchemaPatch } from "../input-types";
...
export class ApiSchemaModel {
  ...
  create<S extends ApiSchemaSelect>(args: CreateArgs<S, CreateApiSchemaInput["apiSchema"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("ApiSchema", "createApiSchema", "apiSchema", args.select, args.data, "CreateApiSchemaInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ApiSchema",
  ...
  update<S extends ApiSchemaSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("ApiSchema", "updateApiSchema", "apiSchema", args.select, args.where.id, args.data, "UpdateApiSchemaInput", "id", "apiSchemaPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ApiSchema",
  ...
  delete<S extends ApiSchemaSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("ApiSchema", "deleteApiSchema", "apiSchema", {
      id: args.where.id
