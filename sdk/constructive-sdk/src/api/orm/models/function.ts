...
import type { Function, FunctionWithRelations, FunctionSelect, FunctionFilter, FunctionOrderBy, CreateFunctionInput, UpdateFunctionInput, FunctionPatch } from "../input-types";
...
export class FunctionModel {
  ...
  findMany<S extends FunctionSelect>(args: FindManyArgs<S, FunctionFilter, FunctionOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("Function", "functions", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "FunctionFilter", "FunctionOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends FunctionSelect>(args: FindFirstArgs<S, FunctionFilter, FunctionOrderBy> & {
    select: S;
  } & StrictSelect<S, FunctionSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("Function", "functions", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "FunctionFilter", "FunctionOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends FunctionSelect>(args: CreateArgs<S, CreateFunctionInput["function"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("Function", "createFunction", "function", args.select, args.data, "CreateFunctionInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "Function",
  ...
  update<S extends FunctionSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("Function", "updateFunction", "function", args.select, args.where.id, args.data, "UpdateFunctionInput", "id", "functionPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "Function",
  ...
  delete<S extends FunctionSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("Function", "deleteFunction", "function", {
      id: args.where.id
    }, "DeleteFunctionInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "Function",
