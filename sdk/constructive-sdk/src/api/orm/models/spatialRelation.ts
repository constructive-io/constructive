...
import type { SpatialRelation, SpatialRelationWithRelations, SpatialRelationSelect, SpatialRelationFilter, SpatialRelationOrderBy, CreateSpatialRelationInput, UpdateSpatialRelationInput, SpatialRelationPatch } from "../input-types";
...
export class SpatialRelationModel {
  ...
  findMany<S extends SpatialRelationSelect>(args: FindManyArgs<S, SpatialRelationFilter, SpatialRelationOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("SpatialRelation", "spatialRelations", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "SpatialRelationFilter", "SpatialRelationOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends SpatialRelationSelect>(args: FindFirstArgs<S, SpatialRelationFilter, SpatialRelationOrderBy> & {
    select: S;
  } & StrictSelect<S, SpatialRelationSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("SpatialRelation", "spatialRelations", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "SpatialRelationFilter", "SpatialRelationOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends SpatialRelationSelect>(args: CreateArgs<S, CreateSpatialRelationInput["spatialRelation"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("SpatialRelation", "createSpatialRelation", "spatialRelation", args.select, args.data, "CreateSpatialRelationInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "SpatialRelation",
  ...
  update<S extends SpatialRelationSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("SpatialRelation", "updateSpatialRelation", "spatialRelation", args.select, args.where.id, args.data, "UpdateSpatialRelationInput", "id", "spatialRelationPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "SpatialRelation",
  ...
  delete<S extends SpatialRelationSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("SpatialRelation", "deleteSpatialRelation", "spatialRelation", {
      id: args.where.id
    }, "DeleteSpatialRelationInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "SpatialRelation",
