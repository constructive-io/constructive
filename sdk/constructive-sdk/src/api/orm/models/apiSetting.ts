...
import type { ApiSetting, ApiSettingWithRelations, ApiSettingSelect, ApiSettingFilter, ApiSettingOrderBy, CreateApiSettingInput, UpdateApiSettingInput, ApiSettingPatch } from "../input-types";
...
export class ApiSettingModel {
  ...
  findMany<S extends ApiSettingSelect>(args: FindManyArgs<S, ApiSettingFilter, ApiSettingOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("ApiSetting", "apiSettings", args.select, {
      where: args?.where,
  ...
  findFirst<S extends ApiSettingSelect>(args: FindFirstArgs<S, ApiSettingFilter, ApiSettingOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("ApiSetting", "apiSettings", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "ApiSettingFilter", "ApiSettingOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends ApiSettingSelect>(args: CreateArgs<S, CreateApiSettingInput["apiSetting"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("ApiSetting", "createApiSetting", "apiSetting", args.select, args.data, "CreateApiSettingInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ApiSetting",
  ...
  update<S extends ApiSettingSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("ApiSetting", "updateApiSetting", "apiSetting", args.select, args.where.id, args.data, "UpdateApiSettingInput", "id", "apiSettingPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ApiSetting",
  ...
  delete<S extends ApiSettingSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("ApiSetting", "deleteApiSetting", "apiSetting", {
      id: args.where.id
