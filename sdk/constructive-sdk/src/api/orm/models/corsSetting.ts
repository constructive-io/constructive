...
import type { CorsSetting, CorsSettingWithRelations, CorsSettingSelect, CorsSettingFilter, CorsSettingOrderBy, CreateCorsSettingInput, UpdateCorsSettingInput, CorsSettingPatch } from "../input-types";
...
export class CorsSettingModel {
  ...
  findMany<S extends CorsSettingSelect>(args: FindManyArgs<S, CorsSettingFilter, CorsSettingOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("CorsSetting", "corsSettings", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "CorsSettingFilter", "CorsSettingOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends CorsSettingSelect>(args: FindFirstArgs<S, CorsSettingFilter, CorsSettingOrderBy> & {
    select: S;
  } & StrictSelect<S, CorsSettingSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("CorsSetting", "corsSettings", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "CorsSettingFilter", "CorsSettingOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends CorsSettingSelect>(args: CreateArgs<S, CreateCorsSettingInput["corsSetting"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("CorsSetting", "createCorsSetting", "corsSetting", args.select, args.data, "CreateCorsSettingInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "CorsSetting",
  ...
  update<S extends CorsSettingSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("CorsSetting", "updateCorsSetting", "corsSetting", args.select, args.where.id, args.data, "UpdateCorsSettingInput", "id", "corsSettingPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "CorsSetting",
  ...
  delete<S extends CorsSettingSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("CorsSetting", "deleteCorsSetting", "corsSetting", {
      id: args.where.id
    }, "DeleteCorsSettingInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "CorsSetting",
