...
import type { CompositeType, CompositeTypeWithRelations, CompositeTypeSelect, CompositeTypeFilter, CompositeTypeOrderBy, CreateCompositeTypeInput, UpdateCompositeTypeInput, CompositeTypePatch } from "../input-types";
...
export class CompositeTypeModel {
  ...
  findMany<S extends CompositeTypeSelect>(args: FindManyArgs<S, CompositeTypeFilter, CompositeTypeOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("CompositeType", "compositeTypes", args.select, {
      where: args?.where,
  ...
  findFirst<S extends CompositeTypeSelect>(args: FindFirstArgs<S, CompositeTypeFilter, CompositeTypeOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("CompositeType", "compositeTypes", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "CompositeTypeFilter", "CompositeTypeOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends CompositeTypeSelect>(args: CreateArgs<S, CreateCompositeTypeInput["compositeType"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("CompositeType", "createCompositeType", "compositeType", args.select, args.data, "CreateCompositeTypeInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "CompositeType",
  ...
  update<S extends CompositeTypeSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("CompositeType", "updateCompositeType", "compositeType", args.select, args.where.id, args.data, "UpdateCompositeTypeInput", "id", "compositeTypePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "CompositeType",
  ...
  delete<S extends CompositeTypeSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("CompositeType", "deleteCompositeType", "compositeType", {
      id: args.where.id
