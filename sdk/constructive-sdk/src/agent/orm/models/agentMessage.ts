...
import type { AgentMessage, AgentMessageWithRelations, AgentMessageSelect, AgentMessageFilter, AgentMessageOrderBy, CreateAgentMessageInput, UpdateAgentMessageInput, AgentMessagePatch } from "../input-types";
...
export class AgentMessageModel {
  ...
  findMany<S extends AgentMessageSelect>(args: FindManyArgs<S, AgentMessageFilter, AgentMessageOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("AgentMessage", "agentMessages", args.select, {
      where: args?.where,
  ...
  findFirst<S extends AgentMessageSelect>(args: FindFirstArgs<S, AgentMessageFilter, AgentMessageOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("AgentMessage", "agentMessages", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "AgentMessageFilter", "AgentMessageOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends AgentMessageSelect>(args: CreateArgs<S, CreateAgentMessageInput["agentMessage"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AgentMessage", "createAgentMessage", "agentMessage", args.select, args.data, "CreateAgentMessageInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AgentMessage",
  ...
  update<S extends AgentMessageSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AgentMessage", "updateAgentMessage", "agentMessage", args.select, args.where.id, args.data, "UpdateAgentMessageInput", "id", "agentMessagePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AgentMessage",
  ...
  delete<S extends AgentMessageSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AgentMessage", "deleteAgentMessage", "agentMessage", {
      id: args.where.id
