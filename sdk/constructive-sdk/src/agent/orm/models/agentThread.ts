...
import type { AgentThread, AgentThreadWithRelations, AgentThreadSelect, AgentThreadFilter, AgentThreadOrderBy, CreateAgentThreadInput, UpdateAgentThreadInput, AgentThreadPatch } from "../input-types";
...
export class AgentThreadModel {
  ...
  findMany<S extends AgentThreadSelect>(args: FindManyArgs<S, AgentThreadFilter, AgentThreadOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("AgentThread", "agentThreads", args.select, {
      where: args?.where,
  ...
  findFirst<S extends AgentThreadSelect>(args: FindFirstArgs<S, AgentThreadFilter, AgentThreadOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("AgentThread", "agentThreads", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "AgentThreadFilter", "AgentThreadOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends AgentThreadSelect>(args: CreateArgs<S, CreateAgentThreadInput["agentThread"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AgentThread", "createAgentThread", "agentThread", args.select, args.data, "CreateAgentThreadInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AgentThread",
  ...
  update<S extends AgentThreadSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AgentThread", "updateAgentThread", "agentThread", args.select, args.where.id, args.data, "UpdateAgentThreadInput", "id", "agentThreadPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AgentThread",
  ...
  delete<S extends AgentThreadSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AgentThread", "deleteAgentThread", "agentThread", {
      id: args.where.id
