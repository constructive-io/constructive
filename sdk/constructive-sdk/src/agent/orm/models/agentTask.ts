...
import type { AgentTask, AgentTaskWithRelations, AgentTaskSelect, AgentTaskFilter, AgentTaskOrderBy, CreateAgentTaskInput, UpdateAgentTaskInput, AgentTaskPatch } from "../input-types";
...
export class AgentTaskModel {
  ...
  findMany<S extends AgentTaskSelect>(args: FindManyArgs<S, AgentTaskFilter, AgentTaskOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("AgentTask", "agentTasks", args.select, {
      where: args?.where,
  ...
  findFirst<S extends AgentTaskSelect>(args: FindFirstArgs<S, AgentTaskFilter, AgentTaskOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("AgentTask", "agentTasks", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "AgentTaskFilter", "AgentTaskOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends AgentTaskSelect>(args: CreateArgs<S, CreateAgentTaskInput["agentTask"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AgentTask", "createAgentTask", "agentTask", args.select, args.data, "CreateAgentTaskInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AgentTask",
  ...
  update<S extends AgentTaskSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AgentTask", "updateAgentTask", "agentTask", args.select, args.where.id, args.data, "UpdateAgentTaskInput", "id", "agentTaskPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AgentTask",
  ...
  delete<S extends AgentTaskSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AgentTask", "deleteAgentTask", "agentTask", {
      id: args.where.id
