...
export interface AgentEventRelations {
  run?: AgentRun | null;
}
export interface AgentMessageRelations {
  agent?: Agent | null;
  deliveredRun?: AgentRun | null;
...
export interface AgentRunRelations {
  thread?: AgentThread | null;
  agentEventsByRunId?: ConnectionResult<AgentEvent>;
  agentMessagesByDeliveredRunId?: ConnectionResult<AgentMessage>;
  agentRunWorkspacesByRunId?: ConnectionResult<AgentRunWorkspace>;
}
export interface AgentRunWorkspaceRelations {
  run?: AgentRun | null;
}
...
export interface AgentThreadRelations {
  ...
  agentRunsByThreadId?: ConnectionResult<AgentRun>;
...
export type AgentEventWithRelations = AgentEvent & AgentEventRelations;
...
export type AgentRunWithRelations = AgentRun & AgentRunRelations;
export type AgentRunWorkspaceWithRelations = AgentRunWorkspace & AgentRunWorkspaceRelations;
...
export type AgentRunSelect = {
  ...
  agentEventsByRunId?: {
    ...
    orderBy?: AgentEventOrderBy[];
  };
  agentMessagesByDeliveredRunId?: {
    select: AgentMessageSelect;
    first?: number;
    filter?: AgentMessageFilter;
    orderBy?: AgentMessageOrderBy[];
  };
  agentRunWorkspacesByRunId?: {
    select: AgentRunWorkspaceSelect;
    first?: number;
    filter?: AgentRunWorkspaceFilter;
    orderBy?: AgentRunWorkspaceOrderBy[];
  };
};
export type AgentRunWorkspaceSelect = {
  actorId?: boolean;
  artifacts?: boolean;
  baseBranch?: boolean;
  baseCommit?: boolean;
...
export const connectionFieldsMap = {
  ...
  AgentRun: {
    agentEventsByRunId: 'AgentEvent',
    agentMessagesByDeliveredRunId: 'AgentMessage',
    agentRunWorkspacesByRunId: 'AgentRunWorkspace',
  },
  AgentThread: {
    agentMessagesByThreadId: 'AgentMessage',
    agentPlansByThreadId: 'AgentPlan',
    agentRunsByThreadId: 'AgentRun',
...
export type CreateAgentEventPayloadSelect = {
  agentEvent?: {
    select: AgentEventSelect;
  };
  agentEventEdge?: {
    select: AgentEventEdgeSelect;
  };
  clientMutationId?: boolean;
};
...
export type UpdateAgentEventPayloadSelect = {
  agentEvent?: {
    select: AgentEventSelect;
  };
  agentEventEdge?: {
...
export type DeleteAgentEventPayloadSelect = {
  agentEvent?: {
    select: AgentEventSelect;
  };
  agentEventEdge?: {
...
export type CreateAgentRunPayloadSelect = {
  agentRun?: {
    select: AgentRunSelect;
  };
  agentRunEdge?: {
    select: AgentRunEdgeSelect;
  };
  clientMutationId?: boolean;
};
...
export type UpdateAgentRunPayloadSelect = {
  agentRun?: {
    select: AgentRunSelect;
  };
  agentRunEdge?: {
...
export type DeleteAgentRunPayloadSelect = {
  agentRun?: {
    select: AgentRunSelect;
  };
  agentRunEdge?: {
...
export type CreateAgentRunWorkspacePayloadSelect = {
  agentRunWorkspace?: {
    select: AgentRunWorkspaceSelect;
  };
  agentRunWorkspaceEdge?: {
    select: AgentRunWorkspaceEdgeSelect;
  };
  clientMutationId?: boolean;
};
...
export type UpdateAgentRunWorkspacePayloadSelect = {
  agentRunWorkspace?: {
    select: AgentRunWorkspaceSelect;
  };
  agentRunWorkspaceEdge?: {
...
export type DeleteAgentRunWorkspacePayloadSelect = {
  agentRunWorkspace?: {
    select: AgentRunWorkspaceSelect;
  };
  agentRunWorkspaceEdge?: {
...
export type AgentEventEdgeSelect = {
  cursor?: boolean;
  node?: {
    select: AgentEventSelect;
  };
...
export type AgentRunEdgeSelect = {
  cursor?: boolean;
  node?: {
    select: AgentRunSelect;
  };
...
export type AgentRunWorkspaceEdgeSelect = {
  cursor?: boolean;
  node?: {
    select: AgentRunWorkspaceSelect;
  };
