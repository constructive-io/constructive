...
export interface DatabaseFilter {
  ...
  /** Filter by the object’s `inferenceLogModule` relation. */
  inferenceLogModule?: InferenceLogModuleFilter;
  /** A related `inferenceLogModule` exists. */
  inferenceLogModuleExists?: boolean;
