...
/**
 * Query hook for fetching ViewRule list
 *
 * @example
 * ```tsx
...
/**
 * Fetch ViewRule list without React hooks
 *
 * @example
 * ```ts
...
/**
 * Prefetch ViewRule list for SSR or cache warming
 *
 * @example
 * ```ts
