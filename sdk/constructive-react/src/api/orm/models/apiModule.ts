...
import type { ApiModule, ApiModuleWithRelations, ApiModuleSelect, ApiModuleFilter, ApiModuleOrderBy, CreateApiModuleInput, UpdateApiModuleInput, ApiModulePatch } from "../input-types";
...
export class ApiModuleModel {
  ...
  create<S extends ApiModuleSelect>(args: CreateArgs<S, CreateApiModuleInput["apiModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("ApiModule", "createApiModule", "apiModule", args.select, args.data, "CreateApiModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ApiModule",
  ...
  update<S extends ApiModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("ApiModule", "updateApiModule", "apiModule", args.select, args.where.id, args.data, "UpdateApiModuleInput", "id", "apiModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ApiModule",
  ...
  delete<S extends ApiModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("ApiModule", "deleteApiModule", "apiModule", {
      id: args.where.id
