...
import type { UniqueConstraint, UniqueConstraintWithRelations, UniqueConstraintSelect, UniqueConstraintFilter, UniqueConstraintOrderBy, CreateUniqueConstraintInput, UpdateUniqueConstraintInput, UniqueConstraintPatch } from "../input-types";
...
export class UniqueConstraintModel {
  ...
  create<S extends UniqueConstraintSelect>(args: CreateArgs<S, CreateUniqueConstraintInput["uniqueConstraint"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("UniqueConstraint", "createUniqueConstraint", "uniqueConstraint", args.select, args.data, "CreateUniqueConstraintInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "UniqueConstraint",
  ...
  update<S extends UniqueConstraintSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("UniqueConstraint", "updateUniqueConstraint", "uniqueConstraint", args.select, args.where.id, args.data, "UpdateUniqueConstraintInput", "id", "uniqueConstraintPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "UniqueConstraint",
  ...
  delete<S extends UniqueConstraintSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("UniqueConstraint", "deleteUniqueConstraint", "uniqueConstraint", {
      id: args.where.id
    }, "DeleteUniqueConstraintInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "UniqueConstraint",
