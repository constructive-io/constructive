...
import type { TriggerFunction, TriggerFunctionWithRelations, TriggerFunctionSelect, TriggerFunctionFilter, TriggerFunctionOrderBy, CreateTriggerFunctionInput, UpdateTriggerFunctionInput, TriggerFunctionPatch } from "../input-types";
...
export class TriggerFunctionModel {
  ...
  create<S extends TriggerFunctionSelect>(args: CreateArgs<S, CreateTriggerFunctionInput["triggerFunction"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("TriggerFunction", "createTriggerFunction", "triggerFunction", args.select, args.data, "CreateTriggerFunctionInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "TriggerFunction",
  ...
  update<S extends TriggerFunctionSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("TriggerFunction", "updateTriggerFunction", "triggerFunction", args.select, args.where.id, args.data, "UpdateTriggerFunctionInput", "id", "triggerFunctionPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "TriggerFunction",
  ...
  delete<S extends TriggerFunctionSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("TriggerFunction", "deleteTriggerFunction", "triggerFunction", {
      id: args.where.id
    }, "DeleteTriggerFunctionInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "TriggerFunction",
