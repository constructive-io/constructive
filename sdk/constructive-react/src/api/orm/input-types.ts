...
export interface Route {
  ...
  targetFunctionId?: string | null;
  /** Redirect catalog row this route targets; the edge answers with a redirect status instead of proxying a backend */
  targetRedirectId?: string | null;
...
export type PlatformSiteAppLinkSelect = {
  appIdentifier?: boolean;
  createdAt?: boolean;
  id?: boolean;
  pathComponents?: boolean;
  platform?: boolean;
  sha256CertFingerprints?: boolean;
  siteId?: boolean;
  storeUrl?: boolean;
  teamId?: boolean;
  updatedAt?: boolean;
