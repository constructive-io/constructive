 ...
 * ```
 */
export function useUpdatePlatformCorsSettingMutation<S extends PlatformCorsSettingSelect>(
  params: {
    selection: {
...
>;
export function useUpdatePlatformCorsSettingMutation(
  params: {
