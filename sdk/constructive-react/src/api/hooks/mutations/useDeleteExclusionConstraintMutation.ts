 ...
 * ```
 */
export function useDeleteExclusionConstraintMutation<S extends ExclusionConstraintSelect>(
  params: {
    selection: {
...
>;
export function useDeleteExclusionConstraintMutation(
  params: {
