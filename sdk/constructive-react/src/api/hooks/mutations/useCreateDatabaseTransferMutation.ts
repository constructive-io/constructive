 ...
 * ```
 */
export function useCreateDatabaseTransferMutation<S extends DatabaseTransferSelect>(params: {
  selection: ({
...
export function useCreateDatabaseTransferMutation(params: {
...
} & Omit<UseMutationOptions<any, Error, CreateDatabaseTransferInput["databaseTransfer"]>, "mutationFn">) {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateDatabaseTransferInput["databaseTransfer"]) => getClient().databaseTransfer.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
