...
>(
  params: {
    ...
    UseMutationOptions<
      ...
      Error,
      CreatePlatformDomainVerificationInput['platformDomainVerification']
    >,
    'mutationFn'
  >
): UseMutationResult<
...
export function useCreatePlatformDomainVerificationMutation(
  ...
  return useMutation({
    ...
    mutationFn: (data: CreatePlatformDomainVerificationInput['platformDomainVerification']) =>
      getClient()
        .platformDomainVerification.create({
          data,
          select: args.select,
        })
        .unwrap(),
