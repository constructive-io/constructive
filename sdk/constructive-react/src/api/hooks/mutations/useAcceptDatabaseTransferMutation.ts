...
export function useAcceptDatabaseTransferMutation<S extends AcceptDatabaseTransferPayloadSelect>(params: {
  selection: ({
  ...
  return useMutation({
    ...
    mutationFn: (variables: AcceptDatabaseTransferVariables) => getClient().mutation.acceptDatabaseTransfer(variables, {
      select: args.select
    } as {
      select: S;
    } & StrictSelect<S, AcceptDatabaseTransferPayloadSelect>).unwrap(),
    ...mutationOptions
  });
}
