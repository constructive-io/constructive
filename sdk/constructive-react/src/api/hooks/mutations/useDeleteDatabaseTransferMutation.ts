 ...
 * ```
 */
export function useDeleteDatabaseTransferMutation<S extends DatabaseTransferSelect>(params: {
  selection: ({
...
export function useDeleteDatabaseTransferMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().databaseTransfer.delete({
      where: {
        id
      },
      select: args.select
