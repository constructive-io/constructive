 ...
 * ```
 */
export function useCreatePlatformDomainEventMutation<S extends PlatformDomainEventSelect>(
  params: {
    selection: {
    ...
    UseMutationOptions<
      ...
      Error,
      CreatePlatformDomainEventInput['platformDomainEvent']
    >,
    'mutationFn'
  >
): UseMutationResult<
  ...
  CreatePlatformDomainEventInput['platformDomainEvent']
>;
export function useCreatePlatformDomainEventMutation(
  params: {
    selection: SelectionConfig<PlatformDomainEventSelect>;
  } & Omit<
    UseMutationOptions<any, Error, CreatePlatformDomainEventInput['platformDomainEvent']>,
    'mutationFn'
  >
) {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreatePlatformDomainEventInput['platformDomainEvent']) =>
      getClient()
        .platformDomainEvent.create({
          data,
          select: args.select,
        })
        .unwrap(),
