 ...
 * ```
 */
export function useCreatePlatformApiMutation<S extends PlatformApiSelect>(params: {
  selection: ({
...
export function useCreatePlatformApiMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreatePlatformApiInput["platformApi"]) => getClient().platformApi.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
