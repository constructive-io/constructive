 ...
 * ```
 */
export function useUpdateDatabaseTransferMutation<S extends DatabaseTransferSelect>(params: {
  selection: ({
...
export function useUpdateDatabaseTransferMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
      databaseTransferPatch: DatabaseTransferPatch;
    }) => getClient().databaseTransfer.update({
      where: {
        id
      },
