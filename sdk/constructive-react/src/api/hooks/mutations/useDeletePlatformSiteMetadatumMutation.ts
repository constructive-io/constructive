 ...
 * ```
 */
export function useDeletePlatformSiteMetadatumMutation<S extends PlatformSiteMetadatumSelect>(
  params: {
    selection: {
...
>;
export function useDeletePlatformSiteMetadatumMutation(
  params: {
