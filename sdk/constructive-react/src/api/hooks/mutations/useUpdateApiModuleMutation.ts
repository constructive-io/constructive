...
import type { ApiModuleSelect, ApiModuleWithRelations, ApiModulePatch } from "../../orm/input-types";
import type { InferSelectResult, HookStrictSelect } from "../../orm/select-types";
export type { ApiModuleSelect, ApiModuleWithRelations, ApiModulePatch } from "../../orm/input-types";
/**
 * Server-side module configuration for an API surface; stores module name and JSON settings
 * 
 * @example
 ...
 * ```
 */
export function useUpdateApiModuleMutation<S extends ApiModuleSelect>(params: {
  selection: ({
