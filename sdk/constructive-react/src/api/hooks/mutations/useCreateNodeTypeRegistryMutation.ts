 ...
 * ```
 */
export function useCreateNodeTypeRegistryMutation<S extends NodeTypeRegistrySelect>(params: {
  selection: ({
...
export function useCreateNodeTypeRegistryMutation(params: {
...
} & Omit<UseMutationOptions<any, Error, CreateNodeTypeRegistryInput["nodeTypeRegistry"]>, "mutationFn">) {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateNodeTypeRegistryInput["nodeTypeRegistry"]) => getClient().nodeTypeRegistry.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
