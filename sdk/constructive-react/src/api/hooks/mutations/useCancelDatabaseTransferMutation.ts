...
export function useCancelDatabaseTransferMutation<S extends CancelDatabaseTransferPayloadSelect>(params: {
  selection: ({
  ...
  return useMutation({
    ...
    mutationFn: (variables: CancelDatabaseTransferVariables) => getClient().mutation.cancelDatabaseTransfer(variables, {
      select: args.select
    } as {
      select: S;
    } & StrictSelect<S, CancelDatabaseTransferPayloadSelect>).unwrap(),
    ...mutationOptions
  });
}
