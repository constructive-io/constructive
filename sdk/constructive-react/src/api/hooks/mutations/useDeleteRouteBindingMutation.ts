 ...
 * ```
 */
export function useDeleteRouteBindingMutation<S extends RouteBindingSelect>(params: {
  selection: ({
...
export function useDeleteRouteBindingMutation(params: {
