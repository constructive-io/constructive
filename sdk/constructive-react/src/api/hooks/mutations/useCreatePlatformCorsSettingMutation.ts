 ...
 * ```
 */
export function useCreatePlatformCorsSettingMutation<S extends PlatformCorsSettingSelect>(
  params: {
    selection: {
    ...
    UseMutationOptions<
      ...
      Error,
      CreatePlatformCorsSettingInput['platformCorsSetting']
    >,
    'mutationFn'
  >
): UseMutationResult<
  ...
  CreatePlatformCorsSettingInput['platformCorsSetting']
>;
export function useCreatePlatformCorsSettingMutation(
  params: {
    selection: SelectionConfig<PlatformCorsSettingSelect>;
  } & Omit<
    UseMutationOptions<any, Error, CreatePlatformCorsSettingInput['platformCorsSetting']>,
    'mutationFn'
  >
) {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreatePlatformCorsSettingInput['platformCorsSetting']) =>
      getClient()
        .platformCorsSetting.create({
          data,
          select: args.select,
        })
        .unwrap(),
