 ...
 * ```
 */
export function useDeleteDatabaseSettingMutation<S extends DatabaseSettingSelect>(params: {
  selection: ({
...
export function useDeleteDatabaseSettingMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().databaseSetting.delete({
      where: {
        id
      },
      select: args.select
