 ...
 * ```
 */
export function useDeletePlatformSiteThemeMutation<S extends PlatformSiteThemeSelect>(
  params: {
    selection: {
...
>;
export function useDeletePlatformSiteThemeMutation(
  params: {
