 ...
 * ```
 */
export function useDeleteManagedDomainMutation<S extends ManagedDomainSelect>(params: {
  selection: ({
...
export function useDeleteManagedDomainMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().managedDomain.delete({
      where: {
        id
      },
      select: args.select
