 ...
 * ```
 */
export function useUpdatePlatformSiteMutation<S extends PlatformSiteSelect>(
  params: {
    selection: {
...
>;
export function useUpdatePlatformSiteMutation(
  params: {
  ...
  return useMutation({
    ...
    mutationFn: ({ id, platformSitePatch }: { id: string; platformSitePatch: PlatformSitePatch }) =>
      getClient()
        .platformSite.update({
          where: {
            id,
