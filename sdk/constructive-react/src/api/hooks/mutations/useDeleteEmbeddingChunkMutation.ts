 ...
 * ```
 */
export function useDeleteEmbeddingChunkMutation<S extends EmbeddingChunkSelect>(params: {
  selection: ({
...
export function useDeleteEmbeddingChunkMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().embeddingChunk.delete({
      where: {
        id
      },
      select: args.select
