 ...
 * ```
 */
export function useDeleteHttpRouteMutation<S extends HttpRouteSelect>(params: {
  selection: ({
...
export function useDeleteHttpRouteMutation(params: {
