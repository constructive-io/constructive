 ...
 * ```
 */
export function useCreateApiMutation<S extends ApiSelect>(params: {
  selection: ({
    fields: S & ApiSelect;
...
export function useCreateApiMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateApiInput["api"]) => getClient().api.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
