...
export const customMutationKeys = {
  ...
  /** Mutation key for suspendDatabase */ suspendDatabase: (identifier?: string) =>
    identifier
      ? (['mutation', 'suspendDatabase', identifier] as const)
      : (['mutation', 'suspendDatabase'] as const),
  /** Mutation key for unsuspendDatabase */ unsuspendDatabase: (identifier?: string) =>
    identifier
      ? (['mutation', 'unsuspendDatabase', identifier] as const)
      : (['mutation', 'unsuspendDatabase'] as const),
} as const;
/**
