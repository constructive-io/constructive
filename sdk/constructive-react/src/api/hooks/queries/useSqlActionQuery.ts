 ...
 * ```
 */
export function useSqlActionQuery<S extends SqlActionSelect, TData = {
...
export function useSqlActionQuery(params: {
  ...
  return useQuery({
    ...
    queryFn: () => getClient().sqlAction.findOne({
      id: params.id,
      select: args.select
    }).unwrap(),
    ...queryOptions
...
export async function fetchSqlActionQuery(params: {
  ...
  const args = buildSelectionArgs<SqlActionSelect>(params.selection);
  return getClient().sqlAction.findOne({
    id: params.id,
    select: args.select
  }).unwrap();
}
 ...
 * ```
 */
export async function prefetchSqlActionQuery<S extends SqlActionSelect>(queryClient: QueryClient, params: {
  id: number;
  selection: {
    fields: S;
  } & HookStrictSelect<NoInfer<S>, SqlActionSelect>;
}): Promise<void>;
export async function prefetchSqlActionQuery(queryClient: QueryClient, params: {
  id: number;
  selection: SelectionConfig<SqlActionSelect>;
}): Promise<void> {
  const args = buildSelectionArgs<SqlActionSelect>(params.selection);
