 ...
 * ```
 */
export function useDatabaseTransfersQuery<S extends DatabaseTransferSelect, TData = {
...
export function useDatabaseTransfersQuery(params: {
  selection: ListSelectionConfig<DatabaseTransferSelect, DatabaseTransferFilter, DatabaseTransferOrderBy>;
} & Omit<UseQueryOptions<any, Error, any, any>, "queryKey" | "queryFn">) {
  const args = buildListSelectionArgs<DatabaseTransferSelect, DatabaseTransferFilter, DatabaseTransferOrderBy>(params.selection);
  const {
 ...
 * ```
 */
export async function prefetchDatabaseTransfersQuery<S extends DatabaseTransferSelect>(queryClient: QueryClient, params: {
  selection: {
    fields: S;
  } & Omit<ListSelectionConfig<S, DatabaseTransferFilter, DatabaseTransferOrderBy>, "fields"> & HookStrictSelect<NoInfer<S>, DatabaseTransferSelect>;
}): Promise<void>;
export async function prefetchDatabaseTransfersQuery(queryClient: QueryClient, params: {
  selection: ListSelectionConfig<DatabaseTransferSelect, DatabaseTransferFilter, DatabaseTransferOrderBy>;
}): Promise<void> {
  const args = buildListSelectionArgs<DatabaseTransferSelect, DatabaseTransferFilter, DatabaseTransferOrderBy>(params.selection);
