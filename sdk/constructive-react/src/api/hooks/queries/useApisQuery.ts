 ...
 * ```
 */
export function useApisQuery<S extends ApiSelect, TData = {
  apis: ConnectionResult<InferSelectResult<ApiWithRelations, S>>;
}>(params: {
  selection: {
    fields: S;
  } & Omit<ListSelectionConfig<S, ApiFilter, ApiOrderBy>, "fields"> & HookStrictSelect<NoInfer<S>, ApiSelect>;
 ...
 * ```
 */
export async function prefetchApisQuery<S extends ApiSelect>(queryClient: QueryClient, params: {
  selection: {
    fields: S;
  } & Omit<ListSelectionConfig<S, ApiFilter, ApiOrderBy>, "fields"> & HookStrictSelect<NoInfer<S>, ApiSelect>;
}): Promise<void>;
export async function prefetchApisQuery(queryClient: QueryClient, params: {
  selection: ListSelectionConfig<ApiSelect, ApiFilter, ApiOrderBy>;
}): Promise<void> {
  const args = buildListSelectionArgs<ApiSelect, ApiFilter, ApiOrderBy>(params.selection);
