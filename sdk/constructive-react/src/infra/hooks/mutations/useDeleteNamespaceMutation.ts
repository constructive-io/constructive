 ...
 * ```
 */
export function useDeleteNamespaceMutation<S extends NamespaceSelect>(params: {
  selection: ({
...
export function useDeleteNamespaceMutation(params: {
