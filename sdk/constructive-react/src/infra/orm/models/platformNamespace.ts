...
import type { PlatformNamespace, PlatformNamespaceWithRelations, PlatformNamespaceSelect, PlatformNamespaceFilter, PlatformNamespaceOrderBy, CreatePlatformNamespaceInput, UpdatePlatformNamespaceInput, PlatformNamespacePatch } from "../input-types";
...
export class PlatformNamespaceModel {
  ...
  findMany<S extends PlatformNamespaceSelect>(args: FindManyArgs<S, PlatformNamespaceFilter, PlatformNamespaceOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("PlatformNamespace", "platformNamespaces", args.select, {
      where: args?.where,
  ...
  findFirst<S extends PlatformNamespaceSelect>(args: FindFirstArgs<S, PlatformNamespaceFilter, PlatformNamespaceOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("PlatformNamespace", "platformNamespaces", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "PlatformNamespaceFilter", "PlatformNamespaceOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends PlatformNamespaceSelect>(args: CreateArgs<S, CreatePlatformNamespaceInput["platformNamespace"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("PlatformNamespace", "createPlatformNamespace", "platformNamespace", args.select, args.data, "CreatePlatformNamespaceInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "PlatformNamespace",
  ...
  update<S extends PlatformNamespaceSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("PlatformNamespace", "updatePlatformNamespace", "platformNamespace", args.select, args.where.id, args.data, "UpdatePlatformNamespaceInput", "id", "platformNamespacePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "PlatformNamespace",
  ...
  delete<S extends PlatformNamespaceSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("PlatformNamespace", "deletePlatformNamespace", "platformNamespace", {
      id: args.where.id
