...
export const agentEventKeys = {
  /** All agentEvent queries */ all: ['agentevent'] as const,
  /** List query keys */ lists: () => [...agentEventKeys.all, 'list'] as const,
  /** List query key with variables */ list: (variables?: object) =>
    [...agentEventKeys.lists(), variables] as const,
  /** Detail query keys */ details: () => [...agentEventKeys.all, 'detail'] as const,
  /** Detail query key for specific item */ detail: (id: string | number) =>
    [...agentEventKeys.details(), id] as const,
} as const;
...
export const agentRunKeys = {
  /** All agentRun queries */ all: ['agentrun'] as const,
  /** List query keys */ lists: () => [...agentRunKeys.all, 'list'] as const,
  /** List query key with variables */ list: (variables?: object) =>
    [...agentRunKeys.lists(), variables] as const,
  /** Detail query keys */ details: () => [...agentRunKeys.all, 'detail'] as const,
  /** Detail query key for specific item */ detail: (id: string | number) =>
    [...agentRunKeys.details(), id] as const,
} as const;
export const agentRunWorkspaceKeys = {
  /** All agentRunWorkspace queries */ all: ['agentrunworkspace'] as const,
  /** List query keys */ lists: () => [...agentRunWorkspaceKeys.all, 'list'] as const,
  /** List query key with variables */ list: (variables?: object) =>
    [...agentRunWorkspaceKeys.lists(), variables] as const,
  /** Detail query keys */ details: () => [...agentRunWorkspaceKeys.all, 'detail'] as const,
  /** Detail query key for specific item */ detail: (id: string | number) =>
    [...agentRunWorkspaceKeys.details(), id] as const,
} as const;
...
export const queryKeys = {
  ...
  agentRun: agentRunKeys,
  agentRunWorkspace: agentRunWorkspaceKeys,
