 ...
 * ```
 */
export function useDeleteAgentPromptMutation<S extends AgentPromptSelect>(params: {
  selection: ({
...
export function useDeleteAgentPromptMutation(params: {
