 ...
 * ```
 */
export function useCreateAgentMessageMutation<S extends AgentMessageSelect>(params: {
  selection: ({
...
export function useCreateAgentMessageMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateAgentMessageInput["agentMessage"]) => getClient().agentMessage.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
