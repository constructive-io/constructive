 ...
 * ```
 */
export function useDeleteAgentPlanMutation<S extends AgentPlanSelect>(params: {
  selection: ({
...
export function useDeleteAgentPlanMutation(params: {
