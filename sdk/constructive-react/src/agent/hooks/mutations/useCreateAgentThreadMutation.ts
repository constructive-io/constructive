 ...
 * ```
 */
export function useCreateAgentThreadMutation<S extends AgentThreadSelect>(params: {
  selection: ({
...
export function useCreateAgentThreadMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateAgentThreadInput["agentThread"]) => getClient().agentThread.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
