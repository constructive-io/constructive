 ...
 * ```
 */
export function useCreateAgentTaskMutation<S extends AgentTaskSelect>(params: {
  selection: ({
...
export function useCreateAgentTaskMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateAgentTaskInput["agentTask"]) => getClient().agentTask.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
