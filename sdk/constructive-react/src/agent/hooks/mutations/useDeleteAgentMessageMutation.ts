 ...
 * ```
 */
export function useDeleteAgentMessageMutation<S extends AgentMessageSelect>(params: {
  selection: ({
...
export function useDeleteAgentMessageMutation(params: {
