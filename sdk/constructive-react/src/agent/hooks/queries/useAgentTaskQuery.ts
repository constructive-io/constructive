 ...
 * ```
 */
export function useAgentTaskQuery<S extends AgentTaskSelect, TData = {
...
export function useAgentTaskQuery(params: {
  id: string;
  ...
  return useQuery({
    ...
    queryFn: () => getClient().agentTask.findOne({
      id: params.id,
      select: args.select
    }).unwrap(),
    ...queryOptions
...
export async function fetchAgentTaskQuery(params: {
  ...
  const args = buildSelectionArgs<AgentTaskSelect>(params.selection);
  return getClient().agentTask.findOne({
    id: params.id,
    select: args.select
  }).unwrap();
}
 ...
 * ```
 */
export async function prefetchAgentTaskQuery<S extends AgentTaskSelect>(queryClient: QueryClient, params: {
  id: string;
  selection: {
    fields: S;
  } & HookStrictSelect<NoInfer<S>, AgentTaskSelect>;
}): Promise<void>;
export async function prefetchAgentTaskQuery(queryClient: QueryClient, params: {
  id: string;
  selection: SelectionConfig<AgentTaskSelect>;
}): Promise<void> {
  const args = buildSelectionArgs<AgentTaskSelect>(params.selection);
