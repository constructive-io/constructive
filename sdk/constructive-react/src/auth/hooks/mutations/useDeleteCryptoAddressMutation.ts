 ...
 * ```
 */
export function useDeleteCryptoAddressMutation<S extends CryptoAddressSelect>(params: {
  selection: ({
...
export function useDeleteCryptoAddressMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().cryptoAddress.delete({
      where: {
        id
      },
      select: args.select
