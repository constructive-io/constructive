 ...
 * ```
 */
export function useUpdatePrincipalEntityMutation<S extends PrincipalEntitySelect>(params: {
  selection: ({
...
export function useUpdatePrincipalEntityMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
      principalEntityPatch: PrincipalEntityPatch;
    }) => getClient().principalEntity.update({
      where: {
        id
      },
