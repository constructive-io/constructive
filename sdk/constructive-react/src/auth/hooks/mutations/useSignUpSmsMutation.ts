...
export function useSignUpSmsMutation<S extends SignUpSmsPayloadSelect>(params: {
  selection: ({
  ...
  return useMutation({
    ...
    mutationFn: (variables: SignUpSmsVariables) => getClient().mutation.signUpSms(variables, {
      select: args.select
    } as {
      select: S;
    } & StrictSelect<S, SignUpSmsPayloadSelect>).unwrap(),
    ...mutationOptions
  });
}
