 ...
 * ```
 */
export function useCreateWebauthnCredentialMutation<S extends WebauthnCredentialSelect>(params: {
  selection: ({
...
export function useCreateWebauthnCredentialMutation(params: {
...
} & Omit<UseMutationOptions<any, Error, CreateWebauthnCredentialInput["webauthnCredential"]>, "mutationFn">) {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateWebauthnCredentialInput["webauthnCredential"]) => getClient().webauthnCredential.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
