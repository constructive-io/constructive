 ...
 * ```
 */
export function useWebauthnCredentialsQuery<S extends WebauthnCredentialSelect, TData = {
...
export function useWebauthnCredentialsQuery(params: {
  selection: ListSelectionConfig<WebauthnCredentialSelect, WebauthnCredentialFilter, WebauthnCredentialOrderBy>;
} & Omit<UseQueryOptions<any, Error, any, any>, "queryKey" | "queryFn">) {
  const args = buildListSelectionArgs<WebauthnCredentialSelect, WebauthnCredentialFilter, WebauthnCredentialOrderBy>(params.selection);
  const {
 ...
 * ```
 */
export async function prefetchWebauthnCredentialsQuery<S extends WebauthnCredentialSelect>(queryClient: QueryClient, params: {
  selection: {
    fields: S;
  } & Omit<ListSelectionConfig<S, WebauthnCredentialFilter, WebauthnCredentialOrderBy>, "fields"> & HookStrictSelect<NoInfer<S>, WebauthnCredentialSelect>;
}): Promise<void>;
export async function prefetchWebauthnCredentialsQuery(queryClient: QueryClient, params: {
  selection: ListSelectionConfig<WebauthnCredentialSelect, WebauthnCredentialFilter, WebauthnCredentialOrderBy>;
}): Promise<void> {
  const args = buildListSelectionArgs<WebauthnCredentialSelect, WebauthnCredentialFilter, WebauthnCredentialOrderBy>(params.selection);
