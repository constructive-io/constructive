...
import type { IdentityProvider, IdentityProviderWithRelations, IdentityProviderSelect, IdentityProviderFilter, IdentityProviderOrderBy, CreateIdentityProviderInput, UpdateIdentityProviderInput, IdentityProviderPatch } from "../input-types";
...
export class IdentityProviderModel {
  ...
  findMany<S extends IdentityProviderSelect>(args: FindManyArgs<S, IdentityProviderFilter, IdentityProviderOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("IdentityProvider", "identityProviders", args.select, {
      where: args?.where,
  ...
  findFirst<S extends IdentityProviderSelect>(args: FindFirstArgs<S, IdentityProviderFilter, IdentityProviderOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("IdentityProvider", "identityProviders", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "IdentityProviderFilter", "IdentityProviderOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends IdentityProviderSelect>(args: CreateArgs<S, CreateIdentityProviderInput["identityProvider"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("IdentityProvider", "createIdentityProvider", "identityProvider", args.select, args.data, "CreateIdentityProviderInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "IdentityProvider",
