...
import type { UserConnectedAccount, UserConnectedAccountWithRelations, UserConnectedAccountSelect, UserConnectedAccountFilter, UserConnectedAccountOrderBy, CreateUserConnectedAccountInput, UpdateUserConnectedAccountInput, UserConnectedAccountPatch } from "../input-types";
...
export class UserConnectedAccountModel {
  ...
  findMany<S extends UserConnectedAccountSelect>(args: FindManyArgs<S, UserConnectedAccountFilter, UserConnectedAccountOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("UserConnectedAccount", "userConnectedAccounts", args.select, {
      where: args?.where,
  ...
  findFirst<S extends UserConnectedAccountSelect>(args: FindFirstArgs<S, UserConnectedAccountFilter, UserConnectedAccountOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("UserConnectedAccount", "userConnectedAccounts", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "UserConnectedAccountFilter", "UserConnectedAccountOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends UserConnectedAccountSelect>(args: CreateArgs<S, CreateUserConnectedAccountInput["userConnectedAccount"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("UserConnectedAccount", "createUserConnectedAccount", "userConnectedAccount", args.select, args.data, "CreateUserConnectedAccountInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "UserConnectedAccount",
