...
import type { OrgLimitCredit, OrgLimitCreditWithRelations, OrgLimitCreditSelect, OrgLimitCreditFilter, OrgLimitCreditOrderBy, CreateOrgLimitCreditInput, UpdateOrgLimitCreditInput, OrgLimitCreditPatch } from "../input-types";
...
export class OrgLimitCreditModel {
  ...
  findMany<S extends OrgLimitCreditSelect>(args: FindManyArgs<S, OrgLimitCreditFilter, OrgLimitCreditOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("OrgLimitCredit", "orgLimitCredits", args.select, {
      where: args?.where,
  ...
  findFirst<S extends OrgLimitCreditSelect>(args: FindFirstArgs<S, OrgLimitCreditFilter, OrgLimitCreditOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("OrgLimitCredit", "orgLimitCredits", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "OrgLimitCreditFilter", "OrgLimitCreditOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends OrgLimitCreditSelect>(args: CreateArgs<S, CreateOrgLimitCreditInput["orgLimitCredit"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("OrgLimitCredit", "createOrgLimitCredit", "orgLimitCredit", args.select, args.data, "CreateOrgLimitCreditInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgLimitCredit",
  ...
  update<S extends OrgLimitCreditSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("OrgLimitCredit", "updateOrgLimitCredit", "orgLimitCredit", args.select, args.where.id, args.data, "UpdateOrgLimitCreditInput", "id", "orgLimitCreditPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgLimitCredit",
  ...
  delete<S extends OrgLimitCreditSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("OrgLimitCredit", "deleteOrgLimitCredit", "orgLimitCredit", {
      id: args.where.id
