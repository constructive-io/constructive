...
import type { OrgLimitCap, OrgLimitCapWithRelations, OrgLimitCapSelect, OrgLimitCapFilter, OrgLimitCapOrderBy, CreateOrgLimitCapInput, UpdateOrgLimitCapInput, OrgLimitCapPatch } from "../input-types";
...
export class OrgLimitCapModel {
  ...
  findMany<S extends OrgLimitCapSelect>(args: FindManyArgs<S, OrgLimitCapFilter, OrgLimitCapOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("OrgLimitCap", "orgLimitCaps", args.select, {
      where: args?.where,
  ...
  findFirst<S extends OrgLimitCapSelect>(args: FindFirstArgs<S, OrgLimitCapFilter, OrgLimitCapOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("OrgLimitCap", "orgLimitCaps", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "OrgLimitCapFilter", "OrgLimitCapOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends OrgLimitCapSelect>(args: CreateArgs<S, CreateOrgLimitCapInput["orgLimitCap"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("OrgLimitCap", "createOrgLimitCap", "orgLimitCap", args.select, args.data, "CreateOrgLimitCapInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgLimitCap",
  ...
  update<S extends OrgLimitCapSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("OrgLimitCap", "updateOrgLimitCap", "orgLimitCap", args.select, args.where.id, args.data, "UpdateOrgLimitCapInput", "id", "orgLimitCapPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgLimitCap",
  ...
  delete<S extends OrgLimitCapSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("OrgLimitCap", "deleteOrgLimitCap", "orgLimitCap", {
      id: args.where.id
