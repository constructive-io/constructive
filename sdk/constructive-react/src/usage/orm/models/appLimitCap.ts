...
import type { AppLimitCap, AppLimitCapWithRelations, AppLimitCapSelect, AppLimitCapFilter, AppLimitCapOrderBy, CreateAppLimitCapInput, UpdateAppLimitCapInput, AppLimitCapPatch } from "../input-types";
...
export class AppLimitCapModel {
  ...
  findMany<S extends AppLimitCapSelect>(args: FindManyArgs<S, AppLimitCapFilter, AppLimitCapOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("AppLimitCap", "appLimitCaps", args.select, {
      where: args?.where,
  ...
  findFirst<S extends AppLimitCapSelect>(args: FindFirstArgs<S, AppLimitCapFilter, AppLimitCapOrderBy> & {
    select: S;
  } & StrictSelect<S, AppLimitCapSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("AppLimitCap", "appLimitCaps", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "AppLimitCapFilter", "AppLimitCapOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends AppLimitCapSelect>(args: CreateArgs<S, CreateAppLimitCapInput["appLimitCap"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AppLimitCap", "createAppLimitCap", "appLimitCap", args.select, args.data, "CreateAppLimitCapInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppLimitCap",
  ...
  update<S extends AppLimitCapSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AppLimitCap", "updateAppLimitCap", "appLimitCap", args.select, args.where.id, args.data, "UpdateAppLimitCapInput", "id", "appLimitCapPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppLimitCap",
  ...
  delete<S extends AppLimitCapSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AppLimitCap", "deleteAppLimitCap", "appLimitCap", {
      id: args.where.id
