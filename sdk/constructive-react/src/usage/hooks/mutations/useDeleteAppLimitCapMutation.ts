 ...
 * ```
 */
export function useDeleteAppLimitCapMutation<S extends AppLimitCapSelect>(params: {
  selection: ({
...
export function useDeleteAppLimitCapMutation(params: {
