 ...
 * ```
 */
export function useUpdateOrgLimitWarningMutation<S extends OrgLimitWarningSelect>(params: {
  selection: ({
...
export function useUpdateOrgLimitWarningMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
      orgLimitWarningPatch: OrgLimitWarningPatch;
    }) => getClient().orgLimitWarning.update({
      where: {
        id
      },
