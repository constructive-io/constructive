 ...
 * ```
 */
export function useCreateOrgLimitEventMutation<S extends OrgLimitEventSelect>(params: {
  selection: ({
...
export function useCreateOrgLimitEventMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateOrgLimitEventInput["orgLimitEvent"]) => getClient().orgLimitEvent.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
