 ...
 * ```
 */
export function useCreateAppLimitEventMutation<S extends AppLimitEventSelect>(params: {
  selection: ({
...
export function useCreateAppLimitEventMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateAppLimitEventInput["appLimitEvent"]) => getClient().appLimitEvent.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
