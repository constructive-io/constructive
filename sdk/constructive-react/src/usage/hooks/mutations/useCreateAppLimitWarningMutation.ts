 ...
 * ```
 */
export function useCreateAppLimitWarningMutation<S extends AppLimitWarningSelect>(params: {
  selection: ({
...
export function useCreateAppLimitWarningMutation(params: {
...
} & Omit<UseMutationOptions<any, Error, CreateAppLimitWarningInput["appLimitWarning"]>, "mutationFn">) {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateAppLimitWarningInput["appLimitWarning"]) => getClient().appLimitWarning.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
