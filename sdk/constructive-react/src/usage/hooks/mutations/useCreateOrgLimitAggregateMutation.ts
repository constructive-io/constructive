 ...
 * ```
 */
export function useCreateOrgLimitAggregateMutation<S extends OrgLimitAggregateSelect>(params: {
  selection: ({
...
export function useCreateOrgLimitAggregateMutation(params: {
...
} & Omit<UseMutationOptions<any, Error, CreateOrgLimitAggregateInput["orgLimitAggregate"]>, "mutationFn">) {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateOrgLimitAggregateInput["orgLimitAggregate"]) => getClient().orgLimitAggregate.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
