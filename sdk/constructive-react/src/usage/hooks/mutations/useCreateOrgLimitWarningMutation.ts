 ...
 * ```
 */
export function useCreateOrgLimitWarningMutation<S extends OrgLimitWarningSelect>(params: {
  selection: ({
...
export function useCreateOrgLimitWarningMutation(params: {
...
} & Omit<UseMutationOptions<any, Error, CreateOrgLimitWarningInput["orgLimitWarning"]>, "mutationFn">) {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateOrgLimitWarningInput["orgLimitWarning"]) => getClient().orgLimitWarning.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
