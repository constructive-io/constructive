 ...
 * ```
 */
export function useAppLimitEventsQuery<S extends AppLimitEventSelect, TData = {
...
export function useAppLimitEventsQuery(params: {
  ...
  const args = buildListSelectionArgs<AppLimitEventSelect, AppLimitEventFilter, AppLimitEventOrderBy>(params.selection);
  const {
 ...
 * ```
 */
export async function prefetchAppLimitEventsQuery<S extends AppLimitEventSelect>(queryClient: QueryClient, params: {
  selection: {
    fields: S;
  } & Omit<ListSelectionConfig<S, AppLimitEventFilter, AppLimitEventOrderBy>, "fields"> & HookStrictSelect<NoInfer<S>, AppLimitEventSelect>;
}): Promise<void>;
export async function prefetchAppLimitEventsQuery(queryClient: QueryClient, params: {
  selection: ListSelectionConfig<AppLimitEventSelect, AppLimitEventFilter, AppLimitEventOrderBy>;
}): Promise<void> {
  const args = buildListSelectionArgs<AppLimitEventSelect, AppLimitEventFilter, AppLimitEventOrderBy>(params.selection);
