 ...
 * ```
 */
export function useAppLimitWarningQuery<S extends AppLimitWarningSelect, TData = {
...
export function useAppLimitWarningQuery(params: {
  ...
  return useQuery({
    ...
    queryFn: () => getClient().appLimitWarning.findOne({
      id: params.id,
      select: args.select
    }).unwrap(),
    ...queryOptions
...
export async function fetchAppLimitWarningQuery(params: {
  ...
  const args = buildSelectionArgs<AppLimitWarningSelect>(params.selection);
  return getClient().appLimitWarning.findOne({
    id: params.id,
    select: args.select
  }).unwrap();
}
 ...
 * ```
 */
export async function prefetchAppLimitWarningQuery<S extends AppLimitWarningSelect>(queryClient: QueryClient, params: {
  id: string;
  selection: {
    fields: S;
  } & HookStrictSelect<NoInfer<S>, AppLimitWarningSelect>;
}): Promise<void>;
export async function prefetchAppLimitWarningQuery(queryClient: QueryClient, params: {
  id: string;
  selection: SelectionConfig<AppLimitWarningSelect>;
}): Promise<void> {
  const args = buildSelectionArgs<AppLimitWarningSelect>(params.selection);
