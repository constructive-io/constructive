...
export const appLimitCapKeys = {
  ...
  /** List query key with variables */list: (variables?: object) => [...appLimitCapKeys.lists(), variables] as const,
  /** Detail query keys */details: () => [...appLimitCapKeys.all, "detail"] as const,
  /** Detail query key for specific item */detail: (id: string | number) => [...appLimitCapKeys.details(), id] as const
} as const;
export const appLimitCapsDefaultKeys = {
  ...
  /** List query key with variables */list: (variables?: object) => [...appLimitCapsDefaultKeys.lists(), variables] as const,
  /** Detail query keys */details: () => [...appLimitCapsDefaultKeys.all, "detail"] as const,
  /** Detail query key for specific item */detail: (id: string | number) => [...appLimitCapsDefaultKeys.details(), id] as const
} as const;
...
export const appLimitCreditCodeKeys = {
  ...
  /** List query key with variables */list: (variables?: object) => [...appLimitCreditCodeKeys.lists(), variables] as const,
  /** Detail query keys */details: () => [...appLimitCreditCodeKeys.all, "detail"] as const,
  /** Detail query key for specific item */detail: (id: string | number) => [...appLimitCreditCodeKeys.details(), id] as const
} as const;
export const appLimitCreditCodeItemKeys = {
  ...
  /** List query key with variables */list: (variables?: object) => [...appLimitCreditCodeItemKeys.lists(), variables] as const,
  /** Detail query keys */details: () => [...appLimitCreditCodeItemKeys.all, "detail"] as const,
  /** Detail query key for specific item */detail: (id: string | number) => [...appLimitCreditCodeItemKeys.details(), id] as const
} as const;
export const appLimitCreditKeys = {
  ...
  /** List query key with variables */list: (variables?: object) => [...appLimitCreditKeys.lists(), variables] as const,
  /** Detail query keys */details: () => [...appLimitCreditKeys.all, "detail"] as const,
  /** Detail query key for specific item */detail: (id: string | number) => [...appLimitCreditKeys.details(), id] as const
} as const;
export const appLimitCreditRedemptionKeys = {
  ...
  /** List query key with variables */list: (variables?: object) => [...appLimitCreditRedemptionKeys.lists(), variables] as const,
  /** Detail query keys */details: () => [...appLimitCreditRedemptionKeys.all, "detail"] as const,
  /** Detail query key for specific item */detail: (id: string | number) => [...appLimitCreditRedemptionKeys.details(), id] as const
} as const;
...
export const appLimitEventKeys = {
  ...
  /** List query key with variables */list: (variables?: object) => [...appLimitEventKeys.lists(), variables] as const,
  /** Detail query keys */details: () => [...appLimitEventKeys.all, "detail"] as const,
  /** Detail query key for specific item */detail: (id: string | number) => [...appLimitEventKeys.details(), id] as const
} as const;
export const appLimitWarningKeys = {
  ...
  /** List query key with variables */list: (variables?: object) => [...appLimitWarningKeys.lists(), variables] as const,
  /** Detail query keys */details: () => [...appLimitWarningKeys.all, "detail"] as const,
  /** Detail query key for specific item */detail: (id: string | number) => [...appLimitWarningKeys.details(), id] as const
} as const;
export const orgLimitAggregateKeys = {
  ...
  /** List query key with variables */list: (variables?: object) => [...orgLimitAggregateKeys.lists(), variables] as const,
  /** Detail query keys */details: () => [...orgLimitAggregateKeys.all, "detail"] as const,
  /** Detail query key for specific item */detail: (id: string | number) => [...orgLimitAggregateKeys.details(), id] as const
} as const;
export const orgLimitCapKeys = {
  ...
  /** List query key with variables */list: (variables?: object) => [...orgLimitCapKeys.lists(), variables] as const,
  /** Detail query keys */details: () => [...orgLimitCapKeys.all, "detail"] as const,
  /** Detail query key for specific item */detail: (id: string | number) => [...orgLimitCapKeys.details(), id] as const
} as const;
export const orgLimitCapsDefaultKeys = {
  ...
  /** List query key with variables */list: (variables?: object) => [...orgLimitCapsDefaultKeys.lists(), variables] as const,
  /** Detail query keys */details: () => [...orgLimitCapsDefaultKeys.all, "detail"] as const,
  /** Detail query key for specific item */detail: (id: string | number) => [...orgLimitCapsDefaultKeys.details(), id] as const
} as const;
...
export const orgLimitCreditKeys = {
  ...
  /** List query key with variables */list: (variables?: object) => [...orgLimitCreditKeys.lists(), variables] as const,
  /** Detail query keys */details: () => [...orgLimitCreditKeys.all, "detail"] as const,
  /** Detail query key for specific item */detail: (id: string | number) => [...orgLimitCreditKeys.details(), id] as const
} as const;
...
export const orgLimitEventKeys = {
  ...
  /** List query key with variables */list: (variables?: object) => [...orgLimitEventKeys.lists(), variables] as const,
  /** Detail query keys */details: () => [...orgLimitEventKeys.all, "detail"] as const,
  /** Detail query key for specific item */detail: (id: string | number) => [...orgLimitEventKeys.details(), id] as const
} as const;
export const orgLimitWarningKeys = {
  ...
  /** List query key with variables */list: (variables?: object) => [...orgLimitWarningKeys.lists(), variables] as const,
  /** Detail query keys */details: () => [...orgLimitWarningKeys.all, "detail"] as const,
  /** Detail query key for specific item */detail: (id: string | number) => [...orgLimitWarningKeys.details(), id] as const
} as const;
/**
