 ...
 * ```
 */
export function useDeleteAppClaimedInviteMutation<S extends AppClaimedInviteSelect>(params: {
  selection: ({
...
export function useDeleteAppClaimedInviteMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().appClaimedInvite.delete({
      where: {
        id
      },
      select: args.select
