...
export function useSubmitAppInviteCodeMutation<S extends SubmitAppInviteCodePayloadSelect>(params: {
  selection: ({
  ...
  return useMutation({
    ...
    mutationFn: (variables: SubmitAppInviteCodeVariables) => getClient().mutation.submitAppInviteCode(variables, {
      select: args.select
    } as {
      select: S;
    } & StrictSelect<S, SubmitAppInviteCodePayloadSelect>).unwrap(),
    ...mutationOptions
  });
}
