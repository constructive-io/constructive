 ...
 * ```
 */
export function useDeleteOrgMemberProfileMutation<S extends OrgMemberProfileSelect>(params: {
  selection: ({
...
export function useDeleteOrgMemberProfileMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().orgMemberProfile.delete({
      where: {
        id
      },
      select: args.select
