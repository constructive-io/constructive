 ...
 * ```
 */
export function useDeleteOrgInviteMutation<S extends OrgInviteSelect>(params: {
  selection: ({
...
export function useDeleteOrgInviteMutation(params: {
