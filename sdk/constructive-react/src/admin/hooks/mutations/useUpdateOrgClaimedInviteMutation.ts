...
import type { OrgClaimedInviteSelect, OrgClaimedInviteWithRelations, OrgClaimedInvitePatch } from "../../orm/input-types";
import type { InferSelectResult, HookStrictSelect } from "../../orm/select-types";
export type { OrgClaimedInviteSelect, OrgClaimedInviteWithRelations, OrgClaimedInvitePatch } from "../../orm/input-types";
/**
 * Records of successfully claimed invitations, linking senders to receivers
 * 
 * @example
 ...
 * ```
 */
export function useUpdateOrgClaimedInviteMutation<S extends OrgClaimedInviteSelect>(params: {
  selection: ({
...
export function useUpdateOrgClaimedInviteMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
      orgClaimedInvitePatch: OrgClaimedInvitePatch;
    }) => getClient().orgClaimedInvite.update({
      where: {
        id
      },
