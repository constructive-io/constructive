 ...
 * ```
 */
export function useDeleteOrgPermissionDefaultMutation<S extends OrgPermissionDefaultSelect>(params: {
  selection: ({
...
export function useDeleteOrgPermissionDefaultMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().orgPermissionDefault.delete({
      where: {
        id
      },
      select: args.select
