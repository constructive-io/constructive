 ...
 * ```
 */
export function useDeleteAppOwnerGrantMutation<S extends AppOwnerGrantSelect>(params: {
  selection: ({
...
export function useDeleteAppOwnerGrantMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().appOwnerGrant.delete({
      where: {
        id
      },
      select: args.select
