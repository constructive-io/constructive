 ...
 * ```
 */
export function useDeleteOrgMembershipMutation<S extends OrgMembershipSelect>(params: {
  selection: ({
...
export function useDeleteOrgMembershipMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().orgMembership.delete({
      where: {
        id
      },
      select: args.select
