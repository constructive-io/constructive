 ...
 * ```
 */
export function useCreateOrgMembershipSettingMutation<S extends OrgMembershipSettingSelect>(params: {
  selection: ({
...
export function useCreateOrgMembershipSettingMutation(params: {
...
} & Omit<UseMutationOptions<any, Error, CreateOrgMembershipSettingInput["orgMembershipSetting"]>, "mutationFn">) {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateOrgMembershipSettingInput["orgMembershipSetting"]) => getClient().orgMembershipSetting.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
