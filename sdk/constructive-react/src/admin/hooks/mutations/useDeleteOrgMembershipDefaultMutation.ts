 ...
 * ```
 */
export function useDeleteOrgMembershipDefaultMutation<S extends OrgMembershipDefaultSelect>(params: {
  selection: ({
...
export function useDeleteOrgMembershipDefaultMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().orgMembershipDefault.delete({
      where: {
        id
      },
      select: args.select
