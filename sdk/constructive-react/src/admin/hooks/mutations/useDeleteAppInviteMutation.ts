 ...
 * ```
 */
export function useDeleteAppInviteMutation<S extends AppInviteSelect>(params: {
  selection: ({
...
export function useDeleteAppInviteMutation(params: {
