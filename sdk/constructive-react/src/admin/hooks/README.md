...
create({ channel: '<String>', expiresAt: '<Datetime>', senderId: '<UUID>' });
```
...
create({ channel: '<String>', entityId: '<UUID>', expiresAt: '<Datetime>', senderId: '<UUID>' });
```
