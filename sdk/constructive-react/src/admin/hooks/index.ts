 ...
 *
 * Tables: OrgGetManagersRecord, OrgGetSubordinatesRecord, AppPermission, AppPermissionDefaultGrant, OrgPermission, OrgPermissionDefaultPermission, OrgPermissionDefaultGrant, OrgMember, AppPermissionDefault, OrgPermissionDefault, AppPermissionDefaultPermission, AppAdminGrant, AppOwnerGrant, OrgAdminGrant, OrgOwnerGrant, OrgChartEdgeGrant, AppClaimedInvite, MembershipType, AppGrant, AppMembershipDefault, OrgMembershipDefault, OrgClaimedInvite, OrgGrant, OrgChartEdge, OrgMembershipSetting, AppMembership, OrgMembership, OrgMemberProfile, AppInvite, OrgInvite
 *
 * Usage:
 *
