 ...
 * ```
 */
export function useAppPermissionDefaultGrantsQuery<S extends AppPermissionDefaultGrantSelect, TData = {
...
export function useAppPermissionDefaultGrantsQuery(params: {
  selection: ListSelectionConfig<AppPermissionDefaultGrantSelect, AppPermissionDefaultGrantFilter, AppPermissionDefaultGrantOrderBy>;
} & Omit<UseQueryOptions<any, Error, any, any>, "queryKey" | "queryFn">) {
  const args = buildListSelectionArgs<AppPermissionDefaultGrantSelect, AppPermissionDefaultGrantFilter, AppPermissionDefaultGrantOrderBy>(params.selection);
  const {
 ...
 * ```
 */
export async function fetchAppPermissionDefaultGrantsQuery<S extends AppPermissionDefaultGrantSelect>(params: {
  selection: {
    fields: S;
  } & Omit<ListSelectionConfig<S, AppPermissionDefaultGrantFilter, AppPermissionDefaultGrantOrderBy>, "fields"> & HookStrictSelect<NoInfer<S>, AppPermissionDefaultGrantSelect>;
}): Promise<{
 ...
 * ```
 */
export async function prefetchAppPermissionDefaultGrantsQuery<S extends AppPermissionDefaultGrantSelect>(queryClient: QueryClient, params: {
  selection: {
    fields: S;
  } & Omit<ListSelectionConfig<S, AppPermissionDefaultGrantFilter, AppPermissionDefaultGrantOrderBy>, "fields"> & HookStrictSelect<NoInfer<S>, AppPermissionDefaultGrantSelect>;
}): Promise<void>;
export async function prefetchAppPermissionDefaultGrantsQuery(queryClient: QueryClient, params: {
  selection: ListSelectionConfig<AppPermissionDefaultGrantSelect, AppPermissionDefaultGrantFilter, AppPermissionDefaultGrantOrderBy>;
}): Promise<void> {
  const args = buildListSelectionArgs<AppPermissionDefaultGrantSelect, AppPermissionDefaultGrantFilter, AppPermissionDefaultGrantOrderBy>(params.selection);
