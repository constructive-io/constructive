 ...
 * ```
 */
export function useOrgPermissionDefaultGrantQuery<S extends OrgPermissionDefaultGrantSelect, TData = {
...
export function useOrgPermissionDefaultGrantQuery(params: {
  ...
  return useQuery({
    ...
    queryFn: () => getClient().orgPermissionDefaultGrant.findOne({
      id: params.id,
      select: args.select
    }).unwrap(),
    ...queryOptions
 ...
 * ```
 */
export async function fetchOrgPermissionDefaultGrantQuery<S extends OrgPermissionDefaultGrantSelect>(params: {
  id: string;
  selection: {
    fields: S;
  } & HookStrictSelect<NoInfer<S>, OrgPermissionDefaultGrantSelect>;
...
export async function fetchOrgPermissionDefaultGrantQuery(params: {
  ...
  const args = buildSelectionArgs<OrgPermissionDefaultGrantSelect>(params.selection);
  return getClient().orgPermissionDefaultGrant.findOne({
    id: params.id,
    select: args.select
  }).unwrap();
}
 ...
 * ```
 */
export async function prefetchOrgPermissionDefaultGrantQuery<S extends OrgPermissionDefaultGrantSelect>(queryClient: QueryClient, params: {
  id: string;
  selection: {
    fields: S;
  } & HookStrictSelect<NoInfer<S>, OrgPermissionDefaultGrantSelect>;
}): Promise<void>;
export async function prefetchOrgPermissionDefaultGrantQuery(queryClient: QueryClient, params: {
  id: string;
  selection: SelectionConfig<OrgPermissionDefaultGrantSelect>;
}): Promise<void> {
  const args = buildSelectionArgs<OrgPermissionDefaultGrantSelect>(params.selection);
