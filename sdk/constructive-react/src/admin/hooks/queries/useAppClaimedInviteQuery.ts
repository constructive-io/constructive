 ...
 * ```
 */
export function useAppClaimedInviteQuery<S extends AppClaimedInviteSelect, TData = {
...
export function useAppClaimedInviteQuery(params: {
  ...
  return useQuery({
    ...
    queryFn: () => getClient().appClaimedInvite.findOne({
      id: params.id,
      select: args.select
    }).unwrap(),
    ...queryOptions
...
export async function fetchAppClaimedInviteQuery(params: {
  ...
  const args = buildSelectionArgs<AppClaimedInviteSelect>(params.selection);
  return getClient().appClaimedInvite.findOne({
    id: params.id,
    select: args.select
  }).unwrap();
}
 ...
 * ```
 */
export async function prefetchAppClaimedInviteQuery<S extends AppClaimedInviteSelect>(queryClient: QueryClient, params: {
  id: string;
  selection: {
    fields: S;
  } & HookStrictSelect<NoInfer<S>, AppClaimedInviteSelect>;
}): Promise<void>;
export async function prefetchAppClaimedInviteQuery(queryClient: QueryClient, params: {
  id: string;
  selection: SelectionConfig<AppClaimedInviteSelect>;
}): Promise<void> {
  const args = buildSelectionArgs<AppClaimedInviteSelect>(params.selection);
