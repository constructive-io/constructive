 ...
 * ```
 */
export function useAppClaimedInvitesQuery<S extends AppClaimedInviteSelect, TData = {
...
export function useAppClaimedInvitesQuery(params: {
  selection: ListSelectionConfig<AppClaimedInviteSelect, AppClaimedInviteFilter, AppClaimedInviteOrderBy>;
} & Omit<UseQueryOptions<any, Error, any, any>, "queryKey" | "queryFn">) {
  const args = buildListSelectionArgs<AppClaimedInviteSelect, AppClaimedInviteFilter, AppClaimedInviteOrderBy>(params.selection);
  const {
 ...
 * ```
 */
export async function prefetchAppClaimedInvitesQuery<S extends AppClaimedInviteSelect>(queryClient: QueryClient, params: {
  selection: {
    fields: S;
  } & Omit<ListSelectionConfig<S, AppClaimedInviteFilter, AppClaimedInviteOrderBy>, "fields"> & HookStrictSelect<NoInfer<S>, AppClaimedInviteSelect>;
}): Promise<void>;
export async function prefetchAppClaimedInvitesQuery(queryClient: QueryClient, params: {
  selection: ListSelectionConfig<AppClaimedInviteSelect, AppClaimedInviteFilter, AppClaimedInviteOrderBy>;
}): Promise<void> {
  const args = buildListSelectionArgs<AppClaimedInviteSelect, AppClaimedInviteFilter, AppClaimedInviteOrderBy>(params.selection);
