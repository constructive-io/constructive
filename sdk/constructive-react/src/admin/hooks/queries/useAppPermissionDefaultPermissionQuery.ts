 ...
 * ```
 */
export function useAppPermissionDefaultPermissionQuery<S extends AppPermissionDefaultPermissionSelect, TData = {
...
export function useAppPermissionDefaultPermissionQuery(params: {
  ...
  return useQuery({
    ...
    queryFn: () => getClient().appPermissionDefaultPermission.findOne({
      id: params.id,
      select: args.select
    }).unwrap(),
    ...queryOptions
 ...
 * ```
 */
export async function fetchAppPermissionDefaultPermissionQuery<S extends AppPermissionDefaultPermissionSelect>(params: {
  id: string;
  selection: {
    fields: S;
  } & HookStrictSelect<NoInfer<S>, AppPermissionDefaultPermissionSelect>;
...
export async function fetchAppPermissionDefaultPermissionQuery(params: {
  ...
  const args = buildSelectionArgs<AppPermissionDefaultPermissionSelect>(params.selection);
  return getClient().appPermissionDefaultPermission.findOne({
    id: params.id,
    select: args.select
  }).unwrap();
}
 ...
 * ```
 */
export async function prefetchAppPermissionDefaultPermissionQuery<S extends AppPermissionDefaultPermissionSelect>(queryClient: QueryClient, params: {
  id: string;
  selection: {
    fields: S;
  } & HookStrictSelect<NoInfer<S>, AppPermissionDefaultPermissionSelect>;
}): Promise<void>;
export async function prefetchAppPermissionDefaultPermissionQuery(queryClient: QueryClient, params: {
  id: string;
  selection: SelectionConfig<AppPermissionDefaultPermissionSelect>;
}): Promise<void> {
  const args = buildSelectionArgs<AppPermissionDefaultPermissionSelect>(params.selection);
