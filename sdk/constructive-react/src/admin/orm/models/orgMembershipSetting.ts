...
import type { OrgMembershipSetting, OrgMembershipSettingWithRelations, OrgMembershipSettingSelect, OrgMembershipSettingFilter, OrgMembershipSettingOrderBy, CreateOrgMembershipSettingInput, UpdateOrgMembershipSettingInput, OrgMembershipSettingPatch } from "../input-types";
...
export class OrgMembershipSettingModel {
  ...
  findMany<S extends OrgMembershipSettingSelect>(args: FindManyArgs<S, OrgMembershipSettingFilter, OrgMembershipSettingOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("OrgMembershipSetting", "orgMembershipSettings", args.select, {
      where: args?.where,
  ...
  findFirst<S extends OrgMembershipSettingSelect>(args: FindFirstArgs<S, OrgMembershipSettingFilter, OrgMembershipSettingOrderBy> & {
    select: S;
  } & StrictSelect<S, OrgMembershipSettingSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("OrgMembershipSetting", "orgMembershipSettings", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "OrgMembershipSettingFilter", "OrgMembershipSettingOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends OrgMembershipSettingSelect>(args: CreateArgs<S, CreateOrgMembershipSettingInput["orgMembershipSetting"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("OrgMembershipSetting", "createOrgMembershipSetting", "orgMembershipSetting", args.select, args.data, "CreateOrgMembershipSettingInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgMembershipSetting",
  ...
  update<S extends OrgMembershipSettingSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("OrgMembershipSetting", "updateOrgMembershipSetting", "orgMembershipSetting", args.select, args.where.id, args.data, "UpdateOrgMembershipSettingInput", "id", "orgMembershipSettingPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgMembershipSetting",
  ...
  delete<S extends OrgMembershipSettingSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("OrgMembershipSetting", "deleteOrgMembershipSetting", "orgMembershipSetting", {
      id: args.where.id
