...
import type { AppOwnerGrant, AppOwnerGrantWithRelations, AppOwnerGrantSelect, AppOwnerGrantFilter, AppOwnerGrantOrderBy, CreateAppOwnerGrantInput, UpdateAppOwnerGrantInput, AppOwnerGrantPatch } from "../input-types";
...
export class AppOwnerGrantModel {
  ...
  findFirst<S extends AppOwnerGrantSelect>(args: FindFirstArgs<S, AppOwnerGrantFilter, AppOwnerGrantOrderBy> & {
    select: S;
  } & StrictSelect<S, AppOwnerGrantSelect>): QueryBuilder<{
  ...
  create<S extends AppOwnerGrantSelect>(args: CreateArgs<S, CreateAppOwnerGrantInput["appOwnerGrant"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AppOwnerGrant", "createAppOwnerGrant", "appOwnerGrant", args.select, args.data, "CreateAppOwnerGrantInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppOwnerGrant",
  ...
  update<S extends AppOwnerGrantSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AppOwnerGrant", "updateAppOwnerGrant", "appOwnerGrant", args.select, args.where.id, args.data, "UpdateAppOwnerGrantInput", "id", "appOwnerGrantPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppOwnerGrant",
  ...
  delete<S extends AppOwnerGrantSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AppOwnerGrant", "deleteAppOwnerGrant", "appOwnerGrant", {
      id: args.where.id
