...
import type { MembershipType, MembershipTypeWithRelations, MembershipTypeSelect, MembershipTypeFilter, MembershipTypeOrderBy, CreateMembershipTypeInput, UpdateMembershipTypeInput, MembershipTypePatch } from "../input-types";
...
export class MembershipTypeModel {
  ...
  create<S extends MembershipTypeSelect>(args: CreateArgs<S, CreateMembershipTypeInput["membershipType"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("MembershipType", "createMembershipType", "membershipType", args.select, args.data, "CreateMembershipTypeInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "MembershipType",
  ...
  update<S extends MembershipTypeSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("MembershipType", "updateMembershipType", "membershipType", args.select, args.where.id, args.data, "UpdateMembershipTypeInput", "id", "membershipTypePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "MembershipType",
  ...
  delete<S extends MembershipTypeSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("MembershipType", "deleteMembershipType", "membershipType", {
      id: args.where.id
    }, "DeleteMembershipTypeInput", args.select, connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "MembershipType",
