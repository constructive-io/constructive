...
import type { AppPermissionDefault, AppPermissionDefaultWithRelations, AppPermissionDefaultSelect, AppPermissionDefaultFilter, AppPermissionDefaultOrderBy, CreateAppPermissionDefaultInput, UpdateAppPermissionDefaultInput, AppPermissionDefaultPatch } from "../input-types";
...
export class AppPermissionDefaultModel {
  ...
  findMany<S extends AppPermissionDefaultSelect>(args: FindManyArgs<S, AppPermissionDefaultFilter, AppPermissionDefaultOrderBy> & {
    ...
    const {
      ...
      before: args?.before,
      offset: args?.offset
    }, "AppPermissionDefaultFilter", "AppPermissionDefaultOrderBy", connectionFieldsMap);
  ...
  create<S extends AppPermissionDefaultSelect>(args: CreateArgs<S, CreateAppPermissionDefaultInput["appPermissionDefault"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AppPermissionDefault", "createAppPermissionDefault", "appPermissionDefault", args.select, args.data, "CreateAppPermissionDefaultInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppPermissionDefault",
  ...
  update<S extends AppPermissionDefaultSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AppPermissionDefault", "updateAppPermissionDefault", "appPermissionDefault", args.select, args.where.id, args.data, "UpdateAppPermissionDefaultInput", "id", "appPermissionDefaultPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppPermissionDefault",
  ...
  delete<S extends AppPermissionDefaultSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AppPermissionDefault", "deleteAppPermissionDefault", "appPermissionDefault", {
      id: args.where.id
