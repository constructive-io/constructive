...
import type { OrgMemberProfile, OrgMemberProfileWithRelations, OrgMemberProfileSelect, OrgMemberProfileFilter, OrgMemberProfileOrderBy, CreateOrgMemberProfileInput, UpdateOrgMemberProfileInput, OrgMemberProfilePatch } from "../input-types";
...
export class OrgMemberProfileModel {
  ...
  findMany<S extends OrgMemberProfileSelect>(args: FindManyArgs<S, OrgMemberProfileFilter, OrgMemberProfileOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("OrgMemberProfile", "orgMemberProfiles", args.select, {
      where: args?.where,
  ...
  findFirst<S extends OrgMemberProfileSelect>(args: FindFirstArgs<S, OrgMemberProfileFilter, OrgMemberProfileOrderBy> & {
    select: S;
  } & StrictSelect<S, OrgMemberProfileSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("OrgMemberProfile", "orgMemberProfiles", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "OrgMemberProfileFilter", "OrgMemberProfileOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends OrgMemberProfileSelect>(args: CreateArgs<S, CreateOrgMemberProfileInput["orgMemberProfile"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("OrgMemberProfile", "createOrgMemberProfile", "orgMemberProfile", args.select, args.data, "CreateOrgMemberProfileInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgMemberProfile",
  ...
  update<S extends OrgMemberProfileSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("OrgMemberProfile", "updateOrgMemberProfile", "orgMemberProfile", args.select, args.where.id, args.data, "UpdateOrgMemberProfileInput", "id", "orgMemberProfilePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "OrgMemberProfile",
  ...
  delete<S extends OrgMemberProfileSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("OrgMemberProfile", "deleteOrgMemberProfile", "orgMemberProfile", {
      id: args.where.id
