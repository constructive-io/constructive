...
import type { AppAdminGrant, AppAdminGrantWithRelations, AppAdminGrantSelect, AppAdminGrantFilter, AppAdminGrantOrderBy, CreateAppAdminGrantInput, UpdateAppAdminGrantInput, AppAdminGrantPatch } from "../input-types";
...
export class AppAdminGrantModel {
  ...
  create<S extends AppAdminGrantSelect>(args: CreateArgs<S, CreateAppAdminGrantInput["appAdminGrant"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AppAdminGrant", "createAppAdminGrant", "appAdminGrant", args.select, args.data, "CreateAppAdminGrantInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppAdminGrant",
  ...
  update<S extends AppAdminGrantSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AppAdminGrant", "updateAppAdminGrant", "appAdminGrant", args.select, args.where.id, args.data, "UpdateAppAdminGrantInput", "id", "appAdminGrantPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AppAdminGrant",
  ...
  delete<S extends AppAdminGrantSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AppAdminGrant", "deleteAppAdminGrant", "appAdminGrant", {
      id: args.where.id
