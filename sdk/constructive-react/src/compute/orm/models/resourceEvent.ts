...
import type { ResourceEvent, ResourceEventWithRelations, ResourceEventSelect, ResourceEventFilter, ResourceEventOrderBy, CreateResourceEventInput, UpdateResourceEventInput, ResourceEventPatch } from "../input-types";
...
export class ResourceEventModel {
  ...
  findMany<S extends ResourceEventSelect>(args: FindManyArgs<S, ResourceEventFilter, ResourceEventOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("ResourceEvent", "resourceEvents", args.select, {
      where: args?.where,
  ...
  findFirst<S extends ResourceEventSelect>(args: FindFirstArgs<S, ResourceEventFilter, ResourceEventOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("ResourceEvent", "resourceEvents", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "ResourceEventFilter", "ResourceEventOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends ResourceEventSelect>(args: CreateArgs<S, CreateResourceEventInput["resourceEvent"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("ResourceEvent", "createResourceEvent", "resourceEvent", args.select, args.data, "CreateResourceEventInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ResourceEvent",
  ...
  update<S extends ResourceEventSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("ResourceEvent", "updateResourceEvent", "resourceEvent", args.select, args.where.id, args.data, "UpdateResourceEventInput", "id", "resourceEventPatch", connectionFieldsMap, {
  ...
  delete<S extends ResourceEventSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("ResourceEvent", "deleteResourceEvent", "resourceEvent", {
      id: args.where.id,
      createdAt: args.where.createdAt
