...
export class ResourcesResolvedRequirementModel {
  ...
  findMany<S extends ResourcesResolvedRequirementSelect>(args: FindManyArgs<S, ResourcesResolvedRequirementFilter, ResourcesResolvedRequirementOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("ResourcesResolvedRequirement", "resourcesResolvedRequirements", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "ResourcesResolvedRequirementFilter", "ResourcesResolvedRequirementOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends ResourcesResolvedRequirementSelect>(args: FindFirstArgs<S, ResourcesResolvedRequirementFilter, ResourcesResolvedRequirementOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("ResourcesResolvedRequirement", "resourcesResolvedRequirements", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "ResourcesResolvedRequirementFilter", "ResourcesResolvedRequirementOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends ResourcesResolvedRequirementSelect>(args: CreateArgs<S, CreateResourcesResolvedRequirementInput["resourcesResolvedRequirement"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("ResourcesResolvedRequirement", "createResourcesResolvedRequirement", "resourcesResolvedRequirement", args.select, args.data, "CreateResourcesResolvedRequirementInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ResourcesResolvedRequirement",
