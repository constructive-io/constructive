...
import type { GetAllTreeNodesRecord, GetAllTreeNodesRecordWithRelations, GetAllTreeNodesRecordSelect, GetAllTreeNodesRecordFilter, GetAllTreeNodesRecordsOrderBy, CreateGetAllTreeNodesRecordInput, UpdateGetAllTreeNodesRecordInput, GetAllTreeNodesRecordPatch } from "../input-types";
...
export class GetAllTreeNodesRecordModel {
  ...
  findMany<S extends GetAllTreeNodesRecordSelect>(args: FindManyArgs<S, GetAllTreeNodesRecordFilter, GetAllTreeNodesRecordsOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("GetAllTreeNodesRecord", "getAllTreeNodes", args.select, {
      where: args?.where,
  ...
  findFirst<S extends GetAllTreeNodesRecordSelect>(args: FindFirstArgs<S, GetAllTreeNodesRecordFilter, GetAllTreeNodesRecordsOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("GetAllTreeNodesRecord", "getAllTreeNodes", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "GetAllTreeNodesRecordFilter", "GetAllTreeNodesRecordsOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends GetAllTreeNodesRecordSelect>(args: CreateArgs<S, CreateGetAllTreeNodesRecordInput["getAllTreeNodesRecord"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("GetAllTreeNodesRecord", "createGetAllTreeNodesRecord", "getAllTreeNodesRecord", args.select, args.data, "CreateGetAllTreeNodesRecordInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "GetAllTreeNodesRecord",
