...
export class ResourcesRequirementsStateModel {
  ...
  findMany<S extends ResourcesRequirementsStateSelect>(args: FindManyArgs<S, ResourcesRequirementsStateFilter, ResourcesRequirementsStateOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("ResourcesRequirementsState", "resourcesRequirementsStates", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "ResourcesRequirementsStateFilter", "ResourcesRequirementsStateOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends ResourcesRequirementsStateSelect>(args: FindFirstArgs<S, ResourcesRequirementsStateFilter, ResourcesRequirementsStateOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("ResourcesRequirementsState", "resourcesRequirementsStates", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "ResourcesRequirementsStateFilter", "ResourcesRequirementsStateOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends ResourcesRequirementsStateSelect>(args: CreateArgs<S, CreateResourcesRequirementsStateInput["resourcesRequirementsState"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("ResourcesRequirementsState", "createResourcesRequirementsState", "resourcesRequirementsState", args.select, args.data, "CreateResourcesRequirementsStateInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ResourcesRequirementsState",
