...
import type { PlatformNamespaceEvent, PlatformNamespaceEventWithRelations, PlatformNamespaceEventSelect, PlatformNamespaceEventFilter, PlatformNamespaceEventOrderBy, CreatePlatformNamespaceEventInput, UpdatePlatformNamespaceEventInput, PlatformNamespaceEventPatch } from "../input-types";
...
export class PlatformNamespaceEventModel {
  ...
  findMany<S extends PlatformNamespaceEventSelect>(args: FindManyArgs<S, PlatformNamespaceEventFilter, PlatformNamespaceEventOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("PlatformNamespaceEvent", "platformNamespaceEvents", args.select, {
      where: args?.where,
  ...
  findFirst<S extends PlatformNamespaceEventSelect>(args: FindFirstArgs<S, PlatformNamespaceEventFilter, PlatformNamespaceEventOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("PlatformNamespaceEvent", "platformNamespaceEvents", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "PlatformNamespaceEventFilter", "PlatformNamespaceEventOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends PlatformNamespaceEventSelect>(args: CreateArgs<S, CreatePlatformNamespaceEventInput["platformNamespaceEvent"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("PlatformNamespaceEvent", "createPlatformNamespaceEvent", "platformNamespaceEvent", args.select, args.data, "CreatePlatformNamespaceEventInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "PlatformNamespaceEvent",
  ...
  update<S extends PlatformNamespaceEventSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("PlatformNamespaceEvent", "updatePlatformNamespaceEvent", "platformNamespaceEvent", args.select, args.where.id, args.data, "UpdatePlatformNamespaceEventInput", "id", "platformNamespaceEventPatch", connectionFieldsMap, {
  ...
  delete<S extends PlatformNamespaceEventSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("PlatformNamespaceEvent", "deletePlatformNamespaceEvent", "platformNamespaceEvent", {
      id: args.where.id,
      createdAt: args.where.createdAt
