...
export class InfraGetAllTreeNodesRecordModel {
  ...
  findMany<S extends InfraGetAllTreeNodesRecordSelect>(args: FindManyArgs<S, InfraGetAllTreeNodesRecordFilter, InfraGetAllTreeNodesRecordsOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("InfraGetAllTreeNodesRecord", "infraGetAllTreeNodes", args.select, {
      where: args?.where,
      ...
      before: args?.before,
      offset: args?.offset
    }, "InfraGetAllTreeNodesRecordFilter", "InfraGetAllTreeNodesRecordsOrderBy", connectionFieldsMap);
  ...
  findFirst<S extends InfraGetAllTreeNodesRecordSelect>(args: FindFirstArgs<S, InfraGetAllTreeNodesRecordFilter, InfraGetAllTreeNodesRecordsOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("InfraGetAllTreeNodesRecord", "infraGetAllTreeNodes", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "InfraGetAllTreeNodesRecordFilter", "InfraGetAllTreeNodesRecordsOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends InfraGetAllTreeNodesRecordSelect>(args: CreateArgs<S, CreateInfraGetAllTreeNodesRecordInput["infraGetAllTreeNodesRecord"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("InfraGetAllTreeNodesRecord", "createInfraGetAllTreeNodesRecord", "infraGetAllTreeNodesRecord", args.select, args.data, "CreateInfraGetAllTreeNodesRecordInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "InfraGetAllTreeNodesRecord",
