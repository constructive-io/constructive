...
import type { Resource, ResourceWithRelations, ResourceSelect, ResourceFilter, ResourceOrderBy, CreateResourceInput, UpdateResourceInput, ResourcePatch } from "../input-types";
...
export class ResourceModel {
  ...
  findMany<S extends ResourceSelect>(args: FindManyArgs<S, ResourceFilter, ResourceOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("Resource", "resources", args.select, {
      where: args?.where,
  ...
  findFirst<S extends ResourceSelect>(args: FindFirstArgs<S, ResourceFilter, ResourceOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("Resource", "resources", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "ResourceFilter", "ResourceOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends ResourceSelect>(args: CreateArgs<S, CreateResourceInput["resource"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("Resource", "createResource", "resource", args.select, args.data, "CreateResourceInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "Resource",
  ...
  update<S extends ResourceSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("Resource", "updateResource", "resource", args.select, args.where.id, args.data, "UpdateResourceInput", "id", "resourcePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "Resource",
  ...
  delete<S extends ResourceSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("Resource", "deleteResource", "resource", {
      id: args.where.id
