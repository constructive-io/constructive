 ...
 * ```
 */
export function useDeleteWebhookEventMutation<S extends WebhookEventSelect>(params: {
  selection: ({
...
export function useDeleteWebhookEventMutation(params: {
