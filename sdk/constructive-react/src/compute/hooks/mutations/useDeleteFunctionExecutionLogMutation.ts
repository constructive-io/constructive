 ...
 * ```
 */
export function useDeleteFunctionExecutionLogMutation<S extends FunctionExecutionLogSelect>(params: {
  selection: ({
...
export function useDeleteFunctionExecutionLogMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
      createdAt: string;
    }) => getClient().functionExecutionLog.delete({
      where: {
        id,
        createdAt
      },
