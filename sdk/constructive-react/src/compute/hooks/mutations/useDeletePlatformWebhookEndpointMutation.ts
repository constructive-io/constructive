 ...
 * ```
 */
export function useDeletePlatformWebhookEndpointMutation<S extends PlatformWebhookEndpointSelect>(params: {
  selection: ({
...
export function useDeletePlatformWebhookEndpointMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().platformWebhookEndpoint.delete({
      where: {
        id
      },
      select: args.select
