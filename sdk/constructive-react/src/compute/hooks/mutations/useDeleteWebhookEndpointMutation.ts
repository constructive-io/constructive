 ...
 * ```
 */
export function useDeleteWebhookEndpointMutation<S extends WebhookEndpointSelect>(params: {
  selection: ({
...
export function useDeleteWebhookEndpointMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().webhookEndpoint.delete({
      where: {
        id
      },
      select: args.select
