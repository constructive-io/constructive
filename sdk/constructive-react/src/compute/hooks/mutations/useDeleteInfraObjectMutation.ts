 ...
 * ```
 */
export function useDeleteInfraObjectMutation<S extends InfraObjectSelect>(params: {
  selection: ({
...
export function useDeleteInfraObjectMutation(params: {
