 ...
 * ```
 */
export function useDeleteFunctionGraphMutation<S extends FunctionGraphSelect>(params: {
  selection: ({
...
export function useDeleteFunctionGraphMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().functionGraph.delete({
      where: {
        id
      },
      select: args.select
