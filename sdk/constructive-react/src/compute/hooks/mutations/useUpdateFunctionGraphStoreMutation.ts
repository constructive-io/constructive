...
import type { FunctionGraphStoreSelect, FunctionGraphStoreWithRelations, FunctionGraphStorePatch } from "../../orm/input-types";
import type { InferSelectResult, HookStrictSelect } from "../../orm/select-types";
export type { FunctionGraphStoreSelect, FunctionGraphStoreWithRelations, FunctionGraphStorePatch } from "../../orm/input-types";
/**
 * Named stores — one per version-controlled tree (e.g. one graph, one definition set)
 * 
 * @example
 ...
 * ```
 */
export function useUpdateFunctionGraphStoreMutation<S extends FunctionGraphStoreSelect>(params: {
  selection: ({
...
export function useUpdateFunctionGraphStoreMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
      functionGraphStorePatch: FunctionGraphStorePatch;
    }) => getClient().functionGraphStore.update({
      where: {
        id
      },
