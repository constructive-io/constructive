 ...
 * ```
 */
export function useDeletePlatformResourceMutation<S extends PlatformResourceSelect>(params: {
  selection: ({
...
export function useDeletePlatformResourceMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().platformResource.delete({
      where: {
        id
      },
      select: args.select
