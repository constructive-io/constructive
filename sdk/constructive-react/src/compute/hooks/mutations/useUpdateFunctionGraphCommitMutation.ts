...
import type { FunctionGraphCommitSelect, FunctionGraphCommitWithRelations, FunctionGraphCommitPatch } from "../../orm/input-types";
import type { InferSelectResult, HookStrictSelect } from "../../orm/select-types";
export type { FunctionGraphCommitSelect, FunctionGraphCommitWithRelations, FunctionGraphCommitPatch } from "../../orm/input-types";
/**
 * Commit history — each commit snapshots a tree root for a store
 * 
 * @example
 ...
 * ```
 */
export function useUpdateFunctionGraphCommitMutation<S extends FunctionGraphCommitSelect>(params: {
  selection: ({
...
export function useUpdateFunctionGraphCommitMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      scopeId: string;
      functionGraphCommitPatch: FunctionGraphCommitPatch;
    }) => getClient().functionGraphCommit.update({
      where: {
        id,
        scopeId
      },
