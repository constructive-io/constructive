 ...
 * ```
 */
export function useDeleteResourceEventMutation<S extends ResourceEventSelect>(params: {
  selection: ({
...
export function useDeleteResourceEventMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
      createdAt: string;
    }) => getClient().resourceEvent.delete({
      where: {
        id,
        createdAt
      },
