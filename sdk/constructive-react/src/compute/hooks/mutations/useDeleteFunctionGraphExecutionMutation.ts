 ...
 * ```
 */
export function useDeleteFunctionGraphExecutionMutation<S extends FunctionGraphExecutionSelect>(params: {
  selection: ({
...
export function useDeleteFunctionGraphExecutionMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
      startedAt: string;
    }) => getClient().functionGraphExecution.delete({
      where: {
        id,
        startedAt
      },
