 ...
 * ```
 */
export function useDeletePlatformInfraCommitMutation<S extends PlatformInfraCommitSelect>(params: {
  selection: ({
...
export function useDeletePlatformInfraCommitMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
      scopeId: string;
    }) => getClient().platformInfraCommit.delete({
      where: {
        id,
        scopeId
      },
