 ...
 * ```
 */
export function useDeletePlatformFunctionInvocationAttemptMutation<S extends PlatformFunctionInvocationAttemptSelect>(params: {
  selection: ({
...
export function useDeletePlatformFunctionInvocationAttemptMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
      createdAt: string;
    }) => getClient().platformFunctionInvocationAttempt.delete({
      where: {
        id,
        createdAt
      },
