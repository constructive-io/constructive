 ...
 * ```
 */
export function useDeleteIntegrationProviderMutation<S extends IntegrationProviderSelect>(params: {
  selection: ({
...
export function useDeleteIntegrationProviderMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().integrationProvider.delete({
      where: {
        id
      },
      select: args.select
