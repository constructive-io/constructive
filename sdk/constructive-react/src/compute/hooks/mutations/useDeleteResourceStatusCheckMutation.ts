 ...
 * ```
 */
export function useDeleteResourceStatusCheckMutation<S extends ResourceStatusCheckSelect>(params: {
  selection: ({
...
export function useDeleteResourceStatusCheckMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().resourceStatusCheck.delete({
      where: {
        id
      },
      select: args.select
