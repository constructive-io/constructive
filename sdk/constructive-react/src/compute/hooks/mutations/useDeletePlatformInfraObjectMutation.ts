 ...
 * ```
 */
export function useDeletePlatformInfraObjectMutation<S extends PlatformInfraObjectSelect>(params: {
  selection: ({
...
export function useDeletePlatformInfraObjectMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
      scopeId: string;
    }) => getClient().platformInfraObject.delete({
      where: {
        id,
        scopeId
      },
