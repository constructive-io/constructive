 ...
 * ```
 */
export function useDeleteFunctionDeploymentMutation<S extends FunctionDeploymentSelect>(params: {
  selection: ({
...
export function useDeleteFunctionDeploymentMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().functionDeployment.delete({
      where: {
        id
      },
      select: args.select
