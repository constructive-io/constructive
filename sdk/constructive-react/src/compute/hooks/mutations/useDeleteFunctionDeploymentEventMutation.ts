 ...
 * ```
 */
export function useDeleteFunctionDeploymentEventMutation<S extends FunctionDeploymentEventSelect>(params: {
  selection: ({
...
export function useDeleteFunctionDeploymentEventMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
      createdAt: string;
    }) => getClient().functionDeploymentEvent.delete({
      where: {
        id,
        createdAt
      },
