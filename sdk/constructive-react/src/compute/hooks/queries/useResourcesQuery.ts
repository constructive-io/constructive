 ...
 * ```
 */
export function useResourcesQuery<S extends ResourceSelect, TData = {
...
export function useResourcesQuery(params: {
  ...
  const args = buildListSelectionArgs<ResourceSelect, ResourceFilter, ResourceOrderBy>(params.selection);
  const {
 ...
 * ```
 */
export async function prefetchResourcesQuery<S extends ResourceSelect>(queryClient: QueryClient, params: {
  selection: {
    fields: S;
  } & Omit<ListSelectionConfig<S, ResourceFilter, ResourceOrderBy>, "fields"> & HookStrictSelect<NoInfer<S>, ResourceSelect>;
}): Promise<void>;
export async function prefetchResourcesQuery(queryClient: QueryClient, params: {
  selection: ListSelectionConfig<ResourceSelect, ResourceFilter, ResourceOrderBy>;
}): Promise<void> {
  const args = buildListSelectionArgs<ResourceSelect, ResourceFilter, ResourceOrderBy>(params.selection);
