...
import type { DevicesModule, DevicesModuleWithRelations, DevicesModuleSelect, DevicesModuleFilter, DevicesModuleOrderBy, CreateDevicesModuleInput, UpdateDevicesModuleInput, DevicesModulePatch } from "../input-types";
...
export class DevicesModuleModel {
  ...
  findMany<S extends DevicesModuleSelect>(args: FindManyArgs<S, DevicesModuleFilter, DevicesModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("DevicesModule", "devicesModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends DevicesModuleSelect>(args: FindFirstArgs<S, DevicesModuleFilter, DevicesModuleOrderBy> & {
    select: S;
  } & StrictSelect<S, DevicesModuleSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("DevicesModule", "devicesModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "DevicesModuleFilter", "DevicesModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends DevicesModuleSelect>(args: CreateArgs<S, CreateDevicesModuleInput["devicesModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("DevicesModule", "createDevicesModule", "devicesModule", args.select, args.data, "CreateDevicesModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "DevicesModule",
  ...
  update<S extends DevicesModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("DevicesModule", "updateDevicesModule", "devicesModule", args.select, args.where.id, args.data, "UpdateDevicesModuleInput", "id", "devicesModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "DevicesModule",
  ...
  delete<S extends DevicesModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("DevicesModule", "deleteDevicesModule", "devicesModule", {
      id: args.where.id
