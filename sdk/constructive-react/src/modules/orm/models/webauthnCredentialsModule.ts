...
import type { WebauthnCredentialsModule, WebauthnCredentialsModuleWithRelations, WebauthnCredentialsModuleSelect, WebauthnCredentialsModuleFilter, WebauthnCredentialsModuleOrderBy, CreateWebauthnCredentialsModuleInput, UpdateWebauthnCredentialsModuleInput, WebauthnCredentialsModulePatch } from "../input-types";
...
export class WebauthnCredentialsModuleModel {
  ...
  findMany<S extends WebauthnCredentialsModuleSelect>(args: FindManyArgs<S, WebauthnCredentialsModuleFilter, WebauthnCredentialsModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("WebauthnCredentialsModule", "webauthnCredentialsModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends WebauthnCredentialsModuleSelect>(args: FindFirstArgs<S, WebauthnCredentialsModuleFilter, WebauthnCredentialsModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("WebauthnCredentialsModule", "webauthnCredentialsModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "WebauthnCredentialsModuleFilter", "WebauthnCredentialsModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends WebauthnCredentialsModuleSelect>(args: CreateArgs<S, CreateWebauthnCredentialsModuleInput["webauthnCredentialsModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("WebauthnCredentialsModule", "createWebauthnCredentialsModule", "webauthnCredentialsModule", args.select, args.data, "CreateWebauthnCredentialsModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "WebauthnCredentialsModule",
  ...
  update<S extends WebauthnCredentialsModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("WebauthnCredentialsModule", "updateWebauthnCredentialsModule", "webauthnCredentialsModule", args.select, args.where.id, args.data, "UpdateWebauthnCredentialsModuleInput", "id", "webauthnCredentialsModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "WebauthnCredentialsModule",
  ...
  delete<S extends WebauthnCredentialsModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("WebauthnCredentialsModule", "deleteWebauthnCredentialsModule", "webauthnCredentialsModule", {
      id: args.where.id
