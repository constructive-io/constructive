...
import type { FunctionInvocationModule, FunctionInvocationModuleWithRelations, FunctionInvocationModuleSelect, FunctionInvocationModuleFilter, FunctionInvocationModuleOrderBy, CreateFunctionInvocationModuleInput, UpdateFunctionInvocationModuleInput, FunctionInvocationModulePatch } from "../input-types";
...
export class FunctionInvocationModuleModel {
  ...
  findMany<S extends FunctionInvocationModuleSelect>(args: FindManyArgs<S, FunctionInvocationModuleFilter, FunctionInvocationModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("FunctionInvocationModule", "functionInvocationModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends FunctionInvocationModuleSelect>(args: FindFirstArgs<S, FunctionInvocationModuleFilter, FunctionInvocationModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("FunctionInvocationModule", "functionInvocationModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "FunctionInvocationModuleFilter", "FunctionInvocationModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends FunctionInvocationModuleSelect>(args: CreateArgs<S, CreateFunctionInvocationModuleInput["functionInvocationModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("FunctionInvocationModule", "createFunctionInvocationModule", "functionInvocationModule", args.select, args.data, "CreateFunctionInvocationModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "FunctionInvocationModule",
  ...
  update<S extends FunctionInvocationModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("FunctionInvocationModule", "updateFunctionInvocationModule", "functionInvocationModule", args.select, args.where.id, args.data, "UpdateFunctionInvocationModuleInput", "id", "functionInvocationModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "FunctionInvocationModule",
  ...
  delete<S extends FunctionInvocationModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("FunctionInvocationModule", "deleteFunctionInvocationModule", "functionInvocationModule", {
      id: args.where.id
