...
import type { ConnectedAccountsModule, ConnectedAccountsModuleWithRelations, ConnectedAccountsModuleSelect, ConnectedAccountsModuleFilter, ConnectedAccountsModuleOrderBy, CreateConnectedAccountsModuleInput, UpdateConnectedAccountsModuleInput, ConnectedAccountsModulePatch } from "../input-types";
...
export class ConnectedAccountsModuleModel {
  ...
  findFirst<S extends ConnectedAccountsModuleSelect>(args: FindFirstArgs<S, ConnectedAccountsModuleFilter, ConnectedAccountsModuleOrderBy> & {
    select: S;
  } & StrictSelect<S, ConnectedAccountsModuleSelect>): QueryBuilder<{
  ...
  findOne<S extends ConnectedAccountsModuleSelect>(args: {
    id: string;
    select: S;
  } & StrictSelect<S, ConnectedAccountsModuleSelect>): QueryBuilder<{
    connectedAccountsModule: InferSelectResult<ConnectedAccountsModuleWithRelations, S> | null;
  ...
  create<S extends ConnectedAccountsModuleSelect>(args: CreateArgs<S, CreateConnectedAccountsModuleInput["connectedAccountsModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("ConnectedAccountsModule", "createConnectedAccountsModule", "connectedAccountsModule", args.select, args.data, "CreateConnectedAccountsModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ConnectedAccountsModule",
  ...
  update<S extends ConnectedAccountsModuleSelect>(args: UpdateArgs<S, {
    id: string;
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("ConnectedAccountsModule", "updateConnectedAccountsModule", "connectedAccountsModule", args.select, args.where.id, args.data, "UpdateConnectedAccountsModuleInput", "id", "connectedAccountsModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ConnectedAccountsModule",
  ...
  delete<S extends ConnectedAccountsModuleSelect>(args: DeleteArgs<{
    id: string;
  }, S> & {
    select: S;
  } & StrictSelect<S, ConnectedAccountsModuleSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("ConnectedAccountsModule", "deleteConnectedAccountsModule", "connectedAccountsModule", {
      id: args.where.id
