...
import type { AgentModule, AgentModuleWithRelations, AgentModuleSelect, AgentModuleFilter, AgentModuleOrderBy, CreateAgentModuleInput, UpdateAgentModuleInput, AgentModulePatch } from "../input-types";
...
export class AgentModuleModel {
  ...
  findMany<S extends AgentModuleSelect>(args: FindManyArgs<S, AgentModuleFilter, AgentModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("AgentModule", "agentModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends AgentModuleSelect>(args: FindFirstArgs<S, AgentModuleFilter, AgentModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("AgentModule", "agentModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "AgentModuleFilter", "AgentModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends AgentModuleSelect>(args: CreateArgs<S, CreateAgentModuleInput["agentModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("AgentModule", "createAgentModule", "agentModule", args.select, args.data, "CreateAgentModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AgentModule",
  ...
  update<S extends AgentModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("AgentModule", "updateAgentModule", "agentModule", args.select, args.where.id, args.data, "UpdateAgentModuleInput", "id", "agentModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "AgentModule",
  ...
  delete<S extends AgentModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("AgentModule", "deleteAgentModule", "agentModule", {
      id: args.where.id
