...
import type { ResourceModule, ResourceModuleWithRelations, ResourceModuleSelect, ResourceModuleFilter, ResourceModuleOrderBy, CreateResourceModuleInput, UpdateResourceModuleInput, ResourceModulePatch } from "../input-types";
...
export class ResourceModuleModel {
  ...
  findMany<S extends ResourceModuleSelect>(args: FindManyArgs<S, ResourceModuleFilter, ResourceModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("ResourceModule", "resourceModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends ResourceModuleSelect>(args: FindFirstArgs<S, ResourceModuleFilter, ResourceModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("ResourceModule", "resourceModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "ResourceModuleFilter", "ResourceModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends ResourceModuleSelect>(args: CreateArgs<S, CreateResourceModuleInput["resourceModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("ResourceModule", "createResourceModule", "resourceModule", args.select, args.data, "CreateResourceModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ResourceModule",
  ...
  update<S extends ResourceModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("ResourceModule", "updateResourceModule", "resourceModule", args.select, args.where.id, args.data, "UpdateResourceModuleInput", "id", "resourceModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ResourceModule",
  ...
  delete<S extends ResourceModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("ResourceModule", "deleteResourceModule", "resourceModule", {
      id: args.where.id
