...
import type { Blueprint, BlueprintWithRelations, BlueprintSelect, BlueprintFilter, BlueprintOrderBy, CreateBlueprintInput, UpdateBlueprintInput, BlueprintPatch } from "../input-types";
...
export class BlueprintModel {
  ...
  findMany<S extends BlueprintSelect>(args: FindManyArgs<S, BlueprintFilter, BlueprintOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("Blueprint", "blueprints", args.select, {
      where: args?.where,
  ...
  findFirst<S extends BlueprintSelect>(args: FindFirstArgs<S, BlueprintFilter, BlueprintOrderBy> & {
    select: S;
  } & StrictSelect<S, BlueprintSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("Blueprint", "blueprints", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "BlueprintFilter", "BlueprintOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends BlueprintSelect>(args: CreateArgs<S, CreateBlueprintInput["blueprint"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("Blueprint", "createBlueprint", "blueprint", args.select, args.data, "CreateBlueprintInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "Blueprint",
  ...
  update<S extends BlueprintSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("Blueprint", "updateBlueprint", "blueprint", args.select, args.where.id, args.data, "UpdateBlueprintInput", "id", "blueprintPatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "Blueprint",
  ...
  delete<S extends BlueprintSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("Blueprint", "deleteBlueprint", "blueprint", {
      id: args.where.id
