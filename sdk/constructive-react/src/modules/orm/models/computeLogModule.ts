...
import type { ComputeLogModule, ComputeLogModuleWithRelations, ComputeLogModuleSelect, ComputeLogModuleFilter, ComputeLogModuleOrderBy, CreateComputeLogModuleInput, UpdateComputeLogModuleInput, ComputeLogModulePatch } from "../input-types";
...
export class ComputeLogModuleModel {
  ...
  findMany<S extends ComputeLogModuleSelect>(args: FindManyArgs<S, ComputeLogModuleFilter, ComputeLogModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("ComputeLogModule", "computeLogModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends ComputeLogModuleSelect>(args: FindFirstArgs<S, ComputeLogModuleFilter, ComputeLogModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("ComputeLogModule", "computeLogModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "ComputeLogModuleFilter", "ComputeLogModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends ComputeLogModuleSelect>(args: CreateArgs<S, CreateComputeLogModuleInput["computeLogModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("ComputeLogModule", "createComputeLogModule", "computeLogModule", args.select, args.data, "CreateComputeLogModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ComputeLogModule",
  ...
  update<S extends ComputeLogModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("ComputeLogModule", "updateComputeLogModule", "computeLogModule", args.select, args.where.id, args.data, "UpdateComputeLogModuleInput", "id", "computeLogModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "ComputeLogModule",
  ...
  delete<S extends ComputeLogModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("ComputeLogModule", "deleteComputeLogModule", "computeLogModule", {
      id: args.where.id
