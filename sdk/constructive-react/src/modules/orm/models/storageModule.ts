...
import type { StorageModule, StorageModuleWithRelations, StorageModuleSelect, StorageModuleFilter, StorageModuleOrderBy, CreateStorageModuleInput, UpdateStorageModuleInput, StorageModulePatch } from "../input-types";
...
export class StorageModuleModel {
  ...
  findMany<S extends StorageModuleSelect>(args: FindManyArgs<S, StorageModuleFilter, StorageModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("StorageModule", "storageModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends StorageModuleSelect>(args: FindFirstArgs<S, StorageModuleFilter, StorageModuleOrderBy> & {
    select: S;
  } & StrictSelect<S, StorageModuleSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("StorageModule", "storageModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "StorageModuleFilter", "StorageModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends StorageModuleSelect>(args: CreateArgs<S, CreateStorageModuleInput["storageModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("StorageModule", "createStorageModule", "storageModule", args.select, args.data, "CreateStorageModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "StorageModule",
  ...
  update<S extends StorageModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("StorageModule", "updateStorageModule", "storageModule", args.select, args.where.id, args.data, "UpdateStorageModuleInput", "id", "storageModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "StorageModule",
  ...
  delete<S extends StorageModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("StorageModule", "deleteStorageModule", "storageModule", {
      id: args.where.id
