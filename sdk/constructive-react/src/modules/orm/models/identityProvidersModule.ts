...
import type { IdentityProvidersModule, IdentityProvidersModuleWithRelations, IdentityProvidersModuleSelect, IdentityProvidersModuleFilter, IdentityProvidersModuleOrderBy, CreateIdentityProvidersModuleInput, UpdateIdentityProvidersModuleInput, IdentityProvidersModulePatch } from "../input-types";
...
export class IdentityProvidersModuleModel {
  ...
  findMany<S extends IdentityProvidersModuleSelect>(args: FindManyArgs<S, IdentityProvidersModuleFilter, IdentityProvidersModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("IdentityProvidersModule", "identityProvidersModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends IdentityProvidersModuleSelect>(args: FindFirstArgs<S, IdentityProvidersModuleFilter, IdentityProvidersModuleOrderBy> & {
    select: S;
  } & StrictSelect<S, IdentityProvidersModuleSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("IdentityProvidersModule", "identityProvidersModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "IdentityProvidersModuleFilter", "IdentityProvidersModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends IdentityProvidersModuleSelect>(args: CreateArgs<S, CreateIdentityProvidersModuleInput["identityProvidersModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("IdentityProvidersModule", "createIdentityProvidersModule", "identityProvidersModule", args.select, args.data, "CreateIdentityProvidersModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "IdentityProvidersModule",
  ...
  update<S extends IdentityProvidersModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("IdentityProvidersModule", "updateIdentityProvidersModule", "identityProvidersModule", args.select, args.where.id, args.data, "UpdateIdentityProvidersModuleInput", "id", "identityProvidersModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "IdentityProvidersModule",
  ...
  delete<S extends IdentityProvidersModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("IdentityProvidersModule", "deleteIdentityProvidersModule", "identityProvidersModule", {
      id: args.where.id
