...
import type { PlansModule, PlansModuleWithRelations, PlansModuleSelect, PlansModuleFilter, PlansModuleOrderBy, CreatePlansModuleInput, UpdatePlansModuleInput, PlansModulePatch } from "../input-types";
...
export class PlansModuleModel {
  ...
  findMany<S extends PlansModuleSelect>(args: FindManyArgs<S, PlansModuleFilter, PlansModuleOrderBy> & {
    ...
    const {
      document,
      variables
    } = buildFindManyDocument("PlansModule", "plansModules", args.select, {
      where: args?.where,
  ...
  findFirst<S extends PlansModuleSelect>(args: FindFirstArgs<S, PlansModuleFilter, PlansModuleOrderBy> & {
    select: S;
  } & StrictSelect<S, PlansModuleSelect>): QueryBuilder<{
    ...
    const {
      document,
      variables
    } = buildFindFirstDocument("PlansModule", "plansModules", args.select, {
      where: args?.where,
      orderBy: args?.orderBy as string[] | undefined
    }, "PlansModuleFilter", "PlansModuleOrderBy", connectionFieldsMap);
    return new QueryBuilder({
  ...
  create<S extends PlansModuleSelect>(args: CreateArgs<S, CreatePlansModuleInput["plansModule"]> & {
    ...
    const {
      document,
      variables
    } = buildCreateDocument("PlansModule", "createPlansModule", "plansModule", args.select, args.data, "CreatePlansModuleInput", connectionFieldsMap);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "PlansModule",
  ...
  update<S extends PlansModuleSelect>(args: UpdateArgs<S, {
    ...
    const {
      document,
      variables
    } = buildUpdateByPkDocument("PlansModule", "updatePlansModule", "plansModule", args.select, args.where.id, args.data, "UpdatePlansModuleInput", "id", "plansModulePatch", connectionFieldsMap, undefined);
    return new QueryBuilder({
      client: this.client,
      operation: "mutation",
      operationName: "PlansModule",
  ...
  delete<S extends PlansModuleSelect>(args: DeleteArgs<{
    ...
    const {
      document,
      variables
    } = buildDeleteByPkDocument("PlansModule", "deletePlansModule", "plansModule", {
      id: args.where.id
