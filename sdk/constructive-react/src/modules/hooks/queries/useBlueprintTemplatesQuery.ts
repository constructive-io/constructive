 ...
 * ```
 */
export function useBlueprintTemplatesQuery<S extends BlueprintTemplateSelect, TData = {
...
export function useBlueprintTemplatesQuery(params: {
  selection: ListSelectionConfig<BlueprintTemplateSelect, BlueprintTemplateFilter, BlueprintTemplateOrderBy>;
} & Omit<UseQueryOptions<any, Error, any, any>, "queryKey" | "queryFn">) {
  const args = buildListSelectionArgs<BlueprintTemplateSelect, BlueprintTemplateFilter, BlueprintTemplateOrderBy>(params.selection);
  const {
 ...
 * ```
 */
export async function prefetchBlueprintTemplatesQuery<S extends BlueprintTemplateSelect>(queryClient: QueryClient, params: {
  selection: {
    fields: S;
  } & Omit<ListSelectionConfig<S, BlueprintTemplateFilter, BlueprintTemplateOrderBy>, "fields"> & HookStrictSelect<NoInfer<S>, BlueprintTemplateSelect>;
}): Promise<void>;
export async function prefetchBlueprintTemplatesQuery(queryClient: QueryClient, params: {
  selection: ListSelectionConfig<BlueprintTemplateSelect, BlueprintTemplateFilter, BlueprintTemplateOrderBy>;
}): Promise<void> {
  const args = buildListSelectionArgs<BlueprintTemplateSelect, BlueprintTemplateFilter, BlueprintTemplateOrderBy>(params.selection);
