 ...
 * ```
 */
export function useStorageModulesQuery<S extends StorageModuleSelect, TData = {
...
export function useStorageModulesQuery(params: {
  ...
  const args = buildListSelectionArgs<StorageModuleSelect, StorageModuleFilter, StorageModuleOrderBy>(params.selection);
  const {
 ...
 * ```
 */
export async function prefetchStorageModulesQuery<S extends StorageModuleSelect>(queryClient: QueryClient, params: {
  selection: {
    fields: S;
  } & Omit<ListSelectionConfig<S, StorageModuleFilter, StorageModuleOrderBy>, "fields"> & HookStrictSelect<NoInfer<S>, StorageModuleSelect>;
}): Promise<void>;
export async function prefetchStorageModulesQuery(queryClient: QueryClient, params: {
  selection: ListSelectionConfig<StorageModuleSelect, StorageModuleFilter, StorageModuleOrderBy>;
}): Promise<void> {
  const args = buildListSelectionArgs<StorageModuleSelect, StorageModuleFilter, StorageModuleOrderBy>(params.selection);
