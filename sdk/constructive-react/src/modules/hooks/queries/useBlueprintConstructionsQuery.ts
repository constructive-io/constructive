 ...
 * ```
 */
export function useBlueprintConstructionsQuery<S extends BlueprintConstructionSelect, TData = {
...
export function useBlueprintConstructionsQuery(params: {
  selection: ListSelectionConfig<BlueprintConstructionSelect, BlueprintConstructionFilter, BlueprintConstructionOrderBy>;
} & Omit<UseQueryOptions<any, Error, any, any>, "queryKey" | "queryFn">) {
  const args = buildListSelectionArgs<BlueprintConstructionSelect, BlueprintConstructionFilter, BlueprintConstructionOrderBy>(params.selection);
  const {
 ...
 * ```
 */
export async function fetchBlueprintConstructionsQuery<S extends BlueprintConstructionSelect>(params: {
  selection: {
    fields: S;
  } & Omit<ListSelectionConfig<S, BlueprintConstructionFilter, BlueprintConstructionOrderBy>, "fields"> & HookStrictSelect<NoInfer<S>, BlueprintConstructionSelect>;
}): Promise<{
 ...
 * ```
 */
export async function prefetchBlueprintConstructionsQuery<S extends BlueprintConstructionSelect>(queryClient: QueryClient, params: {
  selection: {
    fields: S;
  } & Omit<ListSelectionConfig<S, BlueprintConstructionFilter, BlueprintConstructionOrderBy>, "fields"> & HookStrictSelect<NoInfer<S>, BlueprintConstructionSelect>;
}): Promise<void>;
export async function prefetchBlueprintConstructionsQuery(queryClient: QueryClient, params: {
  selection: ListSelectionConfig<BlueprintConstructionSelect, BlueprintConstructionFilter, BlueprintConstructionOrderBy>;
}): Promise<void> {
  const args = buildListSelectionArgs<BlueprintConstructionSelect, BlueprintConstructionFilter, BlueprintConstructionOrderBy>(params.selection);
