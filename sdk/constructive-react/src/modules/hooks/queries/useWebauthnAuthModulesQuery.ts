 ...
 * ```
 */
export function useWebauthnAuthModulesQuery<S extends WebauthnAuthModuleSelect, TData = {
...
export function useWebauthnAuthModulesQuery(params: {
  selection: ListSelectionConfig<WebauthnAuthModuleSelect, WebauthnAuthModuleFilter, WebauthnAuthModuleOrderBy>;
} & Omit<UseQueryOptions<any, Error, any, any>, "queryKey" | "queryFn">) {
  const args = buildListSelectionArgs<WebauthnAuthModuleSelect, WebauthnAuthModuleFilter, WebauthnAuthModuleOrderBy>(params.selection);
  const {
 ...
 * ```
 */
export async function prefetchWebauthnAuthModulesQuery<S extends WebauthnAuthModuleSelect>(queryClient: QueryClient, params: {
  selection: {
    fields: S;
  } & Omit<ListSelectionConfig<S, WebauthnAuthModuleFilter, WebauthnAuthModuleOrderBy>, "fields"> & HookStrictSelect<NoInfer<S>, WebauthnAuthModuleSelect>;
}): Promise<void>;
export async function prefetchWebauthnAuthModulesQuery(queryClient: QueryClient, params: {
  selection: ListSelectionConfig<WebauthnAuthModuleSelect, WebauthnAuthModuleFilter, WebauthnAuthModuleOrderBy>;
}): Promise<void> {
  const args = buildListSelectionArgs<WebauthnAuthModuleSelect, WebauthnAuthModuleFilter, WebauthnAuthModuleOrderBy>(params.selection);
