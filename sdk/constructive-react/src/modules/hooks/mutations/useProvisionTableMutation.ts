...
export function useProvisionTableMutation<S extends ProvisionTablePayloadSelect>(params: {
  selection: ({
  ...
  return useMutation({
    ...
    mutationFn: (variables: ProvisionTableVariables) => getClient().mutation.provisionTable(variables, {
      select: args.select
    } as {
      select: S;
    } & StrictSelect<S, ProvisionTablePayloadSelect>).unwrap(),
    ...mutationOptions
  });
}
