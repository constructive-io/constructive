 ...
 * ```
 */
export function useDeleteInternalSecretsModuleMutation<S extends InternalSecretsModuleSelect>(params: {
  selection: ({
...
export function useDeleteInternalSecretsModuleMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().internalSecretsModule.delete({
      where: {
        id
      },
      select: args.select
