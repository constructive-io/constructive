 ...
 * ```
 */
export function useDeleteUserCredentialsModuleMutation<S extends UserCredentialsModuleSelect>(params: {
  selection: ({
...
export function useDeleteUserCredentialsModuleMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().userCredentialsModule.delete({
      where: {
        id
      },
      select: args.select
