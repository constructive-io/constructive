 ...
 * ```
 */
export function useCreateResourceModuleMutation<S extends ResourceModuleSelect>(params: {
  selection: ({
...
export function useCreateResourceModuleMutation(params: {
  selection: SelectionConfig<ResourceModuleSelect>;
} & Omit<UseMutationOptions<any, Error, CreateResourceModuleInput["resourceModule"]>, "mutationFn">) {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateResourceModuleInput["resourceModule"]) => getClient().resourceModule.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
