...
export function useProvisionFullTextSearchMutation<S extends ProvisionFullTextSearchPayloadSelect>(params: {
  selection: ({
  ...
  return useMutation({
    ...
    mutationFn: (variables: ProvisionFullTextSearchVariables) => getClient().mutation.provisionFullTextSearch(variables, {
      select: args.select
    } as {
      select: S;
    } & StrictSelect<S, ProvisionFullTextSearchPayloadSelect>).unwrap(),
    ...mutationOptions
  });
}
