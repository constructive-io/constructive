...
export function useProvisionUniqueConstraintMutation<S extends ProvisionUniqueConstraintPayloadSelect>(params: {
  selection: ({
  ...
  return useMutation({
    ...
    mutationFn: (variables: ProvisionUniqueConstraintVariables) => getClient().mutation.provisionUniqueConstraint(variables, {
      select: args.select
    } as {
      select: S;
    } & StrictSelect<S, ProvisionUniqueConstraintPayloadSelect>).unwrap(),
    ...mutationOptions
  });
}
