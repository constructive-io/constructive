 ...
 * ```
 */
export function useDeleteInfraSecretsModuleMutation<S extends InfraSecretsModuleSelect>(params: {
  selection: ({
...
export function useDeleteInfraSecretsModuleMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().infraSecretsModule.delete({
      where: {
        id
      },
      select: args.select
