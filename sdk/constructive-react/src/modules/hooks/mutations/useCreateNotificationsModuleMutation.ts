 ...
 * ```
 */
export function useCreateNotificationsModuleMutation<S extends NotificationsModuleSelect>(params: {
  selection: ({
...
export function useCreateNotificationsModuleMutation(params: {
...
} & Omit<UseMutationOptions<any, Error, CreateNotificationsModuleInput["notificationsModule"]>, "mutationFn">) {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateNotificationsModuleInput["notificationsModule"]) => getClient().notificationsModule.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
