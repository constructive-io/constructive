...
export function useProvisionRelationMutation<S extends ProvisionRelationPayloadSelect>(params: {
  selection: ({
  ...
  return useMutation({
    ...
    mutationFn: (variables: ProvisionRelationVariables) => getClient().mutation.provisionRelation(variables, {
      select: args.select
    } as {
      select: S;
    } & StrictSelect<S, ProvisionRelationPayloadSelect>).unwrap(),
    ...mutationOptions
  });
}
