 ...
 * ```
 */
export function useCreateHttpRouteModuleMutation<S extends HttpRouteModuleSelect>(params: {
  selection: ({
...
export function useCreateHttpRouteModuleMutation(params: {
...
} & Omit<UseMutationOptions<any, Error, CreateHttpRouteModuleInput["httpRouteModule"]>, "mutationFn">) {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateHttpRouteModuleInput["httpRouteModule"]) => getClient().httpRouteModule.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
