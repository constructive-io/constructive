...
export function useCopyTemplateToBlueprintMutation<S extends CopyTemplateToBlueprintPayloadSelect>(params: {
  selection: ({
  ...
  return useMutation({
    ...
    mutationFn: (variables: CopyTemplateToBlueprintVariables) => getClient().mutation.copyTemplateToBlueprint(variables, {
      select: args.select
    } as {
      select: S;
    } & StrictSelect<S, CopyTemplateToBlueprintPayloadSelect>).unwrap(),
    ...mutationOptions
  });
}
