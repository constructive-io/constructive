 ...
 * ```
 */
export function useUpdateWebauthnAuthModuleMutation<S extends WebauthnAuthModuleSelect>(params: {
  selection: ({
...
export function useUpdateWebauthnAuthModuleMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
      webauthnAuthModulePatch: WebauthnAuthModulePatch;
    }) => getClient().webauthnAuthModule.update({
      where: {
        id
      },
