 ...
 * ```
 */
export function useDeleteWebauthnCredentialsModuleMutation<S extends WebauthnCredentialsModuleSelect>(params: {
  selection: ({
...
export function useDeleteWebauthnCredentialsModuleMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().webauthnCredentialsModule.delete({
      where: {
        id
      },
      select: args.select
