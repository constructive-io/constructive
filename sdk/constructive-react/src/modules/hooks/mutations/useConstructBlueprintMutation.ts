...
export function useConstructBlueprintMutation<S extends ConstructBlueprintPayloadSelect>(params: {
  selection: ({
  ...
  return useMutation({
    ...
    mutationFn: (variables: ConstructBlueprintVariables) => getClient().mutation.constructBlueprint(variables, {
      select: args.select
    } as {
      select: S;
    } & StrictSelect<S, ConstructBlueprintPayloadSelect>).unwrap(),
    ...mutationOptions
  });
}
