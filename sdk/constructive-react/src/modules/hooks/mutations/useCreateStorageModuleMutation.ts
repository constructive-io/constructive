 ...
 * ```
 */
export function useCreateStorageModuleMutation<S extends StorageModuleSelect>(params: {
  selection: ({
...
export function useCreateStorageModuleMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateStorageModuleInput["storageModule"]) => getClient().storageModule.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
