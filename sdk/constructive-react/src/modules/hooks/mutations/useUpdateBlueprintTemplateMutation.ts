 ...
 * ```
 */
export function useUpdateBlueprintTemplateMutation<S extends BlueprintTemplateSelect>(params: {
  selection: ({
...
export function useUpdateBlueprintTemplateMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
      blueprintTemplatePatch: BlueprintTemplatePatch;
    }) => getClient().blueprintTemplate.update({
      where: {
        id
      },
