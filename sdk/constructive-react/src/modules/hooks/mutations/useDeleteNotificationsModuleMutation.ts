 ...
 * ```
 */
export function useDeleteNotificationsModuleMutation<S extends NotificationsModuleSelect>(params: {
  selection: ({
...
export function useDeleteNotificationsModuleMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().notificationsModule.delete({
      where: {
        id
      },
      select: args.select
