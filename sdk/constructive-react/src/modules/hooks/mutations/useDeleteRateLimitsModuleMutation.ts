 ...
 * ```
 */
export function useDeleteRateLimitsModuleMutation<S extends RateLimitsModuleSelect>(params: {
  selection: ({
...
export function useDeleteRateLimitsModuleMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().rateLimitsModule.delete({
      where: {
        id
      },
      select: args.select
