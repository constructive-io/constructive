 ...
 * ```
 */
export function useDeleteInferenceLogModuleMutation<S extends InferenceLogModuleSelect>(params: {
  selection: ({
...
export function useDeleteInferenceLogModuleMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().inferenceLogModule.delete({
      where: {
        id
      },
      select: args.select
