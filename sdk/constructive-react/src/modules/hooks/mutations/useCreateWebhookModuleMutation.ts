 ...
 * ```
 */
export function useCreateWebhookModuleMutation<S extends WebhookModuleSelect>(params: {
  selection: ({
...
export function useCreateWebhookModuleMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateWebhookModuleInput["webhookModule"]) => getClient().webhookModule.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
