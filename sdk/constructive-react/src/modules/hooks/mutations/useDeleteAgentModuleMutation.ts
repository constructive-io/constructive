 ...
 * ```
 */
export function useDeleteAgentModuleMutation<S extends AgentModuleSelect>(params: {
  selection: ({
...
export function useDeleteAgentModuleMutation(params: {
