 ...
 * ```
 */
export function useCreatePrincipalAuthModuleMutation<S extends PrincipalAuthModuleSelect>(params: {
  selection: ({
...
export function useCreatePrincipalAuthModuleMutation(params: {
  selection: SelectionConfig<PrincipalAuthModuleSelect>;
} & Omit<UseMutationOptions<any, Error, CreatePrincipalAuthModuleInput["principalAuthModule"]>, "mutationFn">) {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreatePrincipalAuthModuleInput["principalAuthModule"]) => getClient().principalAuthModule.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
