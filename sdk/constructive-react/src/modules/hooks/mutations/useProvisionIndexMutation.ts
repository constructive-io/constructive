...
export function useProvisionIndexMutation<S extends ProvisionIndexPayloadSelect>(params: {
  selection: ({
  ...
  return useMutation({
    ...
    mutationFn: (variables: ProvisionIndexVariables) => getClient().mutation.provisionIndex(variables, {
      select: args.select
    } as {
      select: S;
    } & StrictSelect<S, ProvisionIndexPayloadSelect>).unwrap(),
    ...mutationOptions
  });
}
