 ...
 * ```
 */
export function useCreateWebauthnAuthModuleMutation<S extends WebauthnAuthModuleSelect>(params: {
  selection: ({
...
export function useCreateWebauthnAuthModuleMutation(params: {
  selection: SelectionConfig<WebauthnAuthModuleSelect>;
} & Omit<UseMutationOptions<any, Error, CreateWebauthnAuthModuleInput["webauthnAuthModule"]>, "mutationFn">) {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateWebauthnAuthModuleInput["webauthnAuthModule"]) => getClient().webauthnAuthModule.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
