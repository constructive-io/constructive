 ...
 * ```
 */
export function useCreateBlueprintConstructionMutation<S extends BlueprintConstructionSelect>(params: {
  selection: ({
...
export function useCreateBlueprintConstructionMutation(params: {
...
} & Omit<UseMutationOptions<any, Error, CreateBlueprintConstructionInput["blueprintConstruction"]>, "mutationFn">) {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateBlueprintConstructionInput["blueprintConstruction"]) => getClient().blueprintConstruction.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
