 ...
 * ```
 */
export function useCreateBlueprintTemplateMutation<S extends BlueprintTemplateSelect>(params: {
  selection: ({
...
export function useCreateBlueprintTemplateMutation(params: {
...
} & Omit<UseMutationOptions<any, Error, CreateBlueprintTemplateInput["blueprintTemplate"]>, "mutationFn">) {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateBlueprintTemplateInput["blueprintTemplate"]) => getClient().blueprintTemplate.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
