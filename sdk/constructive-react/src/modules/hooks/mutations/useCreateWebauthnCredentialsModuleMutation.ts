...
import type { WebauthnCredentialsModuleSelect, WebauthnCredentialsModuleWithRelations, CreateWebauthnCredentialsModuleInput } from "../../orm/input-types";
 ...
 * @example
 * ```tsx
 * const { mutate, isPending } = useCreateWebauthnCredentialsModuleMutation({
 ...
 * ```
 */
export function useCreateWebauthnCredentialsModuleMutation<S extends WebauthnCredentialsModuleSelect>(params: {
  selection: ({
...
}, Error, CreateWebauthnCredentialsModuleInput["webauthnCredentialsModule"]>, "mutationFn">): UseMutationResult<{
  createWebauthnCredentialsModule: {
    webauthnCredentialsModule: InferSelectResult<WebauthnCredentialsModuleWithRelations, S>;
  };
}, Error, CreateWebauthnCredentialsModuleInput["webauthnCredentialsModule"]>;
export function useCreateWebauthnCredentialsModuleMutation(params: {
  selection: SelectionConfig<WebauthnCredentialsModuleSelect>;
} & Omit<UseMutationOptions<any, Error, CreateWebauthnCredentialsModuleInput["webauthnCredentialsModule"]>, "mutationFn">) {
  ...
  return useMutation({
    mutationKey: webauthnCredentialsModuleMutationKeys.create(),
    mutationFn: (data: CreateWebauthnCredentialsModuleInput["webauthnCredentialsModule"]) => getClient().webauthnCredentialsModule.create({
      data,
      select: args.select
    }).unwrap(),
    onSuccess: () => {
