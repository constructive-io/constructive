 ...
 * ```
 */
export function useDeleteDevicesModuleMutation<S extends DevicesModuleSelect>(params: {
  selection: ({
...
export function useDeleteDevicesModuleMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().devicesModule.delete({
      where: {
        id
      },
      select: args.select
