 ...
 * ```
 */
export function useDeleteFunctionModuleMutation<S extends FunctionModuleSelect>(params: {
  selection: ({
...
export function useDeleteFunctionModuleMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().functionModule.delete({
      where: {
        id
      },
      select: args.select
