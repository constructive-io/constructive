 ...
 * ```
 */
export function useDeleteDbPoolConfigMutation<S extends DbPoolConfigSelect>(params: {
  selection: ({
...
export function useDeleteDbPoolConfigMutation(params: {
