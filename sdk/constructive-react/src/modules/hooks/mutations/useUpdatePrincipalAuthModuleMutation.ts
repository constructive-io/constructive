 ...
 * ```
 */
export function useUpdatePrincipalAuthModuleMutation<S extends PrincipalAuthModuleSelect>(params: {
  selection: ({
...
export function useUpdatePrincipalAuthModuleMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
      principalAuthModulePatch: PrincipalAuthModulePatch;
    }) => getClient().principalAuthModule.update({
      where: {
        id
      },
