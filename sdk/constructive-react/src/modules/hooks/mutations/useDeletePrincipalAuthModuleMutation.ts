 ...
 * ```
 */
export function useDeletePrincipalAuthModuleMutation<S extends PrincipalAuthModuleSelect>(params: {
  selection: ({
...
export function useDeletePrincipalAuthModuleMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().principalAuthModule.delete({
      where: {
        id
      },
      select: args.select
