 ...
 * ```
 */
export function useDeleteBlueprintTemplateMutation<S extends BlueprintTemplateSelect>(params: {
  selection: ({
...
export function useDeleteBlueprintTemplateMutation(params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      id: string;
    }) => getClient().blueprintTemplate.delete({
      where: {
        id
      },
      select: args.select
