                        ...
                        spec: {
                            ...
                            containers: [{
                                ...
                                env: [
                                    ...
                                    // Mocks for App Startup
                                    { name: "GRAPHQL_URL", value: "http://localhost:8080/graphql" },
                                    { name: "MAILGUN_DOMAIN", value: "test.com" },
                                    { name: "MAILGUN_API_KEY", value: "key-123" },
                                    { name: "MAILGUN_KEY", value: "key-123" },
                                    { name: "MAILGUN_FROM", value: "no-reply@test.com" },
                                    { name: "MAILGUN_REPLY", value: "no-reply@test.com" }
                                ]
                            }]
                        }
                    }
