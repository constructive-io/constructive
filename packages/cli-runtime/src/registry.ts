...
function jsonSnapshot<T>(value: T, label: string): T {
  try {
...
function snapshotCommand(command: CommandDefinition): CommandDefinition {
...
export class CommandRegistry {
  ...
  constructor(commands: readonly CommandDefinition[]) {
    ...
    for (const command of this.byId.values()) validateExamples(command);
  }
