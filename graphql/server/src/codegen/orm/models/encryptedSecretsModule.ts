...
import {
  ...
  type EncryptedSecretsModuleWithRelations,
  type EncryptedSecretsModuleSelect,
  type EncryptedSecretsModuleFilter,
  type EncryptedSecretsModulesOrderBy,
  type CreateEncryptedSecretsModuleInput,
  type UpdateEncryptedSecretsModuleInput,
  type EncryptedSecretsModulePatch,
} from '../input-types';
...
export class EncryptedSecretsModuleModel {
  ...
  findMany<const S extends EncryptedSecretsModuleSelect>(
    args?: FindManyArgs<
      S,
      EncryptedSecretsModuleFilter,
      EncryptedSecretsModulesOrderBy
    >
  ): QueryBuilder<{
  ...
  findFirst<const S extends EncryptedSecretsModuleSelect>(
  ...
  create<const S extends EncryptedSecretsModuleSelect>(
    args: CreateArgs<
      S,
  ...
  update<const S extends EncryptedSecretsModuleSelect>(
    args: UpdateArgs<S, { id: string }, EncryptedSecretsModulePatch>
  ): QueryBuilder<{
  ...
  delete(
    ...
    deleteEncryptedSecretsModule: { encryptedSecretsModule: { id: string } };
  }> {
