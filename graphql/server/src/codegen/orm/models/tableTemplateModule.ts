...
export class TableTemplateModuleModel {
  ...
  findMany<const S extends TableTemplateModuleSelect>(
    args?: FindManyArgs<
      DeepExact<S, TableTemplateModuleSelect>,
      TableTemplateModuleFilter,
      TableTemplateModulesOrderBy
    >,
  ): QueryBuilder<{
  ...
  findFirst<const S extends TableTemplateModuleSelect>(
    args?: FindFirstArgs<
      DeepExact<S, TableTemplateModuleSelect>,
      TableTemplateModuleFilter
    >,
  ...
  create<const S extends TableTemplateModuleSelect>(
    args: CreateArgs<
      DeepExact<S, TableTemplateModuleSelect>,
    ...
    createTableTemplateModule: {
      tableTemplateModule: InferSelectResult<
        TableTemplateModuleWithRelations,
        S
      >;
    };
  ...
  update<const S extends TableTemplateModuleSelect>(
    args: UpdateArgs<
      DeepExact<S, TableTemplateModuleSelect>,
      {
        id: string;
