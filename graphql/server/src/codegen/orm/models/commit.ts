...
export class CommitModel {
  ...
  findMany<const S extends CommitSelect>(
    args?: FindManyArgs<
      DeepExact<S, CommitSelect>,
      CommitFilter,
      CommitsOrderBy
    >,
  ): QueryBuilder<{
  ...
  findFirst<const S extends CommitSelect>(
    args?: FindFirstArgs<DeepExact<S, CommitSelect>, CommitFilter>,
  ): QueryBuilder<{
    commits: {
  ...
  create<const S extends CommitSelect>(
    args: CreateArgs<DeepExact<S, CommitSelect>, CreateCommitInput['commit']>,
  ): QueryBuilder<{
    createCommit: {
  ...
  update<const S extends CommitSelect>(
    args: UpdateArgs<
      DeepExact<S, CommitSelect>,
      {
        id: string;
