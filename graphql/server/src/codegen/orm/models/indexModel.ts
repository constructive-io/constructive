...
export class IndexModel {
  ...
  findMany<const S extends IndexSelect>(
    args?: FindManyArgs<DeepExact<S, IndexSelect>, IndexFilter, IndicesOrderBy>,
  ): QueryBuilder<{
  ...
  findFirst<const S extends IndexSelect>(
    args?: FindFirstArgs<DeepExact<S, IndexSelect>, IndexFilter>,
  ): QueryBuilder<{
    indices: {
  ...
  create<const S extends IndexSelect>(
    args: CreateArgs<DeepExact<S, IndexSelect>, CreateIndexInput['index']>,
  ): QueryBuilder<{
    createIndex: {
