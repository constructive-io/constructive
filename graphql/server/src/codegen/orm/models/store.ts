...
export class StoreModel {
  ...
  findMany<const S extends StoreSelect>(
    args?: FindManyArgs<DeepExact<S, StoreSelect>, StoreFilter, StoresOrderBy>,
  ): QueryBuilder<{
  ...
  findFirst<const S extends StoreSelect>(
    args?: FindFirstArgs<DeepExact<S, StoreSelect>, StoreFilter>,
  ): QueryBuilder<{
    stores: {
  ...
  create<const S extends StoreSelect>(
    args: CreateArgs<DeepExact<S, StoreSelect>, CreateStoreInput['store']>,
  ): QueryBuilder<{
    createStore: {
  ...
  update<const S extends StoreSelect>(
    args: UpdateArgs<
      DeepExact<S, StoreSelect>,
      {
        id: string;
      },
      StorePatch
