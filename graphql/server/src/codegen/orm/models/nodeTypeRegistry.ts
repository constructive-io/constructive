...
export class NodeTypeRegistryModel {
  ...
  findMany<const S extends NodeTypeRegistrySelect>(
    args?: FindManyArgs<
      DeepExact<S, NodeTypeRegistrySelect>,
      NodeTypeRegistryFilter,
      NodeTypeRegistriesOrderBy
    >,
  ): QueryBuilder<{
    nodeTypeRegistries: ConnectionResult<
      InferSelectResult<NodeTypeRegistryWithRelations, S>
    >;
  }> {
  ...
  findFirst<const S extends NodeTypeRegistrySelect>(
    args?: FindFirstArgs<
      DeepExact<S, NodeTypeRegistrySelect>,
      NodeTypeRegistryFilter
    >,
  ...
  create<const S extends NodeTypeRegistrySelect>(
    args: CreateArgs<
      DeepExact<S, NodeTypeRegistrySelect>,
  ...
  update<const S extends NodeTypeRegistrySelect>(
    args: UpdateArgs<
      DeepExact<S, NodeTypeRegistrySelect>,
      {
        id: string;
