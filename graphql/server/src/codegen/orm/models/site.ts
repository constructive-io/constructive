...
export class SiteModel {
  ...
  findMany<const S extends SiteSelect>(
    args?: FindManyArgs<DeepExact<S, SiteSelect>, SiteFilter, SitesOrderBy>,
  ): QueryBuilder<{
  ...
  findFirst<const S extends SiteSelect>(
    args?: FindFirstArgs<DeepExact<S, SiteSelect>, SiteFilter>,
  ): QueryBuilder<{
    sites: {
  ...
  create<const S extends SiteSelect>(
    args: CreateArgs<DeepExact<S, SiteSelect>, CreateSiteInput["site"]>,
  ): QueryBuilder<{
    createSite: {
