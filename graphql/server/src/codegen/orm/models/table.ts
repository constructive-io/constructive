...
export class TableModel {
  ...
  findMany<const S extends TableSelect>(
    args?: FindManyArgs<DeepExact<S, TableSelect>, TableFilter, TablesOrderBy>,
  ): QueryBuilder<{
  ...
  findFirst<const S extends TableSelect>(
    args?: FindFirstArgs<DeepExact<S, TableSelect>, TableFilter>,
  ): QueryBuilder<{
    tables: {
  ...
  create<const S extends TableSelect>(
    args: CreateArgs<DeepExact<S, TableSelect>, CreateTableInput["table"]>,
  ): QueryBuilder<{
    createTable: {
