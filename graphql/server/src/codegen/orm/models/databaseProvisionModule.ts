...
import type {
  ...
  DatabaseProvisionModulesOrderBy,
...
export class DatabaseProvisionModuleModel {
  ...
  findMany<const S extends DatabaseProvisionModuleSelect>(
    args?: FindManyArgs<
      DeepExact<S, DatabaseProvisionModuleSelect>,
      DatabaseProvisionModuleFilter,
      DatabaseProvisionModulesOrderBy
    >,
  ): QueryBuilder<{
  ...
  findFirst<const S extends DatabaseProvisionModuleSelect>(
    args?: FindFirstArgs<
      DeepExact<S, DatabaseProvisionModuleSelect>,
      DatabaseProvisionModuleFilter
    >,
  ...
  create<const S extends DatabaseProvisionModuleSelect>(
    args: CreateArgs<
      DeepExact<S, DatabaseProvisionModuleSelect>,
    ...
    createDatabaseProvisionModule: {
      databaseProvisionModule: InferSelectResult<
        DatabaseProvisionModuleWithRelations,
        S
      >;
    };
  ...
  update<const S extends DatabaseProvisionModuleSelect>(
    args: UpdateArgs<
      DeepExact<S, DatabaseProvisionModuleSelect>,
      {
        id: string;
