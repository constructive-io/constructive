...
export class TableModuleModel {
  ...
  findMany<const S extends TableModuleSelect>(
    args?: FindManyArgs<
      DeepExact<S, TableModuleSelect>,
      TableModuleFilter,
      TableModulesOrderBy
    >,
  ): QueryBuilder<{
    tableModules: ConnectionResult<
      InferSelectResult<TableModuleWithRelations, S>
    >;
  }> {
  ...
  findFirst<const S extends TableModuleSelect>(
    args?: FindFirstArgs<DeepExact<S, TableModuleSelect>, TableModuleFilter>,
  ): QueryBuilder<{
    tableModules: {
  ...
  create<const S extends TableModuleSelect>(
    args: CreateArgs<
      DeepExact<S, TableModuleSelect>,
  ...
  update<const S extends TableModuleSelect>(
    args: UpdateArgs<
      DeepExact<S, TableModuleSelect>,
      {
        id: string;
