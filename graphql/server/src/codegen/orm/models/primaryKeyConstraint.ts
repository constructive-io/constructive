...
import {
  ...
  type PrimaryKeyConstraintWithRelations,
  type PrimaryKeyConstraintSelect,
  type PrimaryKeyConstraintFilter,
  type PrimaryKeyConstraintsOrderBy,
  type CreatePrimaryKeyConstraintInput,
  type UpdatePrimaryKeyConstraintInput,
  type PrimaryKeyConstraintPatch,
} from '../input-types';
...
export class PrimaryKeyConstraintModel {
  ...
  findMany<const S extends PrimaryKeyConstraintSelect>(
    args?: FindManyArgs<
      S,
      PrimaryKeyConstraintFilter,
      PrimaryKeyConstraintsOrderBy
    >
  ): QueryBuilder<{
  ...
  findFirst<const S extends PrimaryKeyConstraintSelect>(
  ...
  update<const S extends PrimaryKeyConstraintSelect>(
    args: UpdateArgs<S, { id: string }, PrimaryKeyConstraintPatch>
  ): QueryBuilder<{
  ...
  delete(
    ...
    deletePrimaryKeyConstraint: { primaryKeyConstraint: { id: string } };
  }> {
