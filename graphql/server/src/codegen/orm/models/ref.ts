...
export class RefModel {
  ...
  findMany<const S extends RefSelect>(
    args?: FindManyArgs<DeepExact<S, RefSelect>, RefFilter, RefsOrderBy>,
  ): QueryBuilder<{
  ...
  findFirst<const S extends RefSelect>(
    args?: FindFirstArgs<DeepExact<S, RefSelect>, RefFilter>,
  ): QueryBuilder<{
    refs: {
  ...
  create<const S extends RefSelect>(
    args: CreateArgs<DeepExact<S, RefSelect>, CreateRefInput["ref"]>,
  ): QueryBuilder<{
    createRef: {
  ...
  update<const S extends RefSelect>(
    args: UpdateArgs<
      DeepExact<S, RefSelect>,
      {
        id: string;
      },
      RefPatch
