...
import {
  ...
  type DenormalizedTableFieldSelect,
  type DenormalizedTableFieldFilter,
  type DenormalizedTableFieldsOrderBy,
  type CreateDenormalizedTableFieldInput,
  type UpdateDenormalizedTableFieldInput,
  type DenormalizedTableFieldPatch,
} from '../input-types';
...
export class DenormalizedTableFieldModel {
  ...
  findMany<const S extends DenormalizedTableFieldSelect>(
    args?: FindManyArgs<
      S,
      DenormalizedTableFieldFilter,
      DenormalizedTableFieldsOrderBy
    >
  ): QueryBuilder<{
  ...
  findFirst<const S extends DenormalizedTableFieldSelect>(
  ...
  create<const S extends DenormalizedTableFieldSelect>(
    args: CreateArgs<
      S,
    ...
    createDenormalizedTableField: {
      denormalizedTableField: InferSelectResult<
  ...
  update<const S extends DenormalizedTableFieldSelect>(
    args: UpdateArgs<S, { id: string }, DenormalizedTableFieldPatch>
  ): QueryBuilder<{
  ...
  delete(
    ...
    deleteDenormalizedTableField: { denormalizedTableField: { id: string } };
  }> {
