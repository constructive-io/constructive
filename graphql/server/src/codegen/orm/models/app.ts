...
export class AppModel {
  ...
  findMany<const S extends AppSelect>(
    args?: FindManyArgs<DeepExact<S, AppSelect>, AppFilter, AppsOrderBy>,
  ): QueryBuilder<{
  ...
  findFirst<const S extends AppSelect>(
    args?: FindFirstArgs<DeepExact<S, AppSelect>, AppFilter>,
  ): QueryBuilder<{
    apps: {
  ...
  create<const S extends AppSelect>(
    args: CreateArgs<DeepExact<S, AppSelect>, CreateAppInput['app']>,
  ): QueryBuilder<{
    createApp: {
