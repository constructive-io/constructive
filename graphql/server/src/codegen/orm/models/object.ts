...
export class ObjectModel {
  ...
  findMany<const S extends ObjectSelect>(
    args?: FindManyArgs<
      DeepExact<S, ObjectSelect>,
      ObjectFilter,
      ObjectsOrderBy
    >,
  ): QueryBuilder<{
  ...
  findFirst<const S extends ObjectSelect>(
    args?: FindFirstArgs<DeepExact<S, ObjectSelect>, ObjectFilter>,
  ): QueryBuilder<{
    objects: {
  ...
  create<const S extends ObjectSelect>(
    args: CreateArgs<DeepExact<S, ObjectSelect>, CreateObjectInput['object']>,
  ): QueryBuilder<{
    createObject: {
  ...
  update<const S extends ObjectSelect>(
    args: UpdateArgs<
      DeepExact<S, ObjectSelect>,
      {
        id: string;
